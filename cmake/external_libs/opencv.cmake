...
if(MSVC)
    ...
    add_library(luojianet_ms::opencv_core ALIAS opencv::opencv_core451.lib)
    add_library(luojianet_ms::opencv_imgcodecs ALIAS opencv::opencv_imgcodecs451.lib)
    add_library(luojianet_ms::opencv_imgproc ALIAS opencv::opencv_imgproc451.lib)
elseif(WIN32)
    if("${BUILD_LITE}" STREQUAL "on" OR PYTHON_VERSION MATCHES "3.9")
        include_directories(${opencv_INC})
        add_library(luojianet_ms::opencv_core ALIAS opencv::libopencv_core451.dll.a)
        add_library(luojianet_ms::opencv_imgcodecs ALIAS opencv::libopencv_imgcodecs451.dll.a)
        add_library(luojianet_ms::opencv_imgproc ALIAS opencv::libopencv_imgproc451.dll.a)
    elseif(PYTHON_VERSION MATCHES "3.8" OR PYTHON_VERSION MATCHES "3.7")
        include_directories(${opencv_INC})
        add_library(luojianet_ms::opencv_core ALIAS opencv::libopencv_core420.dll.a)
        add_library(luojianet_ms::opencv_imgcodecs ALIAS opencv::libopencv_imgcodecs420.dll.a)
        add_library(luojianet_ms::opencv_imgproc ALIAS opencv::libopencv_imgproc420.dll.a)
    endif()
else()
