...
set(LUOJIANET_LITE_LIB_NAME libluojianet_ms-lite)
set(LUOJIANET_CORE_LIB_NAME libluojianet_core)
...
set(LUOJIANET_LITE_TRAIN_LIB_NAME libluojianet_ms-lite-train)
...
function(__install_micro_wrapper)
    ...
    install(DIRECTORY ${NNACL_DIR}/intrinsics DESTINATION ${CODEGEN_ROOT_DIR}/include/nnacl
            COMPONENT ${RUNTIME_COMPONENT_NAME} FILES_MATCHING PATTERN "*.h")
    install(DIRECTORY ${TOP_DIR}/luojianet_ms/lite/micro/coder/wrapper DESTINATION ${CODEGEN_ROOT_DIR}/include
            COMPONENT ${RUNTIME_COMPONENT_NAME} FILES_MATCHING PATTERN "*.h")
...
if(PLATFORM_ARM64)
    ...
    if(SUPPORT_TRAIN)
        ...
        install(FILES ${TOP_DIR}/luojianet_ms/lite/build/src/${LUOJIANET_LITE_TRAIN_LIB_NAME}.so DESTINATION
                ${RUNTIME_LIB_DIR} COMPONENT ${RUNTIME_COMPONENT_NAME})
        install(FILES ${TOP_DIR}/luojianet_ms/lite/build/src/${LUOJIANET_LITE_TRAIN_LIB_NAME}.a DESTINATION
                ${RUNTIME_LIB_DIR} COMPONENT ${RUNTIME_COMPONENT_NAME})
    else()
        install(DIRECTORY ${TOP_DIR}/luojianet_ms/lite/include/ DESTINATION ${RUNTIME_INC_DIR}
    ...
    install(FILES ${TOP_DIR}/luojianet_ms/lite/build/schema/ops_types_generated.h DESTINATION ${RUNTIME_INC_DIR}/schema
            COMPONENT ${RUNTIME_COMPONENT_NAME})
    install(FILES ${TOP_DIR}/luojianet_ms/lite/build/src/${LUOJIANET_LITE_LIB_NAME}.so DESTINATION ${RUNTIME_LIB_DIR}
            COMPONENT ${RUNTIME_COMPONENT_NAME})
    install(FILES ${TOP_DIR}/luojianet_ms/lite/build/src/${LUOJIANET_LITE_LIB_NAME}.a DESTINATION ${RUNTIME_LIB_DIR}
            COMPONENT ${RUNTIME_COMPONENT_NAME})
    if(ENABLE_MODEL_OBF)
            ...
            if(TARGET_HIMIX)
                if(${MSLITE_REGISTRY_DEVICE}  STREQUAL "Hi3516D" OR ${MSLITE_REGISTRY_DEVICE}  STREQUAL "Hi3519A")
                    ...
                    if(${MSLITE_REGISTRY_DEVICE}  STREQUAL "Hi3516D")
                        install(FILES
                                ${TOP_DIR}/luojianet_ms/lite/tools/benchmark/nnie/third_patry/${MICRO_NNIE_LIB_NAME}.so
                                DESTINATION ${PROVIDERS_LIB_DIR}/${MSLITE_REGISTRY_DEVICE}
                                COMPONENT ${RUNTIME_COMPONENT_NAME})
                    endif()
                endif()
...
elseif(WIN32)
    ...
    install(DIRECTORY ${TOP_DIR}/include/c_api/ DESTINATION ${RUNTIME_INC_DIR}/c_api
            COMPONENT ${RUNTIME_COMPONENT_NAME} FILES_MATCHING PATTERN "*.h")
    if(MSVC)
        install(FILES ${TOP_DIR}/build/luojianet_ms/src/${LUOJIANET_LITE_LIB_NAME}.lib DESTINATION ${RUNTIME_LIB_DIR}
                COMPONENT ${RUNTIME_COMPONENT_NAME})
        install(FILES ${TOP_DIR}/build/luojianet_ms/src/${LUOJIANET_LITE_LIB_NAME}.dll DESTINATION ${RUNTIME_LIB_DIR}
                COMPONENT ${RUNTIME_COMPONENT_NAME})
        install(FILES ${TOP_DIR}/build/luojianet_ms/src/${LUOJIANET_LITE_LIB_NAME}.dll.lib DESTINATION ${RUNTIME_LIB_DIR}
                COMPONENT ${RUNTIME_COMPONENT_NAME})
    else()
        install(FILES ${TOP_DIR}/build/luojianet_ms/src/${LUOJIANET_LITE_LIB_NAME}.a DESTINATION ${RUNTIME_LIB_DIR}
                COMPONENT ${RUNTIME_COMPONENT_NAME})
        install(FILES ${TOP_DIR}/build/luojianet_ms/src/${LUOJIANET_LITE_LIB_NAME}.dll.a DESTINATION ${RUNTIME_LIB_DIR}
                COMPONENT ${RUNTIME_COMPONENT_NAME})
        install(FILES ${TOP_DIR}/build/luojianet_ms/src/${LUOJIANET_LITE_LIB_NAME}.dll DESTINATION ${RUNTIME_LIB_DIR}
                COMPONENT ${RUNTIME_COMPONENT_NAME})
    ...
    if(MSLITE_ENABLE_CONVERTER)
        ...
        if(MSLITE_ENABLE_ACL)
            ...
            install(FILES ${LITE_ACL_DIR}/luojianet_shared_lib/libluojianet_shared_lib.so
                    DESTINATION ${CONVERTER_ROOT_DIR}/lib COMPONENT ${RUNTIME_COMPONENT_NAME})
