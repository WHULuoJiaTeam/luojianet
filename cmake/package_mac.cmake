...
if(USE_GLOG)
    install(FILES ${glog_LIBPATH}/libluojianet_ms_glog.0.4.0.dylib
        DESTINATION ${INSTALL_LIB_DIR} RENAME libluojianet_ms_glog.0.dylib COMPONENT luojianet_ms)
endif()
...
if(MS_BUILD_GRPC)
    install(FILES ${grpc_LIBPATH}/libluojianet_ms_grpc++.1.36.1.dylib
        DESTINATION ${INSTALL_LIB_DIR} RENAME libluojianet_ms_grpc++.1.dylib COMPONENT luojianet_ms)
    install(FILES ${grpc_LIBPATH}/libluojianet_ms_grpc.15.0.0.dylib
        DESTINATION ${INSTALL_LIB_DIR} RENAME libluojianet_ms_grpc.15.dylib COMPONENT luojianet_ms)
    install(FILES ${grpc_LIBPATH}/libluojianet_ms_gpr.15.0.0.dylib
        DESTINATION ${INSTALL_LIB_DIR} RENAME libluojianet_ms_gpr.15.dylib COMPONENT luojianet_ms)
    install(FILES ${grpc_LIBPATH}/libluojianet_ms_upb.15.0.0.dylib
        DESTINATION ${INSTALL_LIB_DIR} RENAME libluojianet_ms_upb.15.dylib COMPONENT luojianet_ms)
    install(FILES ${grpc_LIBPATH}/libluojianet_ms_address_sorting.15.0.0.dylib
        DESTINATION ${INSTALL_LIB_DIR} RENAME libluojianet_ms_address_sorting.15.dylib COMPONENT luojianet_ms)
endif()
...
if(ENABLE_MINDDATA)
    ...
    install(FILES ${opencv_LIBPATH}/libopencv_core.4.5.2.dylib
        DESTINATION ${INSTALL_LIB_DIR} RENAME libopencv_core.4.5.dylib COMPONENT luojianet_ms)
    install(FILES ${opencv_LIBPATH}/libopencv_imgcodecs.4.5.2.dylib
        DESTINATION ${INSTALL_LIB_DIR} RENAME libopencv_imgcodecs.4.5.dylib COMPONENT luojianet_ms)
    install(FILES ${opencv_LIBPATH}/libopencv_imgproc.4.5.2.dylib
        DESTINATION ${INSTALL_LIB_DIR} RENAME libopencv_imgproc.4.5.dylib COMPONENT luojianet_ms)
    install(FILES ${tinyxml2_LIBPATH}/libtinyxml2.8.0.0.dylib
        DESTINATION ${INSTALL_LIB_DIR} RENAME libtinyxml2.8.dylib COMPONENT luojianet_ms)

    install(FILES ${icu4c_LIBPATH}/libicuuc.69.1.dylib
        DESTINATION ${INSTALL_LIB_DIR} RENAME libicuuc.69.dylib COMPONENT luojianet_ms)
    install(FILES ${icu4c_LIBPATH}/libicudata.69.1.dylib
        DESTINATION ${INSTALL_LIB_DIR} RENAME libicudata.69.dylib COMPONENT luojianet_ms)
    install(FILES ${icu4c_LIBPATH}/libicui18n.69.1.dylib
        DESTINATION ${INSTALL_LIB_DIR} RENAME libicui18n.69.dylib COMPONENT luojianet_ms)
endif()

if(ENABLE_CPU)
    install(FILES ${onednn_LIBPATH}/libdnnl.2.2.dylib
        DESTINATION ${INSTALL_LIB_DIR} RENAME libdnnl.2.dylib COMPONENT luojianet_ms)
    install(
        TARGETS nnacl
        DESTINATION ${INSTALL_LIB_DIR}
        COMPONENT luojianet_ms
