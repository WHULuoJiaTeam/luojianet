...
function(__find_pkg_then_add_target pkg_name pkg_exe lib_path)
    ...
    if(pkg_exe)
        ...
        if(NOT EXISTS ${${pkg_name}_BASE_DIR}/bin/${pkg_exe})
            ...
            set_target_properties(${pkg_name}::${pkg_exe} PROPERTIES
                IMPORTED_LOCATION ${${pkg_name}_BASE_DIR}/bin/${pkg_exe}
                )
        endif()
...
function(luojianet_ms_add_pkg pkg_name)
    ...
    set(options)
    set(oneValueArgs URL MD5 GIT_REPOSITORY GIT_TAG VER EXE DIR SUB_DIR HEAD_ONLY CMAKE_PATH RELEASE LIB_PATH CUSTOM_CMAKE)
    set(multiValueArgs
