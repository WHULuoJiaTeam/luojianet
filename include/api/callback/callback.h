 ...
 */
#ifndef LUOJIANET_MS_INCLUDE_API_CALLBACK_CALLBACK_H
#define LUOJIANET_MS_INCLUDE_API_CALLBACK_CALLBACK_H
...
#endif  // LUOJIANET_MS_INCLUDE_API_CALLBACK_CALLBACK_H
