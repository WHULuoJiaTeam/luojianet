 ...
 */
#ifndef LUOJIANET_INCLUDE_API_CALLBACK_LOSS_MONITOR_H
#define LUOJIANET_INCLUDE_API_CALLBACK_LOSS_MONITOR_H
...
#endif  // LUOJIANET_INCLUDE_API_CALLBACK_LOSS_MONITOR_H
