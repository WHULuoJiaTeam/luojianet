...
void AddOutputAndCallerToMap(const CNodePtr &cnode, luojianet_ms::HashMap<AnfNodePtr, AnfNodePtr> *out_caller_map) {
...
bool NodePass::Run(const FuncGraphPtr &func_graph) {
  ...
  luojianet_ms::HashMap<AnfNodePtr, AnfNodePtr> subgraph_out_caller_map = {};
  luojianet_ms::HashSet<AnfNodePtr> seen_node;
