 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_COMMON_NODE_PASS_H_
#define LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_COMMON_NODE_PASS_H_
#include <string>
#include <memory>
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_COMMON_NODE_PASS_H_
