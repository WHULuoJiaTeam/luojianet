...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_COMMON_PATTERN_ENGINE_H_
#define LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_COMMON_PATTERN_ENGINE_H_
...
using PrimitiveVarMap = luojianet_ms::HashMap<PrimitivePtr, VarPtr>;
...
namespace std {
using luojianet_ms::ERROR;
using luojianet_ms::LogStream;
using luojianet_ms::NoExceptionType;
template <>
struct hash<luojianet_ms::VarPtr> {
  std::size_t operator()(const luojianet_ms::VarPtr var) const {
    if (var == nullptr) {
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_COMMON_PATTERN_ENGINE_H_
