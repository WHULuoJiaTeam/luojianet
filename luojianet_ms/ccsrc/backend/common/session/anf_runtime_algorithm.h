...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_SESSION_ANF_RUNTIME_ALGORITHM_H
#define LUOJIANET_MS_CCSRC_BACKEND_SESSION_ANF_RUNTIME_ALGORITHM_H
#include <iostream>
#include <string>
#include <vector>
#include <set>
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_SESSION_ANF_RUNTIME_ALGORITHM_H
