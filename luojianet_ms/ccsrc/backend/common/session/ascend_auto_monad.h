 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_SESSION_ASCEND_AUTO_MONAD_H
#define LUOJIANET_MS_CCSRC_BACKEND_SESSION_ASCEND_AUTO_MONAD_H
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_SESSION_ASCEND_AUTO_MONAD_H
