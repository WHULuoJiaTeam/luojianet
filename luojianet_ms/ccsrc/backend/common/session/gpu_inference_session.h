 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_SESSION_GPU_INFERENCE_SESSION_H
#define LUOJIANET_MS_CCSRC_BACKEND_SESSION_GPU_INFERENCE_SESSION_H
#include <string>
#include <memory>
#include <vector>
#include <utility>
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_SESSION_GPU_INFERENCE_SESSION_H
