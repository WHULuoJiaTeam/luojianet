...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_SESSION_KERNEL_BUILD_CLIENT_H_
#define LUOJIANET_MS_CCSRC_BACKEND_SESSION_KERNEL_BUILD_CLIENT_H_
...
class AscendKernelBuildClient : public KernelBuildClient {
 public:
  ...
  constexpr inline static auto kGetPathScript =
    ...
    "import pkgutil;"
    "path = pkgutil"
    ".get_loader(\\\"luojianet_ms._extends.remote.kernel_build_server_ascend\\\")"  // Server module name
    ".get_filename();"
    "print('[~]' + path)"
    "\"";
...
class AkgKernelBuildClient : public KernelBuildClient {
 public:
  ...
  constexpr inline static auto kGetPathScript =
    ...
    "import pkgutil;"
    "path = pkgutil"
    ".get_loader(\\\"luojianet_ms._extends.remote.kernel_build_server_akg\\\")"  // Server module name
    ".get_filename();"
    "print('[~]' + path)"
    "\"";
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_SESSION_KERNEL_BUILD_CLIENT_H_
