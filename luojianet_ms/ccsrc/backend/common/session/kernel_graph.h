 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_SESSION_KERNEL_GRAPH_H
#define LUOJIANET_MS_CCSRC_BACKEND_SESSION_KERNEL_GRAPH_H
...
class BACKEND_EXPORT KernelGraph : public FuncGraph {
 public:
  ...
  const luojianet_ms::HashMap<AnfNodePtr, AnfNodePtr> &backend_front_anf_map() const { return backend_front_anf_map_; }
  ...
  const luojianet_ms::HashSet<ValueNodePtr> graph_value_nodes() const { return graph_value_nodes_; }
  ...
  void set_device_loop_ctrl_params(const std::map<std::string, luojianet_ms::ParameterPtr> &device_loop_ctrl_params) {
    device_loop_ctrl_params_ = device_loop_ctrl_params;
  }
  const std::map<std::string, luojianet_ms::ParameterPtr> device_loop_control_params() const {
  ...
  luojianet_ms::HashMap<uint32_t, std::weak_ptr<session::KernelGraph>> get_pre_graphs() const { return pre_graphs_; }
  ...
  const luojianet_ms::HashMap<CNodePtr, std::pair<CNodePtr, CNodePtr>> &allreduce_from_send_recv_pairs() const {
    return allreduce_from_send_recv_pairs_;
  }
  const luojianet_ms::HashMap<CNodePtr, std::pair<CNodePtr, CNodePtr>> &allreduce_to_send_recv_pairs() const {
  ...
  const luojianet_ms::HashMap<AnfNodePtr, AnfNodePtr> &front_backend_anf_map() const { return front_backend_anf_map_; }
 ...
 private:
  ...
  void EnqueueReadyNodes(const AnfNodePtr &node, std::queue<AnfNodePtr> *visit_queue,
                         luojianet_ms::HashSet<AnfNodePtr> *visited_nodes, bool comm_first = true);
  ...
  luojianet_ms::HashMap<AnfNodePtr, AnfNodePtr> front_backend_anf_map_;
  luojianet_ms::HashMap<AnfNodePtr, AnfNodePtr> backend_front_anf_map_;
  luojianet_ms::HashMap<AnfNodePtr, AnfWithOutIndex> tuple_backend_front_anf_index_map_;
  // there may be a tensor from ME backend ,a value ndoe will be create according the tensor,map record
  luojianet_ms::HashMap<tensor::TensorPtr, ValueNodePtr> tensor_to_value_node_map_;
  // include all value nodes
  luojianet_ms::HashSet<ValueNodePtr> graph_value_nodes_;
  luojianet_ms::HashMap<AnfNodePtr, size_t> node_input_num_;
  luojianet_ms::HashMap<AnfNodePtr, std::vector<std::pair<AnfNodePtr, size_t>>> node_input_edges_;
  ...
  luojianet_ms::HashMap<AnfNodePtr, std::vector<std::pair<AnfNodePtr, size_t>>> node_output_edges_;
  std::map<std::string, std::pair<AnfNodePtr, int>> summary_nodes_;
  // parameters that will be updated when graph is executed
  luojianet_ms::HashSet<ParameterPtr> updated_parameters_;
  ...
  std::map<std::string, luojianet_ms::ParameterPtr> device_loop_ctrl_params_;
  ...
  luojianet_ms::HashMap<AnfNodePtr, AnfWithOutIndex> internal_parameter_to_front_node_map_;
  ...
  luojianet_ms::HashMap<AnfNodePtr, AnfNodePtr> front_to_internal_outputs_map_;
  luojianet_ms::HashMap<AnfNodePtr, luojianet_ms::HashMap<size_t, std::pair<AnfNodePtr, bool>>>
    internal_outputs_to_front_map_;
  luojianet_ms::HashMap<AnfNodePtr, luojianet_ms::HashMap<size_t, tensor::TensorPtr>> internal_outputs_tensor_map_;
  uint32_t current_epoch_;
  luojianet_ms::HashMap<AnfNodePtr, AnfNodePtr> tuple_parameter_to_make_tuple_map_;
  ...
  luojianet_ms::HashMap<uint32_t, std::weak_ptr<session::KernelGraph>> pre_graphs_;
  luojianet_ms::HashMap<uint32_t, std::weak_ptr<session::KernelGraph>> post_graphs_;
  ...
  luojianet_ms::HashMap<CNodePtr, std::pair<CNodePtr, CNodePtr>> allreduce_from_send_recv_pairs_;
  luojianet_ms::HashMap<CNodePtr, std::pair<CNodePtr, CNodePtr>> allreduce_to_send_recv_pairs_;
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_SESSION_KERNEL_GRAPH_H
