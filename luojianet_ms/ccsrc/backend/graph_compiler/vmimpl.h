...
#ifndef LUOJIANET_MS_CCSRC_VM_VMIMPL_H_
#define LUOJIANET_MS_CCSRC_VM_VMIMPL_H_
...
using AnfNodePtrToBaseRefMap = luojianet_ms::HashMap<AnfNodePtr, BaseRef>;
using AnfNodePtrToAnfNodePtrMap = luojianet_ms::HashMap<AnfNodePtr, AnfNodePtr>;

using FuncGraphPtrToBaseRefMap = luojianet_ms::HashMap<FuncGraphPtr, BaseRef>;
...
#endif  // LUOJIANET_MS_CCSRC_VM_VMIMPL_H_
