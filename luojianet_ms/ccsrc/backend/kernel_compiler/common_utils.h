...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_COMMON_UTILS_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_COMMON_UTILS_H_
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_COMMON_UTILS_H_
