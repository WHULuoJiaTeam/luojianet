...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_FL_GET_KEYS_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_FL_GET_KEYS_H_
...
class GetKeysKernel : public CPUKernel {
 ...
 private:
  ...
  bool SavePublicKeyList(
    const flatbuffers::Vector<flatbuffers::Offset<luojianet_ms::schema::ClientPublicKeys>> *remote_public_key);
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_FL_GET_KEYS_H_
