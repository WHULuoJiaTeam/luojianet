...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_FL_GET_MODEL_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_FL_GET_MODEL_H_
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_FL_GET_MODEL_H_
