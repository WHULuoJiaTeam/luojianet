...
#ifndef LUOJIANET_MS_NNACL_BASE_CONV_DEPTHWISE_BASE_H_
#define LUOJIANET_MS_NNACL_BASE_CONV_DEPTHWISE_BASE_H_
...
#endif  // LUOJIANET_MS_NNACL_BASE_CONV_DEPTHWISE_BASE_H_
