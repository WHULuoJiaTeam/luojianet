...
#ifndef LUOJIANET_MS_NNACL_MINIMAL_FILTERING_GENERATOR_H_
#define LUOJIANET_MS_NNACL_MINIMAL_FILTERING_GENERATOR_H_
...
#endif  // LUOJIANET_MS_NNACL_MINIMAL_FILTERING_GENERATOR_H_
