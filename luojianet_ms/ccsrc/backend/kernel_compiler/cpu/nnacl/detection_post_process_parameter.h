...
#ifndef LUOJIANET_MS_NNACL_DETECTION_POST_PROCESS_PARAMETER_H_
#define LUOJIANET_MS_NNACL_DETECTION_POST_PROCESS_PARAMETER_H_
...
#endif  // LUOJIANET_MS_NNACL_DETECTION_POST_PROCESS_PARAMETER_H_
