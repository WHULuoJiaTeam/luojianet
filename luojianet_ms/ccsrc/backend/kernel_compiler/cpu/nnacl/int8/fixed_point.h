...
#ifndef LUOJIANET_MS_NNACL_QUANTIZATION_FIXED_POINT_H_
#define LUOJIANET_MS_NNACL_QUANTIZATION_FIXED_POINT_H_
...
#endif  // LUOJIANET_MS_NNACL_QUANTIZATION_FIXED_POINT_H_
