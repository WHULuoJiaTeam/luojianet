...
#ifndef LUOJIANET_MS_NNACL_INTRINSICS_MS_SIMD_INSTRUCTIONS_H_
#define LUOJIANET_MS_NNACL_INTRINSICS_MS_SIMD_INSTRUCTIONS_H_
#include <math.h>
...
#endif  // LUOJIANET_MS_NNACL_INTRINSICS_MS_SIMD_INSTRUCTIONS_H_
