 ...
 */
#ifndef LUOJIANET_MS_NNACL_STRIDED_SLICE_PARAMETER_H_
#define LUOJIANET_MS_NNACL_STRIDED_SLICE_PARAMETER_H_
...
#endif  // LUOJIANET_MS_NNACL_STRIDED_SLICE_PARAMETER_H_
