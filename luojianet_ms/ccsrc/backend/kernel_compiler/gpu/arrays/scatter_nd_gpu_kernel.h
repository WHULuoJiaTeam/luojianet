...
#ifndef LUOJIANET_MS_CCSRC_KERNEL_GPU_SCATTER_ND_GPU_KERNEL_H
#define LUOJIANET_MS_CCSRC_KERNEL_GPU_SCATTER_ND_GPU_KERNEL_H
...
#endif  // LUOJIANET_MS_CCSRC_KERNEL_GPU_SCATTER_ND_GPU_KERNEL_H
