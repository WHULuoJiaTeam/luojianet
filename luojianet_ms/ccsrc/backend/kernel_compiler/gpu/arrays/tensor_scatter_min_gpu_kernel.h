...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_ARRAYS_TENSOR_SCATTER_MIN_GPU_KERNEL_H
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_ARRAYS_TENSOR_SCATTER_MIN_GPU_KERNEL_H

#include <vector>
#include <algorithm>
#include "backend/kernel_compiler/gpu/cuda_impl/tensor_scatter_min.cuh"
...
class TensorScatterMinGpuKernel : public GpuKernel {
 public:
  TensorScatterMinGpuKernel()
      : input_size_(1),
        update_size_(1),
        indices_size_(1),
        output_size_(1),
  ...
  bool Launch(const std::vector<AddressPtr> &inputs, const std::vector<AddressPtr> &workspace,
    ...
    if (!memcpy_flag_) {
      ...
      CHECK_CUDA_RET_WITH_EXCEPT(kernel_node_,
                                 ...
                                 "cudaMemcpy failed in TensorScatterMinGpuKernel::Launch.");
      CHECK_CUDA_RET_WITH_EXCEPT(kernel_node_,
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_ARRAYS_TENSOR_SCATTER_MIN_GPU_KERNEL_H
