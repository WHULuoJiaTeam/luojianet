...
#ifndef LUOJIANET_MS_CCSRC_PS_PS_CACHE_KERNEL_HASH_IMPL_H_
#define LUOJIANET_MS_CCSRC_PS_PS_CACHE_KERNEL_HASH_IMPL_H_
...
void DoHashSwapIn(T *hash_table, const T *swap_in_value, const int *swap_in_index, const int index_size,
                  const int hash_dim, cudaStream_t cuda_stream);
#endif  // LUOJIANET_MS_CCSRC_PS_PS_CACHE_KERNEL_HASH_IMPL_H_
