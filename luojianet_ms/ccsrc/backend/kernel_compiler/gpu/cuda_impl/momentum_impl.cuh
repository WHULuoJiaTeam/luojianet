...
#ifndef LUOJIANET_MS_CCSRC_KERNEL_GPU_CUDA_IMP_MOMENTUMIMPL_H_
#define LUOJIANET_MS_CCSRC_KERNEL_GPU_CUDA_IMP_MOMENTUMIMPL_H_
...
void CombineFusedScaleMomentum(const size_t max, const size_t num, const size_t *element, T **scale, T **variable,
                               ...
                               cudaStream_t cuda_stream);
#endif  // LUOJIANET_MS_CCSRC_KERNEL_GPU_CUDA_IMP_MOMENTUMIMPL_H_
