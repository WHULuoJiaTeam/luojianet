...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_CUDA_IMPL_PAD_IMPL_CUH_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_CUDA_IMPL_PAD_IMPL_CUH_
...
void CalPadGradNDHWC(const size_t size, const T *dy, const int num, const int old_depth, const int old_height,
                     ...
                     const int padded_width, const int pad_head, const int pad_top, const int pad_left, T *dx,
                     cudaStream_t cuda_stream);
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_CUDA_IMPL_PAD_IMPL_CUH_
