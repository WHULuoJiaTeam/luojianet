...
#ifndef LUOJIANET_MS_CCSRC_KERNEL_GPU_CUDA_IMPL_RESIZE_BILINEAR_H_
#define LUOJIANET_MS_CCSRC_KERNEL_GPU_CUDA_IMPL_RESIZE_BILINEAR_H_
...
void CalResizeBilinearGrad(const float *input, const int n_, const int c_, const int input_h_, const int input_w_,
  ...
  cudaStream_t cuda_stream);
#endif  // LUOJIANET_MS_CCSRC_KERNEL_GPU_CUDA_IMPL_RESIZE_BILINEAR_H_
