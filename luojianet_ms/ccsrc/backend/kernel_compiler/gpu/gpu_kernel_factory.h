 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_GPUKERNELFACTORY_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_GPUKERNELFACTORY_H_
...
namespace kernel {
using luojianet_ms::device::gpu::KernelAttr;
...
class GpuKernelFactory {
 public:
  ...
  bool ReducePrecision(const std::string &kernel_name,
                       std::shared_ptr<luojianet_ms::kernel::KernelBuildInfo::KernelBuildInfoBuilder> builder);
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_GPUKERNELFACTORY_H_
