...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_NCCL_SYNC_BATCH_NORM_GPU_KERNEL_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_NCCL_SYNC_BATCH_NORM_GPU_KERNEL_H_
...
class SyncBatchNormGpuKernel : public NcclGpuKernel {
 ...
 private:
  ...
  luojianet_ms::TypeId GetTypeID(float *input) { return kNumberTypeFloat32; }
  luojianet_ms::TypeId GetTypeID(int *input) { return kNumberTypeInt32; }
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_NCCL_SYNC_BATCH_NORM_GPU_KERNEL_H_
