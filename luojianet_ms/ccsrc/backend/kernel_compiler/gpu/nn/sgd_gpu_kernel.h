...
#ifndef LUOJIANET_MS_CCSRC_KERNEL_GPU_NN_SGD_KERNEL_H_
#define LUOJIANET_MS_CCSRC_KERNEL_GPU_NN_SGD_KERNEL_H_
...
#endif  // LUOJIANET_MS_CCSRC_KERNEL_GPU_NN_SGD_KERNEL_H_
