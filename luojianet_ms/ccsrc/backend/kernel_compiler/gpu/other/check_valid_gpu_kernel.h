...
#ifndef LUOJIANET_MS_CCSRC_KERNEL_GPU_OTHER_CHECK_VALID_GPU_KERNEL_H
#define LUOJIANET_MS_CCSRC_KERNEL_GPU_OTHER_CHECK_VALID_GPU_KERNEL_H
...
#endif  // LUOJIANET_MS_CCSRC_KERNEL_GPU_OTHER_CHECK_VALID_GPU_KERNEL_H
