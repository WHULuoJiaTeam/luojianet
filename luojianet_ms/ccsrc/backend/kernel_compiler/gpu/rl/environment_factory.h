...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_ENV_FACTORY_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_ENV_FACTORY_H_
...
namespace kernel {
// Interface of LuoJiaNet built-in environment.
