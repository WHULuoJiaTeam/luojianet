...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_NN_GRU_GPU_KERNEL_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_NN_GRU_GPU_KERNEL_H_
...
template <typename T>
class GruGpuKernel : public GpuKernel {
 public:
  GruGpuKernel()
      : batch_size_(0),
        seq_len_(0),
  ...
  ~GruGpuKernel() override { DestroyResource(); }
  ...
  bool Init(const CNodePtr &kernel_node) override {
    ...
    CHECK_CUDNN_RET_WITH_EXCEPT(kernel_node_,
                                ...
                                "set rnn_desc failed");
#endif
    auto weight_shape = AnfAlgo::GetPrevNodeOutputInferShape(kernel_node, 2);
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_NN_GRU_GPU_KERNEL_H_
