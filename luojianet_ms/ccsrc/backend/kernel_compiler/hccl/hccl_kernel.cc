...
using HcclTaskInfoPtr = std::shared_ptr<luojianet_ms::ge::model_runner::HcclTaskInfo>;
using luojianet_ms::ge::model_runner::HcclTaskInfo;

namespace {
static std::map<std::string, std::string> kMsOpNameToHcomHcclType = {
  {luojianet_ms::kAllReduceOpName, luojianet_ms::kHcomOpTypeAllReduce},
  {luojianet_ms::kAllGatherOpName, luojianet_ms::kHcomOpTypeAllGather},
  {luojianet_ms::kBroadcastOpName, luojianet_ms::kHcomOpTypeBroadcast},
  {luojianet_ms::kHcomSendOpName, luojianet_ms::kHcomOpTypeSend},
  {luojianet_ms::kReceiveOpName, luojianet_ms::kHcomOpTypeReceive},
  {luojianet_ms::kReduceScatterOpName, luojianet_ms::kHcomOpTypeReduceScatter}};
