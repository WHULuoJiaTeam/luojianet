...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_HCCL_HCOM_ALL_BROADCAST_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_HCCL_HCOM_ALL_BROADCAST_H_
