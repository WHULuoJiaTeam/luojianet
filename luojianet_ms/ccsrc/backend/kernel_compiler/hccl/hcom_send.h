...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_HCCL_HCOM_SEND_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_HCCL_HCOM_SEND_H_
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_HCCL_HCOM_SEND_H_
