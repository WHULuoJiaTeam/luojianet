 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_HOST_DYNAMIC_RESHAPE_KERNEL_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_HOST_DYNAMIC_RESHAPE_KERNEL_H_
#include <vector>
#include <memory>
#include <string>
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_HOST_DYNAMIC_RESHAPE_KERNEL_H_
