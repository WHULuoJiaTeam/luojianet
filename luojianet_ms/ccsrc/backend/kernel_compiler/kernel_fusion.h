...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_KERNELFUSION_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_KERNELFUSION_H_
#include <utility>
#include <vector>
#include <map>
#include <string>
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_KERNELFUSION_H_
