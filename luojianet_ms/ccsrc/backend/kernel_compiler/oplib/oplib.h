...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_OPLIB_OPLIB_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_OPLIB_OPLIB_H_
#include <vector>
#include <string>
#include <memory>
#include <map>
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_OPLIB_OPLIB_H_
