...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_RTS_ASSIGN_H
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_RTS_ASSIGN_H
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_RTS_ASSIGN_H
