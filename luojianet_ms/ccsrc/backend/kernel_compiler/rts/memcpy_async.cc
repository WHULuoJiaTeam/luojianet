...
using luojianet_ms::ge::model_runner::MemcpyAsyncTaskInfo;
using MemcpyAsyncTaskInfoPtr = std::shared_ptr<MemcpyAsyncTaskInfo>;
using luojianet_ms::device::ascend::MemcpyRtsDynamicKernel;
...
bool MemCpyAsyncKernel::Init(const luojianet_ms::AnfNodePtr &anf_node) {
