...
bool ParseListIntValue(const luojianet_ms::ValuePtr &value, std::vector<int64_t> *attr_value) {
...
bool ParseAttrValue(const std::string &type, const luojianet_ms::ValuePtr &value, nlohmann::json *attr_obj) {
...
void ParseConstValue(const luojianet_ms::ValuePtr &value, nlohmann::json *json_obj) {
