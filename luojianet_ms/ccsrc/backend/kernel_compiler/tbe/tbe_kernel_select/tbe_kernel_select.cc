...
void TbeKernelSelect::SetTbeBuildCommonInfo(const luojianet_ms::kernel::OpInfo &op_info,
                                            luojianet_ms::kernel::KernelBuildInfo::KernelBuildInfoBuilder *builder) {
...
void TbeKernelSelect::CreateNewOpIOInfo(const luojianet_ms::kernel::OpIOInfo &op_io_info,
                                        const std::vector<std::vector<std::string>> &support_format_item, size_t index,
                                        luojianet_ms::kernel::OpIOInfo *op_io_info_new) {
...
void TbeKernelSelect::CreateNewOpInfo(const luojianet_ms::kernel::OpInfo &op_info, const SupportFormat &support_format,
                                      luojianet_ms::kernel::OpInfo *op_info_new) {
...
void TbeKernelSelect::CreateNewOpInfo(const luojianet_ms::kernel::OpInfo &op_info,
                                      luojianet_ms::kernel::OpInfo *op_info_new) {
  MS_EXCEPTION_IF_NULL(op_info_new);
