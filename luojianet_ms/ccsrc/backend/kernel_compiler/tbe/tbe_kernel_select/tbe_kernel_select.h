...
#ifndef LUOJIANET_MS_TBE_KERNEL_SELECT_H
#define LUOJIANET_MS_TBE_KERNEL_SELECT_H
...
class TbeKernelSelect {
 ...
 private:
  ...
  // op select(dynamic)
  void CreateNewOpInfo(const luojianet_ms::kernel::OpInfo &op_info, luojianet_ms::kernel::OpInfo *op_info_new);
...
#endif  // LUOJIANET_MS_TBE_KERNEL_SELECT_H
