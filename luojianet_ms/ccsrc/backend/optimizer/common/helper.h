 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_COMMON_HELPER_H_
#define LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_COMMON_HELPER_H_
...
void ConstInputToAttr(const CNodePtr &cnode, const luojianet_ms::HashSet<size_t> &input_attrs);
...
void GetCustomOpAttrIndex(const PrimitivePtr &primitive, luojianet_ms::HashSet<size_t> *indexes);
}  // namespace opt
}  // namespace luojianet_ms
#endif  // LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_COMMON_HELPER_H_
