 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_COMMON_OPTIMIZER_H_
#define LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_COMMON_OPTIMIZER_H_
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_COMMON_OPTIMIZER_H_
