...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_DECREASE_TRANSFER_PRECISION_H_
#define LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_DECREASE_TRANSFER_PRECISION_H_
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_DECREASE_TRANSFER_PRECISION_H_
