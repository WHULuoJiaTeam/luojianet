 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_GRAPH_KERNEL_MODEL_NODE_H_
#define LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_GRAPH_KERNEL_MODEL_NODE_H_
...
#include "luojianet_ms/core/ir/value.h"
#include "luojianet_ms/core/ir/tensor.h"
#include "luojianet_ms/core/utils/shape_utils.h"
...
using DAttrs = luojianet_ms::HashMap<std::string, ValuePtr>;
...
class Node : public NodeBase, public std::enable_shared_from_this<Node> {
 public:
  ...
  const luojianet_ms::HashMap<Node *, std::set<size_t>> &users() const { return users_; }

 protected:
  std::string name_;
  DAttrs attrs_;
  NodePtrList inputs_;
  luojianet_ms::HashMap<Node *, std::set<size_t>> users_;
