 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_GRAPH_KERNEL_MODEL_OP_REGISTER_H_
#define LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_GRAPH_KERNEL_MODEL_OP_REGISTER_H_
...
class OpRegistry {
 ...
 private:
  ...
  ~OpRegistry() = default;
  luojianet_ms::HashMap<std::string, std::function<PrimOpPtr(const std::string &, const std::string &)>> creators;
};
}  // namespace luojianet_ms::graphkernel::inner
#endif
