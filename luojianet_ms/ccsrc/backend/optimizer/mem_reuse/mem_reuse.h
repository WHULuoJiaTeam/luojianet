...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_MEM_REUSE_MEM_REUSE_H_
#define LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_MEM_REUSE_MEM_REUSE_H_
#include <map>
#include <memory>
#include <vector>
...
using KernelDefPtrMaps = std::vector<luojianet_ms::memreuse::KernelDefPtr>;
...
class MemReuseUtil {
 ...
 private:
  ...
  luojianet_ms::HashMap<AnfNodePtr, session::KernelWithIndex> visit_kernel_with_return_type_in0pos_cache_;
  luojianet_ms::HashMap<AnfNodePtr, session::KernelWithIndex> visit_kernel_with_return_type_in0pos_skip_nop_cache_;
};
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_MEM_REUSE_MEM_REUSE_H_
