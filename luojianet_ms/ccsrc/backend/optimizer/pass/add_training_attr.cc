...
namespace opt {
namespace {
luojianet_ms::HashMap<std::string, luojianet_ms::HashSet<std::string>> MarkOp{
  {"LSTM", {"LSTMGradWeight", "LSTMGrad", "LSTMGradData"}}};

bool CheckOP(const FuncGraphManagerPtr &manager, const AnfNodePtr &cnode, const luojianet_ms::HashSet<std::string> &set) {
