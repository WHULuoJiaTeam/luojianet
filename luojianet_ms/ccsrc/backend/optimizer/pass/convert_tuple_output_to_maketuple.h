...
#ifndef LUOJIANET_MS_CONVERT_TUPLE_OUTPUT_TO_MAKETUPLE_H
#define LUOJIANET_MS_CONVERT_TUPLE_OUTPUT_TO_MAKETUPLE_H
#include <string>
#include <vector>
...
#endif  // LUOJIANET_MS_CONVERT_TUPLE_OUTPUT_TO_MAKETUPLE_H
