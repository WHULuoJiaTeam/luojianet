...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_OPTITIMIZER_TRT_PASS_LAYER_INPUT_H_
#define LUOJIANET_MS_CCSRC_BACKEND_OPTITIMIZER_TRT_PASS_LAYER_INPUT_H_
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_OPTITIMIZER_TRT_PASS_LAYER_INPUT_H_
