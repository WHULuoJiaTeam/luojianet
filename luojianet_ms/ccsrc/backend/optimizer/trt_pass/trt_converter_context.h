...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_OPTITIMIZER_TRT_CONVERTER_CONTEXT_H_
#define LUOJIANET_MS_CCSRC_BACKEND_OPTITIMIZER_TRT_CONVERTER_CONTEXT_H_
...
class TrtConverterContext : public std::enable_shared_from_this<TrtConverterContext> {
 ...
 private:
  ...
  luojianet_ms::HashMap<AnfNodePtr, luojianet_ms::HashMap<size_t, LayerInput>> output_map_;
  std::vector<std::shared_ptr<tensor::Tensor>> temp_weights_;
};
}  // namespace opt
}  // namespace luojianet_ms

#endif  // LUOJIANET_MS_CCSRC_BACKEND_OPTITIMIZER_TRT_CONVERTER_HELPER_H_
