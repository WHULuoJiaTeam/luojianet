...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_OPTITIMIZER_TRT_PASS_OP_FACTORY_H_
#define LUOJIANET_MS_CCSRC_BACKEND_OPTITIMIZER_TRT_PASS_OP_FACTORY_H_
...
class TrtOpFactory {
 ...
 private:
  ...
  luojianet_ms::HashMap<std::string, ConvertFunc> op_convert_map_;
};
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_OPTITIMIZER_TRT_PASS_OP_FACTORY_H_
