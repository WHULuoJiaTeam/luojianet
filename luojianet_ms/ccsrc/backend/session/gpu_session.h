 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_SESSION_GPU_SESSION_H
#define LUOJIANET_MS_CCSRC_BACKEND_SESSION_GPU_SESSION_H
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_SESSION_GPU_SESSION_H
