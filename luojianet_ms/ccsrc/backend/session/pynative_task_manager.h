...
#ifndef LUOJIANET_MS_LUOJIANET_MS_CCSRC_BACKEND_SESSION_PYNATIVE_TASK_MANAGER_H_
#define LUOJIANET_MS_LUOJIANET_MS_CCSRC_BACKEND_SESSION_PYNATIVE_TASK_MANAGER_H_
...
#endif  // LUOJIANET_MS_LUOJIANET_MS_CCSRC_BACKEND_SESSION_PYNATIVE_TASK_MANAGER_H_
