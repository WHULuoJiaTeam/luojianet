 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_SESSION_SESSION_BASIC_H
#define LUOJIANET_MS_CCSRC_BACKEND_SESSION_SESSION_BASIC_H
...
using CallBackFunc = uint32_t (*)(uint32_t graph_id,
                                  const std::map<std::string, luojianet_ms::tensor::TensorPtr> &params_list);
...
class SessionBasic : public std::enable_shared_from_this<SessionBasic> {
 public:
  ...
  CNodePtr CreateNewCNode(const CNodePtr &cnode, KernelGraph *graph,
                          luojianet_ms::HashMap<AnfNodePtr, AnfNodePtr> *other_graph_cnode, const std::string &target);
  CNodePtr CreateNewCNode(const CNodePtr &cnode, KernelGraph *graph);
 ...
 protected:
  ...
  friend class luojianet_ms::runtime::GraphCompiler;
  ...
  luojianet_ms::HashMap<GraphId, std::shared_ptr<KernelGraph>> graphs_;
  luojianet_ms::HashMap<GraphInfo, std::shared_ptr<KernelGraph>> run_op_graphs_;
  luojianet_ms::HashMap<FuncGraph *, KernelGraphPtr> front_backend_graph_map_;
  luojianet_ms::HashMap<AnfNodePtr, AnfNodePtr> partial_parameters_map_;
  luojianet_ms::HashMap<AnfNodePtr, std::string> partial_target_map_;
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_SESSION_SESSION_BASIC_H
