...
class Graph {
  struct Cluster {
    ...
    Cluster(size_t node_id, const AnfNodePtr &node, const luojianet_ms::HashMap<AnfNodePtr, size_t> &node_idx_map)
        : cluster_id_(node_id) {
 ...
 public:
  ...
  Graph(const AnfNodePtrList &nodes, const luojianet_ms::HashMap<AnfNodePtr, size_t> &node_idx_map) {
