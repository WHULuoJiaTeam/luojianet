 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_GRAPH_KERNEL_CORE_SHAPE_OPS_SPLITTER_H_
#define LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_GRAPH_KERNEL_CORE_SHAPE_OPS_SPLITTER_H_
#include <memory>
#include <vector>
#include <utility>
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_GRAPH_KERNEL_CORE_SHAPE_OPS_SPLITTER_H_
