...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_MEM_REUSE_KERNEL_REFCOUNT_H_
#define LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_MEM_REUSE_KERNEL_REFCOUNT_H_
#include <vector>
#include <map>
#include <string>
#include <memory>
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_MEM_REUSE_KERNEL_REFCOUNT_H_
