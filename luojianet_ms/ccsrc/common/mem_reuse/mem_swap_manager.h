...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_MEM_REUSE_MEM_SWAP_MANAGER_H_
#define LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_MEM_REUSE_MEM_SWAP_MANAGER_H_
...
class MemSwapManager {
 public:
  ...
  bool Init(const luojianet_ms::session::KernelGraph *kernel_graph);
 ...
 private:
  ...
  luojianet_ms::HashMap<void *, KernelExecutionInfo> kernel_execution_info_;
  luojianet_ms::HashMap<void *, std::map<size_t, PerformPair>> kernel_swap_perform_;
  // Key: trigger swap kernel, value: MemSwapInfoSet of kernel need to be swapped
  luojianet_ms::HashMap<void *, MemSwapInfoSet> mem_swap_info_map_;
  ...
  const luojianet_ms::session::KernelGraph *kernel_graph_{nullptr};
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_MEM_REUSE_MEM_SWAP_MANAGER_H_
