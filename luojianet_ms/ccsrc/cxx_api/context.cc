...
constexpr auto kModelOptionGPUPrecisionMode = "luojianet_ms.option.gpu.precision_mode";
...
constexpr auto kModelOptionAscend310InsertOpCfgPath = "luojianet_ms.option.ascend310.insert_op_config_file_path";
constexpr auto kModelOptionAscend310InputFormat = "luojianet_ms.option.ascend310.input_format";
constexpr auto kModelOptionAscend310InputShapeMap = "luojianet_ms.option.ascend310.input_shape_map";
constexpr auto kModelOptionAscend310InputShape = "luojianet_ms.option.ascend310.input_shape";
constexpr auto kModelOptionAscend310OutputType = "luojianet_ms.option.ascend310.output_type";
constexpr auto kModelOptionAscend310PrecisionMode = "luojianet_ms.option.ascend310.precision_mode";
constexpr auto kModelOptionAscend310OpSelectImplMode = "luojianet_ms.option.ascend310.op_select_impl_mode";
constexpr auto KModelOptionAscend310FusionSwitchCfgPath = "luojianet_ms.option.ascend310.fusion_switch_config_file_path";
constexpr auto kModelOptionAscend310DynamicBatchSize = "luojianet_ms.option.ascend310.dynamic_batch_size";
constexpr auto kModelOptionAscend310BufferOptimize = "luojianet_ms.option.ascend310.buffer_optimize";
