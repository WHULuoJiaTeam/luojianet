 ...
 */
#ifndef LUOJIANET_MS_CCSRC_CXX_API_GRAPH_MS_ASCEND_GRAPH_IMPL_H
#define LUOJIANET_MS_CCSRC_CXX_API_GRAPH_MS_ASCEND_GRAPH_IMPL_H
#include <functional>
#include <map>
#include <string>
#include <vector>
...
class AscendGraphImpl : public GraphCell::GraphImpl {
 public:
  ...
  bool CheckDeviceSupport(luojianet_ms::DeviceType device_type) override;
...
#endif  // LUOJIANET_MS_CCSRC_CXX_API_GRAPH_MS_ASCEND_GRAPH_IMPL_H
