 ...
 */
#ifndef LUOJIANET_MS_CCSRC_CXX_API_MODEL_MODEL_IMPL_H
#define LUOJIANET_MS_CCSRC_CXX_API_MODEL_MODEL_IMPL_H
#include <functional>
#include <map>
#include <string>
#include <vector>
...
#endif  // LUOJIANET_MS_CCSRC_CXX_API_MODEL_MODEL_IMPL_H
