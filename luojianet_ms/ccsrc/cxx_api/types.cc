...
#include "luojianet_ms/core/utils/convert_utils_base.h"
...
void MSTensor::SetFormat(luojianet_ms::Format) { MS_LOG_EXCEPTION << "Invalid implement."; }

luojianet_ms::Format MSTensor::format() const { MS_LOG_EXCEPTION << "Invalid implement."; }
