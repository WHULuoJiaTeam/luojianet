...
const std::map<ProtoDataType, luojianet_ms::TypeId> kDataTypetoMSTypeMap = {
  {ProtoDataType::DT_UNDEFINED, luojianet_ms::TypeId::kTypeUnknown},
  {ProtoDataType::DT_FLOAT, luojianet_ms::TypeId::kNumberTypeFloat32},
  {ProtoDataType::DT_FLOAT16, luojianet_ms::TypeId::kNumberTypeFloat16},
  {ProtoDataType::DT_INT8, luojianet_ms::TypeId::kNumberTypeInt8},
  {ProtoDataType::DT_UINT8, luojianet_ms::TypeId::kNumberTypeUInt8},
  {ProtoDataType::DT_INT16, luojianet_ms::TypeId::kNumberTypeInt16},
  {ProtoDataType::DT_UINT16, luojianet_ms::TypeId::kNumberTypeUInt16},
  {ProtoDataType::DT_INT32, luojianet_ms::TypeId::kNumberTypeInt32},
  {ProtoDataType::DT_INT64, luojianet_ms::TypeId::kNumberTypeInt64},
  {ProtoDataType::DT_UINT32, luojianet_ms::TypeId::kNumberTypeUInt32},
  {ProtoDataType::DT_UINT64, luojianet_ms::TypeId::kNumberTypeUInt64},
  {ProtoDataType::DT_BOOL, luojianet_ms::TypeId::kNumberTypeBool},
  {ProtoDataType::DT_DOUBLE, luojianet_ms::TypeId::kNumberTypeFloat64},
  {ProtoDataType::DT_STRING, luojianet_ms::TypeId::kObjectTypeString}};
#endif
