 ...
 */
#ifndef LUOJIANET_MS_CCSRC_DEBUG_DEBUGGER_DEBUGGER_H_
#define LUOJIANET_MS_CCSRC_DEBUG_DEBUGGER_DEBUGGER_H_
...
class BACKEND_EXPORT Debugger : public std::enable_shared_from_this<Debugger> {
 public:
  ...
  // returns true if reply received and luojianet_ms version matched with mindInsight version
...
#endif  // LUOJIANET_MS_CCSRC_DEBUG_DEBUGGER_DEBUGGER_H_
