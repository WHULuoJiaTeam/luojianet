 ...
 */
#ifndef LUOJIANET_MS_TENSOR_SUMMARY_H
#define LUOJIANET_MS_TENSOR_SUMMARY_H
...
class TensorSummary : public ITensorSummary {
 ...
 private:
  ...
  luojianet_ms::HashMap<std::string, std::unique_ptr<MeanCalculator>> means_;
  luojianet_ms::HashMap<uint32_t, std::unique_ptr<AllCloseCalculator>> all_close_;
  luojianet_ms::HashMap<uint32_t, std::unique_ptr<RangeCountCalculator>> range_counts_;
...
#endif
#endif  // LUOJIANET_MS_TENSOR_SUMMARY_H
