 ...
 */
#ifndef LUOJIANET_MS_CCSRC_DEBUG_RDR_BASE_RECORDER_H_
#define LUOJIANET_MS_CCSRC_DEBUG_RDR_BASE_RECORDER_H_
#include <memory>
#include <string>
#include <sstream>
#include <chrono>
...
class BaseRecorder {
 public:
  ...
  BaseRecorder(const std::string &module, const std::string &name) : module_(module), name_(name), filename_("") {
    directory_ = luojianet_ms::EnvConfigParser::GetInstance().RdrPath();
...
#endif  // LUOJIANET_MS_CCSRC_DEBUG_RDR_BASE_RECORDER_H_
