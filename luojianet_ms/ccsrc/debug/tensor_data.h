 ...
 */
#ifndef LUOJIANET_MS_CCSRC_DEBUG_TENSOR_DATA_H_
#define LUOJIANET_MS_CCSRC_DEBUG_TENSOR_DATA_H_
...
#ifdef ONLINE_DBG_MODE
  void SetTensor(const luojianet_ms::tensor::TensorPtr &out_tensor) { this->tensor_ptr_ = out_tensor; }
#endif
...
#ifdef ONLINE_DBG_MODE
  luojianet_ms::tensor::TensorPtr tensor_ptr_{nullptr};
#endif
};
}  // namespace luojianet_ms
#endif  // LUOJIANET_MS_CCSRC_DEBUG_TENSOR_DATA_H_
