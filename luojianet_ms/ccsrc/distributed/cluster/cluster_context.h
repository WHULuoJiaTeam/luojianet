...
#ifndef LUOJIANET_MS_CCSRC_DISTRIBUTED_CLUSTER_CLUSTER_CONTEXT_H_
#define LUOJIANET_MS_CCSRC_DISTRIBUTED_CLUSTER_CLUSTER_CONTEXT_H_
...
namespace cluster {
// The detailed reason of failing to run 'luojianet_ms.communication.init()' with ClusterContext.
constexpr char kDetailedFailureReason[] =
  "Maybe you are trying to call 'luojianet_ms.communication.init()' without using 'mpirun', which will make LuoJiaNET "
  ...
  "https://www.luojianet_ms.cn/tutorials/experts/zh-CN/r1.7/parallel/train_gpu.html#openmpi.";

// Node role based cluster built by LuoJiaNET communication framework.
...
#endif  // LUOJIANET_MS_CCSRC_DISTRIBUTED_CLUSTER_CLUSTER_CONTEXT_H_
