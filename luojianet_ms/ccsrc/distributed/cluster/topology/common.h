...
#ifndef LUOJIANET_MS_CCSRC_DISTRIBUTED_CLUSTER_TOPOLOGY_COMMON_H_
#define LUOJIANET_MS_CCSRC_DISTRIBUTED_CLUSTER_TOPOLOGY_COMMON_H_
...
#endif  // LUOJIANET_MS_CCSRC_DISTRIBUTED_CLUSTER_TOPOLOGY_COMMON_H_
