...
#ifndef LUOJIANET_MS_CCSRC_DISTRIBUTED_PERSISTENT_STORAGE_BLOCK_H_
#define LUOJIANET_MS_CCSRC_DISTRIBUTED_PERSISTENT_STORAGE_BLOCK_H_
...
#endif  // LUOJIANET_MS_CCSRC_DISTRIBUTED_PERSISTENT_STORAGE_BLOCK_H_
