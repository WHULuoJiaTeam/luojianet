...
#ifndef LUOJIANET_MS_CCSRC_DISTRIBUTED_RECOVERY_RECOVERY_H_
#define LUOJIANET_MS_CCSRC_DISTRIBUTED_RECOVERY_RECOVERY_H_
...
#endif  // LUOJIANET_MS_CCSRC_DISTRIBUTED_RECOVERY_RECOVERY_H_
