...
#ifndef LUOJIANET_MS_CCSRC_ARMOUR_CIPHER_META_STORAGE_H
#define LUOJIANET_MS_CCSRC_ARMOUR_CIPHER_META_STORAGE_H
...
class CipherMetaStorage {
 public:
  ...
  bool UpdateClientShareToServer(
    ...
    const flatbuffers::Vector<flatbuffers::Offset<luojianet_ms::schema::ClientShare>> *shares);
};
}  // namespace armour
}  // namespace luojianet_ms

#endif  // LUOJIANET_MS_CCSRC_ARMOUR_CIPHER_META_STORAGE_H
