...
#ifndef LUOJIANET_MS_CCSRC_ARMOUR_CIPHER_RECONSTRUCT_H
#define LUOJIANET_MS_CCSRC_ARMOUR_CIPHER_RECONSTRUCT_H
...
#endif  // LUOJIANET_MS_CCSRC_ARMOUR_CIPHER_KEYS_H
