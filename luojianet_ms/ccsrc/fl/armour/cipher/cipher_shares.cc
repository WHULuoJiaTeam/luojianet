...
bool CipherShares::ShareSecrets(const int cur_iterator, const schema::RequestShareSecrets *share_secrets_req,
  ...
  const flatbuffers::Vector<flatbuffers::Offset<luojianet_ms::schema::ClientShare>> *encrypted_shares =
...
bool CipherShares::GetSecrets(const schema::GetShareSecrets *get_secrets_req,
  ...
  std::vector<flatbuffers::Offset<luojianet_ms::schema::ClientShare>> encrypted_shares;
...
void CipherShares::BuildGetSecretsRsp(
  ...
  const std::vector<flatbuffers::Offset<luojianet_ms::schema::ClientShare>> *encrypted_shares) {
