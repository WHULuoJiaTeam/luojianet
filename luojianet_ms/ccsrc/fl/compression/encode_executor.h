...
#ifndef LUOJIANET_MS_CCSRC_FL_COMPRESSION_ENCODE_EXECUTOR_H_
#define LUOJIANET_MS_CCSRC_FL_COMPRESSION_ENCODE_EXECUTOR_H_
...
#endif  // LUOJIANET_MS_CCSRC_FL_COMPRESSION_ENCODE_EXECUTOR_H_
