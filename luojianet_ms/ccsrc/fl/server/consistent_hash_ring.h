...
#ifndef LUOJIANET_MS_CCSRC_FL_SERVER_CONSISTENT_HASH_RING_H_
#define LUOJIANET_MS_CCSRC_FL_SERVER_CONSISTENT_HASH_RING_H_
...
#endif  // LUOJIANET_MS_CCSRC_FL_SERVER_CONSISTENT_HASH_RING_H_
