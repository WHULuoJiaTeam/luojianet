...
#ifndef LUOJIANET_MS_CCSRC_FL_SERVER_DISTRIBUTED_COUNT_SERVICE_H_
#define LUOJIANET_MS_CCSRC_FL_SERVER_DISTRIBUTED_COUNT_SERVICE_H_
...
#endif  // LUOJIANET_MS_CCSRC_FL_SERVER_DISTRIBUTED_COUNT_SERVICE_H_
