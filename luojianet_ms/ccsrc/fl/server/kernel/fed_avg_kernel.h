...
#ifndef LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_FED_AVG_KERNEL_H_
#define LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_FED_AVG_KERNEL_H_
...
#endif  // LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_FED_AVG_KERNEL_H_
