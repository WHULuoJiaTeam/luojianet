...
#ifndef LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_KERNEL_FACTORY_H_
#define LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_KERNEL_FACTORY_H_
...
// Unlike normal LuoJiaNet operator kernels, the server defines multiple types of kernels. For example: Aggregation
...
#endif  // LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_KERNEL_FACTORY_H_
