...
#ifndef LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_OPTIMIZER_KERNEL_H_
#define LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_OPTIMIZER_KERNEL_H_
...
namespace server {
namespace kernel {
using luojianet_ms::kernel::IsSameShape;
using luojianet_ms::kernel::USE_NESTEROV;
...
#endif  // LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_OPTIMIZER_KERNEL_H_
