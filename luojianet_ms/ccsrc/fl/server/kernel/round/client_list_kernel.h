...
#ifndef LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_CLIENT_LIST_KERNEL_H
#define LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_CLIENT_LIST_KERNEL_H
#include <string>
#include <vector>
#include <memory>
...
#endif  // LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_CLIENT_LIST_KERNEL_H
