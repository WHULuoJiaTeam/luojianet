...
sigVerifyResult ExchangeKeysKernel::VerifySignature(const schema::RequestExchangeKeys *exchange_keys_req) {
  ...
  bool ret_create_code_cpk = luojianet_ms::armour::CreateArray<uint8_t>(&cpk, *fbs_cpk);
  bool ret_create_code_spk = luojianet_ms::armour::CreateArray<uint8_t>(&spk, *fbs_spk);
  ...
  luojianet_ms::ps::server::CertVerify certVerify;
