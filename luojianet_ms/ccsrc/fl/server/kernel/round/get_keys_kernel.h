...
#ifndef LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_GET_KEYS_KERNEL_H
#define LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_GET_KEYS_KERNEL_H
...
#endif  // LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_GET_KEYS_KERNEL_H
