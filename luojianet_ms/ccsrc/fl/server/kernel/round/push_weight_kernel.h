...
#ifndef LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_PUSH_WEIGHT_KERNEL_H_
#define LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_PUSH_WEIGHT_KERNEL_H_
...
#endif  // LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_PUSH_WEIGHT_KERNEL_H_
