...
#ifndef LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_ROUND_ROUND_KERNEL_H_
#define LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_ROUND_ROUND_KERNEL_H_
...
#endif  // LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_ROUND_ROUND_KERNEL_H_
