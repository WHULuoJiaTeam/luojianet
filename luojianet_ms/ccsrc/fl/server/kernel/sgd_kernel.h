...
#ifndef LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_SGD_KERNEL_H_
#define LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_SGD_KERNEL_H_
...
namespace server {
namespace kernel {
using luojianet_ms::kernel::SGDCpuKernelMod;
template <typename T>
...
#endif  // LUOJIANET_MS_CCSRC_FL_SERVER_KERNEL_SGD_KERNEL_H_
