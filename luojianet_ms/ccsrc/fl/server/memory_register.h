...
#ifndef LUOJIANET_MS_CCSRC_FL_SERVER_MEMORY_REGISTER_H_
#define LUOJIANET_MS_CCSRC_FL_SERVER_MEMORY_REGISTER_H_
...
#endif  // LUOJIANET_MS_CCSRC_FL_SERVER_MEMORY_REGISTER_H_
