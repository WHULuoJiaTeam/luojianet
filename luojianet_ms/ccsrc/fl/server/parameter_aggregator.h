...
#ifndef LUOJIANET_MS_CCSRC_FL_SERVER_PARAMETER_AGGREGATOR_H_
#define LUOJIANET_MS_CCSRC_FL_SERVER_PARAMETER_AGGREGATOR_H_
...
#endif  // LUOJIANET_MS_CCSRC_FL_SERVER_PARAMETER_AGGREGATOR_H_
