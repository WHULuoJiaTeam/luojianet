...
#ifndef LUOJIANET_MS_CCSRC_FL_SERVER_SERVER_H_
#define LUOJIANET_MS_CCSRC_FL_SERVER_SERVER_H_
...
// Class Server is the entrance of LuoJiaNet's parameter server training mode and federated learning.
class Server {
 public:
  ...
  // According to the current LuoJiaNet framework, method Run is a step of the server pipeline. This method will be
...
#endif  // LUOJIANET_MS_CCSRC_FL_SERVER_SERVER_H_
