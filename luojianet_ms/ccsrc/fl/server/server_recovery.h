...
#ifndef LUOJIANET_MS_CCSRC_FL_SERVER_SERVER_RECOVERY_H_
#define LUOJIANET_MS_CCSRC_FL_SERVER_SERVER_RECOVERY_H_
...
#endif  // LUOJIANET_MS_CCSRC_FL_SERVER_SERVER_RECOVERY_H_
