...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPERATOR_CC_IMPLEMENTATIONS_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_OPERATOR_CC_IMPLEMENTATIONS_H_
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPERATOR_CC_IMPLEMENTATIONS_H_
