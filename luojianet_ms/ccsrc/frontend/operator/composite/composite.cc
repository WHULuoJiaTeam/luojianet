...
namespace prim {
using AbstractTensor = luojianet_ms::abstract::AbstractTensor;
using FuncGraphAbstractClosure = luojianet_ms::abstract::FuncGraphAbstractClosure;
...
using luojianet_ms::abstract::AbstractDictionaryPtr;
using luojianet_ms::abstract::AbstractEllipsis;
using luojianet_ms::abstract::AbstractEllipsisPtr;
using luojianet_ms::abstract::AbstractFunction;
using luojianet_ms::abstract::AbstractFunctionPtr;
using luojianet_ms::abstract::AbstractList;
using luojianet_ms::abstract::AbstractNone;
using luojianet_ms::abstract::AbstractScalar;
using luojianet_ms::abstract::AbstractSlice;
