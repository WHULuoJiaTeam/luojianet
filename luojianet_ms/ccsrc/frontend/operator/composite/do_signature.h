...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPERATOR_COMPOSITE_DO_SIGNATURE_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_OPERATOR_COMPOSITE_DO_SIGNATURE_H_
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPERATOR_COMPOSITE_DO_SIGNATURE_H_
