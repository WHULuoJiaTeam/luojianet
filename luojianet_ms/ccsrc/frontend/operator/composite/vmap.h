...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPERATOR_VMAP_H
#define LUOJIANET_MS_CCSRC_FRONTEND_OPERATOR_VMAP_H
...
constexpr char kVmapFunctionModelName[] = "luojianet_ms.ops._vmap";
constexpr char kNumpyModelName[] = "luojianet_ms.numpy";
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPERATOR_VMAP_H
