...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPERATOR_OPS_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_OPERATOR_OPS_H_
...
ValuePtr GetPythonOps(const std::string &op_name,
                      const std::string &module_name = "luojianet_ms._extends.parse.standard_method",
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPERATOR_OPS_H_
