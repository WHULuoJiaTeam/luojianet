 ...
 */
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPERATE_OPS_FRONT_INFER_FUNCTION_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_OPERATE_OPS_FRONT_INFER_FUNCTION_H_
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPERATE_OPS_FRONT_INFER_FUNCTION_H_
