...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPERATOR_PRIM_TO_FUNCTION_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_OPERATOR_PRIM_TO_FUNCTION_H_
...
class PrimToFunction {
 ...
 private:
  ...
  const luojianet_ms::HashMap<std::string, int64_t> prim_func_type_map_;
};
}  // namespace prim
}  // namespace luojianet_ms
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPERATOR_PRIM_TO_FUNCTION_H_
