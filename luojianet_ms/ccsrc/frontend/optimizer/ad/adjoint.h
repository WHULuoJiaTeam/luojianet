...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_AD_ADJOINT_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_AD_ADJOINT_H_
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_AD_ADJOINT_H_
