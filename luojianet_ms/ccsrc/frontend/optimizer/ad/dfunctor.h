...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_AD_D_FUNCTOR_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_AD_D_FUNCTOR_H_
...
class DFunctor : public std::enable_shared_from_this<DFunctor> {
 ...
 private:
  ...
  luojianet_ms::HashMap<AnfNodePtr, AdjointPtr> anfnode_to_adjoin_;
  // Cache for indirect fv backpropagation, K o K can only do backprop layer by layer.
  luojianet_ms::HashMap<AnfNodePtr, AdjointPtr> anfnode_to_adjoin_indirect_fv_;
  ...
  luojianet_ms::HashMap<AnfNodePtr, std::pair<CNodePtr, CNodePtr>> anfnode_to_envitem_;
  ...
  bool need_cut_;
  bool is_top_;
  static luojianet_ms::HashMap<FuncGraphPtr, std::shared_ptr<DFunctor>> func_graph_to_functor_;
  static luojianet_ms::HashMap<AnfNodePtr, AdjointPtr> anfnode_to_adjoin_definition_;
};
...
class KPrim {
 ...
 private:
  ...
  FuncGraphPtr BpropToK(const T &primal, const FuncGraphPtr &bprop_g, const FuncGraphPtr &current_primal_fg,
                        const CNodePtr &cnode, const luojianet_ms::HashMap<std::string, ValuePtr> &primal_attrs,
  ...
  luojianet_ms::HashMap<PrimitivePtr, MetaFuncGraphPtr> bprop_registry_meta_;
};
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_AD_D_FUNCTOR_H_
