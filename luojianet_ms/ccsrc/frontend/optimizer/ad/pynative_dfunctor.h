...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_AD_PYNATIVE_D_FUNCTOR_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_AD_PYNATIVE_D_FUNCTOR_H_
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_AD_PYNATIVE_D_FUNCTOR_H_
