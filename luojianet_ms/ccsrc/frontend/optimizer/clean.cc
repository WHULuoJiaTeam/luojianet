...
using luojianet_ms::abstract::AbstractBasePtr;
using luojianet_ms::abstract::AbstractClass;
using luojianet_ms::abstract::AbstractCOOTensor;
using luojianet_ms::abstract::AbstractDictionary;
using luojianet_ms::abstract::AbstractList;
using luojianet_ms::abstract::AbstractListPtr;
using luojianet_ms::abstract::AbstractRowTensor;
using luojianet_ms::abstract::AbstractScalar;
using luojianet_ms::abstract::AbstractSequence;
using luojianet_ms::abstract::AbstractSequencePtr;
...
class SimplifyDataStructuresRewriter : public BaseRewriter {
 ...
 protected:
  ...
  using ConverterMap = luojianet_ms::HashMap<PrimitivePtr, Converter, PrimitiveHasher, PrimitiveEqual>;
...
class CleanAfterOptARewriter : public BaseRewriter {
 ...
 protected:
  ...
  static AbstractTuplePtr ConvertAbstractSeqToAbstractTuple(const AbstractSequencePtr &abs_seq, size_t depth) {
    ...
    luojianet_ms::HashMap<AbstractBasePtr, AbstractBasePtr> changed_elements;
