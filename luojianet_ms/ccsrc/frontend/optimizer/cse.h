...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_CSE_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_CSE_H_
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_CSE_H_
