 ...
 */
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_DEAD_NODE_ELIMINATE_H
#define LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_DEAD_NODE_ELIMINATE_H
#include "ir/anf.h"
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_DEAD_NODE_ELIMINATE_H
