...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_GRAPH_TRANSFORM_H
#define LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_GRAPH_TRANSFORM_H
...
class GraphTupleParamTransform {
 public:
  ...
  FuncGraphPtr TransformGraphParam(const FuncGraphPtr &fg, const FuncGraphManagerPtr &mng) {
    ...
    luojianet_ms::HashMap<AnfNodePtr, AnfNodePtr> repl;
    ...
    auto tmp_mng = luojianet_ms::Manage(new_fg, false);
 ...
 private:
  luojianet_ms::HashMap<FuncGraphPtr, FuncGraphPtr> cache_;
};
}  // namespace opt
}  // namespace luojianet_ms
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_GRAPH_TRANSFORM_H
