...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_IRPASS_BRANCH_CULLING_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_IRPASS_BRANCH_CULLING_H_
...
#endif  // #ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_IRPASS_BRANCH_CULLING_H_
