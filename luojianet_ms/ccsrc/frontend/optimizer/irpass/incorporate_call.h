...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_IRPASS_INCORPORATE_CALL_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_IRPASS_INCORPORATE_CALL_H_
...
class CallOutputTransform {
 ...
 private:
  luojianet_ms::HashMap<FuncGraphPtr, luojianet_ms::HashMap<std::pair<size_t, bool>, FuncGraphPtr, PairHasher>> cache_;
};
}  // namespace internal
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_IRPASS_INCORPORATE_CALL_H_
