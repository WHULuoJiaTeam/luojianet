...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_IRPASS_INCORPORATE_GETITEM_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_IRPASS_INCORPORATE_GETITEM_H_
...
class GetitemTransform {
 ...
 private:
  luojianet_ms::HashMap<FuncGraphPtr, luojianet_ms::HashMap<int64_t, FuncGraphPtr>> cache_;
};
...
class IncorporateGetitem : public AnfVisitor {
 ...
 private:
  ...
  luojianet_ms::HashMap<std::pair<FuncGraphPtr, std::vector<int64_t>>, FuncGraphPtr,
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_IRPASS_INCORPORATE_GETITEM_H_
