...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_IRPASS_INLINE_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_IRPASS_INLINE_H_
...
class InlinerBase : public AnfVisitor {
 ...
 private:
  ...
  luojianet_ms::HashMap<FuncGraphPtr, bool> graph_branch_cache_;
};
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_IRPASS_INLINE_H_
