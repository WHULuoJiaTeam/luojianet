...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_IRPASS_LESS_BATCH_NORMALIZATION_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_IRPASS_LESS_BATCH_NORMALIZATION_H_
...
class LessBatchNormalization : public AnfVisitor {
 ...
 private:
  luojianet_ms::HashSet<CNodePtr> remove_node_list_{};
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_IRPASS_LESS_BATCH_NORMALIZATION_H_
