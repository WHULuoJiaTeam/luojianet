...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_IRPASS_RECOMPUTE_PREPARE_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_IRPASS_RECOMPUTE_PREPARE_H_
...
class SetCellOutputNoRecompute : public AnfVisitor {
 public:
  AnfNodePtr operator()(const OptimizerPtr &, const AnfNodePtr &node) override {
    ...
    if (output->isa<CNode>()) {
      luojianet_ms::HashSet<CNodePtr> real_outputs;
  ...
  void GetRealOutputNodes(const AnfNodePtr &output, luojianet_ms::HashSet<CNodePtr> *real_outputs) {
  ...
  bool OutputAllNodes(const luojianet_ms::HashSet<CNodePtr> &real_outputs) {
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_IRPASS_RECOMPUTE_PREPARE_H_
