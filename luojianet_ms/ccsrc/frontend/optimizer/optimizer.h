...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_OPTIMIZER_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_OPTIMIZER_H_
...
class Optimizer : public std::enable_shared_from_this<Optimizer> {
 public:
  ...
  void Init(const OptPassGroupMap &passes, bool run_only_once) {
    ...
    is_watch_renormalize_ = false;
    is_untyped_generated_ = false;
    is_on_debug_ = IS_OUTPUT_ON(luojianet_ms::DEBUG);
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_OPTIMIZER_H_
