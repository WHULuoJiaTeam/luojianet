 ...
 */
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_PATTERN_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_PATTERN_H_
#include <string>
#include <memory>
#include <vector>
...
struct PatternEqual;
using PatternNodeMap = luojianet_ms::HashMap<PatternPtr, AnfNodePtr, PatternHasher, PatternEqual>;
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_PATTERN_H_
