 ...
 */
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_PASS_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_PASS_H_
#include <string>
#include <memory>
...
using NodeEquiv = luojianet_ms::HashMap<std::string, AnfNodePtr>;
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_PASS_H_
