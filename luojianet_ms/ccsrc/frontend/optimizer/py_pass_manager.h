 ...
 */
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_PY_PASS_MANAGER_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_PY_PASS_MANAGER_H_
...
class PyPassManager {
 ...
 private:
  ...
  static luojianet_ms::HashMap<Phase, PassGroupPtr> phase_to_group_;
};
}  // namespace python_pass
}  // namespace opt
}  // namespace luojianet_ms
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_OPTIMIZER_PY_PASS_MANAGER_H_
