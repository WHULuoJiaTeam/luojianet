...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_ALLREDUCE_FUSION_ALLREDUCE_GRAPH_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_ALLREDUCE_FUSION_ALLREDUCE_GRAPH_H_
...
class AllreduceGraph {
 public:
  ...
  const luojianet_ms::HashSet<CNodePtr> &cnode_set() const { return cnode_set_; }
 ...
 private:
  ...
  luojianet_ms::HashSet<CNodePtr> cnode_set_;
  // If One ParameterPtr is used by multiple CNode, the last node for backward computation is saved.
  luojianet_ms::HashMap<AnfNodePtr, std::vector<CNodePtr>> para_cnode_map_;
  // One ParameterPtr may be used by multiple CNode
  luojianet_ms::HashMap<AnfNodePtr, luojianet_ms::HashSet<CNodePtr>> para_cnodeset_map_;
  // Multiple Parameter may be inputs to the same CNode
  luojianet_ms::HashMap<CNodePtr, luojianet_ms::HashSet<AnfNodePtr>> cnode_paraset_map_;
  luojianet_ms::HashMap<CNodePtr, AllreduceNodePtr> cnode_arnode_map_;
  double max_;
};
}  // namespace parallel
}  // namespace luojianet_ms

#endif  // LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_ALLREDUCE_FUSION_ALLREDUCE_GRAPH_H_
