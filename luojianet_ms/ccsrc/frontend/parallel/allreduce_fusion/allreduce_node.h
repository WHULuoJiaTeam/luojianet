...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_ALLREDUCE_FUSION_ALLREDUCE_NODE_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_ALLREDUCE_FUSION_ALLREDUCE_NODE_H_
...
class AllreduceNode {
 public:
  ...
  const luojianet_ms::HashSet<AnfNodePtr> &paras() const { return paras_; }
 ...
 private:
  ...
  luojianet_ms::HashSet<AnfNodePtr> paras_;
  luojianet_ms::HashMap<AnfNodePtr, double> para_size_map_;
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_ALLREDUCE_FUSION_ALLREDUCE_NODE_H_
