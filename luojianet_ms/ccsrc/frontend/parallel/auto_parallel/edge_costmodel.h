...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_AUTO_PARALLEL_EDGE_COSTMODEL_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_AUTO_PARALLEL_EDGE_COSTMODEL_H_
...
using EdgePtr = std::shared_ptr<luojianet_ms::parallel::Edge>;
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_AUTO_PARALLEL_EDGE_COSTMODEL_H_
