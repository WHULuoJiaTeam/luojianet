...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_COSTMODEL_CONTEXT_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_COSTMODEL_CONTEXT_H_
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_COSTMODEL_CONTEXT_H_
