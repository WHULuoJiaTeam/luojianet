...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_DEVICE_MATRIX_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_DEVICE_MATRIX_H_
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_DEVICE_MATRIX_H_
