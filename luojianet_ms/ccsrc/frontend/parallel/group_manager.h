...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_GROUP_MANAGER_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_GROUP_MANAGER_H_
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_GROUP_MANAGER_H_
