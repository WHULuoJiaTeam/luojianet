...
Status MatMulBase::SwapLastTwoElements(luojianet_ms::parallel::Shape *const input) {
  if (input->size() < 2) {
...
Status MatMulBase::PrepareStrategy(int64_t stage_id, size_t dev_num,
                                   luojianet_ms::parallel::Dimensions combined_partitions, size_t input0_shape_size,
                                   size_t input1_shape_size, luojianet_ms::parallel::StrategyPtr *const sp) {
  int64_t product =
...
Status MatMulBase::SetCostUnderStrategy(const luojianet_ms::parallel::StrategyPtr &strategy) {
