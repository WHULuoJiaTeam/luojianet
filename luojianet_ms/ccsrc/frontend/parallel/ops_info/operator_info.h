...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_OPS_INFO_OPERATOR_INFO_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_OPS_INFO_OPERATOR_INFO_H_
...
using PrimitiveAttrs = luojianet_ms::HashMap<std::string, ValuePtr>;
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_OPS_INFO_OPERATOR_INFO_H_
