...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_OPS_INFO_OPS_UTILS_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_OPS_INFO_OPS_UTILS_H_
...
constexpr char OP_PATH[] = "luojianet_ms.ops.operations";
constexpr char INNER_OP_PATH[] = "luojianet_ms.ops.operations._inner_ops";
constexpr char FUNCTIONAL_OP_PATH[] = "luojianet_ms.ops.functional";
constexpr char GET_OP_FUNCTION_PATH[] = "luojianet_ms.parallel._utils";
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_OPS_INFO_OPS_UTILS_H_
