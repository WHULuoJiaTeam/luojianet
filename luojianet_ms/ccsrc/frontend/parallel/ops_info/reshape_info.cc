...
Status ReshapeInfo::SetCostUnderStrategy(const luojianet_ms::parallel::StrategyPtr &strategy) {
...
void ReshapeInfo::SetCostForReshape(const luojianet_ms::parallel::StrategyPtr &strategy) {
