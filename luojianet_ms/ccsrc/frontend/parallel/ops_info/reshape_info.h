...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_OPS_INFO_RESHAPE_INFO_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_OPS_INFO_RESHAPE_INFO_H_
...
class ReshapeInfo : public OperatorInfo {
 public:
  ...
  void SetCostForReshape(const luojianet_ms::parallel::StrategyPtr &strategy);
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_OPS_INFO_RESHAPE_INFO_H_
