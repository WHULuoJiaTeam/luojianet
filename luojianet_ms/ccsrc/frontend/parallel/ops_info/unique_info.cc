...
Status UniqueInfo::ComputeReplaceGraph(const CNodePtr &cnode) {
  ...
  // Use name of tuple_getitem instance in luojianet_ms.ops.functional, not the Primitive name
  ...
  // Use name of make_tuple instance in luojianet_ms.ops.functional, not the Primitive name
