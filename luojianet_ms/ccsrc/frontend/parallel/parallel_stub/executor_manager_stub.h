...
#ifndef LUOJIANET_MS_CCSRC_PARALLEL_EXECUTOR_MANAGER_STUB_H_
#define LUOJIANET_MS_CCSRC_PARALLEL_EXECUTOR_MANAGER_STUB_H_
#include <set>
#include <map>
#include <string>
#include <memory>
...
#endif  // LUOJIANET_MS_CCSRC_PARALLEL_EXECUTOR_MANAGER_STUB_H_
