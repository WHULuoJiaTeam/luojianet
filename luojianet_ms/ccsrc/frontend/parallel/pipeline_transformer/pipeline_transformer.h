...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_PIPELINE_TRANSFORMER_PIPELINE_TRANSFORMER_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_PIPELINE_TRANSFORMER_PIPELINE_TRANSFORMER_H_
...
class PipelineTransformer {
 ...
 private:
  ...
  void RedundancyNode(const AnfNodePtr &node, luojianet_ms::HashMap<CNodePtr, std::vector<AnfNodePtr>> *make_tuple_map);
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_PIPELINE_TRANSFORMER_PIPELINE_TRANSFORMER_H_
