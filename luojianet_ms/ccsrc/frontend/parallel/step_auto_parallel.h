...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_STEP_AUTO_PARALLEL_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_STEP_AUTO_PARALLEL_H_
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_STEP_AUTO_PARALLEL_H_
