...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_STRATEGY_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_STRATEGY_H_
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_STRATEGY_H_
