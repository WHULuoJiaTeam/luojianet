...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_TENSOR_LAYOUT_MAP_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_TENSOR_LAYOUT_MAP_H_
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_TENSOR_LAYOUT_MAP_H_
