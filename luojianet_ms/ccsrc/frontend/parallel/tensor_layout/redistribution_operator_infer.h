...
#ifndef LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_TENSOR_LAYOUT_REDISTRIBUTION_OPERATOR_INFER_H_
#define LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_TENSOR_LAYOUT_REDISTRIBUTION_OPERATOR_INFER_H_
...
using RedistributionOperatorMap = luojianet_ms::HashMap<uint64_t, int64_t>;
...
#endif  // LUOJIANET_MS_CCSRC_FRONTEND_PARALLEL_TENSOR_LAYOUT_REDISTRIBUTION_OPERATOR_INFER_H_
