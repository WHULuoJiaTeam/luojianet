...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_BACKEND_VISIBLE_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_BACKEND_VISIBLE_H_
...
#endif
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_BACKEND_VISIBLE_H_
