...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_COMMON_DEBUG_COMMON_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_COMMON_DEBUG_COMMON_H_
...
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_COMMON_DEBUG_COMMON_H_
