 ...
 */
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_COMMON_DEBUG_RDR_RECORDER_MANAGER_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_COMMON_DEBUG_RDR_RECORDER_MANAGER_H_
#include <vector>
#include <string>
#include <sstream>
#include <map>
...
class COMMON_EXPORT RecorderManager {
 ...
 private:
  ...
  luojianet_ms::HashMap<std::pair<std::string, std::string>, BaseRecorderPtr, pair_hash> recorder_container_;
};
...
#endif  // LUOJIANET_MS_CCSRC_DEBUG_RDR_RECORDER_MANAGER_H_
