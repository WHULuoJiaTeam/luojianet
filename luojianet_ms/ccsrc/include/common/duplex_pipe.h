...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_COMMON_DUPLEX_PIPE_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_COMMON_DUPLEX_PIPE_H_
...
class COMMON_EXPORT DuplexPipe : public std::enable_shared_from_this<luojianet_ms::DuplexPipe> {
 public:
...
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_COMMON_DUPLEX_PIPE_H_
