...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_COMMON_PYBIND_API_API_REGISTER_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_COMMON_PYBIND_API_API_REGISTER_H_
...
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_COMMON_PYBIND_API_API_REGISTER_H_
