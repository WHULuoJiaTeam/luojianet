...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_COMMON_THREAD_POOL_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_COMMON_THREAD_POOL_H_
...
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_COMMON_THREAD_POOL_H_
