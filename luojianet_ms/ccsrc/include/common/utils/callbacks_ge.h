 ...
 */
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_CALLBACKS_GE_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_CALLBACKS_GE_H_
...
#endif
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_CALLBACKS_GE_H_
