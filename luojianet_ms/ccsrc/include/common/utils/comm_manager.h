...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_COMM_MANAGER_H
#define LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_COMM_MANAGER_H
...
#define COMM_MANAGER_REG(NAME, INSTANCE) \
  static bool g_CommManager_##NAME##_reg_result = luojianet_ms::CommManager::Register(NAME, INSTANCE)
}  // namespace luojianet_ms
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_COMM_MANAGER_H
