...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_CONFIG_MANAGER_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_CONFIG_MANAGER_H_
...
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_CONFIG_MANAGER_H_
