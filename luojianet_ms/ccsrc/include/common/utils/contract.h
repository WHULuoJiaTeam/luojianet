...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_CONTRACT_H
#define LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_CONTRACT_H
#include <string>
#include <exception>
#include <memory>
#include <utility>
...
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_CONTRACT_H
