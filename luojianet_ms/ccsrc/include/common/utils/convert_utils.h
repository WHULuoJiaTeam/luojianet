...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_CONVERT_UTILS_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_CONVERT_UTILS_H_
...
using FuncGraphPairMapEquiv = luojianet_ms::HashMap<std::pair<FuncGraphPtr, FuncGraphPtr>, EquivState, PairHasher>;
using NodeMapEquiv = luojianet_ms::HashMap<AnfNodePtr, AnfNodePtr>;
...
const luojianet_ms::HashMap<std::string, int64_t> sparse_attr_map = {
...
// sparse_process.cc
const luojianet_ms::HashSet<std::string> make_sparse_set = {{prim::kMakeCSRTensor}, {prim::kMakeCOOTensor}};
...
// sparse_process.cc
const luojianet_ms::HashSet<std::string> sparse_op_set = {{prim::kSparseTensorDenseMatmul},
                                                       {prim::kCSRReduceSum},
                                                       {prim::kCSRMV},
                                                       {prim::kCSRMul},
                                                       {prim::kCSRGather},
...
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_CONVERT_UTILS_H_
