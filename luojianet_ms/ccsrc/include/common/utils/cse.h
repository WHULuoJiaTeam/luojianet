...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_CSE_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_CSE_H_
...
class COMMON_EXPORT CSE {
 ...
 private:
  ...
  bool DoReplace(const FuncGraphManagerPtr manager, const std::vector<std::size_t> &order_group,
                 luojianet_ms::HashMap<std::size_t, std::vector<AnfNodePtr>> *groups) const;
};
...
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_CSE_H_
