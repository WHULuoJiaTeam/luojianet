...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_MPI_MS_CONTEXT_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_MPI_MS_CONTEXT_H_
...
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_MPI_MS_CONTEXT_H_
