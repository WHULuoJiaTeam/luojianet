...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_PARALLEL_CONTEXT_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_PARALLEL_CONTEXT_H_
...
namespace luojianet_ms::parallel {
...
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_PARALLEL_CONTEXT_H_
