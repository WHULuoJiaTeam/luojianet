...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_PYTHON_ADAPTER_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_PYTHON_ADAPTER_H_
#include <map>
#include <memory>
#include <string>
...
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_PYTHON_ADAPTER_H_
