...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_SCOPED_LONG_RUNNING_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_SCOPED_LONG_RUNNING_H_
...
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_SCOPED_LONG_RUNNING_H_
