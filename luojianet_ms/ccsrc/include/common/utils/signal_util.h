 ...
 */
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_SIGNAL_UTIL_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_SIGNAL_UTIL_H_
...
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_SIGNAL_UTIL_H_
