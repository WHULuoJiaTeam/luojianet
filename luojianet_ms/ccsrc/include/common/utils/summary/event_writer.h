...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_SUMMARY_EVENT_WRITER_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_SUMMARY_EVENT_WRITER_H_
...
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_SUMMARY_EVENT_WRITER_H_
