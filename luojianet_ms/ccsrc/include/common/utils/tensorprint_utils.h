...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_TENSORPRINT_UTILS_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_TENSORPRINT_UTILS_H_
...
#endif
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_TENSORPRINT_UTILS_H_
