...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_UTILS_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_UTILS_H_
...
#define PROF_START(stage) uint64_t start_usec_##stage = luojianet_ms::GetCurrentUSec()
#define PROF_END(stage)                                                                                     \
  do {                                                                                                      \
    uint64_t end_usec_##stage = luojianet_ms::GetCurrentUSec();                                                \
...
#define PROF_MULTI_START(stage) uint64_t start_usec_##stage = luojianet_ms::GetCurrentUSec()
...
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_COMMON_UTILS_UTILS_H_
