...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_COMMON_VISIBLE_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_COMMON_VISIBLE_H_
...
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_COMMON_VISIBLE_H_
