...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_TRANSFORM_GRAPH_IR_CONVERT_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_TRANSFORM_GRAPH_IR_CONVERT_H_
...
class COMMON_EXPORT DfGraphConvertor {
 public:
  explicit DfGraphConvertor(const AnfGraphPtr &anf_graph) : anf_graph_(anf_graph) {
    ...
    auto env_ge = luojianet_ms::common::GetEnv("MS_ENABLE_GE");
    auto env_training = luojianet_ms::common::GetEnv("MS_GE_TRAIN");
 ...
 private:
  ...
  luojianet_ms::HashMap<AnfNode *, std::string> op_draw_name_;
  ...
  luojianet_ms::HashMap<AnfNode *, DfGraph> branches_map_;
  luojianet_ms::HashMap<AnfNode *, OperatorPtr> op_cache_;
  luojianet_ms::HashMap<AnfNode *, std::vector<ControlEdge>> control_edge_cache_;
  luojianet_ms::HashMap<AnfNodePtr, std::set<AnfNodePtr>> monad_control_edge_cache_;
  /* record "tuple_getitem"<->"out_handler" mapping */
  luojianet_ms::HashMap<AnfNode *, OutHandler> out_handle_cache_;
  /* record "make_tuple"<->"out_handler vector" mapping */
  luojianet_ms::HashMap<AnfNode *, std::shared_ptr<std::vector<OutHandler>>> tuple_out_handle_cache_;
  luojianet_ms::HashMap<AnfNode *, std::shared_ptr<std::vector<AnfNodePtr>>> case_input_handle_cache_;
  luojianet_ms::HashMap<std::string, AnfNodePtr> params_;
  luojianet_ms::HashMap<std::string, OperatorPtr> vars_;
...
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_TRANSFORM_GRAPH_IR_CONVERT_H_
