...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_TRANSFORM_GRAPH_IR_OP_ADAPTER_MAP_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_TRANSFORM_GRAPH_IR_OP_ADAPTER_MAP_H_
...
class COMMON_EXPORT OpAdapterMap {
 public:
  static luojianet_ms::HashMap<std::string, std::shared_ptr<OpAdapterDesc>> &get();
};
}  // namespace transform
}  // namespace luojianet_ms
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_TRANSFORM_GRAPH_IR_OP_ADAPTER_MAP_H_
