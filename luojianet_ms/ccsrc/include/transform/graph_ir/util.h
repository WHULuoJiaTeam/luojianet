...
#ifndef LUOJIANET_MS_CCSRC_INCLUDE_TRANSFORM_GRAPH_IR_UTIL_H_
#define LUOJIANET_MS_CCSRC_INCLUDE_TRANSFORM_GRAPH_IR_UTIL_H_
...
#endif  // LUOJIANET_MS_CCSRC_INCLUDE_TRANSFORM_GRAPH_IR_UTIL_H_
