...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_ASCEND_KERNEL_MOD_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_ASCEND_KERNEL_MOD_H_
...
using TaskInfoPtr = std::shared_ptr<luojianet_ms::ge::model_runner::TaskInfo>;
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_ASCEND_KERNEL_MOD_H_
