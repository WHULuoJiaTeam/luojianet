...
#ifndef LUOJIANET_MS_CCSRC_KERNEL_COMMON_UTILS_H_
#define LUOJIANET_MS_CCSRC_KERNEL_COMMON_UTILS_H_
...
static const luojianet_ms::HashMap<std::string, std::pair<MatrixDiag::Alignment, MatrixDiag::Alignment>> AlignmentMap{
...
#endif  // LUOJIANET_MS_CCSRC_KERNEL_COMMON_UTILS_H_
