...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_ENVIRON_MANAGER_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_ENVIRON_MANAGER_H_
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_ENVIRON_MANAGER_H_
