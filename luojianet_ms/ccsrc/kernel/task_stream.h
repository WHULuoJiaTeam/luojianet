...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_TASK_STREAM_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_TASK_STREAM_H_
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_TASK_STREAM_H_
