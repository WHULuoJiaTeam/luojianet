...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CALLBACK_PARAM_H
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CALLBACK_PARAM_H
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CALLBACK_PARAM_H
