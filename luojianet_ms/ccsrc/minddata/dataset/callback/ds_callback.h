...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_DS_CALLBACK_H
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_DS_CALLBACK_H
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_DS_CALLBACK_H
