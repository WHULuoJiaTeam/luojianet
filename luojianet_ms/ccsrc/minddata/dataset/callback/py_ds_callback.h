...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_PY_DS_CALLBACK_H
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_PY_DS_CALLBACK_H
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_PY_DS_CALLBACK_H
