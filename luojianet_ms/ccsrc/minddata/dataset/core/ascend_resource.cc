...
Status AscendResource::Sink(const luojianet_ms::MSTensor &host_input, std::shared_ptr<DeviceTensor> *device_input) {
  std::shared_ptr<luojianet_ms::dataset::Tensor> de_input;
