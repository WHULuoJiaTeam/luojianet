...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_ASCEND_RESOURCE_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_ASCEND_RESOURCE_H_
...
class AscendResource : public DeviceResource {
 public:
  ...
  Status Sink(const luojianet_ms::MSTensor &host_input, std::shared_ptr<DeviceTensor> *device_input) override;
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_ASCEND_RESOURCE_H_
