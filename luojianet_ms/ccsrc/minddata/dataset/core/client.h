 ...
 */
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_CLIENT_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_CLIENT_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_CLIENT_H_
