 ...
 */
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_CONFIG_MANAGER_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_CONFIG_MANAGER_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_CONFIG_MANAGER_H_
