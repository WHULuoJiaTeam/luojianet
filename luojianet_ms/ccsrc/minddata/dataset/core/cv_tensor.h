 ...
 */
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_CV_TENSOR_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_CV_TENSOR_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_CV_TENSOR_H_
