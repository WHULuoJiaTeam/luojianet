 ...
 */
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_DATA_TYPE_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_DATA_TYPE_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_DATA_TYPE_H_
