...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_DEVICE_RESOURCE_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_DEVICE_RESOURCE_H_
...
class DeviceResource {
 public:
  ...
  virtual Status Sink(const luojianet_ms::MSTensor &host_input, std::shared_ptr<DeviceTensor> *device_input);
...
#endif  // LUOJIANET_MS_DEVICE_RESOURCE_H
