...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_DEVICE_TENSOR_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_DEVICE_TENSOR_H_
#include <memory>
#include <utility>
#include <vector>
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_DEVICE_TENSOR_H_
