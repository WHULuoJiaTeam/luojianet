 ...
 */
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_TENSOR_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_TENSOR_H_
...
class Tensor {
 public:
  ...
  Status Slice(TensorPtr *out, const std::vector<luojianet_ms::dataset::SliceOption> slice_options);
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_TENSOR_H_
