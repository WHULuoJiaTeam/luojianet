...
void IndexGeneratorHelper(int8_t depth, std::vector<dsize_t> *numbers,
                          const std::vector<luojianet_ms::dataset::SliceOption> &slice_list,
...
std::vector<std::vector<dsize_t>> IndexGenerator(const std::vector<luojianet_ms::dataset::SliceOption> &slice_list) {
