...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_TENSOR_ROW_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_TENSOR_ROW_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_TENSOR_ROW_H_
