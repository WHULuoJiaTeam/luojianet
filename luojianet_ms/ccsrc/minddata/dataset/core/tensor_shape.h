 ...
 */
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_TENSOR_SHAPE_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_TENSOR_SHAPE_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CORE_TENSOR_SHAPE_H_
