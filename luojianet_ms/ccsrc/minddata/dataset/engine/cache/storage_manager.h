 ...
 */
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_STORAGE_MANAGER_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_STORAGE_MANAGER_H_
...
using ListOfContainers = std::vector<std::shared_ptr<luojianet_ms::dataset::StorageContainer>>;
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_STORAGE_MANAGER_H_
