 ...
 */
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_ENGINE_DATASETOPS_DEVICE_QUEUE_OP_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_ENGINE_DATASETOPS_DEVICE_QUEUE_OP_H_
...
using luojianet_ms::device::BlockQueueStatus_T;
using luojianet_ms::device::GpuBufferMgr;
#endif
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_ENGINE_DATASETOPS_DEVICE_QUEUE_OP_H_
