 ...
 */
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_ENGINE_GNN_GRAPH_DATA_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_ENGINE_GNN_GRAPH_DATA_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_ENGINE_GNN_GRAPH_DATA_H_
