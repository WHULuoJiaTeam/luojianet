 ...
 */
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_ENGINE_GNN_LOCAL_NODE_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_ENGINE_GNN_LOCAL_NODE_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_ENGINE_GNN_LOCAL_NODE_H_
