 ...
 */
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CONNECTOR_SIZE_H
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CONNECTOR_SIZE_H
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CONNECTOR_SIZE_H
