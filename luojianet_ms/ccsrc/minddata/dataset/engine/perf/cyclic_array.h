...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CYCLIC_ARRAY_H
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CYCLIC_ARRAY_H
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_CYCLIC_ARRAY_H
