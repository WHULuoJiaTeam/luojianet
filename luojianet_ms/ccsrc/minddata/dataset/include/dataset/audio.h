...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_INCLUDE_DATASET_AUDIO_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_INCLUDE_DATASET_AUDIO_H_
...
Status CreateDct(luojianet_ms::MSTensor *output, int32_t n_mfcc, int32_t n_mels, NormMode norm = NormMode::kNone);
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_INCLUDE_DATASET_AUDIO_H_
