...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_INCLUDE_DATASET_CONFIG_H
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_INCLUDE_DATASET_CONFIG_H
...
///    Check API `luojianet_ms::dataset::config::load(const std::string &file)` and find more usage.
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_INCLUDE_DATASET_CONFIG_H
