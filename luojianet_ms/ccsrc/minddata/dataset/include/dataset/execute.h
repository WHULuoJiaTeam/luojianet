...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_INCLUDE_DATASET_EXECUTE_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_INCLUDE_DATASET_EXECUTE_H_
...
class MS_API Execute {
 public:
  ...
  ///      luojianet_ms::dataset::Execute transform = Execute({decode, center_crop, rescale});
  ///
  ///      /* Apply transforms */
  ///      luojianet_ms::MSTensor image = ReadFileToTensor("apple.jpg");
  ///      Status rc = transform(image, &image);
  /// \endcode
  Status operator()(const luojianet_ms::MSTensor &input, luojianet_ms::MSTensor *output);
  ...
  ///      luojianet_ms::dataset::Execute transform = Execute({tokenizer});
  ///
  ///      /* Apply transforms */
  ///      std::vector<luojianet_ms::MSTensor> txt = ReadTextToTensor("demo.txt");
  ///      std::vector<luojianet_ms::MSTensor> txt_result;
  ///      Status rc = transform1({txt}, &txt_result);
  /// \endcode
  Status operator()(const std::vector<luojianet_ms::MSTensor> &input_tensor_list, std::vector<luojianet_ms::MSTensor> *out);
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_INCLUDE_DATASET_EXECUTE_H_
