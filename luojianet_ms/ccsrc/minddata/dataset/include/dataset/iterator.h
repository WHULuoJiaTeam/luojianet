...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_INCLUDE_DATASET_ITERATOR_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_INCLUDE_DATASET_ITERATOR_H_
...
using MSTensorMap = std::unordered_map<std::string, luojianet_ms::MSTensor>;
using MSTensorMapChar = std::map<std::vector<char>, luojianet_ms::MSTensor>;
...
class MS_API PullIterator : public Iterator {
 public:
  ...
  ///      /* dataset is an instance of Dataset object */
  ///      std::shared_ptr<Iterator> = dataset->CreatePullBasedIterator();
  ///      std::vector<std::vector<luojianet_ms::MSTensor>> rows;
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_INCLUDE_DATASET_ITERATOR_H_
