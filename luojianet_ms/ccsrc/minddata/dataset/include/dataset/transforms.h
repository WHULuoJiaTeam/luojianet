...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_INCLUDE_DATASET_TRANSFORMS_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_INCLUDE_DATASET_TRANSFORMS_H_
...
class MS_API Fill final : public TensorTransform {
 public:
  ...
  ///               It can only be MSTensor of the following types from luojianet_ms::DataType:
...
class MS_API Mask final : public TensorTransform {
 public:
  ...
  ///                from luojianet_ms::DataType: String, Int, Float, Bool.
  /// \param[in] de_type Type of the generated mask. It can only be numeric or boolean datatype.
  ///               (default=luojianet_ms::DataType::kNumberTypeBool)
  /// \par Example
  /// \code
  ///     /* Define operations */
  ///     luojianet_ms::MSTensor constant;
  ...
  explicit Mask(RelationalOp op, const MSTensor &constant,
                luojianet_ms::DataType ms_type = luojianet_ms::DataType(luojianet_ms::DataType::kNumberTypeBool));
...
/// \brief Cast the LuoJiaNet data type of a tensor to another.
class MS_API TypeCast final : public TensorTransform {
 public:
  /// \brief Constructor.
  /// \param[in] data_type luojianet_ms::DataType to be cast to.
  /// \par Example
  /// \code
  ///     /* Define operations */
  ///     auto typecast_op = transforms::TypeCast(luojianet_ms::DataType::kNumberTypeUInt8);
  ///
  ///     /* dataset is an instance of Dataset object */
  ///     dataset = dataset->Map({typecast_op},      // operations
  ///                            {"column"});        // input columns
  /// \endcode
  explicit TypeCast(luojianet_ms::DataType data_type);
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_INCLUDE_DATASET_TRANSFORMS_H_
