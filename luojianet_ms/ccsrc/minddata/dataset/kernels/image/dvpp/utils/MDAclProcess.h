...
#include "luojianet_ms/ccsrc/minddata/dataset/core/device_tensor.h"
#include "luojianet_ms/ccsrc/minddata/dataset/core/tensor.h"
#include "luojianet_ms/core/utils/log_adapter.h"
#include "luojianet_ms/ccsrc/minddata/dataset/util/status.h"
...
class MDAclProcess {
 public:
  ...
  APP_ERROR H2D_Sink(const std::shared_ptr<luojianet_ms::dataset::Tensor> &input,
                     std::shared_ptr<luojianet_ms::dataset::DeviceTensor> &device_input);

  APP_ERROR D2H_Pop(const std::shared_ptr<luojianet_ms::dataset::DeviceTensor> &device_output,
