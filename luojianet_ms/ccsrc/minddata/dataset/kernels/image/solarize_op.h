...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_KERNELS_IMAGE_SOLARIZE_OP_H
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_KERNELS_IMAGE_SOLARIZE_OP_H
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_KERNELS_IMAGE_SOLARIZE_OP_H
