...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_KERNELS_IR_VALIDATORS_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_KERNELS_IR_VALIDATORS_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_KERNELS_IR_VALIDATORS_H_
