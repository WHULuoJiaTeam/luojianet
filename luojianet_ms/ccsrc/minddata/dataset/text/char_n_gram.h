...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_TEXT_CHAR_N_GRAM_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_TEXT_CHAR_N_GRAM_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_TEXT_CHAR_N_GRAM_H_
