...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_TEXT_IR_KERNELS_TEXT_IR_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_TEXT_IR_KERNELS_TEXT_IR_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_TEXT_IR_KERNELS_TEXT_IR_H_
