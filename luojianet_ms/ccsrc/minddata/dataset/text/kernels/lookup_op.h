...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_TEXT_KERNELS_LOOKUP_OP_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_TEXT_KERNELS_LOOKUP_OP_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_TEXT_KERNELS_LOOKUP_OP_H_
