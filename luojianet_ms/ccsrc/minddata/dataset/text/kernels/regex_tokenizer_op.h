 ...
 */
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_TEXT_REGEX_TOKENIZER_OP_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_TEXT_REGEX_TOKENIZER_OP_H_
#include <memory>
#include <string>
#include <vector>
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_TEXT_REGEX_TOKENIZER_OP_H_
