...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_TEXT_KERNELS_TO_NUMBER_OP_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_TEXT_KERNELS_TO_NUMBER_OP_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_TEXT_KERNELS_TO_NUMBER_OP_H_
