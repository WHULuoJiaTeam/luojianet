...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_TEXT_VECTORS_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_TEXT_VECTORS_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_TEXT_VECTORS_H_
