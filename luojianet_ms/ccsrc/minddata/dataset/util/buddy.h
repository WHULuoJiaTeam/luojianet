...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_BUDDY_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_BUDDY_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_BUDDY_H_
