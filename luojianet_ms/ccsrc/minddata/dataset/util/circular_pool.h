 ...
 */
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_CIRCULAR_POOL_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_CIRCULAR_POOL_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_CIRCULAR_POOL_H_
