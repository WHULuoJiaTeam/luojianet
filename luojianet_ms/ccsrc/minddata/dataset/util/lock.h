 ...
 */
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_LOCK_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_LOCK_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_LOCK_H_
