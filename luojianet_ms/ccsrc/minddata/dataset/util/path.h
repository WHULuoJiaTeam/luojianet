...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_PATH_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_PATH_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_PATH_H_
