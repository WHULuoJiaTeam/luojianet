...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_QUEUE_MAP_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_QUEUE_MAP_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_QUEUE_MAP_H_
