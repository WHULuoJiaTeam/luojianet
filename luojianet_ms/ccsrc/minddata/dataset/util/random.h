 ...
 */
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_RANDOM_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_RANDOM_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_RANDOM_H_
