...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_RDR_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_RDR_H_
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_RDR_H_
