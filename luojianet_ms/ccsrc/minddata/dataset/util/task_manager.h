...
#ifndef LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_TASK_MANAGER_H_
#define LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_TASK_MANAGER_H_
...
#define RETURN_IF_INTERRUPTED()                                            \
  do {                                                                     \
    if (luojianet_ms::dataset::this_thread::is_interrupted()) {               \
...
#endif  // LUOJIANET_MS_CCSRC_MINDDATA_DATASET_UTIL_TASK_MANAGER_H_
