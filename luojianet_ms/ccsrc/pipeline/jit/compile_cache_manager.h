...
#ifndef LUOJIANET_MS_CCSRC_PIPELINE_JIT_COMPILE_CACHE_MANAGER_H_
#define LUOJIANET_MS_CCSRC_PIPELINE_JIT_COMPILE_CACHE_MANAGER_H_
...
#endif  // LUOJIANET_MS_CCSRC_PIPELINE_JIT_COMPILE_CACHE_MANAGER_H_
