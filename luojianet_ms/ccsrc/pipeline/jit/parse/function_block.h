...
#ifndef LUOJIANET_MS_CCSRC_PIPELINE_JIT_PARSE_FUNCTION_BLOCK_H_
#define LUOJIANET_MS_CCSRC_PIPELINE_JIT_PARSE_FUNCTION_BLOCK_H_
...
class FunctionBlock : public std::enable_shared_from_this<FunctionBlock> {
 public:
  ...
  const luojianet_ms::HashMap<ParameterPtr, AnfNodePtr> &removable_phis() const { return removable_phis_; }
 ...
 private:
  ...
  luojianet_ms::HashMap<ParameterPtr, AnfNodePtr> removable_phis_;
  ...
  luojianet_ms::HashMap<AnfNodePtr, ParameterPtr> resolve_to_removable_phis_;
  ...
  luojianet_ms::HashMap<std::string, AnfNodePtr> var_to_resolve_;
...
#endif  // LUOJIANET_MS_CCSRC_PIPELINE_JIT_PARSE_FUNCTION_BLOCK_H_
