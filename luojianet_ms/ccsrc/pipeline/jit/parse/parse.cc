...
FunctionBlockPtr Parser::ParseForUnroll(const FunctionBlockPtr &block, const py::object &node) {
  ...
  std::string less_module_name = "luojianet_ms.ops.composite.multitype_ops.less_impl";
  ...
  // Create 'i = i + 1'
  std::string add_module_name = "luojianet_ms.ops.composite.multitype_ops.add_impl";
