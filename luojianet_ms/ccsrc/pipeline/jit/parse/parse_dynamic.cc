...
namespace luojianet_ms::parse {
static luojianet_ms::HashSet<std::string> cell_input_args_ = {};
static const std::set<std::string> ignore_judge_dynamic_cell = {
  "Cell luojianet_ms.nn.layer.basic.Dense", "Cell luojianet_ms.nn.probability.distribution.normal.Normal",
  "Cell src.transformer.create_attn_mask.CreateAttentionMaskFromInputMask", "Cell luojianet_ms.nn.layer.math.MatMul"};
