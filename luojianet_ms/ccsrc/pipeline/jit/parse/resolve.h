...
#ifndef LUOJIANET_MS_CCSRC_PIPELINE_JIT_PARSE_RESOLVE_H_
#define LUOJIANET_MS_CCSRC_PIPELINE_JIT_PARSE_RESOLVE_H_
...
#endif  // LUOJIANET_MS_CCSRC_PIPELINE_JIT_PARSE_RESOLVE_H_
