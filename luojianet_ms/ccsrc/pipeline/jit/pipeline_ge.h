...
#ifndef LUOJIANET_MS_CCSRC_PIPELINE_JIT_PIPELINE_GE_H_
#define LUOJIANET_MS_CCSRC_PIPELINE_JIT_PIPELINE_GE_H_
...
#endif  // LUOJIANET_MS_CCSRC_PIPELINE_JIT_PIPELINE_GE_H_
