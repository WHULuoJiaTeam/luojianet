...
#ifndef LUOJIANET_MS_CCSRC_PIPELINE_JIT_RESOURCE_H_
#define LUOJIANET_MS_CCSRC_PIPELINE_JIT_RESOURCE_H_
...
using BuiltInTypeMap = luojianet_ms::HashMap<int64_t, luojianet_ms::HashMap<std::string, Any>>;
...
#endif  // LUOJIANET_MS_CCSRC_PIPELINE_JIT_RESOURCE_H_
