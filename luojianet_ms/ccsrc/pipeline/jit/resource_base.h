...
#ifndef LUOJIANET_MS_CCSRC_PIPELINE_JIT_RESOURCE_BASE_H_
#define LUOJIANET_MS_CCSRC_PIPELINE_JIT_RESOURCE_BASE_H_
...
class ResourceBase {
 ...
 protected:
  ...
  luojianet_ms::HashMap<std::string, Any> results_;
};
...
#endif  // LUOJIANET_MS_CCSRC_PIPELINE_JIT_RESOURCE_BASE_H_
