...
#ifndef LUOJIANET_MS_CCSRC_PIPELINE_JIT_STATIC_ANALYSIS_EVALUATOR_H_
#define LUOJIANET_MS_CCSRC_PIPELINE_JIT_STATIC_ANALYSIS_EVALUATOR_H_
...
#endif  // LUOJIANET_MS_CCSRC_PIPELINE_JIT_STATIC_ANALYSIS_EVALUATOR_H_
