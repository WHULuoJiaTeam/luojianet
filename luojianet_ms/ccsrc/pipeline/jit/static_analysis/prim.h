...
#ifndef LUOJIANET_MS_CCSRC_PIPELINE_JIT_STATIC_ANALYSIS_PRIM_H_
#define LUOJIANET_MS_CCSRC_PIPELINE_JIT_STATIC_ANALYSIS_PRIM_H_
...
class UniformPrimEvaluator final : public TrivialPrimEvaluator {
 ...
 private:
  ...
  luojianet_ms::HashMap<TypePtr, std::shared_ptr<std::vector<size_t>>, TypeHasher, TypeEqual> type_map_;
};
...
#endif  // LUOJIANET_MS_CCSRC_PIPELINE_JIT_STATIC_ANALYSIS_PRIM_H_
