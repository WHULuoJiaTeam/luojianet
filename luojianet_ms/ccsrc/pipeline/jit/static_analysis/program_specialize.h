...
#ifndef LUOJIANET_MS_CCSRC_PIPELINE_JIT_STATIC_ANALYSIS_SPECIALIZE_H_
#define LUOJIANET_MS_CCSRC_PIPELINE_JIT_STATIC_ANALYSIS_SPECIALIZE_H_
...
class ProgramSpecializer {
 public:
  ...
  const luojianet_ms::HashSet<AnfNodePtr> &seen() const { return seen_; }
 ...
 private:
  ...
  luojianet_ms::HashSet<AnfNodePtr> seen_;
...
class FuncGraphSpecializer : public std::enable_shared_from_this<FuncGraphSpecializer> {
 ...
 private:
  ...
  luojianet_ms::HashSet<AnfNodePtr> marked_;
  luojianet_ms::HashMap<EvaluatorPtr, EvaluatorCacheMgrPtr> evalcaches_;
...
#endif  // LUOJIANET_MS_CCSRC_PIPELINE_JIT_STATIC_ANALYSIS_SPECIALIZE_H_
