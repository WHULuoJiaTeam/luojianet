...
#ifndef LUOJIANET_MS_CCSRC_PIPELINE_JIT_STATIC_ANALYSIS_STACK_FRAME_H_
#define LUOJIANET_MS_CCSRC_PIPELINE_JIT_STATIC_ANALYSIS_STACK_FRAME_H_
...
#endif  // LUOJIANET_MS_CCSRC_PIPELINE_JIT_STATIC_ANALYSIS_STACK_FRAME_H_
