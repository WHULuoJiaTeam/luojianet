...
#ifndef LUOJIANET_MS_CCSRC_PIPELINE_JIT_STATIC_ANALYSIS_STATIC_ANALYSIS_H_
#define LUOJIANET_MS_CCSRC_PIPELINE_JIT_STATIC_ANALYSIS_STATIC_ANALYSIS_H_
...
using AttrValueMap = luojianet_ms::HashMap<std::string, ValuePtr>;
...
using PrimEvaluatorMap = luojianet_ms::HashMap<PrimitivePtr, EvaluatorPtr, PrimitiveHasher, PrimitiveEqual>;
...
class PrimitiveEvalCache {
 public:
  ...
  using PrimToEvalCache = luojianet_ms::HashMap<std::string, EvalCache>;
...
class AnalysisEngine : public std::enable_shared_from_this<AnalysisEngine> {
 public:
  ...
  luojianet_ms::HashMap<PrimitivePyPtr, EvaluatorPtr> prim_py_evaluators_;
...
#endif  // LUOJIANET_MS_CCSRC_PIPELINE_JIT_STATIC_ANALYSIS_STATIC_ANALYSIS_H_
