...
#ifndef LUOJIANET_MS_CCSRC_PIPELINE_JIT_VALIDATOR_H_
#define LUOJIANET_MS_CCSRC_PIPELINE_JIT_VALIDATOR_H_
...
#endif  // LUOJIANET_MS_CCSRC_PIPELINE_JIT_VALIDATOR_H__
