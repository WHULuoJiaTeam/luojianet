...
#ifndef LUOJIANET_MS_CCSRC_PIPELINE_PYNATIVE_BASE_H_
#define LUOJIANET_MS_CCSRC_PIPELINE_PYNATIVE_BASE_H_
...
#endif  // LUOJIANET_MS_CCSRC_PIPELINE_PYNATIVE_BASE_H_
