...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_ASCEND_ASCEND_LABEL_ASSIGN_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_ASCEND_ASCEND_LABEL_ASSIGN_H_
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_ASCEND_ASCEND_LABEL_ASSIGN_H_
