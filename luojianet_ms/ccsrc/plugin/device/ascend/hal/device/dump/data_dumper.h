...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_ASCEND_DUMP_DATADUMP_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_ASCEND_DUMP_DATADUMP_H_
#include <tuple>
#include <map>
#include <set>
#include <memory>
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_ASCEND_DUMP_DATADUMP_H_
