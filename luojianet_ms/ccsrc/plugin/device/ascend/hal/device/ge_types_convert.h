...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_ASCEND_DUMP_GE_DUMP_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_ASCEND_DUMP_GE_DUMP_H_
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_ASCEND_DUMP_GE_DUMP_H_
