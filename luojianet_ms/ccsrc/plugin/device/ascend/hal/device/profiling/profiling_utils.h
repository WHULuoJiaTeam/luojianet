 ...
 */
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_ASCEND_PROFILING_PROFILING_UTILS_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_ASCEND_PROFILING_PROFILING_UTILS_H_
...
class ProfilingUtils {
 public:
  ...
  static void InsertProfilingTraceIterEnd(const AnfNodePtr &anf_node, const ProfilingTraceInfo &profiling_trace_info,
                                          NotNull<session::KernelGraph *> graph_ptr,
                                          NotNull<std::vector<CNodePtr> *> kernel_list);
  static void InsertProfilingTraceBpEnd(const luojianet_ms::AnfNodePtr &anf_node,
                                        const ProfilingTraceInfo &profiling_trace_info,
                                        NotNull<session::KernelGraph *> graph_ptr,
                                        NotNull<std::vector<luojianet_ms::CNodePtr> *> kernel_list);
  ...
  static void InsertProfilingCustomOp(const luojianet_ms::AnfNodePtr &anf_node,
                                      const ProfilingTraceInfo &profiling_trace_info,
                                      NotNull<session::KernelGraph *> graph_ptr,
                                      NotNull<std::vector<luojianet_ms::CNodePtr> *> kernel_list);
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_ASCEN_D_PROFILING_PROFILING_UTILS_H_
