 ...
 */
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_ASCEND_TASK_TASK_BUILD_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_ASCEND_TASK_TASK_BUILD_H_
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_ASCEND_TASK_TASK_BUILD_H_
