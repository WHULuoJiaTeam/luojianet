 ...
 */
#ifndef LUOJIANET_MS_RUNTIME_HCCL_ADAPTER_ALL_TO_ALL_V_CALC_PARAM_H
#define LUOJIANET_MS_RUNTIME_HCCL_ADAPTER_ALL_TO_ALL_V_CALC_PARAM_H
...
#endif  // LUOJIANET_MS_RUNTIME_HCCL_ADAPTER_ALL_TO_ALL_V_CALC_PARAM_H
