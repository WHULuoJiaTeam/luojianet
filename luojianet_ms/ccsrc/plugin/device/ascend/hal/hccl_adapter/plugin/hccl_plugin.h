 ...
 */
#ifndef LUOJIANET_MS_RUNTIME_HCCL_ADAPTER_PLUGIN_HCCL_PLUGIN_H
#define LUOJIANET_MS_RUNTIME_HCCL_ADAPTER_PLUGIN_HCCL_PLUGIN_H
...
#endif  // LUOJIANET_MS_RUNTIME_HCCL_ADAPTER_PLUGIN_HCCL_PLUGIN_H
