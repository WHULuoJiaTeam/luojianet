...
using AicpuTaskInfoPtr = std::shared_ptr<luojianet_ms::ge::model_runner::AicpuTaskInfo>;
using AicpuDynamicKernel = luojianet_ms::device::ascend::AiCpuDynamicKernel;
...
void AicpuOpKernelMod::SetAnfNode(const luojianet_ms::AnfNodePtr &anf_node) {
...
std::vector<TaskInfoPtr> AicpuOpKernelMod::GenTask(const std::vector<AddressPtr> &inputs,
  ...
  AicpuTaskInfoPtr task_info_ptr = std::make_shared<luojianet_ms::ge::model_runner::AicpuTaskInfo>(
