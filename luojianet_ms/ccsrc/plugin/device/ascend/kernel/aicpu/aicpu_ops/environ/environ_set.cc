...
#include <string>
#include <memory>
#include "luojianet_ms/ccsrc/plugin/device/ascend/kernel/aicpu/aicpu_ops/aicpu_sharder/aicpu_sharder.h"
#include "luojianet_ms/ccsrc/plugin/device/ascend/kernel/aicpu/aicpu_ops/common/tensor.h"
