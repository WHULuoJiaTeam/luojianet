...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_REPLAY_BUFFER_FACTORY_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_REPLAY_BUFFER_FACTORY_H_
...
class ReplayBufferFactory {
 ...
 private:
  ...
  ~ReplayBufferFactory() = default;
  ReplayBufferFactory(const ReplayBufferFactory &) = delete;
  ReplayBufferFactory &operator=(const ReplayBufferFactory &) = delete;
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_ENV_FACTORY_H_
