 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_AICPU_AICPU_UTIL_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_AICPU_AICPU_UTIL_H_
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_AICPU_AICPU_UTIL_H_
