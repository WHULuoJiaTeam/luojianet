...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_RTS_LABEL_SWITCH_H
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_RTS_LABEL_SWITCH_H
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_RTS_LABEL_SWITCH_H
