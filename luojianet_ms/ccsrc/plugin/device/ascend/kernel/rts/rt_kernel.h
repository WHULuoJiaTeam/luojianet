...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_RTS_RT_KERNEL_H
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_RTS_RT_KERNEL_H
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_RTS_RT_KERNEL_H
