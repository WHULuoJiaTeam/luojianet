...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_RTS_STREAM_ACTIVE_H
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_RTS_STREAM_ACTIVE_H
#include <memory>
#include <vector>
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_RTS_STREAM_ACTIVE_H
