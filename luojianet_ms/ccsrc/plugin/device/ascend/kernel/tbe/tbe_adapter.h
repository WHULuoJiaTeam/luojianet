 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_TBE_TBE_ADAPTER_H
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_TBE_TBE_ADAPTER_H
...
class TbeAdapter {
 ...
 private:
  static bool IsSpecialFusionComputeNode(const std::vector<luojianet_ms::AnfNodePtr> &compute_nodes);
  static bool GetSpecInputLayers(const std::string &op_name, const std::vector<luojianet_ms::AnfNodePtr> &reorder_layer,
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_TBE_TBE_ADAPTER_H
