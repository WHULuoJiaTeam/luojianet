...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_TBE_KERNEL_BROADCAST_SELECTER_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_TBE_KERNEL_BROADCAST_SELECTER_H_
...
#endif  // LUOJIANET_MS_TBE_KERNEL_BROADCAST_SELECTER_HELPER_H
