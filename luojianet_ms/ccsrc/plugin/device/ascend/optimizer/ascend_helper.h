 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_ASCEND_ASCEND_HELPER_H_
#define LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_ASCEND_ASCEND_HELPER_H_
...
class KernelQuery {
 public:
  ...
  virtual bool IsTbeRef(const AnfNodePtr &node) {
    ...
    auto op_info = luojianet_ms::kernel::tbe::TbeDynamicShapeUtil::FindOp(common::AnfAlgo::GetCNodeName(node), node);
    if (op_info != nullptr) {
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_ASCEND_ASCEND_HELPER_H_
