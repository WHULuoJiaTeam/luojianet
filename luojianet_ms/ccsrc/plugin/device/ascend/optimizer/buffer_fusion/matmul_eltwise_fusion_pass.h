 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_ASCEND_BUFFER_FUSION_PASS_MATMUL_ELTWISE_FUSION_PASS_H_
#define LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_ASCEND_BUFFER_FUSION_PASS_MATMUL_ELTWISE_FUSION_PASS_H_
...
class MatmulEltwiseFusionPass : public FusionBasePass {
 public:
  explicit MatmulEltwiseFusionPass(const FusionIdAllocatorPtr &idAllocator)
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_ASCEND_BUFFER_FUSION_PASS_MATMUL_ELTWISE_FUSION_PASS_H_
