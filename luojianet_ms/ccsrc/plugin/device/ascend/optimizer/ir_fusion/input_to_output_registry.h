 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_IR_FUSION_INPUT_TO_OUTPUT_REGISTRY_H_
#define LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_IR_FUSION_INPUT_TO_OUTPUT_REGISTRY_H_
#include <string>
#include <vector>
#include <utility>
...
class InputToOutputRegistry {
 ...
 private:
  ...
  luojianet_ms::HashMap<std::string, InputToOutputRegister> op_input_to_output_map_;
};
}  // namespace opt
}  // namespace luojianet_ms

#endif  // LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_IR_FUSION_INPUT_TO_OUTPUT_REGISTRY_H_
