...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_CPU_CPU_MEMORY_MANAGER_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_CPU_CPU_MEMORY_MANAGER_H_
#include <vector>
#include <map>
#include <memory>
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_CPU_CPU_MEMORY_MANAGER_H_
