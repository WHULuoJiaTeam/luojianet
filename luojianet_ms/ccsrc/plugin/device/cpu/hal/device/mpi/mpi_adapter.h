...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_CPU_MPI_MPI_ADAPTER_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_CPU_MPI_MPI_ADAPTER_H_
#include <mpi.h>
#include <vector>
#include <map>
#include <string>
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_CPU_MPI_MPI_ADAPTER_H_
