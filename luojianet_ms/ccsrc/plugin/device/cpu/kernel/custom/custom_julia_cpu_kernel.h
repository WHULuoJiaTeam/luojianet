...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_CUSTOM_JULIA_KERNEL_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_CUSTOM_JULIA_KERNEL_H_
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_CUSTOM_JULIA_KERNEL_H_
