...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_FL_UPDATE_MODEL_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_FL_UPDATE_MODEL_H_
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_FL_UPDATE_MODEL_H_
