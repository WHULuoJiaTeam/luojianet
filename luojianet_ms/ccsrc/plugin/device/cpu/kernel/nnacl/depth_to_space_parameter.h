 ...
 */
#ifndef LUOJIANET_MS_NNACL_DEPTH_TO_SPACE_PARAMETER_H_
#define LUOJIANET_MS_NNACL_DEPTH_TO_SPACE_PARAMETER_H_
...
#endif  // LUOJIANET_MS_NNACL_DEPTH_TO_SPACE_PARAMETER_H_
