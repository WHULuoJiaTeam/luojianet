 ...
 */
#ifndef LUOJIANET_MS_NNACL_FP32_GRAD_ARITHMETIC_GRAD_H_
#define LUOJIANET_MS_NNACL_FP32_GRAD_ARITHMETIC_GRAD_H_
...
#endif  // LUOJIANET_MS_NNACL_FP32_GRAD_ARITHMETIC_GRAD_H_
