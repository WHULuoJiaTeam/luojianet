 ...
 */
#ifndef LUOJIANET_MS_NNACL_BINARY_CROSS_ENTROPY_GRAD_H_
#define LUOJIANET_MS_NNACL_BINARY_CROSS_ENTROPY_GRAD_H_
...
#endif
#endif  // LUOJIANET_MS_NNACL_BINARY_CROSS_ENTROPY_GRAD_H_
