...
#ifndef LUOJIANET_MS_NNACL_AVX512_INTRINSICS_MS_SIMD_INSTRUCTIONS_H_
#define LUOJIANET_MS_NNACL_AVX512_INTRINSICS_MS_SIMD_INSTRUCTIONS_H_
#include <math.h>
#include <float.h>
...
#define MS_SET_ZERO512X4_F32(dst)             \
  ...
  MS_FLOAT32X16 dst##3 = _mm512_setzero_ps(); \
  MS_FLOAT32X16 dst##4 = _mm512_setzero_ps();
#endif  // LUOJIANET_MS_NNACL_AVX512_INTRINSICS_MS_SIMD_INSTRUCTIONS_H_
