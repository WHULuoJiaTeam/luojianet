...
#ifndef LUOJIANET_MS_NNACL_AVX_INTRINSICS_MS_SIMD_INSTRUCTIONS_H_
#define LUOJIANET_MS_NNACL_AVX_INTRINSICS_MS_SIMD_INSTRUCTIONS_H_
#include <math.h>
...
#define MS_SET_ZERO256X4_F32(dst)            \
  ...
  MS_FLOAT32X8 dst##3 = _mm256_setzero_ps(); \
  MS_FLOAT32X8 dst##4 = _mm256_setzero_ps();
#endif  // LUOJIANET_MS_NNACL_AVX_INTRINSICS_MS_SIMD_INSTRUCTIONS_H_
