...
#ifndef LUOJIANET_MS_NNACL_NEON_INTRINSICS_MS_SIMD_INSTRUCTIONS_H_
#define LUOJIANET_MS_NNACL_NEON_INTRINSICS_MS_SIMD_INSTRUCTIONS_H_
#include <math.h>
#include <float.h>
...
#define MS_SET_ZERO128X4_F32(dst)          \
  ...
  MS_FLOAT32X4 dst##3 = MS_MOVQ_F32(0.0f); \
  MS_FLOAT32X4 dst##4 = MS_MOVQ_F32(0.0f);
#endif  // LUOJIANET_MS_NNACL_NEON_INTRINSICS_MS_SIMD_INSTRUCTIONS_H_
