...
#ifndef LUOJIANET_MS_LITE_NNACL_INTRINSICS_SSE_SSE_COMMON_H_
#define LUOJIANET_MS_LITE_NNACL_INTRINSICS_SSE_SSE_COMMON_H_
...
#endif  // LUOJIANET_MS_LITE_NNACL_INTRINSICS_SSE_SSE_COMMON_H_
