...
#ifndef LUOJIANET_MS_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_SPARSE_APPLY_FTRL_PS_KERNEL_H_
#define LUOJIANET_MS_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_SPARSE_APPLY_FTRL_PS_KERNEL_H_
...
namespace kernel {
namespace ps {
using luojianet_ms::kernel::SparseApplyFtrlCpuKernelMod;
...
#endif  // LUOJIANET_MS_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_SPARSE_APPLY_FTRL_PS_KERNEL_H_
