...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_SEGMENT_TREE_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_SEGMENT_TREE_H_
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_SEGMENT_TREE_H_
