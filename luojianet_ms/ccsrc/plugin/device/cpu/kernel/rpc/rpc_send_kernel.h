...
#ifndef LUOJIANET_MS_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_RPC_RPC_SEND_KERNEL_H_
#define LUOJIANET_MS_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_RPC_RPC_SEND_KERNEL_H_
...
#endif  // LUOJIANET_MS_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_RPC_RPC_SEND_KERNEL_H_
