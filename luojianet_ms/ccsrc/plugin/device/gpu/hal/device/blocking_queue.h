...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_GPU_BLOCKING_QUEUE_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_GPU_BLOCKING_QUEUE_H_
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_GPU_BLOCKING_QUEUE_H_
