...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_GPU_GPU_MEMORY_COPY_MANAGER_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_GPU_GPU_MEMORY_COPY_MANAGER_H_
...
namespace device {
namespace gpu {
using luojianet_ms::device::memswap::MemCopyManager;
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_GPU_GPU_MEMORY_COPY_MANAGER_H_
