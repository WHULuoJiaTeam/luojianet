...
#ifndef LUOJIANET_MS_LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_ARRAYS_TENSOR_COPY_GPU_KERNEL_H_
#define LUOJIANET_MS_LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_ARRAYS_TENSOR_COPY_GPU_KERNEL_H_
