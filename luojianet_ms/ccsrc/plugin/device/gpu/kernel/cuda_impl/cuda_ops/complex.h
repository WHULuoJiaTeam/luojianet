 ...
 */
#ifndef LUOJIANET_MS_CCSRC_UTILS_COPLEX_H_
#define LUOJIANET_MS_CCSRC_UTILS_COPLEX_H_
...
namespace utils {
// Implement Complex for luojianet_ms, inspired by std::complex.
...
template <typename T>
using Complex = luojianet_ms::utils::Complex<T>;
namespace std {
template <typename T>
class numeric_limits<luojianet_ms::utils::Complex<T>> : public numeric_limits<T> {};
}  // namespace std

#endif  // LUOJIANET_MS_CCSRC_UTILS_COPLEX_H_
