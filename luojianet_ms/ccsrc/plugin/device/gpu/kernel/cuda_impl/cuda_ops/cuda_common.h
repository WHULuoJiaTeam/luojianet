...
#ifndef LUOJIANET_MS_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_CUDA_IMPL_CUDA_OPS_CUDA_COMMON_H_
#define LUOJIANET_MS_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_CUDA_IMPL_CUDA_OPS_CUDA_COMMON_H_
...
#define GET_BLOCKS(total_threads) luojianet_ms::device::gpu::CudaCommon::GetInstance().blocks_num(total_threads)
#define GET_THREADS luojianet_ms::device::gpu::CudaCommon::GetInstance().threads_num()
#define GET_THREADS_MAXSIZE(size) luojianet_ms::device::gpu::CudaCommon::GetInstance().threads_num(size)
#define GET_MAJOR_SM luojianet_ms::device::gpu::CudaCommon::GetInstance().major_sm()
#define GET_CUDA_CAP luojianet_ms::device::gpu::CudaCommon::GetInstance().cuda_cap()
#define SHARED_MEM_PER_BLOCK luojianet_ms::device::gpu::CudaCommon::GetInstance().share_memory_size()
#define MINIUM_SM 6
...
#endif  // LUOJIANET_MS_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_CUDA_IMPL_CUDA_OPS_CUDA_COMMON_H_
