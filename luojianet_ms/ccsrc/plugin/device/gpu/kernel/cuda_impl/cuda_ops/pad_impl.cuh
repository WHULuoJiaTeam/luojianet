...
#ifndef LUOJIANET_MS_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_CUDA_IMPL_CUDA_OPS_PAD_IMPL_CUH_
#define LUOJIANET_MS_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_CUDA_IMPL_CUDA_OPS_PAD_IMPL_CUH_
...
CUDA_LIB_EXPORT void CalPadGradNDHWC(const size_t size, const T *dy, const int num, const int old_depth,
                                     ...
                                     const int pad_head, const int pad_top, const int pad_left, T *dx,
                                     cudaStream_t cuda_stream);
#endif  // LUOJIANET_MS_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_CUDA_IMPL_CUDA_OPS_PAD_IMPL_CUH_
