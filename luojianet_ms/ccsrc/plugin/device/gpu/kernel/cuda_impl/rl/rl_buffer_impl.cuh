...
#ifndef LUOJIANET_MS_CCSRC_KERNEL_GPU_CUDA_IMP_RL_BUFFER_IMPL_H_
#define LUOJIANET_MS_CCSRC_KERNEL_GPU_CUDA_IMP_RL_BUFFER_IMPL_H_
...
void RandomGenUniform(const int size, curandState *globalState, const int up_bound, unsigned int *indexes,
                      cudaStream_t cuda_stream);
#endif  // LUOJIANET_MS_CCSRC_KERNEL_GPU_CUDA_IMP_ADAM_IMPL_H_
