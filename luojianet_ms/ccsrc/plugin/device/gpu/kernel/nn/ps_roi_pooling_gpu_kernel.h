...
#ifndef LUOJIANET_MS_CCSRC_KERNEL_GPU_PS_ROI_POOLING_GPU_KERNEL_H
#define LUOJIANET_MS_CCSRC_KERNEL_GPU_PS_ROI_POOLING_GPU_KERNEL_H
...
#endif  // LUOJIANET_MS_CCSRC_KERNEL_GPU_PS_ROI_POOING_GPU_KERNEL_H
