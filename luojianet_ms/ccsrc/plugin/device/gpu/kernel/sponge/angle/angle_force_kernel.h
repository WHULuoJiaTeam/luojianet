...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONGE_ANGLE_ANGLE_FORCE_KERNEL_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONGE_ANGLE_ANGLE_FORCE_KERNEL_H_
...
class AngleForceGpuKernelMod : public NativeGpuKernelMod {
 public:
  AngleForceGpuKernelMod() : ele_uint_crd(1) {}
  ~AngleForceGpuKernelMod() override = default;
