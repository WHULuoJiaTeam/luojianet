 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONGE_LJ_LJ_FORCE_KERNEL_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONGE_LJ_LJ_FORCE_KERNEL_H_
...
class LJForceGpuKernelMod : public NativeGpuKernelMod {
 public:
  LJForceGpuKernelMod() : ele_uint_crd(1) {}
  ~LJForceGpuKernelMod() override = default;
