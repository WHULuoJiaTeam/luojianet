...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONG_NB14_DIHEDRAL_14_LJ_ATOM_ENERGY_KERNEL_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONG_NB14_DIHEDRAL_14_LJ_ATOM_ENERGY_KERNEL_H_
...
class Dihedral14LJAtomEnergyGpuKernelMod : public NativeGpuKernelMod {
 public:
  Dihedral14LJAtomEnergyGpuKernelMod() : ele_uint_crd(1) {}
  ~Dihedral14LJAtomEnergyGpuKernelMod() override = default;
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONG_NB14_DIHEDRAL_14_LJ_ATOM_ENERGY_KERNEL_H_
