...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONGE_NEIGHBOR_LIST_UPDATE_NEW_KERNEL_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONGE_NEIGHBOR_LIST_UPDATE_NEW_KERNEL_H_
...
constexpr float kCutoffDef = 9.0;
...
class NeighborListUpdateNewGpuKernelMod : public NativeGpuKernelMod {
 public:
  NeighborListUpdateNewGpuKernelMod()
      : skin(kSkinDef),
        cutoff(kCutoffDef),
 ...
 protected:
  void InitSizeLists() override {
    ...
    const size_t kCrtSize = 3;
    workspace_size_list_.push_back(sizeof(float) * kCrtSize);
