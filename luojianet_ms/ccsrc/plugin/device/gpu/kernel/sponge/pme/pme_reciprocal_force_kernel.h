 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONGE_PME_PME_RECIPROCAL_FORCE_KERNEL_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONGE_PME_PME_RECIPROCAL_FORCE_KERNEL_H_
...
class PMEReciprocalForceGpuKernelMod : public NativeGpuKernelMod {
 public:
  PMEReciprocalForceGpuKernelMod() : ele_uint_crd(1) {}
  ~PMEReciprocalForceGpuKernelMod() override = default;
