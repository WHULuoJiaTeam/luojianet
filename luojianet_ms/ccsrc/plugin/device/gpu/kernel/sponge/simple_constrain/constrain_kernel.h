 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONG_SIMPLE_CONSTRAIN_CONSTRAIN_KERNEL_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONG_SIMPLE_CONSTRAIN_CONSTRAIN_KERNEL_H_
...
class ConstrainGpuKernelMod : public NativeGpuKernelMod {
 public:
  ConstrainGpuKernelMod() : ele_crd(1), step(1) {}
  ~ConstrainGpuKernelMod() override = default;
