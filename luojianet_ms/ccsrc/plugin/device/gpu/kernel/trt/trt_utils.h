...
#ifndef LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_TRT_UTILS_H_
#define LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_TRT_UTILS_H_
 ...
 public:
  TrtLogger() {
    ...
    if (str_level.size() == 1) {
      ...
      if (ch >= luojianet_ms::DEBUG && ch <= luojianet_ms::EXCEPTION) {
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_KERNEL_COMPILER_GPU_TRT_UTILS_H_
