 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_GPU_MATMUL_BIASADD_FUSION_H_
#define LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_GPU_MATMUL_BIASADD_FUSION_H_
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_GPU_MATMUL_BIASADD_FUSION_H_
