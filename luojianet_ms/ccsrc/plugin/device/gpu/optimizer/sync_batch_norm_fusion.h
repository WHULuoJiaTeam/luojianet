 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_GPU_SYNC_BATCH_NORM_FUSION_H_
#define LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_GPU_SYNC_BATCH_NORM_FUSION_H_
...
namespace opt {
class SyncBatchNormFusion : public PatternProcessPass {
 public:
  explicit SyncBatchNormFusion(bool multigraph = true) : PatternProcessPass("sync_batch_norm_fusion", multigraph) {}
  ~SyncBatchNormFusion() override = default;
 ...
 private:
  AnfNodePtr SyncBNFusionForGPU(const FuncGraphPtr &func_graph, const AnfNodePtr &node) const;
};
...
#endif  // LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_GPU_SYNC_BATCH_NORM_FUSION_H_
