 ...
 */
#ifndef LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_TRT_PASS_GRAPH_PARTITIONER_H_
#define LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_TRT_PASS_GRAPH_PARTITIONER_H_
...
class GraphDependency {
 ...
 private:
  luojianet_ms::HashMap<std::string, std::set<std::string>> dependencies_;
};
...
class GraphPartitioner {
 ...
 private:
  ...
  luojianet_ms::HashMap<AnfNodePtr, NodeInfo> node_info_;
  GraphDependency dependency_;
};
}  // namespace opt
}  // namespace luojianet_ms
#endif  // LUOJIANET_MS_CCSRC_BACKEND_OPTIMIZER_TRT_PASS_GRAPH_PARTITIONER_H_
