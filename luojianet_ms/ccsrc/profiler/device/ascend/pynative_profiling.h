...
#ifndef LUOJIANET_MS_CCSRC_PROFILER_DEVICE_ASCEND_PYNATIVE_PROFILING_H_
#define LUOJIANET_MS_CCSRC_PROFILER_DEVICE_ASCEND_PYNATIVE_PROFILING_H_
...
namespace profiler {
namespace ascend {
using luojianet_ms::device::ascend::AscendKernelRuntime;
...
#endif  // LUOJIANET_MS_CCSRC_PROFILER_DEVICE_ASCEND_PYNATIVE_PROFILING_H_
