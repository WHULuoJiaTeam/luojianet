...
#ifndef LUOJIANET_MS_CCSRC_PROFILER_DEVICE_CPU_PROFILING_H
#define LUOJIANET_MS_CCSRC_PROFILER_DEVICE_CPU_PROFILING_H
#include <algorithm>
#include <cstdio>
#include <map>
#include <memory>
...
#endif  // LUOJIANET_MS_CCSRC_PROFILER_DEVICE_CPU_PROFILING_H
