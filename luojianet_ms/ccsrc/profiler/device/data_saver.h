...
#ifndef LUOJIANET_MS_CCSRC_PROFILER_DEVICE_DATA_SAVER_H
#define LUOJIANET_MS_CCSRC_PROFILER_DEVICE_DATA_SAVER_H
#include <iostream>
#include <algorithm>
...
#endif  // LUOJIANET_MS_CCSRC_PROFILER_DEVICE_DATA_SAVER_H
