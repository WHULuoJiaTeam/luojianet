 ...
 */
#ifndef LUOJIANET_MS_CCSRC_PROFILER_DEVICE_GPU_GPU_PROFILING_UTILS_H_
#define LUOJIANET_MS_CCSRC_PROFILER_DEVICE_GPU_GPU_PROFILING_UTILS_H_
...
#endif  // LUOJIANET_MS_CCSRC_PROFILER_DEVICE_GPU_GPU_PROFILING_UTILS_H_
