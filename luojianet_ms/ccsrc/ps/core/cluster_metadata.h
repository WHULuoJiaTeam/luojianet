...
#ifndef LUOJIANET_MS_CCSRC_PS_CORE_CLUSTER_METADATA_H_
#define LUOJIANET_MS_CCSRC_PS_CORE_CLUSTER_METADATA_H_
...
#endif  // LUOJIANET_MS_CCSRC_PS_CORE_CLUSTER_METADATA_H_
