...
#ifndef LUOJIANET_MS_CCSRC_PS_CORE_COMMUNICATOR_MESSAGE_H_
#define LUOJIANET_MS_CCSRC_PS_CORE_COMMUNICATOR_MESSAGE_H_
...
#endif  // LUOJIANET_MS_CCSRC_PS_CORE_COMMUNICATOR_MESSAGE_H_
