...
#ifndef LUOJIANET_MS_CCSRC_PS_CORE_COMMUNICATOR_TCP_MESSAGE_HANDLER_H_
#define LUOJIANET_MS_CCSRC_PS_CORE_COMMUNICATOR_TCP_MESSAGE_HANDLER_H_
...
#endif  // LUOJIANET_MS_CCSRC_PS_CORE_COMMUNICATOR_TCP_MESSAGE_HANDLER_H_
