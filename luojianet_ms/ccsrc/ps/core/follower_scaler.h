...
#ifndef LUOJIANET_MS_CCSRC_PS_CORE_FOLLOWER_SCALER_H_
#define LUOJIANET_MS_CCSRC_PS_CORE_FOLLOWER_SCALER_H_
...
#endif  // LUOJIANET_MS_CCSRC_PS_CORE_FOLLOWER_SCALER_H_
