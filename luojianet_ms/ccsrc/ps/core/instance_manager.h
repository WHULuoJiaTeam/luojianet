...
#ifndef LUOJIANET_MS_CCSRC_PS_CORE_INSTANCE_MANAGER_H_
#define LUOJIANET_MS_CCSRC_PS_CORE_INSTANCE_MANAGER_H_
...
#endif  // LUOJIANET_MS_CCSRC_PS_CORE_INSTANCE_MANAGER_H_
