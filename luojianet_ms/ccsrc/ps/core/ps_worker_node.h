...
#ifndef LUOJIANET_MS_CCSRC_PS_CORE_PS_WORKER_NODE_H_
#define LUOJIANET_MS_CCSRC_PS_CORE_PS_WORKER_NODE_H_
...
#endif  // LUOJIANET_MS_CCSRC_PS_CORE_PS_WORKER_NODE_H_
