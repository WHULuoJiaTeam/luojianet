...
#ifndef LUOJIANET_MS_CCSRC_PS_CORE_SCHEDULER_RECOVERY_H_
#define LUOJIANET_MS_CCSRC_PS_CORE_SCHEDULER_RECOVERY_H_
...
#endif  // LUOJIANET_MS_CCSRC_PS_CORE_SCHEDULER_RECOVERY_H_
