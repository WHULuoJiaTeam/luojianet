...
#ifndef LUOJIANET_MS_CCSRC_PS_OPTIMIZER_INFO_BUILDER_H_
#define LUOJIANET_MS_CCSRC_PS_OPTIMIZER_INFO_BUILDER_H_
...
namespace ps {
using luojianet_ms::kernel::KernelMod;
using luojianet_ms::kernel::ps::PServerKernel;
...
#endif  // LUOJIANET_MS_CCSRC_PS_OPTIMIZER_INFO_BUILDER_H_
