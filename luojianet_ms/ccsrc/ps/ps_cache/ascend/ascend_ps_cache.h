...
#ifndef LUOJIANET_MS_CCSRC_PS_PS_CACHE_ASCEND_ASCEND_PS_CACHE_H_
#define LUOJIANET_MS_CCSRC_PS_PS_CACHE_ASCEND_ASCEND_PS_CACHE_H_
...
#endif  // LUOJIANET_MS_CCSRC_PS_PS_CACHE_ASCEND_ASCEND_PS_CACHE_H_
