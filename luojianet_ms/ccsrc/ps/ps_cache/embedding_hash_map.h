...
#ifndef LUOJIANET_MS_CCSRC_PS_PS_CACHE_EMBEDDING_HASH_MAP_H_
#define LUOJIANET_MS_CCSRC_PS_PS_CACHE_EMBEDDING_HASH_MAP_H_
...
class EmbeddingHashMap {
 public:
  ...
  const luojianet_ms::HashMap<int, int> &hash_id_to_index() const { return hash_id_to_index_; }
 ...
 private:
  ...
  luojianet_ms::HashMap<int, int> hash_id_to_index_;
  size_t current_pos_;
...
#endif  // LUOJIANET_MS_CCSRC_PS_PS_CACHE_EMBEDDING_HASH_MAP_H_
