 ...
 */
#ifndef LUOJIANET_MS_CCSRC_PS_PS_CACHE_PS_CACHE_FACTORY_H_
#define LUOJIANET_MS_CCSRC_PS_PS_CACHE_PS_CACHE_FACTORY_H_
...
#endif  // LUOJIANET_MS_CCSRC_PS_PS_CACHE_PS_CACHE_FACTORY_H_
