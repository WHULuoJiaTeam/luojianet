...
namespace ps {
luojianet_ms::HashMap<std::string, int64_t> Util::optimizer_to_ids{
  {kApplyMomentum, 0},
  {kSparseAdam, 1},
  {kSparseLazyAdam, 2},
  {kSparseFtrl, 3},
...
luojianet_ms::HashMap<int64_t, std::string> Util::id_to_optimizers{
  {0, kApplyMomentum},
  {1, kSparseAdam},
  {2, kSparseLazyAdam},
  {3, kSparseFtrl},
...
luojianet_ms::HashMap<int64_t, std::string> Util::id_to_optimizer_nodes{
  {0, kApplyMomentumOp},
  {1, kSparseAdamOp},
  {2, kSparseLazyAdamOp},
  {3, kSparseFtrlOp},
...
void Util::ReduceSparseGradient(float *gradients, int *indices, const size_t indices_size, size_t segment_size,
                                ...
                                luojianet_ms::kernel::SparseGradient<int> *unique_sparse_grad) {
  ...
  luojianet_ms::kernel::SparseGradient<int> workspace_sparse_grad(
    {workspace_grad.data(), workspace_indices.data(), indices_size});
  luojianet_ms::kernel::SparseGradient<int> input_sparse_grad({gradients, indices, indices_size});
  luojianet_ms::kernel::ReduceSparseGradientParam<int> param;
  ...
  luojianet_ms::kernel::SparseOptimizerCpuKernelMod::BucketReduceSparseGradient(param);
}
