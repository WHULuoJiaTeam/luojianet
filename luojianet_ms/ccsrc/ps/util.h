...
#ifndef LUOJIANET_MS_CCSRC_PS_UTIL_H_
#define LUOJIANET_MS_CCSRC_PS_UTIL_H_
...
class BACKEND_EXPORT Util {
 ...
 private:
  ...
  static luojianet_ms::HashMap<std::string, int64_t> optimizer_to_ids;
  static luojianet_ms::HashMap<int64_t, std::string> id_to_optimizers;
  static luojianet_ms::HashMap<int64_t, std::string> id_to_optimizer_nodes;
  static int64_t rank_id_;
};
}  // namespace ps
}  // namespace luojianet_ms
#endif  // LUOJIANET_MS_CCSRC_PS_UTIL_H_
