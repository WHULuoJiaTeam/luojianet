...
REGISTER_PYBIND_DEFINE(MsContextPy, ([](const py::module *m) {
                         ...
                         (void)py::class_<luojianet_ms::MsContext, std::shared_ptr<luojianet_ms::MsContext>>(*m, "MSContext")
                           .def_static("get_instance", &luojianet_ms::MsContext::GetInstance, "Get ms context instance.")
                           .def("get_param", &luojianet_ms::MsCtxGetParameter, "Get value of specified parameter.")
                           .def("set_param", &luojianet_ms::MsCtxSetParameter, "Set value for specified parameter.")
                           .def("get_backend_policy", &luojianet_ms::MsContext::backend_policy, "Get backend policy.")
                           .def("set_backend_policy", &luojianet_ms::MsContext::set_backend_policy, "Set backend policy.")
                           .def("enable_dump_ir", &luojianet_ms::MsContext::enable_dump_ir, "Get the ENABLE_DUMP_IR.");
                       }));
}  // namespace luojianet_ms
