...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_HARDWARE_COLLECTIVE_COLLECTIVE_LIB_LOADER_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_HARDWARE_COLLECTIVE_COLLECTIVE_LIB_LOADER_H_
...
ORIGIN_METHOD(communication_lib_instance, luojianet_ms::device::CollectiveCommunicationLib *)
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_HARDWARE_COLLECTIVE_COLLECTIVE_LIB_LOADER_H_
