...
namespace {
const std::unordered_map<luojianet_ms::TypeId, std::string> type_id_name_map = {
  {luojianet_ms::kNumberTypeBool, "bool"},       {luojianet_ms::kNumberTypeInt8, "int8"},
  {luojianet_ms::kNumberTypeInt16, "int16"},     {luojianet_ms::kNumberTypeInt32, "int32"},
  {luojianet_ms::kNumberTypeInt64, "int64"},     {luojianet_ms::kNumberTypeFloat16, "float16"},
  {luojianet_ms::kNumberTypeFloat32, "float32"}, {luojianet_ms::kNumberTypeUInt8, "uint8"},
  {luojianet_ms::kNumberTypeUInt16, "uint16"},   {luojianet_ms::kNumberTypeUInt32, "uint32"},
  {luojianet_ms::kNumberTypeUInt64, "uint64"}};
const std::set<std::pair<std::string, std::string>> use_trans_data = {
  std::make_pair("float16", luojianet_ms::kOpFormat_NC1HWC0), std::make_pair("float32", luojianet_ms::kOpFormat_NC1HWC0),
  std::make_pair("bool", luojianet_ms::kOpFormat_NC1HWC0),    std::make_pair("float32", luojianet_ms::kOpFormat_FRAC_Z),
  std::make_pair("float16", luojianet_ms::kOpFormat_FRAC_Z),  std::make_pair("float16", luojianet_ms::kOpFormat_FRAC_NZ),
  std::make_pair("float32", luojianet_ms::kOpFormat_FRAC_NZ), std::make_pair("int32", luojianet_ms::kOpFormat_FRAC_NZ),
  std::make_pair("float16", luojianet_ms::kOpFormat_NHWC),    std::make_pair("float32", luojianet_ms::kOpFormat_NHWC),
  std::make_pair("int8", luojianet_ms::kOpFormat_NHWC),       std::make_pair("int16", luojianet_ms::kOpFormat_NHWC),
  std::make_pair("int32", luojianet_ms::kOpFormat_NHWC),      std::make_pair("int64", luojianet_ms::kOpFormat_NHWC),
  std::make_pair("uint8", luojianet_ms::kOpFormat_NHWC),      std::make_pair("uint16", luojianet_ms::kOpFormat_NHWC),
  std::make_pair("uint32", luojianet_ms::kOpFormat_NHWC),     std::make_pair("uint64", luojianet_ms::kOpFormat_NHWC),
  std::make_pair("float16", luojianet_ms::kOpFormat_HWCN),    std::make_pair("float32", luojianet_ms::kOpFormat_HWCN),
  std::make_pair("int8", luojianet_ms::kOpFormat_HWCN),       std::make_pair("int16", luojianet_ms::kOpFormat_HWCN),
  std::make_pair("int32", luojianet_ms::kOpFormat_HWCN),      std::make_pair("int64", luojianet_ms::kOpFormat_HWCN),
  std::make_pair("uint8", luojianet_ms::kOpFormat_HWCN),      std::make_pair("uint16", luojianet_ms::kOpFormat_HWCN),
  std::make_pair("uint32", luojianet_ms::kOpFormat_HWCN),     std::make_pair("uint64", luojianet_ms::kOpFormat_HWCN)};
}  // namespace
...
bool AscendDeviceAddress::SyncDeviceToHost(const ShapeVector &shape, size_t size, luojianet_ms::TypeId type,
                                           void *host_ptr) const {
...
bool AscendDeviceAddress::SyncDeviceToHostAndConvertFormatBasedOnTransData(const std::vector<size_t> &host_shape,
                                                                           size_t size, luojianet_ms::TypeId type,
                                                                           void *host_ptr) const {
  bool sync_ok = true;
...
bool AscendDeviceAddress::SyncDeviceToHostAndConvertFormat(const ShapeVector &shape, size_t size,
                                                           luojianet_ms::TypeId type, void *host_ptr) const {
...
bool AscendDeviceAddress::SyncHostToDevice(const ShapeVector &shape, size_t size, luojianet_ms::TypeId type,
...
bool AscendDeviceAddress::ConvertFormatAndSyncHostToDevice(const ShapeVector &shape, size_t size,
                                                           luojianet_ms::TypeId type, const void *host_ptr) const {
  bool sync_ok = false;
