...
void ProfilingUtils::InsertProfilingTraceFp(const luojianet_ms::AnfNodePtr &anf_node,
...
CNodePtr ProfilingUtils::CreateProfilingCNodeWithStream(const luojianet_ms::AnfNodePtr &anf_node,
