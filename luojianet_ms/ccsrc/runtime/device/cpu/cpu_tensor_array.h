...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_CPU_CPU_TENSOR_ARRAY_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_CPU_CPU_TENSOR_ARRAY_H_
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_CPU_CPU_TENSOR_ARRAY_H_
