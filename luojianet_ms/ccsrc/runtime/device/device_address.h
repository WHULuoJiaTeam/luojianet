...
#ifndef LUOJIANET_MS_DEVICE_TENSOR_H
#define LUOJIANET_MS_DEVICE_TENSOR_H
...
class DeviceAddress : public luojianet_ms::DeviceSync {
 public:
 ...
 protected:
  ...
  friend class luojianet_ms::device::ascend::tasksink::TaskGenerator;
  friend class luojianet_ms::device::cpu::CPUSimpleMemPlan;
  friend class luojianet_ms::device::cpu::CPUMemoryManager;
  friend class luojianet_ms::device::cpu::CPUKernelRuntime;
  friend class luojianet_ms::device::cpu::CPUDeviceContext;
  friend class luojianet_ms::device::gpu::GPUKernelRuntime;
  friend class luojianet_ms::device::gpu::GPUMemoryManager;
  friend class luojianet_ms::device::gpu::GPUDeviceContext;
  friend class luojianet_ms::device::ascend::AscendKernelRuntime;
  friend class luojianet_ms::device::ascend::AscendMemoryManager;
  friend class luojianet_ms::device::ascend::AscendDeviceContext;
#ifndef ENABLE_SECURITY
  friend class luojianet_ms::device::ascend::DataDumper;
#endif
  friend class luojianet_ms::device::Bucket;
};
...
#endif  // LUOJIANET_MS_DEVICE_TENSOR_H
