...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_GPU_CUDA_COMMON_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_GPU_CUDA_COMMON_H_
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_GPU_CUDA_COMMON_H_
