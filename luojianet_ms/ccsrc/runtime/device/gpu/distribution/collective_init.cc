    ...
    if (handle == nullptr) {
      MS_LOG(EXCEPTION)
        << "Loading libgpu_collective.so failed. Many reasons could cause this:\n"
           "1.libgpu_collective.so is not found, please check this LuoJiaNet package is GPU version and built "
           "with distributed feature.\n"
           "2.NCCL is not found or the user-installed NCCL version installed is incompatible: LuoJiaNet "
           "requires NCCL-2.7.6.\n"
           "3.OpenMPI is not found or the user-installed OpenMPI version is incompatible: LuoJiaNet "
