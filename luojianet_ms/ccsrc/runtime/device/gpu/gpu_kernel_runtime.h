...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_GPU_GPU_KERNEL_RUNTIME_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_GPU_GPU_KERNEL_RUNTIME_H_
...
namespace device {
namespace gpu {
using luojianet_ms::device::memswap::MemSwapManagerPtr;
using luojianet_ms::memreuse::MemReuseUtilPtr;
class GPUKernelRuntime : public KernelRuntime {
 ...
 private:
  ...
  bool IsGraphOutput(const session::KernelGraph *graph, const luojianet_ms::AnfNodePtr &kernel) const;
  ...
  bool AllocKernelDynamicRes(const luojianet_ms::kernel::KernelMod &kernel_mod, const luojianet_ms::AnfNodePtr &kernel,
                             AddressPtrList *kernel_inputs, AddressPtrList *kernel_workspaces,
                             AddressPtrList *kernel_outputs, bool mock);
  bool AllocKernelInputDynamicRes(const luojianet_ms::AnfNodePtr &kernel, AddressPtrList *kernel_inputs, bool mock);
  bool AllocKernelOutputDynamicRes(const luojianet_ms::kernel::KernelMod &kernel_mod, const luojianet_ms::AnfNodePtr &kernel,
                                   AddressPtrList *kernel_outputs, bool mock);
  bool AllocKernelWorkspaceDynamicRes(const luojianet_ms::kernel::KernelMod &kernel_mod,
                                      const luojianet_ms::AnfNodePtr &kernel, AddressPtrList *kernel_workspaces,
                                      bool mock);
  void AllocCommunicationOpDynamicRes(const session::KernelGraph *graph);
  void AllocCommunicationOpInputDynamicRes(const luojianet_ms::AnfNodePtr &kernel);
  void AllocCommunicationOpOutputDynamicRes(const luojianet_ms::AnfNodePtr &kernel);
  ...
  void FreeKernelDynamicRes(const luojianet_ms::AnfNodePtr &kernel);
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_GPU_GPU_KERNEL_RUNTIME_H_
