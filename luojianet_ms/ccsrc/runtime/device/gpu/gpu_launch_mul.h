...
#ifndef LUOJIANET_MS_LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_GPU_GPU_LAUNCH_MUL_H_
#define LUOJIANET_MS_LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_GPU_GPU_LAUNCH_MUL_H_
...
#endif  // LUOJIANET_MS_LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_GPU_GPU_LAUNCH_MUL_H_
