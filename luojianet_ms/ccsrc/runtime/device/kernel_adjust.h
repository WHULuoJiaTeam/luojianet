...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_KERNEL_ADJUST_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_KERNEL_ADJUST_H_
...
using luojianet_ms::device::ascend::ProfilingTraceInfo;
...
class KernelAdjust {
 ...
 private:
  ...
  CNodePtr CreateStreamSwitchOp(const std::shared_ptr<session::KernelGraph> &kernel_graph_ptr,
                                const std::map<std::string, luojianet_ms::ParameterPtr> &switch_loop_input,
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_KERNEL_ADJUST_H_
