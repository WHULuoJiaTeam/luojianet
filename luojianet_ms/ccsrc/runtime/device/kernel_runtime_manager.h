...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_KERNEL_RUNTIME_MANAGER_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_KERNEL_RUNTIME_MANAGER_H_
#include <map>
#include <memory>
#include <string>
#include <functional>
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_KERNEL_RUNTIME_MANAGER_H_
