...
#ifndef LUOJIANET_MS_LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_LAUNCH_KERNEL_H_
#define LUOJIANET_MS_LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_LAUNCH_KERNEL_H_
...
#endif  // LUOJIANET_MS_LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_LAUNCH_KERNEL_H_
