...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_MEMORY_MANAGER_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_MEMORY_MANAGER_H_
#include <memory>
#include <utility>
#include <vector>
#include <map>
...
using SomasPtr = luojianet_ms::somas::SomasPtr;
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_MEMORY_MANAGER_H_
