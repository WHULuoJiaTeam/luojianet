...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_MEMORY_OFFLOAD_STRATEGY_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_MEMORY_OFFLOAD_STRATEGY_H_
#include <vector>
#include <map>
#include <set>
#include <memory>
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_MEMORY_OFFLOAD_STRATEGY_H_
