...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_SYNC_STREAM_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_SYNC_STREAM_H_
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_SYNC_STREAM_H_
