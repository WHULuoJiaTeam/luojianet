...
luojianet_ms::kernel::AddressPtr TensorArray::Read(const int64_t index) {
...
bool TensorArray::Write(const int64_t index, const luojianet_ms::kernel::AddressPtr &dev_value) {
