...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_TENSOR_ARRAY_MANAGER_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_TENSOR_ARRAY_MANAGER_H_
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_DEVICE_TENSOR_ARRAY_MANAGER_H_
