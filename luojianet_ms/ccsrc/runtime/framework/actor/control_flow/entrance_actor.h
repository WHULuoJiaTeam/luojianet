...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_ACTOR_CONTROLFLOW_ENTRANCE_ACTOR_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_ACTOR_CONTROLFLOW_ENTRANCE_ACTOR_H_
...
class EntranceActor : public ControlActor {
 ...
 private:
  ...
  luojianet_ms::HashMap<int, std::vector<AID *>> loop_body_input_op_controls_;
  std::vector<AID> loop_body_input_control_arrow_aids_;
  size_t loop_body_input_controls_nums_{0};

  // Input data with branch id.
  luojianet_ms::HashMap<int, std::queue<OpRealParameterWithBranchID>> real_parameters_with_branch_id_;
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_ACTOR_CONTROLFLOW_ENTRANCE_ACTOR_H_
