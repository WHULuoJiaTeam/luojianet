...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_ACTOR_CONTROLFLOW_GATHER_ACTOR_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_ACTOR_CONTROLFLOW_GATHER_ACTOR_H_
...
class GatherActor : public ControlActor {
 public:
  ...
  const luojianet_ms::HashMap<FuncGraph *, std::vector<AID>> &output_data_with_branch_id_arrows() const {
 ...
 private:
  ...
  luojianet_ms::HashMap<FuncGraph *, std::vector<AID>> output_data_with_branch_id_arrows_;
};
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_ACTOR_CONTROLFLOW_GATHER_ACTOR_H_
