...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_GRAPH_COMPILER_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_GRAPH_COMPILER_H_
...
class GraphCompiler {
 ...
 private:
  ...
  luojianet_ms::HashMap<GraphInfo, KernelGraphPtr> run_op_graphs_;
  // Single op kernel graph output nodes cache for PyNative mode.
  luojianet_ms::HashMap<GraphId, std::vector<KernelWithIndex>> run_op_graph_output_nodes_;
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_GRAPH_COMPILER_H_
