...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_ACTOR_CONTROLFLOW_EXIT_ACTOR_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_ACTOR_CONTROLFLOW_EXIT_ACTOR_H_
...
class ExitActor : public ControlActor {
 public:
  ...
  const luojianet_ms::HashMap<int, std::vector<AID>> &output_branch_control_arrows() const {
    return output_branch_control_arrows_;
  }
  const luojianet_ms::HashMap<int, std::vector<DataArrowPtr>> &output_branch_data_arrows() const {
    return output_branch_data_arrows_;
  }
  const luojianet_ms::HashMap<int, std::vector<DataArrowPtr>> &output_branch_partial_arrows() const {
 ...
 private:
  ...
  luojianet_ms::HashMap<int, std::vector<DataArrowPtr>> output_branch_data_arrows_;
  luojianet_ms::HashMap<int, std::vector<AID>> output_branch_control_arrows_;
  luojianet_ms::HashMap<int, std::vector<DataArrowPtr>> output_branch_partial_arrows_;
  ...
  luojianet_ms::HashMap<int, std::vector<std::pair<size_t, OpDataUniquePtr<DeviceTensor>>>> output_branch_data_;
};
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_ACTOR_CONTROLFLOW_EXIT_ACTOR_H_
