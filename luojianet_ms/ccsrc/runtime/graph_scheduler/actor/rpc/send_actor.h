...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_ACTOR_RPC_SEND_ACTOR_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_ACTOR_RPC_SEND_ACTOR_H_
...
class SendActor : public RpcActor {
 ...
 private:
  ...
  luojianet_ms::HashMap<std::string, std::string> peer_actor_urls_;
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_ACTOR_RPC_SEND_ACTOR_H_
