...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_ACTOR_SUPER_KERNEL_ACTOR_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_ACTOR_SUPER_KERNEL_ACTOR_H_
...
namespace runtime {
using luojianet_ms::device::DeviceAddress;
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_ACTOR_KERNEL_ACTOR_H_
