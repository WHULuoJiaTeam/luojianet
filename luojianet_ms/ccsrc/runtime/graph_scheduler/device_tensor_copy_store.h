...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_DEVICE_TENSOR_COPY_STORE_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_DEVICE_TENSOR_COPY_STORE_H_
...
class DeviceTensorCopyStore {
 ...
 private:
  ...
  luojianet_ms::HashMap<DeviceTensor *, std::set<DeviceTensor *>> copy_device_tensors_;
};
}  // namespace runtime
}  // namespace luojianet_ms

#endif  // LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_DEVICE_TENSOR_COPY_STORE_H_
