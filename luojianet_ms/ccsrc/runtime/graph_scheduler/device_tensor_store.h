...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_DEVICE_TENSOR_STORE_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_DEVICE_TENSOR_STORE_H_
...
namespace runtime {
using DeviceTensor = luojianet_ms::device::DeviceAddress;
using DeviceTensorType = luojianet_ms::device::DeviceAddressType;
...
class DeviceTensorStore {
 ...
 private:
  ...
  luojianet_ms::HashMap<AnfNode *, std::vector<DeviceTensorPtr>> device_tensors_;
};
}  // namespace runtime
}  // namespace luojianet_ms

#endif  // LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_DEVICE_TENSOR_STORE_H_
