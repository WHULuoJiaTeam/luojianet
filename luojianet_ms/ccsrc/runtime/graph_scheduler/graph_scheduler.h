...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_GRAPH_SCHEDULER_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_GRAPH_SCHEDULER_H_
...
class BACKEND_EXPORT GraphScheduler {
 ...
 private:
  ...
  luojianet_ms::HashMap<ActorInfo, ActorSetPtr> actors_;
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_GRAPH_SCHEDULER_H_
