...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_HOST_QUEUE_STORE_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_HOST_QUEUE_STORE_H_
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_FRAMEWORK_HOST_QUEUE_STORE_H_
