...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_HARDWARE_CPU_MS_COLLECTIVE_COMM_LIB_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_HARDWARE_CPU_MS_COLLECTIVE_COMM_LIB_H_
...
using ClusterContext = luojianet_ms::distributed::cluster::ClusterContext;
using CollectiveOpsImpl = luojianet_ms::fl::server::CollectiveOpsImpl;
using CommunicationGroupInfo = luojianet_ms::fl::server::CommunicationGroupInfo;

// The collective communication library for LuoJiaNet self developed communication framework.
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_HARDWARE_CPU_MS_COLLECTIVE_COMM_LIB_H_
