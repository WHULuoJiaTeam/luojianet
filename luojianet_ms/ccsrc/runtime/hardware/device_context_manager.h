...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_HARDWARE_DEVICE_CONTEXT_MANAGER_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_HARDWARE_DEVICE_CONTEXT_MANAGER_H_
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_HARDWARE_DEVICE_CONTEXT_MANAGER_H_
