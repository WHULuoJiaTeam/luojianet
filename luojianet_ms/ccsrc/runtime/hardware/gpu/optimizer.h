...
#ifndef LUOJIANET_MS_CCSRC_RUNTIME_HARDWARE_GPU_OPTIMIZER_H_
#define LUOJIANET_MS_CCSRC_RUNTIME_HARDWARE_GPU_OPTIMIZER_H_
...
#endif  // LUOJIANET_MS_CCSRC_RUNTIME_HARDWARE_GPU_OPTIMIZER_H_
