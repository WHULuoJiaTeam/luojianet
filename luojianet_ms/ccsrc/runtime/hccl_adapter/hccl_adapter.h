...
#ifndef LUOJIANET_MS_RUNTIME_HCCL_ADAPTER_HCCL_ADAPTER_H
#define LUOJIANET_MS_RUNTIME_HCCL_ADAPTER_HCCL_ADAPTER_H
...
#endif  // LUOJIANET_MS_RUNTIME_HCCL_ADAPTER_HCCL_ADAPTER_H
