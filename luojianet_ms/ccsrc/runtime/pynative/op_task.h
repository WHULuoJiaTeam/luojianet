...
#ifndef LUOJIANET_MS_LUOJIANET_MS_CCSRC_RUNTIME_PYNATIVE_OP_TASK_H_
#define LUOJIANET_MS_LUOJIANET_MS_CCSRC_RUNTIME_PYNATIVE_OP_TASK_H_
...
#endif  // LUOJIANET_MS_LUOJIANET_MS_CCSRC_RUNTIME_PYNATIVE_OP_TASK_H_
