...
static luojianet_ms::HashMap<int, mind_ir::TensorProto_DataType> g_data_type_map = {
...
static luojianet_ms::HashMap<int, mind_ir::TensorProto_DataType> g_data_bits_int_map = {
...
static luojianet_ms::HashMap<int, mind_ir::TensorProto_DataType> g_data_bits_uint_map = {
...
static luojianet_ms::HashMap<int, mind_ir::TensorProto_DataType> g_data_bits_float_map = {
...
void IrExportBuilder::BuildModelInfo() {
  ...
  constexpr auto luojianet_ms_name = "LuoJiaNET";
  model_->set_ir_version(ir_version);
  model_->set_producer_name(luojianet_ms_name);
