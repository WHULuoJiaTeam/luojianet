...
namespace transform {
luojianet_ms::HashMap<std::string, std::string> IOFormatMap::io_format_map_ = {{"BasicLSTMCell", "ND"},
...
luojianet_ms::HashMap<std::string, std::string> &IOFormatMap::get() { return io_format_map_; }
}  // namespace transform
}  // namespace luojianet_ms
