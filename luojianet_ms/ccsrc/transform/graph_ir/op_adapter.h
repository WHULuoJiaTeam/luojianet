...
#ifndef LUOJIANET_MS_CCSRC_TRANSFORM_GRAPH_IR_OP_ADAPTER_H_
#define LUOJIANET_MS_CCSRC_TRANSFORM_GRAPH_IR_OP_ADAPTER_H_
...
class OpAdapterImpl {
 public:
  OpAdapterImpl(const luojianet_ms::HashMap<int, InputDesc> &input_map,
                const luojianet_ms::HashMap<int, DynInputDesc> &dyn_input_map,
                const luojianet_ms::HashMap<int, OutputDesc> &output_map,
                const luojianet_ms::HashMap<int, DynOutputDesc> &dyn_output_map,
                const luojianet_ms::HashMap<int, DynSubGraphDesc> &dyn_subgraph_map,
                const luojianet_ms::HashMap<std::string, AttrDesc> &attr_map,
                const luojianet_ms::HashMap<std::string, int> &enum_map,
                const luojianet_ms::HashMap<unsigned int, AttrDesc> &input_attr_map,
                luojianet_ms::HashMap<std::string, luojianet_ms::HashMap<int, std::string>> *cus_input_map,
                luojianet_ms::HashMap<std::string, luojianet_ms::HashMap<int, std::string>> *cus_output_map,
                luojianet_ms::HashMap<std::string, ValuePtr> *extra_attr,
                luojianet_ms::HashMap<std::string, int> *name_counts, BaseOpAdapter *adpt)
 ...
 private:
  const luojianet_ms::HashMap<int, InputDesc> &input_map_;
  const luojianet_ms::HashMap<int, DynInputDesc> &dyn_input_map_;
  const luojianet_ms::HashMap<int, OutputDesc> &output_map_;
  const luojianet_ms::HashMap<int, DynOutputDesc> &dyn_output_map_;
  const luojianet_ms::HashMap<int, DynSubGraphDesc> &dyn_subgraph_map_;
  const luojianet_ms::HashMap<std::string, AttrDesc> &attr_map_;
  const luojianet_ms::HashMap<std::string, int> &enum_map_;
  const luojianet_ms::HashMap<unsigned int, AttrDesc> &input_attr_map_;
  luojianet_ms::HashMap<std::string, luojianet_ms::HashMap<int, std::string>> *const cus_input_map_;
  luojianet_ms::HashMap<std::string, luojianet_ms::HashMap<int, std::string>> *const cus_output_map_;
  luojianet_ms::HashMap<std::string, ValuePtr> *const extra_attr_;
  luojianet_ms::HashMap<std::string, int> *const name_counts_;
...
class OpAdapter : public BaseOpAdapter {
 public:
  ...
  const luojianet_ms::HashMap<int, InputDesc> &getInputMap() override { return input_map_; }
  const luojianet_ms::HashMap<unsigned int, AttrDesc> &getInputAttrMap() override { return input_attr_map_; }
  const luojianet_ms::HashMap<int, DynInputDesc> &getDynInputMap() override { return dyn_input_map_; }
  const luojianet_ms::HashMap<int, OutputDesc> &getOutputMap() override { return output_map_; }
  const luojianet_ms::HashMap<int, DynSubGraphDesc> &getDynSubgraphMap() override { return dyn_subgraph_map_; }
  ...
  luojianet_ms::HashMap<std::string, ValuePtr> GetExtraAttr() override { return extra_attr_; }
 ...
 private:
  ...
  static GeTensor ConvertAny(const ValuePtr &value, const AnyTraits<luojianet_ms::tensor::Tensor> &traits) {
  ...
  static const luojianet_ms::HashMap<int, InputDesc> input_map_;
  static const luojianet_ms::HashMap<int, DynInputDesc> dyn_input_map_;
  static const luojianet_ms::HashMap<int, OutputDesc> output_map_;
  static const luojianet_ms::HashMap<int, DynOutputDesc> dyn_output_map_;
  static const luojianet_ms::HashMap<int, DynSubGraphDesc> dyn_subgraph_map_;
  static const luojianet_ms::HashMap<std::string, AttrDesc> attr_map_;
  static const luojianet_ms::HashMap<std::string, int> enum_map_;
  // convert input from anf graph to Attr in Operators
  static const luojianet_ms::HashMap<unsigned int, AttrDesc> input_attr_map_;
  static luojianet_ms::HashMap<std::string, luojianet_ms::HashMap<int, std::string>> cus_input_map_;
  static luojianet_ms::HashMap<std::string, luojianet_ms::HashMap<int, std::string>> cus_output_map_;
  luojianet_ms::HashMap<std::string, ValuePtr> extra_attr_;
  luojianet_ms::HashMap<std::string, int> name_counts_;
...
template <typename T>
luojianet_ms::HashMap<std::string, luojianet_ms::HashMap<int, std::string>> OpAdapter<T>::cus_input_map_;
template <typename T>
luojianet_ms::HashMap<std::string, luojianet_ms::HashMap<int, std::string>> OpAdapter<T>::cus_output_map_;

// specialization for method
}  // namespace transform
}  // namespace luojianet_ms

#endif  // LUOJIANET_MS_CCSRC_TRANSFORM_GRAPH_IR_OP_ADAPTER_H_
