...
#ifndef LUOJIANET_MS_CCSRC_TRANSFORM_GRAPH_IR_OP_ADAPTER_BASE_H_
#define LUOJIANET_MS_CCSRC_TRANSFORM_GRAPH_IR_OP_ADAPTER_BASE_H_
...
class BaseOpAdapter {
 public:
  ...
  virtual luojianet_ms::HashMap<std::string, ValuePtr> GetExtraAttr() = 0;
  ...
  virtual const luojianet_ms::HashMap<int, InputDesc> &getInputMap() = 0;
  virtual const luojianet_ms::HashMap<unsigned int, AttrDesc> &getInputAttrMap() = 0;
  virtual const luojianet_ms::HashMap<int, DynInputDesc> &getDynInputMap() = 0;
  virtual const luojianet_ms::HashMap<int, OutputDesc> &getOutputMap() = 0;
  virtual const luojianet_ms::HashMap<int, DynSubGraphDesc> &getDynSubgraphMap() = 0;
...
using ExtraAttr = luojianet_ms::HashMap<std::string, ValuePtr>;
}  // namespace transform
}  // namespace luojianet_ms
#endif  // LUOJIANET_MS_CCSRC_TRANSFORM_GRAPH_IR_OP_ADAPTER_BASE_H_
