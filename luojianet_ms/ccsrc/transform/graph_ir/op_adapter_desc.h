...
#ifndef LUOJIANET_MS_CCSRC_TRANSFORM_GRAPH_IR_OP_ADAPTER_DESC_H_
#define LUOJIANET_MS_CCSRC_TRANSFORM_GRAPH_IR_OP_ADAPTER_DESC_H_
...
#endif  // LUOJIANET_MS_CCSRC_TRANSFORM_GRAPH_IR_OP_ADAPTER_DESC_H_
