...
#ifndef LUOJIANET_MS_CCSRC_TRANSFORM_GRAPH_IR_OP_ADAPTER_MAP_H_
#define LUOJIANET_MS_CCSRC_TRANSFORM_GRAPH_IR_OP_ADAPTER_MAP_H_
...
class OpAdapterMap {
 public:
  static luojianet_ms::HashMap<std::string, OpAdapterDescPtr> &get();

 private:
  static luojianet_ms::HashMap<std::string, OpAdapterDescPtr> adpt_map_;
};
}  // namespace transform
}  // namespace luojianet_ms
#endif  // LUOJIANET_MS_CCSRC_TRANSFORM_GRAPH_IR_OP_ADAPTER_MAP_H_
