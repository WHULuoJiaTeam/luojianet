...
#ifndef LUOJIANET_MS_CCSRC_TRANSFORM_GRAPH_IR_OP_ADAPTER_UTIL_H_
#define LUOJIANET_MS_CCSRC_TRANSFORM_GRAPH_IR_OP_ADAPTER_UTIL_H_
...
GeTensor ConvertAnyUtil(const ValuePtr &value, const AnyTraits<luojianet_ms::tensor::Tensor> &traits);
...
#endif  // LUOJIANET_MS_CCSRC_TRANSFORM_GRAPH_IR_OP_ADAPTER_UTIL_H_
