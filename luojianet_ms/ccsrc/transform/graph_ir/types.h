...
#ifndef LUOJIANET_MS_CCSRC_TRANSFORM_GRAPH_IR_TYPES_H_
#define LUOJIANET_MS_CCSRC_TRANSFORM_GRAPH_IR_TYPES_H_
...
#endif  // LUOJIANET_MS_CCSRC_TRANSFORM_GRAPH_IR_TYPES_H_
