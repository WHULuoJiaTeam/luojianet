...
#ifndef LUOJIANET_MS_CCSRC_UTIL_CACHE_EMBBEDDING_HASHMAP_STRUCT_H_
#define LUOJIANET_MS_CCSRC_UTIL_CACHE_EMBBEDDING_HASHMAP_STRUCT_H_
...
#endif  // LUOJIANET_MS_CCSRC_UTIL_CACHE_EMBBEDDING_HASHMAP_STRUCT_H_
