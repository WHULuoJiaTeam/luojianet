...
#ifndef LUOJIANET_MS_CCSRC_UTILS_GRAPH_KERNEL_FLAGS_H
#define LUOJIANET_MS_CCSRC_UTILS_GRAPH_KERNEL_FLAGS_H
...
#endif  // LUOJIANET_MS_CCSRC_UTILS_GRAPH_KERNEL_FLAGS_H
