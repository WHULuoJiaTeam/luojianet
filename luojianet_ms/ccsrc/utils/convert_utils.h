...
#ifndef LUOJIANET_MS_CCSRC_UTILS_CONVERT_UTILS_H_
#define LUOJIANET_MS_CCSRC_UTILS_CONVERT_UTILS_H_
...
const luojianet_ms::HashMap<std::string, int64_t> sparse_attr_map = {{prim::kPrimCSRTensorGetIndptr->name(), 0},
...
// sparse_process.cc
const luojianet_ms::HashSet<std::string> make_sparse_set = {{prim::kPrimMakeCSRTensor->name()}};
...
// sparse_process.cc
const luojianet_ms::HashSet<std::string> sparse_op_set = {{prim::kPrimSparseTensorDenseMatmul->name()},
...
#endif  // LUOJIANET_MS_CCSRC_UTILS_CONVERT_UTILS_H_
