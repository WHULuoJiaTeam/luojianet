...
#ifndef LUOJIANET_MS_CCSRC_UTILS_FUNC_GRAPH_ANALYZER_H_
#define LUOJIANET_MS_CCSRC_UTILS_FUNC_GRAPH_ANALYZER_H_
...
#endif  // LUOJIANET_MS_CCSRC_UTILS_FUNC_GRAPH_ANALYZER_H_
