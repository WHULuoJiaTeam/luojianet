...
#ifndef LUOJIANET_MS_CCSRC_UTILS_TENSORPRINT_UTILS_H_
#define LUOJIANET_MS_CCSRC_UTILS_TENSORPRINT_UTILS_H_
...
#endif
#endif  // LUOJIANET_MS_CCSRC_UTILS_TENSOR_PRINT_H_
