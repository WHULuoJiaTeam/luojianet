 ...
 */
#ifndef LUOJIANET_MS_CCSRC_VM_BACKEND_H_
#define LUOJIANET_MS_CCSRC_VM_BACKEND_H_
...
class MsBackend : public Backend {
 ...
 protected:
  ...
  luojianet_ms::HashMap<GraphId, LinConvertResult> graph_id_map_;
};
...
class MindRTBackend : public Backend {
 ...
 private:
  ...
  luojianet_ms::HashMap<ActorInfo, std::unique_ptr<GraphCompilerInfo>> actor_to_graph_compiler_info_;
