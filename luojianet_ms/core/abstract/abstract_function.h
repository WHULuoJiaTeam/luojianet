...
#ifndef LUOJIANET_MS_CORE_ABSTRACT_ABSTRACT_FUNCTION_H_
#define LUOJIANET_MS_CORE_ABSTRACT_ABSTRACT_FUNCTION_H_
...
#endif  // LUOJIANET_MS_CORE_ABSTRACT_ABSTRACT_FUNCTION_H_
