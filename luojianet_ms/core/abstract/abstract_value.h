...
#ifndef LUOJIANET_MS_CORE_ABSTRACT_ABSTRACT_VALUE_H_
#define LUOJIANET_MS_CORE_ABSTRACT_ABSTRACT_VALUE_H_
...
class MS_CORE_API AbstractClass final : public AbstractBase {
 public:
  ...
  AbstractClass(const Named &tag, const std::vector<AbstractAttribute> &attributes,
                const luojianet_ms::HashMap<std::string, ValuePtr> &methods)
...
#endif  // LUOJIANET_MS_CORE_ABSTRACT_ABSTRACT_VALUE_H_
