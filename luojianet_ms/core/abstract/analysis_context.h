...
#ifndef LUOJIANET_MS_CORE_ABSTRACT_ANALYSIS_CONTEXT_H_
#define LUOJIANET_MS_CORE_ABSTRACT_ANALYSIS_CONTEXT_H_
...
class MS_CORE_API AnalysisContext {
 ...
 private:
  ...
  luojianet_ms::HashMap<FuncGraphPtr, AnalysisContextWeakPtr> extant_context_cache_;
  // Record all created child contexts from this context.
  // Like: key: [func_graph & arguments], value: [child_context]
  luojianet_ms::HashMap<FuncGraphPtr, ArgsSpecToAnalysisContextMap> children_cache_;
...
#endif  // LUOJIANET_MS_CORE_ABSTRACT_ANALYSIS_CONTEXT_H_
