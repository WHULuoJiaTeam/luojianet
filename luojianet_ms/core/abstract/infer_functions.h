...
#ifndef LUOJIANET_MS_CORE_ABSTRACT_INFER_FUNCTIONS_H_
#define LUOJIANET_MS_CORE_ABSTRACT_INFER_FUNCTIONS_H_
#include <string>
#include <memory>
...
#endif  // LUOJIANET_MS_CORE_ABSTRACT_INFER_FUNCTIONS_H_
