...
#ifndef LUOJIANET_MS_CORE_ABSTRACT_PARAM_VALIDATOR_H_
#define LUOJIANET_MS_CORE_ABSTRACT_PARAM_VALIDATOR_H_
...
#endif  // LUOJIANET_MS_CORE_ABSTRACT_PARAM_VALIDATOR_H_
