...
#ifndef LUOJIANET_MS_CORE_API_IR_FUNC_GRAPH_MANAGER_H_
#define LUOJIANET_MS_CORE_API_IR_FUNC_GRAPH_MANAGER_H_
...
namespace luojianet_ms::deprecated::api {
class FuncGraph;
...
using NodeUsersMap = luojianet_ms::HashMap<AnfNodePtr, AnfNodeIndexSet, PointerHash<AnfNodePtr>>;
...
#endif  // LUOJIANET_MS_CORE_API_IR_FUNC_GRAPH_MANAGER_H_
