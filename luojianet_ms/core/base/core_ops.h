...
#ifndef LUOJIANET_MS_CORE_BASE_CORE_OPS_H_
#define LUOJIANET_MS_CORE_BASE_CORE_OPS_H_
...
inline const luojianet_ms::HashMap<std::string, ValuePtr> kSideEffectPropagate = {
  {luojianet_ms::GRAPH_FLAG_SIDE_EFFECT_PROPAGATE, kValueOne},
};
...
inline const PrimitivePtr kPrimResizeNearestNeighborGrad = std::make_shared<Primitive>("ResizeNearestNeighborGrad");
inline const PrimitivePtr kPrimDynamicResizeNearestNeighbor =
...
inline const PrimitivePtr kPrimDropoutDoMaskV3 = std::make_shared<Primitive>(kDropoutDoMaskV3);
...
#endif  // LUOJIANET_MS_CORE_BASE_CORE_OPS_H_
