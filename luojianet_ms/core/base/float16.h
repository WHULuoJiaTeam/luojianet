...
template <>
struct numeric_limits<const luojianet_ms::Float16> : numeric_limits<luojianet_ms::Float16> {};
template <>
struct numeric_limits<volatile luojianet_ms::Float16> : numeric_limits<luojianet_ms::Float16> {};
template <>
struct numeric_limits<const volatile luojianet_ms::Float16> : numeric_limits<luojianet_ms::Float16> {};
}  // namespace std
