 ...
 */
#ifndef LUOJIANET_MS_CORE_BASE_FLOAT16_H_
#define LUOJIANET_MS_CORE_BASE_FLOAT16_H_
...
// Implement Float16 for luojianet_ms, inspired by Eigen::half.
...
using float16 = luojianet_ms::Float16;
...
template <>
struct numeric_limits<const luojianet_ms::Float16> : private numeric_limits<luojianet_ms::Float16> {};
template <>
struct numeric_limits<volatile luojianet_ms::Float16> : private numeric_limits<luojianet_ms::Float16> {};
template <>
struct numeric_limits<const volatile luojianet_ms::Float16> : private numeric_limits<luojianet_ms::Float16> {};
}  // namespace std
...
#endif  // LUOJIANET_MS_CORE_BASE_FLOAT16_H_
