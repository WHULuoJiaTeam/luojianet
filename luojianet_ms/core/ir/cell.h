...
#ifndef LUOJIANET_MS_CCSRC_IR_CELL_H_
#define LUOJIANET_MS_CCSRC_IR_CELL_H_
...
/// \brief The Cell class of LuoJiaNet is the base class for building all networks and the basic unit of a network.
class MS_CORE_API Cell final : public Named {
 public:
  ...
  void set_attrs(const luojianet_ms::HashMap<std::string, ValuePtr> &attrs_input) { attrs_ = attrs_input; }
...
#endif  // LUOJIANET_MS_CCSRC_IR_CELL_H_
