...
#ifndef LUOJIANET_MS_CORE_IR_DTYPE_CONTAINER_H_
#define LUOJIANET_MS_CORE_IR_DTYPE_CONTAINER_H_
...
class MS_CORE_API Class final : public Object {
 public:
  ...
  Class(const Named &tag, const ClassAttrVector &attributes, const luojianet_ms::HashMap<std::string, ValuePtr> &methods);
  ...
  void set_value(const luojianet_ms::HashMap<std::string, ValuePtr> &v) { attributes_value_ = v; }
  ...
  luojianet_ms::HashMap<std::string, ValuePtr> GetValue() { return attributes_value_; }

  /// \brief Get the methods of Class object.
  ///
  /// \return The methods of Class object.
  luojianet_ms::HashMap<std::string, ValuePtr> methods() { return methods_; }
 ...
 private:
  ...
  std::string DumpContent(bool is_dumptext) const;
  Named tag_;
  luojianet_ms::HashMap<std::string, ValuePtr> methods_;
  // For AbstractClass build value
  luojianet_ms::HashMap<std::string, ValuePtr> attributes_value_;
};
...
#endif  // LUOJIANET_MS_CORE_IR_DTYPE_CONTAINER_H_
