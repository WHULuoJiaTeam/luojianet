...
#ifndef LUOJIANET_MS_CORE_IR_DTYPE_TYPE_H_
#define LUOJIANET_MS_CORE_IR_DTYPE_TYPE_H_
...
class MS_CORE_API Type : public Value {
 public:
  ...
  ///
  /// \return The description of Type object.
  std::string ReprString() const { return "luojianet_ms." + ToReprString(); }
...
// TypeId name map
//
const luojianet_ms::HashMap<TypeId, std::string> type_name_map = {
...
const luojianet_ms::HashMap<TypeId, int> type_priority_map = {
...
#endif  // LUOJIANET_MS_CORE_IR_DTYPE_TYPE_H_
