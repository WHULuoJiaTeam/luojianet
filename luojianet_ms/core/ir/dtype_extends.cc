...
std::string GetExcptionTypeString(TypeId id) {
  static luojianet_ms::HashMap<TypeId, std::string> type_id_to_string = {{kMetaTypeType, "MetaType"},
...
TypePtr TypeIdToType(TypeId id) {
  static luojianet_ms::HashMap<TypeId, TypePtr> type_id_to_type = {{kNumberTypeFloat16, kFloat16},
