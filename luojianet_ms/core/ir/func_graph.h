...
#ifndef LUOJIANET_MS_CORE_IR_FUNC_GRAPH_H_
#define LUOJIANET_MS_CORE_IR_FUNC_GRAPH_H_
...
class MS_CORE_API FuncGraph : public deprecated::api::FuncGraph, public FuncGraphBase, public EffectInfoHolder {
 public:
  ...
  luojianet_ms::HashMap<std::string, ValuePtr> &attrs() { return attrs_; }
  void set_attrs(const luojianet_ms::HashMap<std::string, ValuePtr> &attrs) {
    for (auto &attr : attrs) {
  ...
  luojianet_ms::HashMap<std::string, FuncGraphTransform> &transforms() { return transforms_; }
  void set_transforms(const luojianet_ms::HashMap<std::string, FuncGraphTransform> &transforms) {
  ...
  const luojianet_ms::HashMap<AnfNodePtr, int> &meta_fg_prim_value_nodes() const;
  ...
  void GenerateVarParams(const FuncGraphPtr &specialized_graph, int variable_args_count, int pos_args_input_count,
                         ...
                         luojianet_ms::HashMap<AnfNodePtr, AnfNodePtr> *repl_nodes) const;
  ...
  luojianet_ms::HashMap<std::string, ValuePtr> attrs_;
  luojianet_ms::HashMap<std::string, FuncGraphTransform> transforms_;
  ...
  const luojianet_ms::HashSet<AnfNodePtr> &used_forward_nodes() const { return used_forward_nodes_; }
 ...
 private:
  ...
  luojianet_ms::HashMap<AnfNodePtr, int> meta_fg_prim_value_nodes_;
  ...
  luojianet_ms::HashSet<AnfNodePtr> used_forward_nodes_;
...
#endif  // LUOJIANET_MS_CORE_IR_FUNC_GRAPH_H_
