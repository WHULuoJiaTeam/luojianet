...
#ifndef LUOJIANET_MS_LUOJIANET_MS_CORE_IR_FUNC_GRAPH_BASE_H_
#define LUOJIANET_MS_LUOJIANET_MS_CORE_IR_FUNC_GRAPH_BASE_H_
#include <set>
#include <mutex>
#include <memory>
...
#endif  // LUOJIANET_MS_LUOJIANET_MS_CORE_IR_FUNC_GRAPH_BASE_H_
