...
#ifndef LUOJIANET_MS_CORE_IR_FUNC_GRAPH_CLONER_H_
#define LUOJIANET_MS_CORE_IR_FUNC_GRAPH_CLONER_H_
...
using NodeToNodeMap = luojianet_ms::HashMap<AnfNodePtr, AnfNodePtr, PointerHash<AnfNodePtr>>;
...
class MS_CORE_API Cloner {
 public:
  ...
  const luojianet_ms::HashMap<FuncGraphPtr, FuncGraphPtr> &cloned_func_graphs() const { return repl_func_graph_; }
 ...
 private:
  ...
  luojianet_ms::HashMap<FuncGraphPtr, FuncGraphPtr> repl_func_graph_;
  ...
  luojianet_ms::HashMap<FuncGraphPtr, bool> status_;
  luojianet_ms::HashMap<FuncGraphPtr, NodeToNodeMap> repl_map_node_;
  luojianet_ms::HashMap<FuncGraphPtr, luojianet_ms::HashMap<FuncGraphPtr, AnfNodePtr>> repl_map_func_graph_;
  luojianet_ms::HashMap<FuncGraphPtr, AnfNodePtrList> repl_func_graph_params_;
};
...
#endif  // LUOJIANET_MS_CORE_IR_FUNC_GRAPH_CLONER_H_
