...
using luojianet_ms::abstract::PrimitiveAbstractClosure;
using luojianet_ms::abstract::VirtualAbstractClosure;
...
FuncGraphPtr FuncGraph::GenerateGraph(const AbstractBasePtrList &args_spec_list) {
  ...
  std::vector<AnfNodePtr> specialized_parameter_list;
  luojianet_ms::HashMap<AnfNodePtr, AnfNodePtr> repl_nodes;
  ...
  std::shared_ptr<luojianet_ms::FuncGraphManager> manager = luojianet_ms::Manage(specialized_graph, false);
