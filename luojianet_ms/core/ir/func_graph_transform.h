...
#ifndef LUOJIANET_MS_LUOJIANET_MS_CORE_IR_FUNC_GRAPH_TRANSFORM_H_
#define LUOJIANET_MS_LUOJIANET_MS_CORE_IR_FUNC_GRAPH_TRANSFORM_H_
#include "ir/anf.h"
...
#endif  // LUOJIANET_MS_LUOJIANET_MS_CORE_IR_FUNC_GRAPH_TRANSFORM_H_
