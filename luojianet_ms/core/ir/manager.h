...
#ifndef LUOJIANET_MS_CORE_IR_MANAGER_H_
#define LUOJIANET_MS_CORE_IR_MANAGER_H_
...
class FuncGraphParentsTotalComputer final : public DepComputer {
 ...
 private:
  FuncGraphSetPtr SeekParents(const FuncGraphPtr &fg, luojianet_ms::HashMap<FuncGraphPtr, FuncGraphSetPtr> *seen_fgs);
};
...
#endif  // LUOJIANET_MS_CORE_IR_MANAGER_H_
