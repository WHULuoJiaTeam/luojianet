...
#ifndef LUOJIANET_MS_CORE_LOAD_MINDIR_ANF_MODEL_PARSER_H
#define LUOJIANET_MS_CORE_LOAD_MINDIR_ANF_MODEL_PARSER_H
...
class MSANFModelParser {
 ...
 private:
  ...
  luojianet_ms::HashMap<std::string, abstract::AbstractBasePtr> GetAbstractForNode(
  ...
  luojianet_ms::HashMap<std::string, AnfNodePtr> anfnode_build_map_;
...
#endif  // LUOJIANET_MS_CORE_LOAD_MINDIR_ANF_MODEL_PARSER_H
