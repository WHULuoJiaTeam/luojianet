...
#ifndef LUOJIANET_MS_CORE_MINDAPI_BASE_SHARED_PTR_H_
#define LUOJIANET_MS_CORE_MINDAPI_BASE_SHARED_PTR_H_
...
namespace std {
template <typename T>
struct hash<luojianet_ms::api::SharedPtr<T>> {
  size_t operator()(const luojianet_ms::api::SharedPtr<T> &ptr) const noexcept { return static_cast<size_t>(ptr.addr()); }
};
}  // namespace std

#endif  // LUOJIANET_MS_CORE_MINDAPI_BASE_SHARED_PTR_H_
