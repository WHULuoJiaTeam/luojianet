...
#ifndef LUOJIANET_MS_CORE_MINDAPI_IR_FUNC_GRAPH_H_
#define LUOJIANET_MS_CORE_MINDAPI_IR_FUNC_GRAPH_H_
...
class MIND_API FuncGraphManager {
 public:
  ...
  explicit FuncGraphManager(const std::shared_ptr<luojianet_ms::FuncGraphManager> &impl);

  /// \brief Get the shared_ptr to the underly implementation object.
  ///
  /// \return The shared_ptr to the underly implementation object.
  const std::shared_ptr<luojianet_ms::FuncGraphManager> &impl() const { return impl_; }
 ...
 private:
  const std::shared_ptr<luojianet_ms::FuncGraphManager> impl_;
};
}  // namespace luojianet_ms::api
#endif  // LUOJIANET_MS_CORE_MINDAPI_IR_FUNC_GRAPH_H_
