...
#ifndef LUOJIANET_MS_CORE_MINDAPI_IR_UTILS_H_
#define LUOJIANET_MS_CORE_MINDAPI_IR_UTILS_H_
...
namespace luojianet_ms::api::utils {
...
#endif  // LUOJIANET_MS_CORE_MINDAPI_IR_UTILS_H_
