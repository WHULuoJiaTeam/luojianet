...
#ifndef LUOJIANET_MS_CORE_MINDRT_INCLUDE_ACTOR_AID_H
#define LUOJIANET_MS_CORE_MINDRT_INCLUDE_ACTOR_AID_H
...
namespace std {
template <>
struct hash<luojianet_ms::AID> {
  typedef luojianet_ms::AID argument_type;
