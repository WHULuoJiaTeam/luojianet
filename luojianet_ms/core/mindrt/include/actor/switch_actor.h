...
#ifndef LUOJIANET_MS_CORE_MINDRT_INCLUDE_ACTOR_SWITCH_ACTOR_H
#define LUOJIANET_MS_CORE_MINDRT_INCLUDE_ACTOR_SWITCH_ACTOR_H
...
#endif  // LUOJIANET_MS_CORE_MINDRT_INCLUDE_ACTOR_SWITCH_ACTOR_H
