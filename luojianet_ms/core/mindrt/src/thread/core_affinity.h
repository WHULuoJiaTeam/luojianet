...
#ifndef LUOJIANET_MS_CORE_MINDRT_RUNTIME_CORE_AFFINITY_H_
#define LUOJIANET_MS_CORE_MINDRT_RUNTIME_CORE_AFFINITY_H_
...
#endif  // LUOJIANET_MS_CORE_MINDRT_RUNTIME_CORE_AFFINITY_H_
