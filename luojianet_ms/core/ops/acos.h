...
#ifndef LUOJIANET_MS_CORE_OPS_ACOS_H_
#define LUOJIANET_MS_CORE_OPS_ACOS_H_
...
/// Refer to Python API @ref luojianet_ms.ops.ACos for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_ACOS_H_
