...
#ifndef LUOJIANET_MS_CORE_OPS_ACOSH_H_
#define LUOJIANET_MS_CORE_OPS_ACOSH_H_
...
/// Refer to Python API @ref luojianet_ms.ops.Acosh for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_ACOSH_H_
