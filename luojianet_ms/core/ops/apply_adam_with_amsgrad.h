...
#ifndef LUOJIANET_MS_CORE_OPS_APPLY_ADAM_WITH_AMSGRAD_H_
#define LUOJIANET_MS_CORE_OPS_APPLY_ADAM_WITH_AMSGRAD_H_
#include <vector>
#include <memory>
...
#endif  // LUOJIANET_MS_CORE_OPS_APPLY_ADAM_WITH_AMSGRAD_H_
