...
#ifndef LUOJIANET_MS_CORE_OPS_APPLY_KERAS_MOMENTUM_H_
#define LUOJIANET_MS_CORE_OPS_APPLY_KERAS_MOMENTUM_H_
...
#endif  // LUOJIANET_MS_CORE_OPS_APPLY_KERAS_MOMENTUM_H_
