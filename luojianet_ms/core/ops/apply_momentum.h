...
#ifndef LUOJIANET_MS_CORE_OPS_APPLY_MOMENTUM_H_
#define LUOJIANET_MS_CORE_OPS_APPLY_MOMENTUM_H_
#include <vector>
#include <memory>
#include <string>
#include <set>
...
/// Refer to Python API @ref luojianet_ms.ops.ApplyMomentum for more details.
class MIND_API ApplyMomentum : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.ApplyMomentum for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_APPLY_MOMENTUM_H_
