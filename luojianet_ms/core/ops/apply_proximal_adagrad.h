...
#ifndef LUOJIANET_MS_CORE_OPS_APPLY_PROXIMAL_ADAGRAD_H_
#define LUOJIANET_MS_CORE_OPS_APPLY_PROXIMAL_ADAGRAD_H_
...
#endif  // LUOJIANET_MS_CORE_OPS_APPLY_PROXIMAL_ADAGRAD_H_
