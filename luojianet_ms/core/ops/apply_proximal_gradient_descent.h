...
#ifndef LUOJIANET_MS_CORE_OPS_APPLY_PROXIMAL_GRADIENT_DESCENT_H_
#define LUOJIANET_MS_CORE_OPS_APPLY_PROXIMAL_GRADIENT_DESCENT_H_
#include <memory>
#include <vector>
...
#endif  // LUOJIANET_MS_CORE_OPS_APPLY_PROXIMAL_GRADIENT_DESCENT_H_
