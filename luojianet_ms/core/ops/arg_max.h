...
#ifndef LUOJIANET_MS_CORE_OPS_ARG_MAX_H_
#define LUOJIANET_MS_CORE_OPS_ARG_MAX_H_
#include <string>
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.Argmax for more details.
class MIND_API ArgMax : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.Argmax for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_ARG_MAX_H_
