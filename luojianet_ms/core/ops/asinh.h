...
#ifndef LUOJIANET_MS_CORE_OPS_ASINH_H_
#define LUOJIANET_MS_CORE_OPS_ASINH_H_
...
/// Refer to Python API @ref luojianet_ms.ops.Asinh for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_ASINH_H_
