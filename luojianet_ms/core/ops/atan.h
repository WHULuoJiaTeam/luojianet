...
#ifndef LUOJIANET_MS_CORE_OPS_ATAN_H_
#define LUOJIANET_MS_CORE_OPS_ATAN_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.Atan for more details.
class MIND_API Atan : public BaseOperator {
 public:
  MIND_API_BASE_MEMBER(Atan);
  /// \brief Constructor.
  Atan() : BaseOperator(kNameAtan) {}
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.Atan for the inputs.
  void Init() const {}
};
...
#endif  // LUOJIANET_MS_CORE_OPS_ATAN_H_
