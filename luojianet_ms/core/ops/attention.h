 ...
 */
#ifndef LITE_LUOJIANET_MS_LITE_TOOLS_CONVERTER_OPS_ATTENTION_H_
#define LITE_LUOJIANET_MS_LITE_TOOLS_CONVERTER_OPS_ATTENTION_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
#endif  // LITE_LUOJIANET_MS_LITE_TOOLS_CONVERTER_OPS_ATTENTION_H_
