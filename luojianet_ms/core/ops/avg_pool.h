...
#ifndef LUOJIANET_MS_CORE_OPS_AVG_POOL_H_
#define LUOJIANET_MS_CORE_OPS_AVG_POOL_H_
...
/// \brief Average pooling operation. Refer to Python API @ref luojianet_ms.ops.AvgPool for more details.
class MIND_API AvgPool : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.AvgPool for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_AVG_POOL_H_
