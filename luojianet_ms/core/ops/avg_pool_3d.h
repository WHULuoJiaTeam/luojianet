...
#ifndef LUOJIANET_MS_CORE_OPS_AVG_POOL_3D_H_
#define LUOJIANET_MS_CORE_OPS_AVG_POOL_3D_H_
...
/// \brief 3D Average pooling operation. Refer to Python API @ref luojianet_ms.ops.AvgPool3D for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_AVG_POOL_3D_H_
