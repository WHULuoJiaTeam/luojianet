...
#ifndef LUOJIANET_MS_CORE_OPS_BATCH_MATMUL_H_
#define LUOJIANET_MS_CORE_OPS_BATCH_MATMUL_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.BatchMatmul for more details.
class MIND_API BatchMatmul : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.BatchMatmul for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_BATCH_MATMUL_H_
