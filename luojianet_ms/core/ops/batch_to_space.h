 ...
 */
#ifndef LUOJIANET_MS_CORE_OPS_BATCH_TO_SPACE_H_
#define LUOJIANET_MS_CORE_OPS_BATCH_TO_SPACE_H_
...
/// Refer to Python API @ref luojianet_ms.ops.BatchToSpace for more details.
class MIND_API BatchToSpace : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.BatchToSpace for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_BATCH_TO_SPACE_H_
