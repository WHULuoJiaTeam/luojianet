...
#ifndef LUOJIANET_MS_CORE_OPS_BATCH_TO_SPACE_ND_H_
#define LUOJIANET_MS_CORE_OPS_BATCH_TO_SPACE_ND_H_
...
/// Refer to Python API @ref luojianet_ms.ops.BatchToSpaceND for more details.
class MIND_API BatchToSpaceND : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.BatchToSpaceND for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_BATCH_TO_SPACE_ND_H_
