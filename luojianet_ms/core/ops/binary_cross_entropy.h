...
#ifndef LUOJIANET_MS_CORE_OPS_BINARY_CROSS_ENTROPY_H_
#define LUOJIANET_MS_CORE_OPS_BINARY_CROSS_ENTROPY_H_
#include <string>
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.BinaryCrossEntropy for more details.
class MIND_API BinaryCrossEntropy : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.BinaryCrossEntropy for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_BINARY_CROSS_ENTROPY_H_
