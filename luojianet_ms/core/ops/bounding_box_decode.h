...
#ifndef LUOJIANET_MS_CORE_OPS_BOUNDING_BOX_DECODE_H_
#define LUOJIANET_MS_CORE_OPS_BOUNDING_BOX_DECODE_H_
...
#endif  // LUOJIANET_MS_CORE_OPS_BOUNDING_BOX_DECODE_H_
