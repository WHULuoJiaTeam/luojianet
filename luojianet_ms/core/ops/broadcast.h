...
#ifndef LUOJIANET_MS_CORE_OPS_BROADCAST_H_
#define LUOJIANET_MS_CORE_OPS_BROADCAST_H_
#include <string>
#include <vector>
#include <memory>
...
/// \brief Broadcasts the tensor to the whole group. Refer to Python API @ref luojianet_ms.ops.Broadcast for more details.
class MIND_API Broadcast : public BaseOperator {
 public:
  MIND_API_BASE_MEMBER(Broadcast);
  /// \brief Constructor.
  Broadcast() : BaseOperator(kNameBroadcast) {}
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.Broadcast for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_BROADCAST_H_
