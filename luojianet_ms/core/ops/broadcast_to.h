...
#ifndef LUOJIANET_MS_CORE_OPS_BROADCAST_TO_H_
#define LUOJIANET_MS_CORE_OPS_BROADCAST_TO_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.BroadcastTo for more details.
class MIND_API BroadcastTo : public BaseOperator {
 public:
  MIND_API_BASE_MEMBER(BroadcastTo);
  /// \brief Constructor.
  BroadcastTo() : BaseOperator(kNameBroadcastTo) {}
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.BroadcastTo for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_BROADCAST_TO_H_
