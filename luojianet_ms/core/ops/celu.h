...
#ifndef LUOJIANET_MS_CORE_OPS_CELU_H_
#define LUOJIANET_MS_CORE_OPS_CELU_H_
...
/// Refer to Python API @ref luojianet_ms.ops.CeLU for more details.
class MIND_API CeLU : public BaseOperator {
 public:
  MIND_API_BASE_MEMBER(CeLU);
  /// \brief Constructor.
  CeLU() : BaseOperator(kNameCeLU) { InitIOName({"x"}, {"output"}); }
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.CeLU for the inputs.
  void Init() {}
};
...
#endif  // LUOJIANET_MS_CORE_OPS_CELU_H_
