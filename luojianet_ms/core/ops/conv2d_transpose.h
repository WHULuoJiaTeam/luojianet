...
#ifndef LUOJIANET_MS_CORE_OPS_CONV2D_TRANSPOSE_H_
#define LUOJIANET_MS_CORE_OPS_CONV2D_TRANSPOSE_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
/// \brief 2D transposed convolution layer. Refer to Python API @ref luojianet_ms.nn.Conv2dTranspose for more details.
class MS_CORE_API Conv2DTranspose : public PrimitiveC {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.nn.Conv2dTranspose for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_CONV2D_TRANSPOSE_H_
