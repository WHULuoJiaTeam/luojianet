...
#ifndef LUOJIANET_MS_CORE_OPS_CROP_AND_RESIZE_H_
#define LUOJIANET_MS_CORE_OPS_CROP_AND_RESIZE_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.CropAndResize for more details.
class MS_CORE_API CropAndResize : public PrimitiveC {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.CropAndResize for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_CROP_AND_RESIZE_H_
