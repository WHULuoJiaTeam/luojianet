...
#ifndef LUOJIANET_MS_CORE_OPS_CTC_LOSS_V2_H_
#define LUOJIANET_MS_CORE_OPS_CTC_LOSS_V2_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.CTCLossV2 for more details.
class MS_CORE_API CTCLossV2 : public PrimitiveC {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.CTCLossV2 for the inputs.
  void Init() {}
};
...
#endif  // LUOJIANET_MS_CORE_OPS_CTC_LOSS_V2_H_
