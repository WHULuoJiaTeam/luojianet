...
#ifndef LUOJIANET_MS_CORE_OPS_CTCLOSS_H_
#define LUOJIANET_MS_CORE_OPS_CTCLOSS_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.CTCLoss for more details.
class MS_CORE_API CTCLoss : public PrimitiveC {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.CTCLoss for the inputs.
  void Init() {}
};
...
#endif  // LUOJIANET_MS_CORE_OPS_CTCLOSS_H_
