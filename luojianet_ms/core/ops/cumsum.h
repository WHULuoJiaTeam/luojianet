...
#ifndef LUOJIANET_MS_CORE_OPS_CUMSUM_H_
#define LUOJIANET_MS_CORE_OPS_CUMSUM_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.CumSum for more details.
class MS_CORE_API CumSum : public PrimitiveC {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.CumSum for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_CUMSUM_H_
