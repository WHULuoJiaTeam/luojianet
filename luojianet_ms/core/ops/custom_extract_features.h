...
#ifndef LUOJIANET_MS_CORE_OPS_CUSTOM_EXTRACT_FEATURES_H_
#define LUOJIANET_MS_CORE_OPS_CUSTOM_EXTRACT_FEATURES_H_
#include <vector>
#include <memory>
...
#endif  // LUOJIANET_MS_CORE_OPS_CUSTOM_EXTRACT_FEATURES_H_
