...
#ifndef LUOJIANET_MS_CORE_OPS_DATA_FORMAT_DIM_MAP_H_
#define LUOJIANET_MS_CORE_OPS_DATA_FORMAT_DIM_MAP_H_
#include <vector>
#include <memory>
...
#endif  // LUOJIANET_MS_CORE_OPS_DATA_FORMAT_DIM_MAP_INFER_H_
