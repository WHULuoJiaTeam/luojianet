...
#ifndef LUOJIANET_MS_CORE_OPS_DIAG_H_
#define LUOJIANET_MS_CORE_OPS_DIAG_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.Diag for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_DIAG_H_
