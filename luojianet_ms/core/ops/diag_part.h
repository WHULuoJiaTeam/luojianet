...
#ifndef LUOJIANET_MS_CORE_OPS_DIAG_PART_H_
#define LUOJIANET_MS_CORE_OPS_DIAG_PART_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.DiagPart for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_DIAG_PART_H_
