...
#ifndef LUOJIANET_MS_CORE_OPS_DIV_H_
#define LUOJIANET_MS_CORE_OPS_DIV_H_
#include <string>
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.Div for more details.
class MIND_API Div : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.Div for the inputs.
  void Init() const {}
};
...
#endif  // LUOJIANET_MS_CORE_OPS_DIV_H_
