...
#ifndef LUOJIANET_MS_CORE_OPS_DROPOUT_H_
#define LUOJIANET_MS_CORE_OPS_DROPOUT_H_
#include <vector>
#include <memory>
...
//// from a Bernoulli distribution. Refer to Python API @ref luojianet_ms.ops.Dropout for more details.
class MS_CORE_API Dropout : public PrimitiveC {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.Dropout for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_DROPOUT_H_
