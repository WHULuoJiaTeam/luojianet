...
#ifndef LUOJIANET_MS_CORE_OPS_DROPOUT_DO_MASK_H_
#define LUOJIANET_MS_CORE_OPS_DROPOUT_DO_MASK_H_
...
/// Refer to Python API @ref luojianet_ms.ops.DropoutDoMask for more details.
class MIND_API DropoutDoMask : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.DropoutDoMask for the inputs.
  void Init() const {}
};
...
#endif  // LUOJIANET_MS_CORE_OPS_DROPOUT_DO_MASK_H_
