...
#ifndef LUOJIANET_MS_CORE_OPS_DROPOUT_GEN_MASK_H_
#define LUOJIANET_MS_CORE_OPS_DROPOUT_GEN_MASK_H_
...
/// Refer to Python API @ref luojianet_ms.ops.DropoutGenMask for more details.
class MIND_API DropoutGenMask : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.DropoutGenMask for the inputs.
  void Init() const {}
};
...
#endif  // LUOJIANET_MS_CORE_OPS_DROPOUT_GEN_MASK_H_
