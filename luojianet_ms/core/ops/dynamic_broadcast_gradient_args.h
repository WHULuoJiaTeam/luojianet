...
#ifndef LUOJIANET_MS_CORE_OPS_DYNAMIC_BROADCAST_GRADIENT_ARGS_H_
#define LUOJIANET_MS_CORE_OPS_DYNAMIC_BROADCAST_GRADIENT_ARGS_H_
#include <vector>
#include <memory>
...
#endif  // LUOJIANET_MS_CORE_OPS_DYNAMIC_BROADCAST_GRADIENT_ARGS_H_
