 ...
 */
#ifndef LUOJIANET_MS_CORE_OPS_DYNAMIC_RESIZE_NEAREST_NEIGHBOR_H_
#define LUOJIANET_MS_CORE_OPS_DYNAMIC_RESIZE_NEAREST_NEIGHBOR_H_
...
#endif  // LUOJIANET_MS_CORE_OPS_DYNAMIC_RESIZE_NEAREST_NEIGHBOR_H_
