 ...
 */
#ifndef LUOJIANET_MS_CORE_OPS_EINSUM_H_
#define LUOJIANET_MS_CORE_OPS_EINSUM_H_
...
/// \brief .
/// Refer to Python API @ref luojianet_ms.ops.Einsum for more details.
class MIND_API Einsum : public BaseOperator {
 public:
  MIND_API_BASE_MEMBER(Einsum);
  /// \brief Constructor.
  Einsum() : BaseOperator(kNameEinsum) { InitIOName({"x"}, {"output"}); }
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.Einsum for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_EINSUM_H_
