...
#ifndef LUOJIANET_MS_CORE_OPS_EMBEDDING_LOOKUP_H_
#define LUOJIANET_MS_CORE_OPS_EMBEDDING_LOOKUP_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.EmbeddingLookup for more details.
class MS_CORE_API EmbeddingLookup : public PrimitiveC {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.EmbeddingLookup for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_EMBEDDING_LOOKUP_H_
