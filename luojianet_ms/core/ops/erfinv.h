...
#ifndef LUOJIANET_MS_CORE_OPS_ERFINV_H_
#define LUOJIANET_MS_CORE_OPS_ERFINV_H_
#include <vector>
#include <memory>
...
/// \brief Computes the inverse error function of input. Refer to Python API @ref luojianet_ms.ops.Erfinv for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_ERFINV_H_
