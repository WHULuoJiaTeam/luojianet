...
#ifndef LUOJIANET_MS_CORE_OPS_EXP_H_
#define LUOJIANET_MS_CORE_OPS_EXP_H_
#include <vector>
#include <memory>
#include <string>
...
/// \brief Returns exponential of a tensor element-wise. Refer to Python API @ref luojianet_ms.ops.Exp for more details.
class MS_CORE_API Exp : public PrimitiveC {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.Exp for the inputs.
  void Init() {}
};
...
#endif  // LUOJIANET_MS_CORE_OPS_EXP_H_
