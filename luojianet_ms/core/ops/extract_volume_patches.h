...
#ifndef LUOJIANET_MS_CORE_OPS_EXTRACT_VOLUME_PATCHES_H_
#define LUOJIANET_MS_CORE_OPS_EXTRACT_VOLUME_PATCHES_H_
#include <map>
#include <set>
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.ExtractVolumePatches for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_EXTRACT_VOLUME_PATCHES_H_
