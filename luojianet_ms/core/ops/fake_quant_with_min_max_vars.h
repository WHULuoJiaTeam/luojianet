 ...
 */
#ifndef LUOJIANET_MS_CORE_OPS_FAKE_QUANT_WITH_MIN_MAX_VARS_H_
#define LUOJIANET_MS_CORE_OPS_FAKE_QUANT_WITH_MIN_MAX_VARS_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.FakeQuantWithMinMaxVars for more details.
class MS_CORE_API FakeQuantWithMinMaxVars : public PrimitiveC {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.FakeQuantWithMinMaxVars for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_FAKE_QUANT_WITH_MIN_MAX_VARS_H_
