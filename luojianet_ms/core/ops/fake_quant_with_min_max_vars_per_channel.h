...
#ifndef LUOJIANET_MS_CORE_OPS_FAKE_QUANT_WITH_MIN_MAX_VARS_PER_CHANNEL_H_
#define LUOJIANET_MS_CORE_OPS_FAKE_QUANT_WITH_MIN_MAX_VARS_PER_CHANNEL_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.FakeQuantWithMinMaxVarsPerChannel for more details.
class MS_CORE_API FakeQuantWithMinMaxVarsPerChannel : public PrimitiveC {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.FakeQuantWithMinMaxVarsPerChannel
  /// for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_FAKE_QUANT_WITH_MIN_MAX_VARS_PER_CHANNEL_H_
