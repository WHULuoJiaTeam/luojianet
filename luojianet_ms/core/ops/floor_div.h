...
#ifndef LUOJIANET_MS_CORE_OPS_FLOOR_DIV_H_
#define LUOJIANET_MS_CORE_OPS_FLOOR_DIV_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.FloorDiv for more details.
class MIND_API FloorDiv : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.FloorDiv for the inputs.
  void Init() const {}
...
#endif  // LUOJIANET_MS_CORE_OPS_FLOOR_DIV_H_
