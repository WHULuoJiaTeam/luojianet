...
#ifndef LUOJIANET_MS_CORE_OPS_FLOOR_MOD_H_
#define LUOJIANET_MS_CORE_OPS_FLOOR_MOD_H_
#include <vector>
...
/// Refer to Python API @ref luojianet_ms.ops.FloorMod for more details.
class MIND_API FloorMod : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.FloorMod for the inputs.
  void Init() const {}
};
...
#endif  // LUOJIANET_MS_CORE_OPS_FLOOR_MOD_H_
