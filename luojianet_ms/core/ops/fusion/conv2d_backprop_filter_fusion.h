...
#ifndef LUOJIANET_MS_CORE_OPS_CONV2D_BACKPROP_FILTER_FUSION_H_
#define LUOJIANET_MS_CORE_OPS_CONV2D_BACKPROP_FILTER_FUSION_H_
#include <vector>
#include <memory>
...
#endif  // LUOJIANET_MS_CORE_OPS_CONV2D_BACKPROP_FILTER_FUSION_H_
