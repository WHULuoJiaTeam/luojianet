...
#ifndef LUOJIANET_MS_CORE_OPS_CONV2D_TRANSPOSE_FUSION_H_
#define LUOJIANET_MS_CORE_OPS_CONV2D_TRANSPOSE_FUSION_H_
#include <vector>
...
#endif  // LUOJIANET_MS_CORE_OPS_CONV2D_TRANSPOSE_FUSION_H_
