...
#ifndef LUOJIANET_MS_CORE_OPS_EMBEDDING_LOOKUP_FUSION_H_
#define LUOJIANET_MS_CORE_OPS_EMBEDDING_LOOKUP_FUSION_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
#endif  // LUOJIANET_MS_CORE_OPS_EMBEDDING_LOOKUP_FUSION_H_
