...
#ifndef LUOJIANET_MS_CORE_OPS_L2_NORMALIZE_FUSION_H_
#define LUOJIANET_MS_CORE_OPS_L2_NORMALIZE_FUSION_H_
#include <vector>
...
#endif  // LUOJIANET_MS_CORE_OPS_L2_NORMALIZE_FUSION_H_
