...
#ifndef LUOJIANET_MS_CORE_OPS_FUSION_MAT_MUL_FUSION_H_
#define LUOJIANET_MS_CORE_OPS_FUSION_MAT_MUL_FUSION_H_
#include <vector>
#include <memory>
...
class MIND_API MatMulFusion : public MatMul {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.MatMulFusion for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_FUSION_MAT_MUL_FUSION_H_
