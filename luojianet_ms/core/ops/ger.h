...
#ifndef LUOJIANET_MS_CORE_OPS_GER_H_
#define LUOJIANET_MS_CORE_OPS_GER_H_
...
/// Refer to Python API @ref luojianet_ms.ops.Ger for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_GER_H_
