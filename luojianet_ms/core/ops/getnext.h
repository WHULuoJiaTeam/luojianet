...
#ifndef LUOJIANET_MS_CORE_OPS_GETNEXT_H_
#define LUOJIANET_MS_CORE_OPS_GETNEXT_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.GetNext for more details.
class MIND_API GetNext : public BaseOperator {
 public:
  MIND_API_BASE_MEMBER(GetNext);
  /// \brief Constructor.
  GetNext() : BaseOperator(kNameGetNext) {}
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.GetNext for the inputs.
  void Init() const {}
};
...
#endif  // LUOJIANET_MS_CORE_OPS_GETNEXT_H_
