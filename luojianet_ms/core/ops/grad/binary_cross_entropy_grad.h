...
#ifndef LUOJIANET_MS_CORE_OPS_BINARY_CROSS_ENTROPY_GRAD_H_
#define LUOJIANET_MS_CORE_OPS_BINARY_CROSS_ENTROPY_GRAD_H_
#include <vector>
#include <memory>
...
#endif  // LUOJIANET_MS_CORE_OPS_BINARY_CROSS_ENTROPY_GRAD_H_
