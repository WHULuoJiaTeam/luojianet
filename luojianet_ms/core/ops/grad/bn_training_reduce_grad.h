...
#ifndef LUOJIANET_MS_CORE_OPS_GRAD_BN_TRAINING_REDUCE_GRAD_H_
#define LUOJIANET_MS_CORE_OPS_GRAD_BN_TRAINING_REDUCE_GRAD_H_
#include <string>
#include <vector>
#include <memory>
...
#endif  // LUOJIANET_MS_CORE_OPS_GRAD_BN_TRAINING_REDUCE_GRAD_H_
