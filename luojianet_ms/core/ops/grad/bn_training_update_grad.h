...
#ifndef LUOJIANET_MS_CORE_OPS_BN_TRAINING_UPDATE_GRAD_H_
#define LUOJIANET_MS_CORE_OPS_BN_TRAINING_UPDATE_GRAD_H_
...
#endif  // LUOJIANET_MS_CORE_OPS_BN_TRAINING_UPDATE_GRAD_H_
