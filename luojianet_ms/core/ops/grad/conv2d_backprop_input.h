...
#ifndef LUOJIANET_MS_CORE_OPS_CONV2D_BACKPROP_INPUT_H_
#define LUOJIANET_MS_CORE_OPS_CONV2D_BACKPROP_INPUT_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
#endif  // LUOJIANET_MS_CORE_OPS_CONV2D_BACKPROP_INPUT_H_
