...
#ifndef LUOJIANET_MS_CORE_OPS_GROUP_CONV2D_GRAD_INPUT_H_
#define LUOJIANET_MS_CORE_OPS_GROUP_CONV2D_GRAD_INPUT_H_
#include <vector>
#include <memory>
...
#endif  // LUOJIANET_MS_CORE_OPS_GROUP_CONV2D_GRAD_INPUT_H_
