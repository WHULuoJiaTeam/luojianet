...
#ifndef LUOJIANET_MS_CORE_OPS_MINIMUM_GRAD_H_
#define LUOJIANET_MS_CORE_OPS_MINIMUM_GRAD_H_
#include <vector>
#include <memory>
...
class MIND_API MinimumGrad : public BaseOperator {
 public:
  ...
  MinimumGrad() : BaseOperator(kNameMinimumGrad) { InitIOName({"x1", "x2", "grads"}, {"y1", "y2"}); }
...
#endif  // LUOJIANET_MS_CORE_OPS_MINIMUM_GRAD_H_
