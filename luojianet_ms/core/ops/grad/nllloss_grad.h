...
#ifndef LUOJIANET_MS_CORE_OPS_NLLLOSS_GRAD_H_
#define LUOJIANET_MS_CORE_OPS_NLLLOSS_GRAD_H_
...
/// \brief NLLLossGrad operation. Refer to Python API @ref luojianet_ms.ops.NLLLossGrad for more details.
class MIND_API NLLLossGrad : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.NLLLossGrad for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_NLLLOSS_GRAD_H_
