...
#ifndef LUOJIANET_MS_CORE_OPS_RESIZE_NEAREST_NEIGHBOR_GRAD_H_
#define LUOJIANET_MS_CORE_OPS_RESIZE_NEAREST_NEIGHBOR_GRAD_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
#endif  // LUOJIANET_MS_CORE_OPS_RESIZE_NEAREST_NEIGHBOR_GRAD_H_
