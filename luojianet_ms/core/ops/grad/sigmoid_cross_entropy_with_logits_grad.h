...
#ifndef LUOJIANET_MS_CORE_OPS_SIGMOID_CROSS_ENTROPY_WITH_LOGITS_GRAD_H_
#define LUOJIANET_MS_CORE_OPS_SIGMOID_CROSS_ENTROPY_WITH_LOGITS_GRAD_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
#endif  // LUOJIANET_MS_CORE_OPS_SIGMOID_CROSS_ENTROPY_WITH_LOGITS_GRAD_H_
