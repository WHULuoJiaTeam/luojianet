...
#ifndef LUOJIANET_MS_CORE_OPS_SMOOTH_L1_LOSS_GRAD_H_
#define LUOJIANET_MS_CORE_OPS_SMOOTH_L1_LOSS_GRAD_H_
#include <memory>
#include <vector>
...
#endif  // LUOJIANET_MS_CORE_OPS_SMOOTH_L1_LOSS_GRAD_H_
