...
#ifndef LUOJIANET_MS_CORE_OPS_SOFT_MARGIN_LOSS_GRAD_H_
#define LUOJIANET_MS_CORE_OPS_SOFT_MARGIN_LOSS_GRAD_H_
#include <memory>
#include <map>
#include <vector>
#include <set>
...
#endif  // LUOJIANET_MS_CORE_OPS_SOFT_MARGIN_LOSS_GRAD_H_
