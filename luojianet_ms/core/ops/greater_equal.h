...
#ifndef LUOJIANET_MS_CORE_OPS_GREATER_EQUAL_H_
#define LUOJIANET_MS_CORE_OPS_GREATER_EQUAL_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.GreaterEqual for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_GREATER_EQUAL_H_
