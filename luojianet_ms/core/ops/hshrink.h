 ...
 */
#ifndef LUOJIANET_MS_CORE_OPS_HSHRINK_H
#define LUOJIANET_MS_CORE_OPS_HSHRINK_H
...
/// Refer to Python API @ref luojianet_ms.ops.HShrink for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_HSHRINK_H
