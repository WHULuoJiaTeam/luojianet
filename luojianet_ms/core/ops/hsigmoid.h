...
#ifndef LUOJIANET_MS_CORE_OPS_HSIGMOID_H_
#define LUOJIANET_MS_CORE_OPS_HSIGMOID_H_
#include <vector>
#include <memory>
...
/// \brief Hard sigmoid activation function. Refer to Python API @ref luojianet_ms.ops.HSigmoid for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_HSIGMOID_H_
