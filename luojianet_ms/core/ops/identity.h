...
#ifndef LUOJIANET_MS_CORE_OPS_IDENTITY_H_
#define LUOJIANET_MS_CORE_OPS_IDENTITY_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.Identity for more details.
class MIND_API Identity : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.Identity for the inputs.
  void Init() const {}
};
...
#endif  // LUOJIANET_MS_CORE_OPS_IDENTITY_H_
