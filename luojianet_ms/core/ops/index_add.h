...
#ifndef LUOJIANET_MS_CORE_OPS_INDEX_ADD_H_
#define LUOJIANET_MS_CORE_OPS_INDEX_ADD_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.IndexAdd for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_INDEX_ADD_H_
