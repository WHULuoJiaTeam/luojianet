...
#ifndef LUOJIANET_MS_CORE_OPS_INVERT_PERMUTATION_H_
#define LUOJIANET_MS_CORE_OPS_INVERT_PERMUTATION_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.InvertPermutation for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_INVERT_PERMUTATION_H_
