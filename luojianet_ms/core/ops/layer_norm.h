...
#ifndef LUOJIANET_MS_CORE_OPS_LAYER_NORM_H_
#define LUOJIANET_MS_CORE_OPS_LAYER_NORM_H_
#include <string>
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.LayerNorm for more details.
class MS_CORE_API LayerNorm : public PrimitiveC {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.LayerNorm for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_LAYER_NORM_H_
