...
#ifndef LUOJIANET_MS_CORE_OPS_LAYERNORMBETAGAMMABACKPROPV2_H_
#define LUOJIANET_MS_CORE_OPS_LAYERNORMBETAGAMMABACKPROPV2_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
#endif  // LUOJIANET_MS_CORE_OPS_LAYERNORMBETAGAMMABACKPROPV2_H_
