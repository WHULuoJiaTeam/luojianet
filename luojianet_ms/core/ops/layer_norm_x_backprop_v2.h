...
#ifndef LUOJIANET_MS_CORE_OPS_LAYERNORMXBACKPROPV2_H_
#define LUOJIANET_MS_CORE_OPS_LAYERNORMXBACKPROPV2_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
class MIND_API LayerNormXBackpropV2 : public BaseOperator {
 public:
...
#endif  // LUOJIANET_MS_CORE_OPS_LAYERNORMXBACKPROPV2_H_
