...
#ifndef LUOJIANET_MS_CORE_OPS_LEAKY_RELU_H_
#define LUOJIANET_MS_CORE_OPS_LEAKY_RELU_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
/// \brief Leaky ReLU activation function. Refer to Python API @ref luojianet_ms.nn.LeakyReLU for more details.
class MS_CORE_API LeakyRelu : public PrimitiveC {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.nn.LeakyReLU for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_LEAKY_RELU_H_
