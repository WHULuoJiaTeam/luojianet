...
#ifndef LUOJIANET_MS_CORE_OPS_LESS_EQUAL_H_
#define LUOJIANET_MS_CORE_OPS_LESS_EQUAL_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.LessEqual for more details.
class MS_CORE_API LessEqual : public PrimitiveC {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.LessEqual for the inputs.
  void Init() {}
};
...
#endif  // LUOJIANET_MS_CORE_OPS_LESS_EQUAL_H_
