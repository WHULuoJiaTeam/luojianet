...
#ifndef LUOJIANET_MS_CORE_OPS_LIN_SPACE_H_
#define LUOJIANET_MS_CORE_OPS_LIN_SPACE_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.LinSpace for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_LIN_SPACE_H_
