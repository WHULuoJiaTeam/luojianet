...
#ifndef LUOJIANET_MS_CORE_OPS_LOG_MATRIX_DETERMINANT_H_
#define LUOJIANET_MS_CORE_OPS_LOG_MATRIX_DETERMINANT_H_
#include <memory>
#include <vector>
...
#endif  // LUOJIANET_MS_CORE_OPS_LOG_MATRIX_DETERMINANT_H_
