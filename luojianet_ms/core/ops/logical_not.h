...
#ifndef LUOJIANET_MS_CORE_OPS_LOGICAL_NOT_H_
#define LUOJIANET_MS_CORE_OPS_LOGICAL_NOT_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.LogicalNot for more details.
class MIND_API LogicalNot : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.LogicalNot for the inputs.
  void Init() const {}
};
...
#endif  // LUOJIANET_MS_CORE_OPS_LOGICAL_NOT_H_
