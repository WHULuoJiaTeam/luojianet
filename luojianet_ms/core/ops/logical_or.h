...
#ifndef LUOJIANET_MS_CORE_OPS_LOGICAL_OR_H_
#define LUOJIANET_MS_CORE_OPS_LOGICAL_OR_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.LogicalOr for more details.
class MIND_API LogicalOr : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.LogicalOr for the inputs.
  void Init() const {}
};
...
#endif  // LUOJIANET_MS_CORE_OPS_LOGICAL_OR_H_
