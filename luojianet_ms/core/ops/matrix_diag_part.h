...
#ifndef LUOJIANET_MS_CORE_OPS_MATRIX_DIAG_PART_H_
#define LUOJIANET_MS_CORE_OPS_MATRIX_DIAG_PART_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.MatrixDiagPart for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_MATRIX_DIAG_PART_H_
