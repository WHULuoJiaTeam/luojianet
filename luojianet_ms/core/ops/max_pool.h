...
#ifndef LUOJIANET_MS_CORE_OPS_MAX_POOL_H_
#define LUOJIANET_MS_CORE_OPS_MAX_POOL_H_
...
/// \brief Max pooling operation. Refer to Python API @ref luojianet_ms.ops.MaxPool for more details.
class MIND_API MaxPool : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.MaxPool for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_MAX_POOL_H_
