...
#ifndef LUOJIANET_MS_CORE_OPS_MAXIMUM_H_
#define LUOJIANET_MS_CORE_OPS_MAXIMUM_H_
...
/// Refer to Python API @ref luojianet_ms.ops.Maximum for more details.
class MIND_API Maximum : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.Maximum for the inputs.
  void Init() const {}
};
...
#endif  // LUOJIANET_MS_CORE_OPS_MAXIMUM_H_
