...
#ifndef LUOJIANET_MS_CORE_OPS_MINIMUM_H_
#define LUOJIANET_MS_CORE_OPS_MINIMUM_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.Minimum for more details.
class MIND_API Minimum : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.Minimum for the inputs.
  void Init() const {}
};
