...
#ifndef LUOJIANET_MS_CORE_OPS_MUL_H_
#define LUOJIANET_MS_CORE_OPS_MUL_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
/// \brief Multiply two tensors element-wise. Refer to Python API @ref luojianet_ms.ops.Mul for more details.
class MIND_API Mul : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.Mul for the inputs.
  void Init() const {}
};
...
#endif  // LUOJIANET_MS_CORE_OPS_MUL_H_
