...
#ifndef LUOJIANET_MS_CORE_OPS_NEIGHBOREXCHANGE_H_
#define LUOJIANET_MS_CORE_OPS_NEIGHBOREXCHANGE_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.NeighborExchange for more details.
class MS_CORE_API NeighborExchange : public PrimitiveC {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.NeighborExchange for the inputs.
  void Init() {}
};
...
#endif  // LUOJIANET_MS_CORE_OPS_NEIGHBOREXCHANGE_H_
