...
#ifndef LUOJIANET_MS_CORE_OPS_NLLLOSS_H_
#define LUOJIANET_MS_CORE_OPS_NLLLOSS_H_
...
/// \brief NLLLoss operation. Refer to Python API @ref luojianet_ms.ops.NLLLoss for more details.
class MIND_API NLLLoss : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.NLLLoss for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_NLLLOSS_H_
