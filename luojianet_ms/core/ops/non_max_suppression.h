...
#ifndef LUOJIANET_MS_CORE_OPS_NON_MAX_SUPPRESSION_H_
#define LUOJIANET_MS_CORE_OPS_NON_MAX_SUPPRESSION_H_
...
#endif  // LUOJIANET_MS_CORE_OPS_NON_MAX_SUPPRESSION_H_
