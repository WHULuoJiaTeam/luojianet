...
#ifndef LUOJIANET_MS_CORE_OPS_NON_ZERO_H_
#define LUOJIANET_MS_CORE_OPS_NON_ZERO_H_
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.NonZero for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_NON_ZERO_H_
