...
#ifndef LUOJIANET_MS_CORE_OPS_NOT_EQUAL_H_
#define LUOJIANET_MS_CORE_OPS_NOT_EQUAL_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.NotEqual for more details.
class MIND_API NotEqual : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.NotEqual for the inputs.
  void Init() const {}
};
...
#endif  // LUOJIANET_MS_CORE_OPS_NOT_EQUAL_H_
