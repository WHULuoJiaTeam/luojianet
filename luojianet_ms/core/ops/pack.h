...
#ifndef LUOJIANET_MS_CORE_OPS_PACK_H_
#define LUOJIANET_MS_CORE_OPS_PACK_H_
...
/// Refer to Python API @ref luojianet_ms.ops.Stack for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_PACK_H_
