...
#ifndef LUOJIANET_MS_CORE_OPS_PAD_H_
#define LUOJIANET_MS_CORE_OPS_PAD_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
/// \brief Pads the input tensor according to the paddings. Refer to Python API @ref luojianet_ms.ops.Pad for more details.
class MS_CORE_API Pad : public PrimitiveC {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.Pad for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_PAD_H_
