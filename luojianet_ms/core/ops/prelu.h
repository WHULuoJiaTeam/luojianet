...
#ifndef LUOJIANET_MS_CORE_OPS_PRELU_H_
#define LUOJIANET_MS_CORE_OPS_PRELU_H_
#include <string>
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.PReLU for more details.
class MIND_API PReLU : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.PReLU for the inputs.
  void Init() const {}
};
...
#endif  // LUOJIANET_MS_CORE_OPS_PRELU_H_
