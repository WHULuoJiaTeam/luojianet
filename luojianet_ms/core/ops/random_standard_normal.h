...
#ifndef LUOJIANET_MS_CORE_OPS_RANDOM_STANDARD_NORMAL_H_
#define LUOJIANET_MS_CORE_OPS_RANDOM_STANDARD_NORMAL_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
#endif  // LUOJIANET_MS_CORE_OPS_RANDOM_STANDARD_NORMAL_H_
