...
#ifndef LUOJIANET_MS_CORE_OPS_RANGE_H_
#define LUOJIANET_MS_CORE_OPS_RANGE_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.nn.Range for more details.
class MS_CORE_API Range : public PrimitiveC {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.nn.Range for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_RANGE_H_
