...
#ifndef LUOJIANET_MS_CORE_OPS_REDUCE_ANY_H_
#define LUOJIANET_MS_CORE_OPS_REDUCE_ANY_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.ReduceAny for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_REDUCE_ANY_H_
