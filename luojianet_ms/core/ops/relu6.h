 ...
 */
#ifndef LUOJIANET_MS_CORE_OPS_RELU6_H_
#define LUOJIANET_MS_CORE_OPS_RELU6_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.ReLU6 for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_RELU6_H_
