...
#ifndef LUOJIANET_MS_CORE_OPS_REVERSE_V2_H_
#define LUOJIANET_MS_CORE_OPS_REVERSE_V2_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.ReverseV2 for more details.
class MIND_API ReverseV2 : public BaseOperator {
 public:
  MIND_API_BASE_MEMBER(ReverseV2);
  /// \brief Constructor.
  ReverseV2() : BaseOperator(kNameReverseV2) {}
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.ReverseV2 for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_REVERSE_V2_H_
