...
#ifndef LUOJIANET_MS_CORE_OPS_ROUND_H_
#define LUOJIANET_MS_CORE_OPS_ROUND_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.Round for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_ROUND_H_
