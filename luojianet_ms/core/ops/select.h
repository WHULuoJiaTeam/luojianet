...
#ifndef LUOJIANET_MS_CORE_OPS_SELECT_H_
#define LUOJIANET_MS_CORE_OPS_SELECT_H_
...
/// Refer to Python API @ref luojianet_ms.ops.Select for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_SELECT_H_
