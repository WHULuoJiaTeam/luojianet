...
#ifndef LUOJIANET_MS_CORE_OPS_SIGMOID_H_
#define LUOJIANET_MS_CORE_OPS_SIGMOID_H_
#include <vector>
#include <memory>
...
/// \brief Sigmoid activation function. Refer to Python API @ref luojianet_ms.ops.Sigmoid for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_SIGMOID_H_
