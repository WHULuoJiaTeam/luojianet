...
#ifndef LUOJIANET_MS_CORE_OPS_SIGMOID_CROSS_ENTROPY_WITH_LOGITS_H_
#define LUOJIANET_MS_CORE_OPS_SIGMOID_CROSS_ENTROPY_WITH_LOGITS_H_
#include <vector>
#include <memory>
#include <string>
#include <set>
...
/// Refer to Python API @ref luojianet_ms.ops.SigmoidCrossEntropyWithLogits for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_SIGMOID_CROSS_ENTROPY_WITH_LOGITS_H_
