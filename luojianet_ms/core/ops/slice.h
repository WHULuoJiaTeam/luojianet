...
#ifndef LUOJIANET_MS_CORE_OPS_SLICE_H_
#define LUOJIANET_MS_CORE_OPS_SLICE_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
/// \brief Slices a tensor in the specified shape. Refer to Python API @ref luojianet_ms.ops.Slice for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_SLICE_H_
