...
#ifndef LUOJIANET_MS_CORE_OPS_SOFT_MARGIN_LOSS_H_
#define LUOJIANET_MS_CORE_OPS_SOFT_MARGIN_LOSS_H_
#include <memory>
#include <map>
#include <vector>
#include <set>
...
/// Refer to Python API @ref luojianet_ms.ops.SoftMarginLoss for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_SOFT_MARGIN_LOSS_H_
