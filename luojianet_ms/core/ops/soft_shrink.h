 ...
 */
#ifndef LUOJIANET_MS_CORE_OPS_SOFTSHRINK_H_
#define LUOJIANET_MS_CORE_OPS_SOFTSHRINK_H_
#include <map>
#include <memory>
#include <vector>
#include <string>
...
/// Refer to Python API @ref luojianet_ms.ops.SoftShrink for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_SOFTSHRINK_H_
