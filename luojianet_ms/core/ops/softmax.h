...
#ifndef LUOJIANET_MS_CORE_OPS_SOFTMAX_H_
#define LUOJIANET_MS_CORE_OPS_SOFTMAX_H_
...
/// \brief Softmax operation. Refer to Python API @ref luojianet_ms.ops.Softmax for more details.
class MS_CORE_API Softmax : public PrimitiveC {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.Softmax for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_SOFTMAX_H_
