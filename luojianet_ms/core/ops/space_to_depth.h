...
#ifndef LUOJIANET_MS_CORE_OPS_SPACE_TO_DEPTH_H_
#define LUOJIANET_MS_CORE_OPS_SPACE_TO_DEPTH_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.SpaceToDepth for more details.
class MS_CORE_API SpaceToDepth : public PrimitiveC {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.SpaceToDepth for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_SpaceToDepth_H_
