...
#ifndef LUOJIANET_MS_CORE_OPS_SPARSE_APPLY_ADADELTA_H_
#define LUOJIANET_MS_CORE_OPS_SPARSE_APPLY_ADADELTA_H_
...
#endif  // LUOJIANET_MS_CORE_OPS_SPARSE_APPLY_ADADELTA_H_
