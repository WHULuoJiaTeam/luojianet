...
#ifndef LUOJIANET_MS_CORE_OPS_SPARSE_APPLY_R_M_S_PROP_H_
#define LUOJIANET_MS_CORE_OPS_SPARSE_APPLY_R_M_S_PROP_H_
...
#endif  // LUOJIANET_MS_CORE_OPS_SPARSE_APPLY_R_M_S_PROP_H_
