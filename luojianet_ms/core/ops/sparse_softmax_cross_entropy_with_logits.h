...
#ifndef LUOJIANET_MS_CORE_OPS_SPARSE_SOFTMAX_CROSS_ENTROPY_WITH_LOGITS_H_
#define LUOJIANET_MS_CORE_OPS_SPARSE_SOFTMAX_CROSS_ENTROPY_WITH_LOGITS_H_
#include <memory>
#include <vector>
...
/// Refer to Python API @ref luojianet_ms.ops.SparseSoftmaxCrossEntropyWithLogits for more details.
class MIND_API SparseSoftmaxCrossEntropyWithLogits : public BaseOperator {
 public:
  ...
  /// \brief Init.
  /// Refer to the parameters of python API @ref luojianet_ms.ops.SparseSoftmaxCrossEntropyWithLogits for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_SPARSE_SOFTMAX_CROSS_ENTROPY_WITH_LOGITS_H_
