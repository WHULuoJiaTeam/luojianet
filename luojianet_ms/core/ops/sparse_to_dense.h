...
#ifndef LUOJIANET_MS_CORE_OPS_SPARSE_TO_DENSE_H_
#define LUOJIANET_MS_CORE_OPS_SPARSE_TO_DENSE_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.SparseToDense for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_SPARSE_TO_DENSE_H_
