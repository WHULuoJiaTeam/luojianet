...
#ifndef LUOJIANET_MS_CORE_OPS_SPLIT_H_
#define LUOJIANET_MS_CORE_OPS_SPLIT_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.Split for more details.
class MS_CORE_API Split : public PrimitiveC {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref luojianet_ms.ops.Split for the inputs.
...
#endif  // LUOJIANET_MS_CORE_OPS_SPLIT_H_
