...
#ifndef LUOJIANET_MS_CORE_OPS_SPLIT_V_H_
#define LUOJIANET_MS_CORE_OPS_SPLIT_V_H_
#include <memory>
#include <vector>
...
/// Refer to Python API @ref luojianet_ms.ops.SplitV for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_Split_V_H_
