...
#ifndef LUOJIANET_MS_CORE_OPS_SQUARED_DIFFERENCE_H_
#define LUOJIANET_MS_CORE_OPS_SQUARED_DIFFERENCE_H_
#include <vector>
#include <memory>
...
/// Refer to Python API @ref luojianet_ms.ops.SquaredDifference for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_SQUARED_DIFFERENCE_H_
