...
#ifndef LUOJIANET_MS_CORE_OPS_TAN_H_
#define LUOJIANET_MS_CORE_OPS_TAN_H_
#include <vector>
#include <memory>
...
/// \brief Computes tangent of x element-wise. Refer to Python API @ref luojianet_ms.ops.Tan for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_TAN_H_
