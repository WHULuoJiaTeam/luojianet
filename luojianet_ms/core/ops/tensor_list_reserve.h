...
#ifndef LUOJIANET_MS_CORE_OPS_TENSOR_LIST_RESERVE_H_
#define LUOJIANET_MS_CORE_OPS_TENSOR_LIST_RESERVE_H_
#include <memory>
...
#endif  // LUOJIANET_MS_CORE_OPS_TENSOR_LIST_RESERVE_H_
