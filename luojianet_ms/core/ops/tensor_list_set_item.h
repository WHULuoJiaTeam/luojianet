...
#ifndef LUOJIANET_MS_CORE_OPS_TENSOR_LIST_SET_ITEM_H_
#define LUOJIANET_MS_CORE_OPS_TENSOR_LIST_SET_ITEM_H_
#include <memory>
...
#endif  // LUOJIANET_MS_CORE_OPS_TENSOR_LIST_SET_ITEM_H_
