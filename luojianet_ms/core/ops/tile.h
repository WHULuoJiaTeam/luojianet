...
#ifndef LUOJIANET_MS_CORE_OPS_TILE_H_
#define LUOJIANET_MS_CORE_OPS_TILE_H_
#include <set>
#include <string>
#include <vector>
#include <memory>
...
/// \brief Replicates a tensor with given multiples times. Refer to Python API @ref luojianet_ms.ops.Tile for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_TILE_H_
