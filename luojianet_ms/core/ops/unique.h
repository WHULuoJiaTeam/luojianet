...
#ifndef LUOJIANET_MS_CORE_OPS_UNIQUE_H_
#define LUOJIANET_MS_CORE_OPS_UNIQUE_H_
...
/// Refer to Python API @ref luojianet_ms.ops.Unique for more details.
...
#endif  // LUOJIANET_MS_CORE_OPS_UNIQUE_H_
