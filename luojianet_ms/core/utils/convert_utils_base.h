...
#ifndef LUOJIANET_MS_CORE_UTILS_CONVERT_UTILS_BASE_H_
#define LUOJIANET_MS_CORE_UTILS_CONVERT_UTILS_BASE_H_
...
#endif  // LUOJIANET_MS_CORE_UTILS_CONVERT_UTILS_BASE_H_
