...
#ifndef LUOJIANET_MS_CORE_UTILS_COUNTER_H_
#define LUOJIANET_MS_CORE_UTILS_COUNTER_H_
#include <list>
#include <vector>
#include <utility>
#include <functional>
...
class Counter {
  ...
  using map_type = luojianet_ms::HashMap<key_type, iterator, KeyHash, KeyEqual>;
...
#endif  // LUOJIANET_MS_CORE_UTILS_COUNTER_H_
