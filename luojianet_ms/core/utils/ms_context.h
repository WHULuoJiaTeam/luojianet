...
#ifndef LUOJIANET_MS_CORE_UTILS_MS_CONTEXT_H_
#define LUOJIANET_MS_CORE_UTILS_MS_CONTEXT_H_
#include <thread>
#include <memory>
#include <map>
#include <set>
...
#include "luojianet_ms/ccsrc/minddata/dataset/engine/tdt/tdt_handle.h"
...
// enum definition for LuoJiaNet Context Parameter
...
#endif  // LUOJIANET_MS_CORE_UTILS_MS_CONTEXT_H_
