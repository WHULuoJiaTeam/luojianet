...
#ifndef LUOJIANET_MS_CORE_UTILS_ORDERED_SET_H_
#define LUOJIANET_MS_CORE_UTILS_ORDERED_SET_H_
...
class OrderedSet {
 public:
  ...
  using map_type = luojianet_ms::HashMap<element_type, iterator, hasher, equal>;
...
class OrderedSet<std::shared_ptr<T>> {
 public:
  ...
  using reverse_iterator = typename sequential_type::reverse_iterator;
  using const_reverse_iterator = typename sequential_type::const_reverse_iterator;
  using map_type = luojianet_ms::HashMap<key_type, iterator, hash_t>;
...
#endif  // LUOJIANET_MS_CORE_UTILS_ORDERED_SET_H_
