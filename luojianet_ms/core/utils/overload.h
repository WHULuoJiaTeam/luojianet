...
#ifndef LUOJIANET_MS_CORE_UTILS_OVERLOAD_H_
#define LUOJIANET_MS_CORE_UTILS_OVERLOAD_H_
...
std::ostream &operator<<(std::ostream &os, const luojianet_ms::HashMap<T1, T2, T3> &map) {
  os << "[const hash_map]";
  return os;
}
...
template <typename T1, typename T2>
std::string ToString(const luojianet_ms::HashMap<T1, T2> &map) {
  std::ostringstream buffer;
...
#endif  // LUOJIANET_MS_CORE_UTILS_OVERLOAD_H_
