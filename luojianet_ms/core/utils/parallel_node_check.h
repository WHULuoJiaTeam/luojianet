...
#ifndef LUOJIANET_MS_CORE_UTILS_PARALLEL_NODE_CHECK_H_
#define LUOJIANET_MS_CORE_UTILS_PARALLEL_NODE_CHECK_H_
...
#endif  // LUOJIANET_MS_CORE_UTILS_PARALLEL_NODE_CHECK_H_
