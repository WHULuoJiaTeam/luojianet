 ...
 */
#ifndef LUOJIANET_MS_CORE_UTILS_TENSOR_CONSTRUCT_UTILS_H_
#define LUOJIANET_MS_CORE_UTILS_TENSOR_CONSTRUCT_UTILS_H_
#include <vector>
#include <algorithm>
#include "ir/tensor.h"
...
#endif  // LUOJIANET_MS_CORE_UTILS_TENSOR_CONSTRUCT_UTILS_H_
