...
get_version
MODEL_DOWNLOAD_URL="https://download.luojianet_ms.cn/model_zoo/official/lite/quick_start/add.tflite"
...
cp -r ${BASEPATH}/build/${LUOJIANET_MS_FILE_NAME}/tools/converter/lib ${BASEPATH}/
cp -r ${BASEPATH}/build/${LUOJIANET_MS_FILE_NAME}/tools/converter/include ${BASEPATH}/
