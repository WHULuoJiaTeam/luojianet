...
#include "luojianet_ms-lite/include/lite_session.h"
...
class Benchmark {
 ...
 private:
  ...
  std::vector<luojianet_ms::tensor::MSTensor *> ms_inputs_;
  std::unordered_map<std::string, std::vector<luojianet_ms::tensor::MSTensor *>> ms_outputs_;
