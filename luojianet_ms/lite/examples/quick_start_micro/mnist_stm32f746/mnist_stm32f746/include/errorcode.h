...
#ifndef LUOJIANET_MS_LITE_INCLUDE_ERRORCODE_H_
#define LUOJIANET_MS_LITE_INCLUDE_ERRORCODE_H_

#include "include/lite_utils.h"

namespace luojianet_ms {
namespace lite {
/// \brief STATUS defined for holding error code in LUOJIANET_MS Lite.
using STATUS = int;
...
#endif  // LUOJIANET_MS_LITE_INCLUDE_ERRORCODE_H_
