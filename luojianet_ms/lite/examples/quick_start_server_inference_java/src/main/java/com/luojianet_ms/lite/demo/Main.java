...
import com.luojianet_ms.config.DeviceType;
import com.luojianet_ms.config.MSContext;
import com.luojianet_ms.config.RunnerConfig;
import com.luojianet_ms.ModelParallelRunner;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (!ret) {
            System.err.println("LUOJIANET_MS Lite predict failed.");
            freeTensor();
            runner.free();
            return;
        }
