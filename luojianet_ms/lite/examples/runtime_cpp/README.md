...
- 编译构建
  ...
  > 若LUOJIANET_MS Lite推理框架下载失败，请手动下载硬件平台为CPU，操作系统为Ubuntu-x64的[LUOJIANET_MS Lite 模型推理框架](https://www.luojianet_ms.cn/lite/docs/zh-CN/r1.7/use/downloads.html)，解压后将其拷贝对应到`luojianet_ms/lite/examples/runtime_cpp/lib`目录。
  >
...
- 执行推理
  ...
  例如：可以执行以下命令，体验LUOJIANET_MS Lite推理MobileNetV2模型。
