...
int Run(const char *model_path) {
  ...
  // Create and Build LUOJIANET_MS model.
...
int main(int argc, const char **argv) {
  if (argc < 3) {
    ...
    std::cerr << "When your Option is 0, you will run LUOJIANET_MS Lite predict." << std::endl;
    std::cerr << "When your Option is 1, you will run LUOJIANET_MS Lite predict with resize." << std::endl;
    std::cerr << "When your Option is 2, you will run LUOJIANET_MS Lite predict with complicated API." << std::endl;
    std::cerr << "When your Option is 3, you will run LUOJIANET_MS Lite predict with model parallel." << std::endl;
    std::cerr << "When your Option is 4, you will run LUOJIANET_MS Lite predict with shared memory pool." << std::endl;
    std::cerr << "When your Option is 5, you will run LUOJIANET_MS Lite predict with callback." << std::endl;
    return -1;
  }
  std::string version = luojianet_ms::Version();
  std::cout << "LUOJIANET_MS Lite Version is " << version << std::endl;
