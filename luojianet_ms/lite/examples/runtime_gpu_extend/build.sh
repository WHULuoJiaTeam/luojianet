...
MODEL_DOWNLOAD_URL2="https://download.luojianet_ms.cn/model_zoo/official/lite/quick_start/add.ms"
...
tar -xzf ${BASEPATH}/build/${LUOJIANET_MS_FILE}
cp -r ${BASEPATH}/build/${LUOJIANET_MS_FILE_NAME}/runtime ${BASEPATH}/
