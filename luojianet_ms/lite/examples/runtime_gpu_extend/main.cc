...
void InitMSContext(const std::shared_ptr<luojianet_ms::Context> &context) {
...
int CompileAndRun(int argc, const char **argv) {
  ...
  std::vector<luojianet_ms::MSTensor> ms_inputs_for_api = ms_model.GetInputs();
...
int main(int argc, const char **argv) { return luojianet_ms::lite::CompileAndRun(argc, argv); }
