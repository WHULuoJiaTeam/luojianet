...
#ifndef LUOJIANET_MS_LITE_EXAMPLES_TRAIN_LENET_SRC_UTILS_H_
#define LUOJIANET_MS_LITE_EXAMPLES_TRAIN_LENET_SRC_UTILS_H_
...
#endif  // LUOJIANET_MS_LITE_EXAMPLES_TRAIN_LENET_SRC_UTILS_H_
