...
#ifndef LUOJIANET_MS_LITE_EXAMPLES_TRANSFER_LEARNING_SRC_DATASET_H_
#define LUOJIANET_MS_LITE_EXAMPLES_TRANSFER_LEARNING_SRC_DATASET_H_
...
#endif  // LUOJIANET_MS_LITE_EXAMPLES_TRANSFER_LEARNING_SRC_DATASET_H_
