...
#ifndef LUOJIANET_MS_LITE_SRC_TENSOR_H_
#define LUOJIANET_MS_LITE_SRC_TENSOR_H_
...
class Tensor : public luojianet_ms::tensor::MSTensor {
 public:
  Tensor() = default;

  Tensor(TypeId data_type, std::vector<int> shape, const luojianet_ms::Format &format = luojianet_ms::NHWC,
  ...
  void set_format(luojianet_ms::Format format) override { this->tensorc.format_ = format; }

  luojianet_ms::Format format() const override { return (luojianet_ms::Format)this->tensorc.format_; }
 ...
 protected:
  ...
  //  luojianet_ms::Format tensor.format_;
  TensorC tensorc;
  Category category_;
...
using TensorPtr = std::shared_ptr<luojianet_ms::lite::Tensor>;
#endif  // LUOJIANET_MS_LITE_SRC_TENSOR_H_
