...
#ifndef LUOJIANET_MS_LITE_INCLUDE_LITE_SESSION_H_
#define LUOJIANET_MS_LITE_INCLUDE_LITE_SESSION_H_
...
namespace session {
/// \brief LiteSession defined session in LUOJIANET_MS Lite for compiling Model and forwarding model.
class MS_API LiteSession {
 public:
  ...
  ///
  /// \return Pointer of LUOJIANET_MS Lite LiteSession.
  ...
  /// \brief Destructor of LUOJIANET_MS Lite LiteSession.
  ...
  /// \brief Compile LUOJIANET_MS Lite model.
  ///
  ...
  /// \brief Get input LUOJIANET_MS Lite MSTensors of model.
  ///
  /// \return The vector of LUOJIANET_MS Lite MSTensor.
  virtual Vector<tensor::MSTensor *> GetInputs() const = 0;

  /// \brief Get input LUOJIANET_MS Lite MSTensors of model by tensor name.
  ///
  /// \param[in] node_name Define tensor name.
  ///
  /// \return The vector of LUOJIANET_MS Lite MSTensor.
  virtual luojianet_ms::tensor::MSTensor *GetInputsByTensorName(const String &tensor_name) const = 0;
  ...
  /// \brief Get output LUOJIANET_MS Lite MSTensors of model by node name.
  ///
...
#ifndef NOT_USE_STL
  /// \brief Get output LUOJIANET_MS Lite MSTensors of model mapped by tensor name.
  ///
  /// \return The map of output tensor name and LUOJIANET_MS Lite MSTensor.
  virtual std::unordered_map<String, luojianet_ms::tensor::MSTensor *> GetOutputs() const = 0;
#endif
  ...
  /// \brief Get output LUOJIANET_MS Lite MSTensors of model by tensor name.
  ///
  /// \param[in] tensor_name Define tensor name.
  ///
  /// \return Pointer of LUOJIANET_MS Lite MSTensor.
  virtual luojianet_ms::tensor::MSTensor *GetOutputByTensorName(const String &tensor_name) const = 0;
  ...
  /// \return STATUS as an error code of compiling graph, STATUS is defined in errorcode.h
  virtual int Train() { return luojianet_ms::lite::RET_ERROR; }
  ...
  /// \return STATUS as an error code of compiling graph, STATUS is defined in errorcode.h
  virtual int Eval() { return luojianet_ms::lite::RET_OK; }
  ...
  virtual int SetLearningRate(float learning_rate) { return luojianet_ms::lite::RET_ERROR; }
  ...
  /// \brief Get output LUOJIANET_MS Lite MSTensors of Training model prediction
  ///
  /// \return a vector of output tensors (LUOJIANET_MS Lite MSTensor).
  ...
  virtual int UpdateWeights(std::vector<tensor::MSTensor *> new_weights) { return luojianet_ms::lite::RET_ERROR; }

  /// \brief Get model featuremap LUOJIANET_MS Lite MSTensors of Training model prediction
  ///
  /// \return a vector of output tensors (LUOJIANET_MS Lite MSTensor).
  ...
  /// \return STATUS as an error code of the set operation, STATUS is defined in errorcode.h
  virtual int UpdateFeatureMaps(const std::vector<tensor::MSTensor *> &features) { return luojianet_ms::lite::RET_ERROR; }

  /// \brief Get model gradient
  ///
  /// \return a vector of gradient tensors (LUOJIANET_MS Lite MSTensor).
  ...
  /// \return STATUS as an error code of the set operation, STATUS is defined in errorcode.h
  virtual int ApplyGradients(const std::vector<tensor::MSTensor *> &gradients) { return luojianet_ms::lite::RET_ERROR; }

  /// \brief Get model optimizer params
  ///
  /// \return a vector of optimizer parameters (LUOJIANET_MS Lite MSTensor).
  ...
  /// \return STATUS as an error code of the set operation, STATUS is defined in errorcode.h
  virtual int SetOptimizerParams(const std::vector<tensor::MSTensor *> &params) { return luojianet_ms::lite::RET_ERROR; }
};
}  // namespace session
}  // namespace luojianet_ms
#endif  // LUOJIANET_MS_LITE_INCLUDE_LITE_SESSION_H_
