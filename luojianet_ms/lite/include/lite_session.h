...
namespace session {
/// \brief LiteSession defined session in LuoJiaNet Lite for compiling Model and forwarding model.
class MS_API LiteSession {
 public:
  ...
  ///
  /// \return Pointer of LuoJiaNet Lite LiteSession.
  ...
  /// \brief Destructor of LuoJiaNet Lite LiteSession.
  ...
  /// \brief Compile LuoJiaNet Lite model.
  ///
  ...
  /// \brief Get input LuoJiaNet Lite MSTensors of model.
  ///
  /// \return The vector of LuoJiaNet Lite MSTensor.
  virtual Vector<tensor::MSTensor *> GetInputs() const = 0;

  /// \brief Get input LuoJiaNet Lite MSTensors of model by tensor name.
  ///
  ...
  /// \brief Get output LuoJiaNet Lite MSTensors of model by node name.
  ///
...
#ifndef NOT_USE_STL
  /// \brief Get output LuoJiaNet Lite MSTensors of model mapped by tensor name.
  ///
  /// \return The map of output tensor name and LuoJiaNet Lite MSTensor.
  ...
  /// \brief Get output LuoJiaNet Lite MSTensors of model by tensor name.
  ///
  /// \param[in] tensor_name Define tensor name.
  ///
  /// \return Pointer of LuoJiaNet Lite MSTensor.
  ...
  /// \brief Get output LuoJiaNet Lite MSTensors of Training model prediction
  ///
  /// \return a vector of output tensors (LuoJiaNet Lite MSTensor).
  ...
  /// \brief Get model featuremap LuoJiaNet Lite MSTensors of Training model prediction
  ///
  /// \return a vector of output tensors (LuoJiaNet Lite MSTensor).
  ...
  ///
  /// \return a vector of gradient tensors (LuoJiaNet Lite MSTensor).
  ...
  ///
  /// \return a vector of optimizer parameters (LuoJiaNet Lite MSTensor).
