...
#ifndef LUOJIANET_MS_LITE_INCLUDE_LITE_UTILS_H_
#define LUOJIANET_MS_LITE_INCLUDE_LITE_UTILS_H_
...
using TensorPtrVector = Vector<luojianet_ms::schema::Tensor *>;
...
using TensorPtrVector = std::vector<luojianet_ms::schema::Tensor *>;
...
#endif  // LUOJIANET_MS_LITE_INCLUDE_LITE_UTILS_H_
