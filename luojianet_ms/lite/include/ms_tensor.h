...
namespace tensor {
/// \brief MSTensor defined tensor in LUOJIANET_MS Lite.
class MS_API MSTensor {
 public:
  /// \brief Constructor of LUOJIANET_MS Lite MSTensor.
  ///
  /// \return Instance of LUOJIANET_MS Lite MSTensor.
  MSTensor() = default;

  /// \brief Destructor of LUOJIANET_MS Lite Model.
  virtual ~MSTensor() = default;

  /// \brief Create a MSTensor.
  ///
  /// \return Pointer to an instance of LUOJIANET_MS Lite MSTensor.
  ...
  /// \brief Get data type of the LUOJIANET_MS Lite MSTensor.
  ///
  ...
  ///
  /// \return LUOJIANET_MS Lite TypeId of the LUOJIANET_MS Lite MSTensor.
  ...
  /// \brief Get shape of the LUOJIANET_MS Lite MSTensor.
  ///
  /// \return A vector of int as the shape of the LUOJIANET_MS Lite MSTensor.
