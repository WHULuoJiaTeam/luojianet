...
#ifndef LUOJIANET_MS_LITE_INCLUDE_REGISTRY_PARSER_CONTEXT_H_
#define LUOJIANET_MS_LITE_INCLUDE_REGISTRY_PARSER_CONTEXT_H_
...
#endif  // LUOJIANET_MS_LITE_INCLUDE_REGISTRY_PARSER_CONTEXT_H_
