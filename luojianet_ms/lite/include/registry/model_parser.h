...
#ifndef LUOJIANET_MS_LITE_INCLUDE_REGISTRY_MODEL_PARSER_H_
#define LUOJIANET_MS_LITE_INCLUDE_REGISTRY_MODEL_PARSER_H_
...
#endif  // LUOJIANET_MS_LITE_INCLUDE_REGISTRY_MODEL_PARSER_H_
