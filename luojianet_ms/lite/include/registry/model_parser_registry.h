...
#ifndef LUOJIANET_MS_LITE_INCLUDE_REGISTRY_MODEL_PARSER_REGISTRY_H
#define LUOJIANET_MS_LITE_INCLUDE_REGISTRY_MODEL_PARSER_REGISTRY_H
...
#define REG_MODEL_PARSER(fmk, parserCreator) \
  static luojianet_ms::registry::ModelParserRegistry g_##type##fmk##ModelParserReg(fmk, parserCreator);
}  // namespace registry
}  // namespace luojianet_ms

#endif  // LUOJIANET_MS_LITE_INCLUDE_REGISTRY_MODEL_PARSER_REGISTRY_H
