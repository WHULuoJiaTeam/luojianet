...
#ifndef LUOJIANET_MS_LITE_INCLUDE_REGISTRY_NODE_PARSER_REGISTRY_H_
#define LUOJIANET_MS_LITE_INCLUDE_REGISTRY_NODE_PARSER_REGISTRY_H_
...
#define REG_NODE_PARSER(fmk_type, node_type, node_parser) \
  static luojianet_ms::registry::NodeParserRegistry g_##fmk_type##node_type##ParserReg(fmk_type, #node_type, node_parser);
}  // namespace registry
}  // namespace luojianet_ms

#endif  // LUOJIANET_MS_LITE_INCLUDE_REGISTRY_NODE_PARSER_REGISTRY_H_
