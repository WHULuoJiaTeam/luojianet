...
#ifndef LUOJIANET_MS_LITE_INCLUDE_REGISTRY_PASS_BASE_H_
#define LUOJIANET_MS_LITE_INCLUDE_REGISTRY_PASS_BASE_H_
...
#endif  // LUOJIANET_MS_LITE_INCLUDE_REGISTRY_PASS_BASE_H_
