...
#ifndef LUOJIANET_MS_LITE_INCLUDE_REGISTRY_REGISTER_KERNEL_H_
#define LUOJIANET_MS_LITE_INCLUDE_REGISTRY_REGISTER_KERNEL_H_
...
#define REGISTER_KERNEL(arch, provider, data_type, op_type, creator)                                                   \
  namespace {                                                                                                          \
  static luojianet_ms::registry::KernelReg g_##arch##provider##data_type##op_type##kernelReg(#arch, #provider, data_type, \
                                                                                          op_type, creator);           \
  }  // namespace
...
#endif  // LUOJIANET_MS_LITE_INCLUDE_REGISTRY_REGISTER_KERNEL_H_
