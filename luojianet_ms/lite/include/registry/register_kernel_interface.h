...
#ifndef LUOJIANET_MS_LITE_INCLUDE_REGISTRY_KERNEL_INTERFACE_H_
#define LUOJIANET_MS_LITE_INCLUDE_REGISTRY_KERNEL_INTERFACE_H_
...
#define REGISTER_KERNEL_INTERFACE(provider, op_type, creator)                                                    \
  namespace {                                                                                                    \
  static luojianet_ms::registry::KernelInterfaceReg g_##provider##op_type##_inter_reg(#provider, op_type, creator); \
  }  // namespace
...
#define REGISTER_CUSTOM_KERNEL_INTERFACE(provider, op_type, creator)                                           \
  namespace {                                                                                                  \
  static luojianet_ms::registry::KernelInterfaceReg g_##provider##op_type##_custom_inter_reg(#provider, #op_type, \
                                                                                          creator);            \
  }  // namespace
}  // namespace registry
}  // namespace luojianet_ms

#endif  // LUOJIANET_MS_LITE_INCLUDE_REGISTRY_KERNEL_INTERFACE_H_
