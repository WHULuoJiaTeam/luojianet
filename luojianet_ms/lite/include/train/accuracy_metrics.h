 ...
 */
#ifndef LUOJIANET_MS_LITE_INCLUDE_TRAIN_ACCURACY_METRICS_H_
#define LUOJIANET_MS_LITE_INCLUDE_TRAIN_ACCURACY_METRICS_H_
#include <vector>
#include "include/train/metrics.h"

using luojianet_ms::session::Metrics;
...
#endif  // LUOJIANET_MS_LITE_INCLUDE_TRAIN_ACCURACY_METRICS_H_
