 ...
 */
#ifndef LUOJIANET_MS_LITE_INCLUDE_TRAIN_LOSS_MONITOR_H_
#define LUOJIANET_MS_LITE_INCLUDE_TRAIN_LOSS_MONITOR_H_
#include <vector>
#include <string>
#include <utility>
#include <climits>
...
#endif  // LUOJIANET_MS_LITE_INCLUDE_TRAIN_LOSS_MONITOR_H_
