 ...
 */
#ifndef LUOJIANET_MS_LITE_INCLUDE_TRAIN_LR_SCHEDULER_H_
#define LUOJIANET_MS_LITE_INCLUDE_TRAIN_LR_SCHEDULER_H_
#include <vector>
#include <string>
#include <utility>
#include <functional>
...
#endif  // LUOJIANET_MS_LITE_INCLUDE_TRAIN_LR_SCHEDULER_H_
