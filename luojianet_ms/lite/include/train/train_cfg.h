 ...
 */
#ifndef LUOJIANET_MS_LITE_INCLUDE_TRAIN_TRAIN_CFG_H_
#define LUOJIANET_MS_LITE_INCLUDE_TRAIN_TRAIN_CFG_H_
#include <string>
#include <vector>
...
#endif  // LUOJIANET_MS_LITE_INCLUDE_TRAIN_TRAIN_CFG_H_
