 ...
 */
#ifndef LUOJIANET_MS_LITE_INCLUDE_TRAIN_TRAIN_LOOP_CALLBACK_H_
#define LUOJIANET_MS_LITE_INCLUDE_TRAIN_TRAIN_LOOP_CALLBACK_H_
#include <vector>
#include <string>
#include <tuple>
#include <utility>
...
#endif  // LUOJIANET_MS_LITE_INCLUDE_TRAIN_TRAIN_LOOP_CALLBACK_H_
