 ...
 */
#ifndef LUOJIANET_MS_LITE_INCLUDE_TRAIN_TRAIN_SESSION_H_
#define LUOJIANET_MS_LITE_INCLUDE_TRAIN_TRAIN_SESSION_H_
#include <string>
...
class TrainSession {
 public:
  ...
  ///
  /// \return Pointer of LUOJIANET_MS LiteSession
...
#endif  // LUOJIANET_MS_LITE_INCLUDE_TRAIN_TRAIN_SESSION_H_
