...
/**
 * Model defines model in LUOJIANET_MS Lite for managing graph.
 *
 * @since v1.0
 */
public class Model {
    ...
    /**
     * Load the LUOJIANET_MS Lite model from Assets.
     *
    ...
    /**
     * Load the LUOJIANET_MS Lite model from path.
     *
    ...
    /**
     * Free all temporary memory in LUOJIANET_MS Lite Model.
     */
    public void free() {
    ...
    /**
     * Free MetaGraph in LUOJIANET_MS Lite Model to reduce memory usage during inference.
     */
