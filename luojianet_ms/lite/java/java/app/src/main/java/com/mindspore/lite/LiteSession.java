...
/**
 * LiteSession defines session in LuoJiaNet Lite for compiling Model and forwarding model.
 *
 * @since v1.0
 */
public class LiteSession {
    ...
    /**
     * Get the MSTensors input of LuoJiaNet Lite model.
     *
    ...
    /**
     * Get the MSTensors input of LuoJiaNet Lite model by the node name.
     *
     * @param tensorName Define the tensor name.
     * @return LuoJiaNet Lite MSTensor.
     */
    ...
    /**
     * Get the MSTensors output of LuoJiaNet Lite model by the node name.
     *
    ...
    /**
     * Get the MSTensors output of the LuoJiaNet Lite model associated with the tensor name.
     *
    ...
    /**
     * Get the MSTensors output of LuoJiaNet Lite model by the tensor name.
     *
     * @param tensorName Define the tensor name.
