...
/**
 * MSTensor defined tensor in LUOJIANET_MS Lite.
 *
 * @since v1.0
 */
public class MSTensor {
    ...
    /**
     * Get the shape of the LUOJIANET_MS Lite MSTensor.
     *
     * @return A array of int as the shape of the LUOJIANET_MS Lite MSTensor.
     */
    public int[] getShape() {
    ...
    /**
     * DataType is defined in com.luojianet_ms.lite.DataType.
     *
     * @return The LUOJIANET_MS Lite data type of the LUOJIANET_MS Lite MSTensor class.
     */
    ...
    /**
     * Free all temporary memory in LUOJIANET_MS Lite MSTensor.
     */
    public void free() {
