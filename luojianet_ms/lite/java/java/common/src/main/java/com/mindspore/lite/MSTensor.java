...
/**
 * MSTensor defined tensor in LuoJiaNet Lite.
 *
 * @since v1.0
 */
public class MSTensor {
    ...
    /**
     * Get the shape of the LuoJiaNet Lite MSTensor.
     *
     * @return A array of int as the shape of the LuoJiaNet Lite MSTensor.
     */
    public int[] getShape() {
     ...
     *
     * @return The LuoJiaNet Lite data type of the LuoJiaNet Lite MSTensor class.
     */
    ...
    /**
     * Free all temporary memory in LuoJiaNet Lite MSTensor.
     */
    public void free() {
