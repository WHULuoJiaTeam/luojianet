...
import com.luojianet_ms.flclient.compression.DecodeExecutor;
...
public class StartFLJob {
    ...
    private List<FeatureMap> parseFeatureMapList(ResponseFLJob flJob) {
        ...
        if (flJob.downloadCompressType() == luojianet_ms.schema.CompressType.NO_COMPRESS) {
