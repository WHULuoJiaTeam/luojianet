...
/**
 * LiteSession defines session in LUOJIANET_MS Lite for compiling Model and forwarding model.
 *
 * @since v1.0
 */
public class LiteSession {
    ...
    /**
     * Compile LUOJIANET_MS Lite model.
     *
    ...
    /**
     * Get the MSTensors input of LUOJIANET_MS Lite model.
     *
    ...
    /**
     * Get the MSTensors input of LUOJIANET_MS Lite model by the node name.
     *
     * @param tensorName Define the tensor name.
     * @return LUOJIANET_MS Lite MSTensor.
     */
    ...
    /**
     * Get the MSTensors output of LUOJIANET_MS Lite model by the node name.
     *
    ...
    /**
     * Get the MSTensors output of the LUOJIANET_MS Lite model associated with the tensor name.
     *
    ...
    /**
     * Get the MSTensors output of LUOJIANET_MS Lite model by the tensor name.
     *
     * @param tensorName Define the tensor name.
