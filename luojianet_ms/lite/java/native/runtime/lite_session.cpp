...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_lite_LiteSession_createSessionWithModel(JNIEnv *env, jobject thiz,
...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_lite_LiteSession_createSession(JNIEnv *env, jobject thiz,
                                                                                     jlong ms_config_ptr) {
  auto *pointer = reinterpret_cast<void *>(ms_config_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Context pointer from java is nullptr");
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_lite_LiteSession_compileGraph(JNIEnv *env, jobject thiz,
                                                                                       jlong session_ptr,
                                                                                       jlong model_ptr) {
...
extern "C" JNIEXPORT void JNICALL Java_com_luojianet_lite_LiteSession_bindThread(JNIEnv *env, jobject thiz,
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_lite_LiteSession_runGraph(JNIEnv *env, jobject thiz,
                                                                                   jlong session_ptr) {
  auto *pointer = reinterpret_cast<void *>(session_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Session pointer from java is nullptr");
...
extern "C" JNIEXPORT jobject JNICALL Java_com_luojianet_lite_LiteSession_getInputs(JNIEnv *env, jobject thiz,
                                                                                   jlong session_ptr) {
...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_lite_LiteSession_getInputsByTensorName(JNIEnv *env, jobject thiz,
                                                                                             jlong session_ptr,
                                                                                             jstring tensor_name) {
  auto *pointer = reinterpret_cast<void *>(session_ptr);
  if (pointer == nullptr) {
...
extern "C" JNIEXPORT jobject JNICALL Java_com_luojianet_lite_LiteSession_getOutputsByNodeName(JNIEnv *env, jobject thiz,
                                                                                              jlong session_ptr,
                                                                                              jstring node_name) {
  jclass array_list = env->FindClass("java/util/ArrayList");
  jmethodID array_list_construct = env->GetMethodID(array_list, "<init>", "()V");
...
extern "C" JNIEXPORT jobject JNICALL Java_com_luojianet_lite_LiteSession_getOutputMapByTensor(JNIEnv *env, jobject thiz,
                                                                                              jlong session_ptr) {
...
extern "C" JNIEXPORT jobject JNICALL Java_com_luojianet_lite_LiteSession_getOutputTensorNames(JNIEnv *env, jobject thiz,
                                                                                              jlong session_ptr) {
  jclass array_list = env->FindClass("java/util/ArrayList");
  jmethodID array_list_construct = env->GetMethodID(array_list, "<init>", "()V");
  jobject ret = env->NewObject(array_list, array_list_construct);
...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_lite_LiteSession_getOutputByTensorName(JNIEnv *env, jobject thiz,
                                                                                             jlong session_ptr,
                                                                                             jstring tensor_name) {
  auto *pointer = reinterpret_cast<void *>(session_ptr);
  if (pointer == nullptr) {
...
extern "C" JNIEXPORT void JNICALL Java_com_luojianet_lite_LiteSession_free(JNIEnv *env, jobject thiz,
                                                                           jlong session_ptr) {
  auto *pointer = reinterpret_cast<void *>(session_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Session pointer from java is nullptr");
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_lite_LiteSession_resize(JNIEnv *env, jobject thiz,
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_lite_LiteSession_export(JNIEnv *env, jobject thiz,
                                                                                 jlong session_ptr,
                                                                                 jstring model_name,
                                                                                 jint model_type,
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_lite_LiteSession_train(JNIEnv *env, jobject thiz,
                                                                                jlong session_ptr) {
  auto *session_pointer = reinterpret_cast<void *>(session_ptr);
  if (session_pointer == nullptr) {
    MS_LOGE("Session pointer from java is nullptr");
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_lite_LiteSession_eval(JNIEnv *env, jobject thiz,
                                                                                jlong session_ptr) {
  auto *session_pointer = reinterpret_cast<void *>(session_ptr);
  if (session_pointer == nullptr) {
    MS_LOGE("Session pointer from java is nullptr");
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_lite_LiteSession_isTrain(JNIEnv *env, jobject thiz,
                                                                                   jlong session_ptr) {
  auto *session_pointer = reinterpret_cast<void *>(session_ptr);
  if (session_pointer == nullptr) {
    MS_LOGE("Session pointer from java is nullptr");
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_lite_LiteSession_isEval(JNIEnv *env, jobject thiz,
                                                                                  jlong session_ptr) {
  auto *session_pointer = reinterpret_cast<void *>(session_ptr);
  if (session_pointer == nullptr) {
    MS_LOGE("Session pointer from java is nullptr");
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_lite_LiteSession_setLearningRate(JNIEnv *env, jobject thiz,
                                                                                           jlong session_ptr,
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_lite_LiteSession_setupVirtualBatch(JNIEnv *env, jobject thiz,
                                                                                           jlong session_ptr,
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_lite_LiteSession_updateFeatures(JNIEnv *env, jclass,
                                                                                         jlong session_ptr,
                                                                                         jlongArray features) {
...
extern "C" JNIEXPORT jobject JNICALL Java_com_luojianet_lite_LiteSession_getFeaturesMap(JNIEnv *env, jobject thiz,
                                                                                        jlong session_ptr) {
  jclass array_list = env->FindClass("java/util/ArrayList");
  jmethodID array_list_construct = env->GetMethodID(array_list, "<init>", "()V");
  jobject ret = env->NewObject(array_list, array_list_construct);
