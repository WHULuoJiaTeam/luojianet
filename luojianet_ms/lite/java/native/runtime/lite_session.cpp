...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_ms_lite_LiteSession_createSessionWithModel(JNIEnv *env, jobject thiz,
  ...
  // create session
  auto session = luojianet_ms::session::LiteSession::CreateSession(model_buf, buffer_len, lite_context_ptr);
  if (session == nullptr) {
...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_ms_lite_LiteSession_createSession(JNIEnv *env, jobject thiz,
                                                                                     jlong ms_config_ptr) {
  auto *pointer = reinterpret_cast<void *>(ms_config_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Context pointer from java is nullptr");
  ...
  auto *lite_context_ptr = static_cast<luojianet_ms::lite::Context *>(pointer);
  auto session = luojianet_ms::session::LiteSession::CreateSession(lite_context_ptr);
  if (session == nullptr) {
    MS_LOGE("CreateSession failed");
    return jlong(nullptr);
  }
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_lite_LiteSession_compileGraph(JNIEnv *env, jobject thiz,
                                                                                       jlong session_ptr,
                                                                                       jlong model_ptr) {
  ...
  auto *lite_session_ptr = static_cast<luojianet_ms::session::LiteSession *>(session_pointer);
  auto *model_pointer = reinterpret_cast<void *>(model_ptr);
  if (model_pointer == nullptr) {
    MS_LOGE("Model pointer from java is nullptr");
    return (jboolean) false;
  }
  auto *lite_model_ptr = static_cast<luojianet_ms::lite::Model *>(model_pointer);

  auto ret = lite_session_ptr->CompileGraph(lite_model_ptr);
  return (jboolean)(ret == luojianet_ms::lite::RET_OK);
}

extern "C" JNIEXPORT void JNICALL Java_com_luojianet_ms_lite_LiteSession_bindThread(JNIEnv *env, jobject thiz,
  ...
  auto *lite_session_ptr = static_cast<luojianet_ms::session::LiteSession *>(pointer);
  lite_session_ptr->BindThread(if_bind);
}

extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_lite_LiteSession_runGraph(JNIEnv *env, jobject thiz,
                                                                                   jlong session_ptr) {
  auto *pointer = reinterpret_cast<void *>(session_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Session pointer from java is nullptr");
...
extern "C" JNIEXPORT jobject JNICALL Java_com_luojianet_ms_lite_LiteSession_getInputs(JNIEnv *env, jobject thiz,
                                                                                   jlong session_ptr) {
...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_ms_lite_LiteSession_getInputsByTensorName(JNIEnv *env, jobject thiz,
                                                                                             jlong session_ptr,
                                                                                             jstring tensor_name) {
  auto *pointer = reinterpret_cast<void *>(session_ptr);
  if (pointer == nullptr) {
...
extern "C" JNIEXPORT jobject JNICALL Java_com_luojianet_ms_lite_LiteSession_getOutputsByNodeName(JNIEnv *env, jobject thiz,
                                                                                              jlong session_ptr,
                                                                                              jstring node_name) {
  jclass array_list = env->FindClass("java/util/ArrayList");
  jmethodID array_list_construct = env->GetMethodID(array_list, "<init>", "()V");
...
extern "C" JNIEXPORT jobject JNICALL Java_com_luojianet_ms_lite_LiteSession_getOutputMapByTensor(JNIEnv *env, jobject thiz,
                                                                                              jlong session_ptr) {
...
extern "C" JNIEXPORT jobject JNICALL Java_com_luojianet_ms_lite_LiteSession_getOutputTensorNames(JNIEnv *env, jobject thiz,
                                                                                              jlong session_ptr) {
  jclass array_list = env->FindClass("java/util/ArrayList");
  jmethodID array_list_construct = env->GetMethodID(array_list, "<init>", "()V");
  jobject ret = env->NewObject(array_list, array_list_construct);
...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_ms_lite_LiteSession_getOutputByTensorName(JNIEnv *env, jobject thiz,
                                                                                             jlong session_ptr,
                                                                                             jstring tensor_name) {
  auto *pointer = reinterpret_cast<void *>(session_ptr);
  if (pointer == nullptr) {
...
extern "C" JNIEXPORT void JNICALL Java_com_luojianet_ms_lite_LiteSession_free(JNIEnv *env, jobject thiz,
                                                                           jlong session_ptr) {
  auto *pointer = reinterpret_cast<void *>(session_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Session pointer from java is nullptr");
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_lite_LiteSession_resize(JNIEnv *env, jobject thiz,
  ...
  std::vector<luojianet_ms::tensor::MSTensor *> c_inputs;
  for (int i = 0; i < input_size; i++) {
    ...
    auto *ms_tensor_ptr = static_cast<luojianet_ms::tensor::MSTensor *>(tensor_pointer);
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_lite_LiteSession_export(JNIEnv *env, jobject thiz,
                                                                                 jlong session_ptr,
                                                                                 jstring model_name,
                                                                                 jint model_type,
  ...
  auto ret = lite_session_ptr->Export(env->GetStringUTFChars(model_name, JNI_FALSE),
                                      static_cast<luojianet_ms::lite::ModelType>(model_type),
                                      static_cast<luojianet_ms::lite::QuantizationType>(quantization_type));
  return (jboolean)(ret == 0);
}

extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_lite_LiteSession_train(JNIEnv *env, jobject thiz,
                                                                                jlong session_ptr) {
  auto *session_pointer = reinterpret_cast<void *>(session_ptr);
  if (session_pointer == nullptr) {
    MS_LOGE("Session pointer from java is nullptr");
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_lite_LiteSession_eval(JNIEnv *env, jobject thiz,
                                                                                jlong session_ptr) {
  auto *session_pointer = reinterpret_cast<void *>(session_ptr);
  if (session_pointer == nullptr) {
    MS_LOGE("Session pointer from java is nullptr");
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_lite_LiteSession_isTrain(JNIEnv *env, jobject thiz,
                                                                                   jlong session_ptr) {
  auto *session_pointer = reinterpret_cast<void *>(session_ptr);
  if (session_pointer == nullptr) {
    MS_LOGE("Session pointer from java is nullptr");
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_lite_LiteSession_isEval(JNIEnv *env, jobject thiz,
                                                                                  jlong session_ptr) {
  auto *session_pointer = reinterpret_cast<void *>(session_ptr);
  if (session_pointer == nullptr) {
    MS_LOGE("Session pointer from java is nullptr");
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_lite_LiteSession_setLearningRate(JNIEnv *env, jobject thiz,
                                                                                           jlong session_ptr,
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_lite_LiteSession_setupVirtualBatch(JNIEnv *env, jobject thiz,
                                                                                           jlong session_ptr,
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_lite_LiteSession_updateFeatures(JNIEnv *env, jclass,
                                                                                         jlong session_ptr,
                                                                                         jlongArray features) {
  jsize size = static_cast<int>(env->GetArrayLength(features));
  jlong *input_data = env->GetLongArrayElements(features, nullptr);
  std::vector<luojianet_ms::tensor::MSTensor *> newFeatures;
  ...
  auto session = reinterpret_cast<luojianet_ms::session::LiteSession *>(session_ptr);
  auto ret = session->UpdateFeatureMaps(newFeatures);
  return (jboolean)(ret == luojianet_ms::lite::RET_OK);
}

extern "C" JNIEXPORT jobject JNICALL Java_com_luojianet_ms_lite_LiteSession_getFeaturesMap(JNIEnv *env, jobject thiz,
                                                                                        jlong session_ptr) {
  jclass array_list = env->FindClass("java/util/ArrayList");
  jmethodID array_list_construct = env->GetMethodID(array_list, "<init>", "()V");
  jobject ret = env->NewObject(array_list, array_list_construct);
  ...
  auto *train_session_ptr = static_cast<luojianet_ms::session::LiteSession *>(pointer);
