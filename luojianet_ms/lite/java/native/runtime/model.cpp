...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_lite_Model_loadModel(JNIEnv *env, jobject thiz, jobject buffer) {
  if (buffer == nullptr) {
...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_lite_Model_loadModelByPath(JNIEnv *env, jobject thiz,
                                                                                 jstring model_path) {
...
extern "C" JNIEXPORT void JNICALL Java_com_luojianet_lite_Model_free(JNIEnv *env, jobject thiz, jlong model_ptr) {
...
extern "C" JNIEXPORT void JNICALL Java_com_luojianet_lite_Model_freeBuffer(JNIEnv *env, jobject thiz, jlong model_ptr) {
  auto *pointer = reinterpret_cast<void *>(model_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Model pointer from java is nullptr");
    return;
