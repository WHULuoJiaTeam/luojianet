...
extern "C" JNIEXPORT jintArray JNICALL Java_com_luojianet_lite_MSTensor_getShape(JNIEnv *env, jobject thiz,
                                                                                 jlong tensor_ptr) {
...
extern "C" JNIEXPORT jint JNICALL Java_com_luojianet_lite_MSTensor_getDataType(JNIEnv *env, jobject thiz,
                                                                               jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
...
extern "C" JNIEXPORT jbyteArray JNICALL Java_com_luojianet_lite_MSTensor_getByteData(JNIEnv *env, jobject thiz,
                                                                                     jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
...
extern "C" JNIEXPORT jlongArray JNICALL Java_com_luojianet_lite_MSTensor_getLongData(JNIEnv *env, jobject thiz,
                                                                                     jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
...
extern "C" JNIEXPORT jintArray JNICALL Java_com_luojianet_lite_MSTensor_getIntData(JNIEnv *env, jobject thiz,
                                                                                   jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
...
extern "C" JNIEXPORT jfloatArray JNICALL Java_com_luojianet_lite_MSTensor_getFloatData(JNIEnv *env, jobject thiz,
                                                                                       jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_lite_MSTensor_setData(JNIEnv *env, jobject thiz,
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_lite_MSTensor_setByteBufferData(JNIEnv *env, jobject thiz,
                                                                                         jlong tensor_ptr,
                                                                                         jobject buffer) {
...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_lite_MSTensor_size(JNIEnv *env, jobject thiz, jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
    return 0;
...
extern "C" JNIEXPORT jint JNICALL Java_com_luojianet_lite_MSTensor_elementsNum(JNIEnv *env, jobject thiz,
                                                                               jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
...
extern "C" JNIEXPORT void JNICALL Java_com_luojianet_lite_MSTensor_free(JNIEnv *env, jobject thiz, jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
    return;
...
extern "C" JNIEXPORT jstring JNICALL Java_com_luojianet_lite_MSTensor_tensorName(JNIEnv *env, jobject thiz,
                                                                                 jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_lite_MSTensor_createTensor(JNIEnv *env, jobject thiz,
