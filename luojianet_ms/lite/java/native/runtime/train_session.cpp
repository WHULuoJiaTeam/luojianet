...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_ms_lite_TrainSession_createTrainSession(JNIEnv *env, jobject thiz,
                                                                                          jstring file_name,
  ...
  auto session = luojianet_ms::session::TrainSession::CreateTrainSession(env->GetStringUTFChars(file_name, JNI_FALSE),
