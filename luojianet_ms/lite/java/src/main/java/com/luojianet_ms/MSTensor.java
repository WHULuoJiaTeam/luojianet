...
public class MSTensor {
    ...
    /**
     * Get the shape of the LUOJIANET_MS MSTensor.
     *
     * @return A array of int as the shape of the LUOJIANET_MS MSTensor.
     */
    public int[] getShape() {
    ...
    /**
     * DataType is defined in com.luojianet_ms.DataType.
     *
     * @return The LUOJIANET_MS data type of the LUOJIANET_MS MSTensor class.
     */
    ...
    /**
     * Free all temporary memory in LUOJIANET_MS MSTensor.
     */
    public void free() {
