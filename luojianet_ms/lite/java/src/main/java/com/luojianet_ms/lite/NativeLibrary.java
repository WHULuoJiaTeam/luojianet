...
import com.luojianet_ms.config.Version;
import java.io.*;
...
public class NativeLibrary {
    ...
    private static final String LUOJIANET_MS_LITE_LIBNAME = "luojianet_ms-lite";
    private static final String LUOJIANET_MS_LITE_JNI_LIBNAME = "luojianet_ms-lite-jni";
    ...
    public static void loadLibs() {
        ...
        loadLib(makeResourceName("lib" + LUOJIANET_MS_LITE_LIBNAME + ".so"));
        loadLib(makeResourceName("lib" + LUOJIANET_MS_LITE_JNI_LIBNAME + ".so"));
    }
    ...
    private static boolean loadLibrary() {
        try {
            ...
            System.loadLibrary(LUOJIANET_MS_LITE_LIBNAME);
            System.loadLibrary(LUOJIANET_MS_LITE_JNI_LIBNAME);
    ...
    private static File mkTmpDir() {
        final String LUOJIANET_MS_LITE_LIBS = "luojianet_ms_lite_libs-";
        Long timestamp = System.currentTimeMillis();
        String dirName = LUOJIANET_MS_LITE_LIBS + timestamp + "-";
        for (int i = 0; i < 10; i++) {
    ...
    /**
     * get native lib file name, eg. com/luojianet_ms/lite/linux_x86_64/libluojianet_ms-lite.so
     *
     * @param basename
     * @return
     */
    private static String makeResourceName(String basename) {
        return "com/luojianet_ms/lite/" + String.format("linux_%s/", architecture()) + basename;
    }
