...
public class MSTensor {
    ...
    /**
     * Get the shape of the LuoJiaNet MSTensor.
     *
     * @return A array of int as the shape of the LuoJiaNet MSTensor.
     */
    public int[] getShape() {
     ...
     *
     * @return The LuoJiaNet data type of the LuoJiaNet MSTensor class.
     */
    ...
    /**
     * Free all temporary memory in LuoJiaNet MSTensor.
     */
    public void free() {
