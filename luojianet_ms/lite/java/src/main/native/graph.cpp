...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_ms_Graph_loadModel(JNIEnv *env, jobject thiz, jstring ms_file) {
...
extern "C" JNIEXPORT void JNICALL Java_com_luojianet_ms_Graph_free(JNIEnv *env, jobject thiz, jlong graph_ptr) {
