...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_Model_buildByGraph(JNIEnv *env, jobject thiz, jlong graph_ptr,
...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_Model_buildByBuffer(JNIEnv *env, jobject thiz,
  ...
  if (model_type >= static_cast<int>(luojianet_ms::kMindIR) && model_type <= static_cast<int>(luojianet_ms::kMindIR_Opt)) {
...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_Model_buildByPath(JNIEnv *env, jobject thiz, jstring model_path,
...
extern "C" JNIEXPORT jobject JNICALL Java_com_luojianet_Model_getInputs(JNIEnv *env, jobject thiz, jlong model_ptr) {
  return GetInOrOutTensors(env, thiz, model_ptr, true);
}

extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_Model_getInputByTensorName(JNIEnv *env, jobject thiz,
                                                                                 jlong model_ptr, jstring tensor_name) {
  return GetTensorByInOutName(env, model_ptr, tensor_name, true);
}

extern "C" JNIEXPORT jobject JNICALL Java_com_luojianet_Model_getOutputs(JNIEnv *env, jobject thiz, jlong model_ptr) {
  return GetInOrOutTensors(env, thiz, model_ptr, false);
}

extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_Model_getOutputByTensorName(JNIEnv *env, jobject thiz,
                                                                                  jlong model_ptr,
                                                                                  jstring tensor_name) {
  return GetTensorByInOutName(env, model_ptr, tensor_name, false);
}

extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_Model_getTrainMode(JNIEnv *env, jobject thiz,
                                                                            jlong model_ptr) {
  auto *pointer = reinterpret_cast<void *>(model_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Model pointer from java is nullptr");
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_Model_setTrainMode(JNIEnv *env, jobject thiz, jlong model_ptr,
                                                                            jboolean train_mode) {
  auto *pointer = reinterpret_cast<void *>(model_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Model pointer from java is nullptr");
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_Model_runStep(JNIEnv *env, jobject thiz, jlong model_ptr) {
  auto *pointer = reinterpret_cast<void *>(model_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Model pointer from java is nullptr");
    return jlong(false);
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_Model_predict(JNIEnv *env, jobject thiz, jlong model_ptr,
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_Model_resize(JNIEnv *env, jobject thiz, jlong model_ptr,
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_Model_export(JNIEnv *env, jobject thiz, jlong model_ptr,
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_Model_updateFeatureMaps(JNIEnv *env, jclass, jlong model_ptr,
                                                                                 jlongArray features) {
...
extern "C" JNIEXPORT jobject JNICALL Java_com_luojianet_Model_getFeatureMaps(JNIEnv *env, jobject thiz,
                                                                             jlong model_ptr) {
  jclass array_list = env->FindClass("java/util/ArrayList");
  jmethodID array_list_construct = env->GetMethodID(array_list, "<init>", "()V");
  jobject ret = env->NewObject(array_list, array_list_construct);
...
extern "C" JNIEXPORT void JNICALL Java_com_luojianet_Model_free(JNIEnv *env, jobject thiz, jlong model_ptr) {
  auto *pointer = reinterpret_cast<void *>(model_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Model pointer from java is nullptr");
    return;
