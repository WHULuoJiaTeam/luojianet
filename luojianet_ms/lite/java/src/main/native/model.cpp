...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_ms_Model_buildByGraph(JNIEnv *env, jobject thiz, jlong graph_ptr,
                                                                         jlong context_ptr, jlong cfg_ptr) {
  auto *c_graph_ptr = reinterpret_cast<luojianet_ms::Graph *>(graph_ptr);
  if (c_graph_ptr == nullptr) {
    MS_LOGE("Graph pointer from java is nullptr");
    return jlong(nullptr);
  }

  auto *c_context_ptr = reinterpret_cast<luojianet_ms::Context *>(context_ptr);
  ...
  auto *c_cfg_ptr = reinterpret_cast<luojianet_ms::TrainCfg *>(cfg_ptr);
  ...
  auto status = model->Build(luojianet_ms::GraphCell(*c_graph_ptr), context, cfg);
...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_ms_Model_buildByBuffer(JNIEnv *env, jobject thiz,
  ...
  luojianet_ms::ModelType c_model_type;
  if (model_type >= static_cast<int>(luojianet_ms::kMindIR) && model_type <= static_cast<int>(luojianet_ms::kMindIR_Lite)) {
    c_model_type = static_cast<luojianet_ms::ModelType>(model_type);
  } else {
  ...
  if (key_str != NULL) {
    ...
    luojianet_ms::Key dec_key{dec_key_data, key_len};
...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_ms_Model_buildByPath(JNIEnv *env, jobject thiz, jstring model_path,
...
jobject GetInOrOutTensors(JNIEnv *env, jobject thiz, jlong model_ptr, bool is_input) {
  ...
  auto *pointer = reinterpret_cast<luojianet_ms::Model *>(model_ptr);
  if (pointer == nullptr) {
  ...
  for (auto &tensor : tensors) {
    auto tensor_ptr = std::make_unique<luojianet_ms::MSTensor>(tensor);
...
jlong GetTensorByInOutName(JNIEnv *env, jlong model_ptr, jstring tensor_name, bool is_input) {
  ...
  auto *lite_model_ptr = static_cast<luojianet_ms::Model *>(pointer);
  luojianet_ms::MSTensor tensor;
  if (is_input) {
...
extern "C" JNIEXPORT jobject JNICALL Java_com_luojianet_ms_Model_getInputs(JNIEnv *env, jobject thiz, jlong model_ptr) {
  return GetInOrOutTensors(env, thiz, model_ptr, true);
}

extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_ms_Model_getInputByTensorName(JNIEnv *env, jobject thiz,
                                                                                 jlong model_ptr, jstring tensor_name) {
  return GetTensorByInOutName(env, model_ptr, tensor_name, true);
}

extern "C" JNIEXPORT jobject JNICALL Java_com_luojianet_ms_Model_getOutputs(JNIEnv *env, jobject thiz, jlong model_ptr) {
  return GetInOrOutTensors(env, thiz, model_ptr, false);
}

extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_ms_Model_getOutputByTensorName(JNIEnv *env, jobject thiz,
                                                                                  jlong model_ptr,
                                                                                  jstring tensor_name) {
  return GetTensorByInOutName(env, model_ptr, tensor_name, false);
}

extern "C" JNIEXPORT jobject JNICALL Java_com_luojianet_ms_Model_getOutputTensorNames(JNIEnv *env, jobject thiz,
                                                                                   jlong model_ptr) {
  jclass array_list = env->FindClass("java/util/ArrayList");
  jmethodID array_list_construct = env->GetMethodID(array_list, "<init>", "()V");
  jobject ret = env->NewObject(array_list, array_list_construct);
...
extern "C" JNIEXPORT jobject JNICALL Java_com_luojianet_ms_Model_getOutputsByNodeName(JNIEnv *env, jobject thiz,
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_Model_getTrainMode(JNIEnv *env, jobject thiz,
                                                                            jlong model_ptr) {
  auto *pointer = reinterpret_cast<void *>(model_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Model pointer from java is nullptr");
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_Model_setTrainMode(JNIEnv *env, jobject thiz, jlong model_ptr,
                                                                            jboolean train_mode) {
  auto *pointer = reinterpret_cast<void *>(model_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Model pointer from java is nullptr");
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_Model_runStep(JNIEnv *env, jobject thiz, jlong model_ptr) {
  auto *pointer = reinterpret_cast<void *>(model_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Model pointer from java is nullptr");
    return (jboolean) false;
...
std::vector<luojianet_ms::MSTensor> convertArrayToVector(JNIEnv *env, jlongArray inputs) {
  auto input_size = static_cast<int>(env->GetArrayLength(inputs));
  jlong *input_data = env->GetLongArrayElements(inputs, nullptr);
  std::vector<luojianet_ms::MSTensor> c_inputs;
  for (int i = 0; i < input_size; i++) {
    ...
    auto *ms_tensor_ptr = static_cast<luojianet_ms::MSTensor *>(tensor_pointer);
    c_inputs.push_back(*ms_tensor_ptr);
  }
  return c_inputs;
}

extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_Model_predict(JNIEnv *env, jobject thiz, jlong model_ptr,
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_Model_resize(JNIEnv *env, jobject thiz, jlong model_ptr,
  ...
  for (int i = 0; i < input_size; i++) {
    ...
    auto &ms_tensor = *static_cast<luojianet_ms::MSTensor *>(tensor_pointer);
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_Model_export(JNIEnv *env, jobject thiz, jlong model_ptr,
  ...
  auto *lite_model_ptr = static_cast<luojianet_ms::Model *>(model_pointer);
  ...
  luojianet_ms::QuantizationType quant_type;
  if (quantization_type >= static_cast<int>(luojianet_ms::kNoQuant) &&
      quantization_type <= static_cast<int>(luojianet_ms::kFullQuant)) {
    quant_type = static_cast<luojianet_ms::QuantizationType>(quantization_type);
  } else {
    MS_LOGE("Invalid quantization_type : %d", quantization_type);
    return (jlong) nullptr;
  }
  auto ret = luojianet_ms::Serialization::ExportModel(*lite_model_ptr, luojianet_ms::kMindIR, model_path, quant_type,
                                                   export_inference_only, output_tensor_names);
  return (jboolean)(ret.IsOk());
}

extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_Model_updateFeatureMaps(JNIEnv *env, jclass, jlong model_ptr,
                                                                                 jlongArray features) {
  auto size = static_cast<int>(env->GetArrayLength(features));
  jlong *input_data = env->GetLongArrayElements(features, nullptr);
  std::vector<luojianet_ms::MSTensor> newFeatures;
  ...
  auto lite_model_ptr = reinterpret_cast<luojianet_ms::Model *>(model_ptr);
  auto ret = lite_model_ptr->UpdateFeatureMaps(newFeatures);
  return (jboolean)(ret.IsOk());
}

extern "C" JNIEXPORT jobject JNICALL Java_com_luojianet_ms_Model_getFeatureMaps(JNIEnv *env, jobject thiz,
                                                                             jlong model_ptr) {
  jclass array_list = env->FindClass("java/util/ArrayList");
  jmethodID array_list_construct = env->GetMethodID(array_list, "<init>", "()V");
  jobject ret = env->NewObject(array_list, array_list_construct);
  ...
  for (auto &feature : features) {
    auto tensor_ptr = std::make_unique<luojianet_ms::MSTensor>(feature);
    if (tensor_ptr == nullptr) {
      MS_LOGE("Make ms tensor failed");
      return ret;
    }
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_Model_setLearningRate(JNIEnv *env, jclass, jlong model_ptr,
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_Model_setupVirtualBatch(
...
extern "C" JNIEXPORT void JNICALL Java_com_luojianet_ms_Model_free(JNIEnv *env, jobject thiz, jlong model_ptr) {
  auto *pointer = reinterpret_cast<void *>(model_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Model pointer from java is nullptr");
    return;
