...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_config_MSContext_createMSContext(JNIEnv *env, jobject thiz,
                                                                                       jint thread_num,
                                                                                       jint cpu_bind_mode,
...
extern "C" JNIEXPORT void JNICALL Java_com_luojianet_config_MSContext_addDeviceInfo(JNIEnv *env, jobject thiz,
...
extern "C" JNIEXPORT void JNICALL Java_com_luojianet_config_MSContext_free(JNIEnv *env, jobject thiz,
                                                                           jlong context_ptr) {
  auto *pointer = reinterpret_cast<void *>(context_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Context pointer from java is nullptr");
