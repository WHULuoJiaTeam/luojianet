...
extern "C" JNIEXPORT jintArray JNICALL Java_com_luojianet_ms_MSTensor_getShape(JNIEnv *env, jobject thiz,
                                                                            jlong tensor_ptr) {
  ...
  auto *ms_tensor_ptr = static_cast<luojianet_ms::MSTensor *>(pointer);
...
extern "C" JNIEXPORT jint JNICALL Java_com_luojianet_ms_MSTensor_getDataType(JNIEnv *env, jobject thiz, jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
...
extern "C" JNIEXPORT jbyteArray JNICALL Java_com_luojianet_ms_MSTensor_getByteData(JNIEnv *env, jobject thiz,
                                                                                jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
...
extern "C" JNIEXPORT jlongArray JNICALL Java_com_luojianet_ms_MSTensor_getLongData(JNIEnv *env, jobject thiz,
                                                                                jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
  ...
  if (ms_tensor_ptr->DataType() != luojianet_ms::DataType::kNumberTypeInt64) {
...
extern "C" JNIEXPORT jintArray JNICALL Java_com_luojianet_ms_MSTensor_getIntData(JNIEnv *env, jobject thiz,
                                                                              jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
  ...
  if (ms_tensor_ptr->DataType() != luojianet_ms::DataType::kNumberTypeInt32) {
    MS_LOGE("data type is error : %d", static_cast<int>(ms_tensor_ptr->DataType()));
    return env->NewIntArray(0);
  }
  auto local_element_num = ms_tensor_ptr->ElementNum();
...
extern "C" JNIEXPORT jfloatArray JNICALL Java_com_luojianet_ms_MSTensor_getFloatData(JNIEnv *env, jobject thiz,
                                                                                  jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
  ...
  if (ms_tensor_ptr->DataType() != luojianet_ms::DataType::kNumberTypeFloat32) {
    MS_LOGE("data type is error : %d", static_cast<int>(ms_tensor_ptr->DataType()));
    return env->NewFloatArray(0);
  }
  auto local_element_num = ms_tensor_ptr->ElementNum();
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_MSTensor_setData(JNIEnv *env, jobject thiz, jlong tensor_ptr,
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_ms_MSTensor_setByteBufferData(JNIEnv *env, jobject thiz,
...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_ms_MSTensor_size(JNIEnv *env, jobject thiz, jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
    return 0;
...
extern "C" JNIEXPORT jint JNICALL Java_com_luojianet_ms_MSTensor_elementsNum(JNIEnv *env, jobject thiz, jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
    return 0;
...
extern "C" JNIEXPORT void JNICALL Java_com_luojianet_ms_MSTensor_free(JNIEnv *env, jobject thiz, jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
    return;
...
extern "C" JNIEXPORT jstring JNICALL Java_com_luojianet_ms_MSTensor_tensorName(JNIEnv *env, jobject thiz,
                                                                            jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_ms_MSTensor_createTensorByNative(JNIEnv *env, jobject thiz,
  ...
  auto tensor =
    luojianet_ms::MSTensor::CreateTensor(env->GetStringUTFChars(tensor_name, JNI_FALSE),
                                      static_cast<luojianet_ms::DataType>(data_type), c_shape, p_data, data_len);
  return jlong(tensor);
}
