...
extern "C" JNIEXPORT jintArray JNICALL Java_com_luojianet_MSTensor_getShape(JNIEnv *env, jobject thiz,
                                                                            jlong tensor_ptr) {
...
extern "C" JNIEXPORT jint JNICALL Java_com_luojianet_MSTensor_getDataType(JNIEnv *env, jobject thiz, jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
...
extern "C" JNIEXPORT jbyteArray JNICALL Java_com_luojianet_MSTensor_getByteData(JNIEnv *env, jobject thiz,
                                                                                jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
...
extern "C" JNIEXPORT jlongArray JNICALL Java_com_luojianet_MSTensor_getLongData(JNIEnv *env, jobject thiz,
                                                                                jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
...
extern "C" JNIEXPORT jintArray JNICALL Java_com_luojianet_MSTensor_getIntData(JNIEnv *env, jobject thiz,
                                                                              jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
...
extern "C" JNIEXPORT jfloatArray JNICALL Java_com_luojianet_MSTensor_getFloatData(JNIEnv *env, jobject thiz,
                                                                                  jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_MSTensor_setData(JNIEnv *env, jobject thiz, jlong tensor_ptr,
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_luojianet_MSTensor_setByteBufferData(JNIEnv *env, jobject thiz,
...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_MSTensor_size(JNIEnv *env, jobject thiz, jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
    return 0;
...
extern "C" JNIEXPORT jint JNICALL Java_com_luojianet_MSTensor_elementsNum(JNIEnv *env, jobject thiz, jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
    return 0;
...
extern "C" JNIEXPORT void JNICALL Java_com_luojianet_MSTensor_free(JNIEnv *env, jobject thiz, jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
    return;
...
extern "C" JNIEXPORT jstring JNICALL Java_com_luojianet_MSTensor_tensorName(JNIEnv *env, jobject thiz,
                                                                            jlong tensor_ptr) {
  auto *pointer = reinterpret_cast<void *>(tensor_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Tensor pointer from java is nullptr");
...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_MSTensor_createTensorByNative(JNIEnv *env, jobject thiz,
  ...
  auto tensor =
    luojianet_ms::MSTensor::CreateTensor(env->GetStringUTFChars(tensor_name, JNI_FALSE),
                                      static_cast<luojianet_ms::DataType>(data_type), c_shape, tensor_data, data_len);
  return jlong(tensor);
}
