...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_config_TrainCfg_createTrainCfg(JNIEnv *env, jobject thiz,
                                                                                     jstring loss_name,
...
extern "C" JNIEXPORT jlong JNICALL Java_com_luojianet_config_TrainCfg_addMixPrecisionCfg(JNIEnv *env, jobject thiz,
                                                                                         jlong train_cfg_ptr,
...
extern "C" JNIEXPORT void JNICALL Java_com_luojianet_config_TrainCfg_free(JNIEnv *env, jobject thiz,
                                                                          jlong train_cfg_ptr) {
  auto *pointer = reinterpret_cast<void *>(train_cfg_ptr);
  if (pointer == nullptr) {
    MS_LOGE("Context pointer from java is nullptr");
