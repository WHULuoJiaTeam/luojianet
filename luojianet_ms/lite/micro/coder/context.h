...
#ifndef LUOJIANET_MS_LITE_MICRO_CODER_CODER_CONTEXT_H_
#define LUOJIANET_MS_LITE_MICRO_CODER_CODER_CONTEXT_H_
#include <map>
#include <memory>
#include <set>
#include <stack>
...
#endif  // LUOJIANET_MS_LITE_MICRO_CODER_CONTEXT_H_
