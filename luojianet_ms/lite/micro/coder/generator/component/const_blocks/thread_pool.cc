...
#ifndef LUOJIANET_MS_LITE_MICRO_CODER_THREAD_WRAPPER_H
#define LUOJIANET_MS_LITE_MICRO_CODER_THREAD_WRAPPER_H
...
#endif  // LUOJIANET_MS_LITE_MICRO_CODER_THREAD_WRAPPER_H
