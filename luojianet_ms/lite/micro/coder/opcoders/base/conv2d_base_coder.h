...
#ifndef LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_BASE_CONV2D_BASE_CODER_H_
#define LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_BASE_CONV2D_BASE_CODER_H_
...
class Conv2DBaseCoder : public OperatorCoder {
 ...
 protected:
  ...
  std::string LayoutTransformFp32(luojianet_ms::Format src_format, luojianet_ms::Format dst_format);

  std::string LayoutTransformInt8(luojianet_ms::Format src_format, luojianet_ms::Format dst_format);

  std::string LayoutTransform(TypeId data_type, luojianet_ms::Format src_format, luojianet_ms::Format dst_format);
...
#endif  // LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_BASE_CONV2D_BASE_CODER_H_
