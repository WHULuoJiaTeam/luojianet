...
#ifndef LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_REDUCE_BASE_CODER_H
#define LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_REDUCE_BASE_CODER_H
...
#endif  // LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_REDUCE_BASE_CODER_H
