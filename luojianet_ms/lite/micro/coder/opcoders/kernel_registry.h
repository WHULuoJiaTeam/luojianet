...
#ifndef LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_KERNEL_REGISTER_H_
#define LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_KERNEL_REGISTER_H_
...
#endif  // LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_KERNEL_REGISTER_H_
