...
#ifndef LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_NNACL_ADDN_FP32_CODER_H_
#define LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_NNACL_ADDN_FP32_CODER_H_
#include <vector>
...
#endif  // LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_NNACL_ADDN_FP32_CODER_H_
