 ...
 */
#ifndef LUOJIANET_MS_LITE_MICRO_OPCODERS_OP_CODER_BUILDER_H_
#define LUOJIANET_MS_LITE_MICRO_OPCODERS_OP_CODER_BUILDER_H_
...
class OpCoderBuilder {
 ...
 private:
  ...
  const luojianet_ms::lite::Model::Node *node_ = nullptr;
...
#endif  // LUOJIANET_MS_LITE_MICRO_OPCODERS_OP_CODER_BUILDER_H_
