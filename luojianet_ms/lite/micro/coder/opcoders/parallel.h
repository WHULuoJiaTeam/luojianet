...
#ifndef LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_PARALLEL_H_
#define LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_PARALLEL_H_
...
#endif  // LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_PARALLEL_H_
