...
#ifndef LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_SERIALIZERS_SERIALIZER_H_
#define LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_SERIALIZERS_SERIALIZER_H_
...
#endif  // LUOJIANET_MS_LITE_MICRO_CODER_SERIALIZERS_SERIALIZER_H_
