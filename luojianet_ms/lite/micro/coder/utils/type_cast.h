...
#ifndef LUOJIANET_MS_LITE_MICRO_CODER_UTILS_TYPE_CAST_H_
#define LUOJIANET_MS_LITE_MICRO_CODER_UTILS_TYPE_CAST_H_
...
std::string EnumMicroTensorFormat(luojianet_ms::Format format);
...
#endif  // LUOJIANET_MS_LITE_MICRO_CODER_UTILS_TYPE_CAST_H_
