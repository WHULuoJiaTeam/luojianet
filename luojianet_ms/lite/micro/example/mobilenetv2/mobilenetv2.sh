...
LUOJIANET_MS_ROOT_DIR=${BASEPATH%%/luojianet_ms/lite/micro/example/mobilenetv2}
...
download_inference() {
    ...
    local LUOJIANET_MS_LITE_DOWNLOAD_URL="https://ms-release.obs.cn-north-4.myhuaweicloud.com/${VERSION_STR}/LuoJiaNet/lite/release/android/${LUOJIANET_MS_FILE}"
...
download_mobile() {
    local MOBILE_DOWNLOAD_URL=https://download.luojianet_ms.cn/model_zoo/official/lite/mobilenetv2_imagenet/r1.2/${MOBILE_FILE}
...
gen_mobile() {
    local CODEGEN_FILE_NAME="luojianet_ms-lite-${VERSION_STR}-linux-x64"
    local CODEGEN_FILE="${CODEGEN_FILE_NAME}.tar.gz"
    local CODEGEN_LITE_DOWNLOAD_URL="https://ms-release.obs.cn-north-4.myhuaweicloud.com/${VERSION_STR}/LuoJiaNet/lite/release/linux/${CODEGEN_FILE}"
