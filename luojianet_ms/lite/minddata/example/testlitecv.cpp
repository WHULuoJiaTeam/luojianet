...
using luojianet_ms::dataset::Execute;
using luojianet_ms::dataset::LDataType;
using luojianet_ms::dataset::LiteMat;
using luojianet_ms::dataset::PaddBorderType;
...
int main(int argc, char **argv) {
  ...
  luojianet_ms::MSTensor image("file", luojianet_ms::DataType::kNumberTypeUInt8, {static_cast<int64_t>(size)}, nullptr, size);
