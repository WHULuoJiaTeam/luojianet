 ...
 */
#ifndef LUOJIANET_MS_LITE_MINDDATA_WRAPPER_ALBUM_OP_ANDROID_H_
#define LUOJIANET_MS_LITE_MINDDATA_WRAPPER_ALBUM_OP_ANDROID_H_
...
#endif  // LUOJIANET_MS_LITE_MINDDATA_WRAPPER_ALBUM_OP_ANDROID_H_
