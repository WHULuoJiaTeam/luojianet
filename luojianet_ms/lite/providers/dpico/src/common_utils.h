...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_ARM_FP32_COMMON_UTILS_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_ARM_FP32_COMMON_UTILS_H_
...
bool InferDone(const std::vector<luojianet_ms::MSTensor> &tensors);

void ExtractAttrsFromPrimitive(const luojianet_ms::schema::Primitive *primitive,
