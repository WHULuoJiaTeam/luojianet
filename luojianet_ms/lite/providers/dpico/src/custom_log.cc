...
int StrToInt(const char *env) {
  if (env == nullptr) {
    return static_cast<int>(luojianet_ms::DpicoLogLevel::WARNING);
  }
  if (strcmp(env, "0") == 0) {
    return static_cast<int>(luojianet_ms::DpicoLogLevel::DEBUG);
  }
  if (strcmp(env, "1") == 0) {
    return static_cast<int>(luojianet_ms::DpicoLogLevel::INFO);
  }
  if (strcmp(env, "2") == 0) {
    return static_cast<int>(luojianet_ms::DpicoLogLevel::WARNING);
  }
  if (strcmp(env, "3") == 0) {
    return static_cast<int>(luojianet_ms::DpicoLogLevel::ERROR);
  }
  return static_cast<int>(luojianet_ms::DpicoLogLevel::WARNING);
}
...
bool IsPrint(int level) {
  ...
  if (level < 0) {
    level = static_cast<int>(luojianet_ms::DpicoLogLevel::WARNING);
  }
