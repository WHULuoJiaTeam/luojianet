...
int NnieCommCreate(NnieRunCfg *nnie_run_cfg, char *model_buf, int size,
                   const std::vector<luojianet_ms::MSTensor> &inputs) {
  HI_U8 *vir_addr = nullptr;
  HI_U32 seg_num;
  HI_U32 off_set;
  HI_U32 total_size;
...
int NnieCommFillData(NnieRunCfg *nnie_run_cfg, void *data, luojianet_ms::DataType dtype, int64_t *shape, int size,
                     int tensor_index) {
  HI_U32 ret = 0;
  int id = tensor_index;
