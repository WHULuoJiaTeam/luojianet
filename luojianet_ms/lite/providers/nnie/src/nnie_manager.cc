...
int NNIEManager::Init(char *model_buf, int size, const std::vector<luojianet_ms::MSTensor> &inputs) {
...
int NNIEManager::Run(std::vector<luojianet_ms::MSTensor> *outputs, unsigned int seg_id,
...
int NNIEManager::GetOutputData(std::vector<luojianet_ms::MSTensor> *outputs,
...
int NNIEManager::FillRoiPooling(luojianet_ms::MSTensor *input) {
...
int NNIEManager::FillData(std::vector<luojianet_ms::MSTensor> *inputs, unsigned int seg_id) {
  bool run_box = false;
  size_t i, j;
