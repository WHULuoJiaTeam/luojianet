...
#ifndef LUOJIANET_MS_LITE_SRC_CONTROLFLOW_ENTRANCE_ACTOR_H_
#define LUOJIANET_MS_LITE_SRC_CONTROLFLOW_ENTRANCE_ACTOR_H_
#include <vector>
#include <memory>
#include <string>
...
#endif  // LUOJIANET_MS_LITE_SRC_CONTROLFLOW_ENTRANCE_ACTOR_H_
