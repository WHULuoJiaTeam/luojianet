...
#ifndef LUOJIANET_MS_LITE_SRC_CONTROL_FLOW_SCHEDULER_H_
#define LUOJIANET_MS_LITE_SRC_CONTROL_FLOW_SCHEDULER_H_
#include <string>
#include <vector>
#include <memory>
#include <utility>
...
class ControlFlowScheduler {
 public:
  ControlFlowScheduler(InnerContext *ctx, const luojianet_ms::Context *ms_ctx, std::vector<Tensor *> *src_tensors)
...
#endif  // LUOJIANET_MS_LITE_SRC_CONTROL_FLOW_SCHEDULER_H_
