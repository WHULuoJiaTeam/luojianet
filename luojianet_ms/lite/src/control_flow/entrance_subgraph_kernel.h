...
#ifndef LUOJIANET_MS_LITE_SRC_ENTRANCE_SUBGRAPH_KERNEL_H_
#define LUOJIANET_MS_LITE_SRC_ENTRANCE_SUBGRAPH_KERNEL_H_
#include <atomic>
#include <utility>
#include <string>
#include <vector>
...
#endif  // LUOJIANET_MS_LITE_SRC_ENTRANCE_SUBGRAPH_KERNEL_H_
