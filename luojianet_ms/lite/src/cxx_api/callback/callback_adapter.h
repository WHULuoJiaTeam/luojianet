...
#ifndef LUOJIANET_MS_LITE_SRC_CXX_API_CALLBACK_CALLBACK_ADAPTER_H_
#define LUOJIANET_MS_LITE_SRC_CXX_API_CALLBACK_CALLBACK_ADAPTER_H_
...
#endif  // LUOJIANET_MS_LITE_SRC_CXX_API_CALLBACK_CALLBACK_ADAPTER_H_
