...
constexpr auto kModelOptionCpuEnableFP16 = "luojianet_ms.option.cpu.enable_fp16";
constexpr auto kModelOptionGPUEnableFP16 = "luojianet_ms.option.gpu.enable_fp16";
#ifdef ENABLE_OPENGL_TEXTURE
constexpr auto kModelOptionGPUEnableGLTexture = "luojianet_ms.option.gpu.enable_gl_texture_";
constexpr auto kModelOptionGPUGLContext = "luojianet_ms.option.gpu.gl_context_";
constexpr auto kModelOptionGPUGLDisplay = "luojianet_ms.option.gpu.gl_display_";
#endif
constexpr auto kModelOptionGPUDeviceID = "luojianet_ms.option.gpu.device_id";
constexpr auto kModelOptionGPURankID = "luojianet_ms.option.gpu.rank_id";
constexpr auto kModelOptionGPUGroupSize = "luojianet_ms.option.gpu.group_size";
constexpr auto kModelOptionKirinNpuFrequency = "luojianet_ms.option.kirin_npu.frequency";
constexpr auto kModelOptionProvider = "luojianet_ms.option.provider";
constexpr auto kModelOptionProviderDevice = "luojianet_ms.option.provider.device";
constexpr auto kModelOptionDeviceID = "luojianet_ms.option.device_id";
constexpr auto kModelOptionAscendDeviceID = kModelOptionDeviceID;
constexpr auto kModelOptionAscendInsertOpCfgPath = "luojianet_ms.option.ascend.insert_op_config_file_path";
constexpr auto kModelOptionAscendInputFormat = "luojianet_ms.option.ascend.input_format";
constexpr auto kModelOptionAscendInputShapeMap = "luojianet_ms.option.ascend.input_shape_map";
constexpr auto kModelOptionAscendInputShape = "luojianet_ms.option.ascend.input_shape";
constexpr auto kModelOptionAscendOutputType = "luojianet_ms.option.ascend.output_type";
constexpr auto kModelOptionAscendPrecisionMode = "luojianet_ms.option.ascend.precision_mode";
constexpr auto kModelOptionAscendOpSelectImplMode = "luojianet_ms.option.ascend.op_select_impl_mode";
constexpr auto KModelOptionAscendFusionSwitchCfgPath = "luojianet_ms.option.ascend.fusion_switch_config_file_path";
constexpr auto kModelOptionAscendDynamicBatchSize = "luojianet_ms.option.ascend.dynamic_batch_size";
constexpr auto kModelOptionAscendDynamicImageSize = "luojianet_ms.option.ascend.dynamic_image_size";
constexpr auto kModelOptionAscendBufferOptimize = "luojianet_ms.option.ascend.buffer_optimize";
