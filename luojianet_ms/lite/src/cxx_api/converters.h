 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_CXX_API_CONVERTERS_H_
#define LUOJIANET_MS_LITE_SRC_CXX_API_CONVERTERS_H_
...
inline lite::QuantizationType A2L_ConvertQT(luojianet_ms::QuantizationType qt) {
  if (qt == kNoQuant) {
    return lite::QT_NONE;
  }
  if (qt == kWeightQuant) {
...
#endif  // LUOJIANET_MS_LITE_SRC_CXX_API_CONVERTERS_H_
