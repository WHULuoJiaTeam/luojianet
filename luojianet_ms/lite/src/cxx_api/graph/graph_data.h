...
#ifndef LUOJIANET_MS_LITE_SRC_CXX_API_GRAPH_GRAPH_DATA_H_
#define LUOJIANET_MS_LITE_SRC_CXX_API_GRAPH_GRAPH_DATA_H_
...
#endif  // LUOJIANET_MS_LITE_SRC_CXX_API_GRAPH_GRAPH_DATA_H_
