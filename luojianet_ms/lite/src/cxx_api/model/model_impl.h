...
#ifndef LUOJIANET_MS_LITE_SRC_CXX_API_MODEL_MODEL_IMPL_H_
#define LUOJIANET_MS_LITE_SRC_CXX_API_MODEL_MODEL_IMPL_H_
...
#endif  // LUOJIANET_MS_LITE_SRC_CXX_API_MODEL_MODEL_IMPL_H_
