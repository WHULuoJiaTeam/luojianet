 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_CXX_API_MODEL_POOL_MODEL_POOL_H_
#define LUOJIANET_MS_LITE_SRC_CXX_API_MODEL_POOL_MODEL_POOL_H_
#include <vector>
...
class ModelPool {
 ...
 private:
  ...
  Status InitDefaultContext(const std::shared_ptr<luojianet_ms::Context> &context);
  std::shared_ptr<Context> InitUserDefineContext(const std::shared_ptr<RunnerConfig> &runner_config);
  Status SetDefaultOptimalModelNum(const std::shared_ptr<luojianet_ms::Context> &context);
...
#endif  // LUOJIANET_MS_LITE_SRC_CXX_API_MODEL_POOL_MODEL_POOL_H_
