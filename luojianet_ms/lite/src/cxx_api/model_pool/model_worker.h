...
#ifndef LUOJIANET_MS_LITE_SRC_CXX_API_MODEL_POOL_MODEL_WORKER_H_
#define LUOJIANET_MS_LITE_SRC_CXX_API_MODEL_POOL_MODEL_WORKER_H_
#include <queue>
#include <string>
#include <mutex>
#include <future>
...
class ModelWorker {
 ...
 private:
  ...
  std::shared_ptr<luojianet_ms::Model> model_ = nullptr;
  std::mutex mtx_model_;
  bool need_copy_output_ = true;
};
}  // namespace luojianet_ms
#endif  // LUOJIANET_MS_LITE_SRC_CXX_API_MODEL_POOL_MODEL_WORKER_H_
