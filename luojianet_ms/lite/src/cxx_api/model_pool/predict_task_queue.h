 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_CXX_API_MODEL_POOL_PREDICT_TASK_QUEUE_H_
#define LUOJIANET_MS_LITE_SRC_CXX_API_MODEL_POOL_PREDICT_TASK_QUEUE_H_
...
#endif  // LUOJIANET_MS_LITE_SRC_CXX_API_MODEL_POOL_PREDICT_TASK_QUEUE_H_
