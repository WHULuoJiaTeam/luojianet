...
#ifndef LUOJIANET_MS_LITE_SRC_CXX_API_TENSOR_TENSOR_IMPL_H_
#define LUOJIANET_MS_LITE_SRC_CXX_API_TENSOR_TENSOR_IMPL_H_
...
class LiteTensorImpl : public luojianet_ms::MSTensor::Impl {
 public:
  LiteTensorImpl() {}
  ...
  std::shared_ptr<luojianet_ms::MSTensor::Impl> Clone() const override { return nullptr; }
...
#endif  // LUOJIANET_MS_LITE_SRC_CXX_API_TENSOR_TENSOR_IMPL_H_
