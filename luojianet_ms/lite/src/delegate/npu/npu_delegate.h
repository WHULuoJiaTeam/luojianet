...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_NPU_DELEGATE_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_NPU_DELEGATE_H_
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_DELEGATE_H_
