...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_NPU_EXECUTOR_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_NPU_EXECUTOR_H_
#include <string>
#include <memory>
#include <utility>
#include <vector>
...
class NPUExecutor {
 public:
  ...
  int Run(const std::vector<luojianet_ms::MSTensor> &in_tensors, const std::vector<luojianet_ms::MSTensor> &valid_out_tensors,
          const std::vector<luojianet_ms::MSTensor> &all_out_tensors, const std::vector<NPUOp *> &out_ops);
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_NPU_EXECUTOR_H_
