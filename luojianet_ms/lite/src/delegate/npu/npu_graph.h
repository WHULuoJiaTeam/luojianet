...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_NPU_GRAPH_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_NPU_GRAPH_H_
...
class NPUGraph : public kernel::Kernel {
 public:
  NPUGraph(std::vector<NPUOp *> npu_ops, NPUManager *npu_manager, const std::vector<luojianet_ms::MSTensor> &inputs,
  ...
  void set_input(luojianet_ms::MSTensor in_tensor, int index) override;

  void set_output(luojianet_ms::MSTensor out_tensor, int index) override;

  int FindPreNextOps();

  std::vector<NPUOp *> *GetOps() { return &npu_ops_; }

  std::vector<luojianet_ms::MSTensor *> *GetInsertTensors() { return &insert_tensors_; }
 ...
 protected:
  ...
  std::vector<luojianet_ms::MSTensor *> insert_tensors_;
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_NPU_GRAPH_H_
