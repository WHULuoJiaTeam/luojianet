...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_NPU_MANAGER_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_NPU_MANAGER_H_
#include <string>
#include <memory>
#include <utility>
#include <vector>
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_NPU_MANAGER_H_
