...
static std::set<luojianet_ms::schema::PrimitiveType> npu_specific_weight_nodes = {
...
void NPUSubGraph::set_input(luojianet_ms::MSTensor in_tensor, int index) {
...
void NPUSubGraph::set_output(luojianet_ms::MSTensor out_tensor, int index) {
...
std::shared_ptr<domi::ModelBufferData> NPUSubGraph::BuildIRModel() {
  ...
  ge::Model model(GetOMModelName(), luojianet_ms::lite::Version());
...
bool NPUSubGraph::IsSubGraphInputTensor(const luojianet_ms::MSTensor &input) {
