...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_NPU_SUBGRAPH_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_NPU_SUBGRAPH_H_
...
class NPUSubGraph : public kernel::Kernel {
 ...
 private:
  ...
  bool IsSubGraphInputTensor(const luojianet_ms::MSTensor &input);
  ...
  std::vector<luojianet_ms::MSTensor> out_tensor_sorted_;

  std::vector<luojianet_ms::MSTensor> all_tensors_from_out_ops_;
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_NPU_SUBGRAPH_H_
