...
int ConvolutionBaseNPUOp::InitWeightConst(const std::vector<luojianet_ms::MSTensor> &inputs) {
...
int ConvolutionBaseNPUOp::InitBiasConst(const std::vector<luojianet_ms::MSTensor> &inputs) {
  if (inputs.size() >= 3) {
