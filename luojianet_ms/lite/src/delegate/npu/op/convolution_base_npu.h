 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_OP_CONVOLUTION_BASE_NPU_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_OP_CONVOLUTION_BASE_NPU_H_
...
class ConvolutionBaseNPUOp : public NPUOp {
 public:
  ConvolutionBaseNPUOp(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
 ...
 protected:
  template <typename T>
  void SetQuantParam(T *conv_, const std::vector<luojianet_ms::MSTensor> &in_tensors) {
  ...
  int InitWeightConst(const std::vector<luojianet_ms::MSTensor> &inputs);
  int InitBiasConst(const std::vector<luojianet_ms::MSTensor> &inputs);
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_OP_CONVOLUTION_BASE_NPU_H_
