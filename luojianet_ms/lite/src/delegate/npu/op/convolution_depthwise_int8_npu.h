...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_OP_CONVOLUTION_DEPTHWISE_INT8_NPU_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_OP_CONVOLUTION_DEPTHWISE_INT8_NPU_H_
#include <utility>
#include <vector>
#include <string>
...
class ConvolutionDepthwiseInt8NPUOp : public ConvolutionBaseNPUOp {
 public:
  ConvolutionDepthwiseInt8NPUOp(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_OP_CONVOLUTION_DEPTHWISE_INT8_NPU_H_
