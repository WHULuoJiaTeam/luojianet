 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_OP_CONVOLUTION_INT8_NPU_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_OP_CONVOLUTION_INT8_NPU_H_
...
class ConvolutionInt8NPUOp : public ConvolutionBaseNPUOp {
 public:
  ConvolutionInt8NPUOp(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
