...
void SetFCQuantParam(hiai::op::QuantizedFullyConnection *fc, const std::vector<luojianet_ms::MSTensor> &in_tensors) {
...
int FullconnectionINT8NPUOp::SetNPUInputs(const std::vector<luojianet_ms::MSTensor> &in_tensors,
                                          const std::vector<luojianet_ms::MSTensor> &out_tensors,
