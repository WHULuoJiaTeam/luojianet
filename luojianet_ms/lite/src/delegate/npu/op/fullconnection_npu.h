...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_OP_FULLCONNECTION_NPU_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_OP_FULLCONNECTION_NPU_H_
#include <vector>
#include <string>
...
class FullconnectionNPUOp : public ConvolutionBaseNPUOp {
 public:
  FullconnectionNPUOp(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
...
NPUOp *GetNPUFCOp(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
                  const std::vector<luojianet_ms::MSTensor> &out_tensors, std::string name);
}  // namespace luojianet_ms
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_OP_FULLCONNECTION_NPU_H_
