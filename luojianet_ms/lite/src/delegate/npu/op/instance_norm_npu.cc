...
int InstanceNormNPUOp::Init(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
  ...
  if (in_tensors.at(0).format() != luojianet_ms::Format::NHWC && in_tensors.at(0).format() != luojianet_ms::Format::NHWC) {
...
int InstanceNormNPUOp::SetNPUInputs(const std::vector<luojianet_ms::MSTensor> &in_tensors,
                                    const std::vector<luojianet_ms::MSTensor> &out_tensors,
