...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_OP_REDUCE_NPU_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_OP_REDUCE_NPU_H_
#include <vector>
#include <string>
...
class ReduceNPUOp : public NPUOp {
 public:
  ReduceNPUOp(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_NPU_REDUCE_NPU_H_
