...
#ifndef LUOJIANET_MS_LITE_SRC_DELEGATE_NPU_OP_RESHAPE_NPU_H_
#define LUOJIANET_MS_LITE_SRC_DELEGATE_NPU_OP_RESHAPE_NPU_H_
#include <vector>
#include <string>
#include <utility>
...
class ReshapeNPUOp : public NPUOp {
 public:
  ReshapeNPUOp(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
...
#endif  // LUOJIANET_MS_LITE_SRC_DELEGATE_NPU_OP_RESHAPE_NPU_H_
