...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_OP_SCALE_NPU_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_OP_SCALE_NPU_H_
#include <vector>
#include <string>
...
class ScaleNPUOp : public NPUOp {
 public:
  ScaleNPUOp(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
 ...
 private:
  ...
  int Adopt4DScale(const std::vector<ge::Operator *> &npu_inputs, const std::vector<luojianet_ms::MSTensor> &in_tensors);
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_OP_SCALE_NPU_H_
