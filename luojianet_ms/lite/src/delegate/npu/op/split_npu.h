...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_NPU_SPLIT_NPU_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_NPU_SPLIT_NPU_H_
#include <vector>
#include <string>
...
class SplitNPUOp : public NPUOp {
 public:
  SplitNPUOp(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_NPU_SPLIT_NPU_H_
