...
int StridedSliceNPUOp::IsSupport(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
...
int StridedSliceNPUOp::Init(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
                            const std::vector<luojianet_ms::MSTensor> &out_tensors) {
...
int StridedSliceNPUOp::SetNPUInputs(const std::vector<luojianet_ms::MSTensor> &in_tensors,
                                    const std::vector<luojianet_ms::MSTensor> &out_tensors,
...
int StridedSliceNPUOp::SetCast(const ge::Operator *input, const ge::Operator *cur_op,
                               const luojianet_ms::MSTensor in_tensor, const luojianet_ms::MSTensor out_tensor) {
