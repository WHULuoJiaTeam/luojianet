...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_NPU_STRIDEDSLICE_NPU_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_NPU_STRIDEDSLICE_NPU_H_
#include <vector>
#include <string>
...
class StridedSliceNPUOp : public NPUOp {
 public:
  StridedSliceNPUOp(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
  ...
  int SetCast(const ge::Operator *input, const ge::Operator *cur_op, const luojianet_ms::MSTensor in_tensor,
              const luojianet_ms::MSTensor out_tensor);
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_NPU_STRIDEDSLICE_NPU_H_
