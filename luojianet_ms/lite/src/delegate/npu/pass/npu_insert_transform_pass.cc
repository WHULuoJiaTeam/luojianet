...
std::set<luojianet_ms::schema::PrimitiveType> insert_nodes = {
...
InsertState NPUInsertTransformPass::GetInsertState(NPUOp *op) {
  ...
  std::vector<luojianet_ms::MSTensor> inputs = NPUPassUtils::GetNonConstInputs(op);
...
int NPUInsertTransformPass::InsertTransNode(NPUOp *op, NPUOp *post_op, const luojianet_ms::MSTensor &trans_in_tensor,
