...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_PASS_NPU_INSERT_TRANSFORM_PASS_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_PASS_NPU_INSERT_TRANSFORM_PASS_H_
#include <vector>
...
class NPUInsertTransformPass : public NPUBasePass {
 ...
 private:
  ...
  int InsertTransNode(NPUOp *op, NPUOp *post_op, const luojianet_ms::MSTensor &trans_in_tensor,
 ...
 private:
  ...
  std::vector<luojianet_ms::MSTensor *> *all_tensors_ = nullptr;
};
}  // namespace luojianet_ms
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_PASS_NPU_INSERT_TRANSFORM_PASS_H_
