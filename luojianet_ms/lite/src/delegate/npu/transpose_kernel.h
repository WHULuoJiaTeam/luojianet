...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_TRANSPOSE_KERNEL_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_TRANSPOSE_KERNEL_H_
#include <utility>
#include <vector>
#include <string>
...
class TransposeNPUKernel : public kernel::Kernel {
 public:
  TransposeNPUKernel(const std::vector<luojianet_ms::MSTensor> &in_tensors,
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_NPU_TRANSPOSE_KERNEL_H_
