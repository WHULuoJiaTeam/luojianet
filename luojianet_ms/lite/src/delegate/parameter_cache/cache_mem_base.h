...
#ifndef LUOJIANET_MS_LITE_PARAMETER_CACHE_MEM_BASE_H_
#define LUOJIANET_MS_LITE_PARAMETER_CACHE_MEM_BASE_H_
#include <utility>
#include <memory>
...
#endif  // LUOJIANET_MS_LITE_PARAMETER_CACHE_MEM_BASE_H_
