...
Status EmbeddingCache::Init(luojianet_ms::MSTensor host_cache_tensor, luojianet_ms::MSTensor device_tensor) {
...
Status EmbeddingCache::Init(uint32_t device_id, const void *context, luojianet_ms::MSTensor host_cache_tensor,
