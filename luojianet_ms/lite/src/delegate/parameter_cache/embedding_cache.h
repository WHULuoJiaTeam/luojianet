...
#ifndef LUOJIANET_MS_LITE_EMBEDDING_CACHE_H_
#define LUOJIANET_MS_LITE_EMBEDDING_CACHE_H_
#include <cmath>
#include <algorithm>
#include <memory>
...
class EmbeddingCache {
 public:
  ...
  ~EmbeddingCache();
  Status Init(uint32_t device_id, const void *context, luojianet_ms::MSTensor host_cache_tensor,
              luojianet_ms::MSTensor device_tensor);
 ...
 private:
  Status Init(luojianet_ms::MSTensor host_cache_tensor, luojianet_ms::MSTensor device_tensor);
