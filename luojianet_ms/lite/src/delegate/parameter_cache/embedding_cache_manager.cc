...
bool EmbeddingCacheManager::IsCacheTensor(luojianet_ms::MSTensor tensor) {
  if (host_cache_model_ == nullptr) {
    return false;
  }
...
std::vector<int64_t> EmbeddingCacheManager::GetCacheShape(luojianet_ms::MSTensor tensor) {
...
size_t EmbeddingCacheManager::GetCacheDataSize(luojianet_ms::MSTensor tensor) {
...
int EmbeddingCacheManager::CacheHandle(const std::string &tensor_name, luojianet_ms::MSTensor model_input_tensor,
