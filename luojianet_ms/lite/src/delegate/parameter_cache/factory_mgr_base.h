...
#ifndef LUOJIANET_MS_LITE_FACTORY_MGR_BASE_H_
#define LUOJIANET_MS_LITE_FACTORY_MGR_BASE_H_
#include <map>
#include <memory>
...
#define RET_COMMON_PRODUCT_REGISTRAR(KEY, PRODUCT, PRODUCT_IMPL, key, name) \
  static luojianet_ms::lite::CommonProcductRegistrar<KEY, PRODUCT, PRODUCT_IMPL> g_commonProcductRegistrar##name(key);
}  // namespace lite
}  // namespace luojianet_ms
#endif  // LUOJIANET_MS_LITE_FACTORY_MGR_BASE_H_
