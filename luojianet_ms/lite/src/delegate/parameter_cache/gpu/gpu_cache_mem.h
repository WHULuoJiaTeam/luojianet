...
#ifndef LUOJIANET_MS_LITE_PARAMETER_GPU_CACHE_MEM_H_
#define LUOJIANET_MS_LITE_PARAMETER_GPU_CACHE_MEM_H_
...
#endif  // LUOJIANET_MS_LITE_PARAMETER_GPU_CACHE_MEM_H_
