...
#ifndef LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_CDUA_IMPL_CUDNN_UTILS_H_
#define LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_CDUA_IMPL_CUDNN_UTILS_H_
...
#endif  // LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_CDUA_IMPL_CUDNN_UTILS_H_
