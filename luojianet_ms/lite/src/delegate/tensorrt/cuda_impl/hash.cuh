...
#ifndef LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_CDUA_IMPL_HASH_H_
#define LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_CDUA_IMPL_HASH_H_
...
void DoHashSwapIn(T *hash_table, const T *swap_in_value, const int *swap_in_index, const int index_size,
                  const int hash_dim, cudaStream_t cuda_stream);
#endif  // LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_CDUA_IMPL_HASH_H_
