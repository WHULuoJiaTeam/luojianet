 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_OP_ALLGATHER_TENSORRT_H_
#define LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_OP_ALLGATHER_TENSORRT_H_
#include <string>
#include <vector>
#include <memory>
#include <functional>
...
class AllGatherTensorRT : public TensorRTOp {
 public:
  AllGatherTensorRT(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
...
#endif  // LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_OP_ALLGATHER_TENSORRT_H_
