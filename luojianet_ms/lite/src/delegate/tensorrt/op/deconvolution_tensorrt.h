 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_TENSORRT_OP_DECONVOLUTION_TENSORRT_H_
#define LUOJIANET_MS_LITE_SRC_TENSORRT_OP_DECONVOLUTION_TENSORRT_H_
#include <string>
#include <vector>
...
class DeconvolutionTensorRT : public TensorRTOp {
 public:
  DeconvolutionTensorRT(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
...
#endif  // LUOJIANET_MS_LITE_SRC_TENSORRT_OP_DECONVOLUTION_TENSORRT_H_
