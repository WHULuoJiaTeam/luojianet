 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_OP_FULLYCONNECTED_TENSORRT_H_
#define LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_OP_FULLYCONNECTED_TENSORRT_H_
...
class FullyConnectedTensorRT : public TensorRTOp {
 public:
  FullyConnectedTensorRT(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
...
#endif  // LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_OP_FULLYCONNECTED_TENSORRT_H_
