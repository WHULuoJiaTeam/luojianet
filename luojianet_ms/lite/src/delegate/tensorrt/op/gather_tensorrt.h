 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_OP_GATHER_TENSORRT_H_
#define LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_OP_GATHER_TENSORRT_H_
#include <string>
#include <vector>
...
class GatherTensorRT : public TensorRTOp {
 public:
  GatherTensorRT(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
 ...
 private:
  int axis_;
  luojianet_ms::MSTensor indices_;
};
}  // namespace luojianet_ms::lite
#endif  // LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_OP_GATHER_TENSORRT_H_
