...
int LSTMTensorRT::IsSupport(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
...
int LSTMTensorRT::AddLSTMLayers() {
  ...
  luojianet_ms::MSTensor &hidden_in_init = in_tensors_[HIDDEN_IN_TENSOR_INIT];
  luojianet_ms::MSTensor &cell_in_init = in_tensors_[CELL_IN_TENSOR_INIT];
...
int LSTMTensorRT::ParseLSTMCellInputs(int layer_index, nvinfer1::ITensor *hidden_init, nvinfer1::ITensor *cell_init,
  ...
  luojianet_ms::MSTensor &input_weight = in_tensors_[INPUT_WEIGHT];
  luojianet_ms::MSTensor &state_weight = in_tensors_[STATE_WEIGHT];
  luojianet_ms::MSTensor &bias = in_tensors_[BIAS];
