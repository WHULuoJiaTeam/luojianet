 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_OP_LSTM_TENSORRT_H_
#define LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_OP_LSTM_TENSORRT_H_
#include <string>
#include <vector>
#include <array>
...
class LSTMTensorRT : public TensorRTOp {
 public:
  LSTMTensorRT(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
...
#endif  // LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_OP_LSTM_TENSORRT_H_
