...
int ReduceTensorRT::IsSupport(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
...
uint32_t ReduceTensorRT::GetAxis() {
  ...
  luojianet_ms::MSTensor axis_tensor = this->in_tensors_[1];
