 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_OP_REDUCE_TENSORRT_H_
#define LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_OP_REDUCE_TENSORRT_H_
...
class ReduceTensorRT : public TensorRTOp {
 public:
  ReduceTensorRT(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
...
#endif  // LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_OP_REDUCE_TENSORRT_H_
