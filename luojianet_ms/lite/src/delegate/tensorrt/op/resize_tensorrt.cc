...
int ResizeTensorRT::IsSupport(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
...
void ResizeTensorRT::ParseValueFromShapeTensor(const luojianet_ms::MSTensor &shape_value_tensor,
                                               std::vector<float> *out_shape) {
