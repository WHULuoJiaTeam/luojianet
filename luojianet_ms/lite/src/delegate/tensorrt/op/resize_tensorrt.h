 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_OP_RESIZE_TENSORRT_H_
#define LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_OP_RESIZE_TENSORRT_H_
...
class ResizeTensorRT : public TensorRTOp {
 public:
  ResizeTensorRT(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
 ...
 private:
  ...
  void ParseValueFromShapeTensor(const luojianet_ms::MSTensor &shape_value_tensor, std::vector<float> *out_shape);
...
#endif  // LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_OP_RESIZE_TENSORRT_H_
