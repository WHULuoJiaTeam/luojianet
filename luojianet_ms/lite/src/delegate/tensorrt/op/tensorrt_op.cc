...
std::vector<luojianet_ms::MSTensor> &TensorRTOp::inputs() { return this->in_tensors_; }

std::vector<luojianet_ms::MSTensor> &TensorRTOp::outputs() { return this->out_tensors_; }
