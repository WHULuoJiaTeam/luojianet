 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_TENSORRT_OP_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_TENSORRT_OP_
...
struct ITensorHelper {
  ...
  luojianet_ms::Format format_{Format::NHWC};
...
class TensorRTOp {
 public:
  explicit TensorRTOp(const schema::Primitive *primitive, std::vector<luojianet_ms::MSTensor> in_tensors,
                      std::vector<luojianet_ms::MSTensor> out_tensors, std::string name, schema::QuantType quant_type)
  ...
  virtual int IsSupport(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
                        const std::vector<luojianet_ms::MSTensor> &out_tensors) = 0;
 ...
 protected:
  ...
  std::vector<luojianet_ms::MSTensor> in_tensors_;

  std::vector<luojianet_ms::MSTensor> out_tensors_;
...
template <class T>
TensorRTOp *GetTensorRTOp(const schema::Primitive *primitive, const std::vector<luojianet_ms::MSTensor> &in_tensors,
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_TENSORRT_OP_
