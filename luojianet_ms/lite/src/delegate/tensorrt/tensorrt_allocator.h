...
#ifndef LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_TENSORRT_ALLOCATOR_H_
#define LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_TENSORRT_ALLOCATOR_H_
...
class TensorRTAllocator {
 public:
  ...
  void *MallocDeviceMem(const luojianet_ms::MSTensor &host_tensor, size_t size);
  ...
  int SyncMemInHostAndDevice(luojianet_ms::MSTensor host_tensor, const std::string &device_tensor_name,
...
#endif  // LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_TENSORRT_ALLOCATOR_H_
