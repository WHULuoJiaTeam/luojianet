...
nvinfer1::ITensor *TensorRTSubGraph::SetTensorRTNetworkInput(const luojianet_ms::MSTensor &in_tensor) {
...
nvinfer1::Dims TensorRTSubGraph::ParseInputDimsProfile(const luojianet_ms::MSTensor &in_tensor) {
...
ITensorHelper TensorRTSubGraph::FindTensorRTInputs(TensorRTOp *cur_op, const luojianet_ms::MSTensor &in_tensor) {
...
bool TensorRTSubGraph::IsCached(TensorRTOp *cur_op, const luojianet_ms::MSTensor &in_tensor) {
  return cache_mgr_ != nullptr && cache_mgr_->IsCacheTensor(in_tensor);
}

void TensorRTSubGraph::FindCacheTensorInfo(TensorRTOp *cur_op, luojianet_ms::MSTensor device_cache_tensor) {
...
int TensorRTSubGraph::HandleCacheTensor(TensorRTOp *cur_op, const luojianet_ms::MSTensor &in_tensor) {
