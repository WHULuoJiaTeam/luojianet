 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_TENSORRT_UTILS_H_
#define LUOJIANET_MS_LITE_SRC_DELEGATE_TENSORRT_TENSORRT_UTILS_H_
#include <vector>
#include <NvInfer.h>
...
nvinfer1::ITensor *ConvertConstantTensor(nvinfer1::INetworkDefinition *network, const luojianet_ms::MSTensor &ms_tensor,
                                         const std::string &op_name);

nvinfer1::ITensor *ConvertTensorWithExpandDims(nvinfer1::INetworkDefinition *network,
                                               const luojianet_ms::MSTensor &ms_tensor, size_t expand_shape_size,
                                               const std::string &op_name);
...
nvinfer1::Weights TransposeWeight4D(const luojianet_ms::MSTensor &ms_tensor, void **pack_weight);

nvinfer1::Weights TransposeWeight2D(const luojianet_ms::MSTensor &ms_tensor, void **pack_weight);

nvinfer1::Weights ConvertWeight(const luojianet_ms::MSTensor &ms_tensor);
...
std::string GetTensorFormat(nvinfer1::ITensor *trt_tensor, luojianet_ms::Format format, bool is_same);
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_DELEGATE_TENSORRT_UTILS_H_
