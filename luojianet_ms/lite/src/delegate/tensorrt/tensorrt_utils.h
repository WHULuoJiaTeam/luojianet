...
nvinfer1::Weights TransposeWeight(const luojianet_ms::MSTensor &ms_tensor, void **pack_weight);

nvinfer1::Weights TransposeWeightFP32(const luojianet_ms::MSTensor &ms_tensor, void **pack_weight);
