...
#ifndef LUOJIANET_MS_LITE_SRC_EXECUTOR_H_
#define LUOJIANET_MS_LITE_SRC_EXECUTOR_H_
...
class Executor {
 public:
  ...
  virtual int Resize(const std::vector<luojianet_ms::tensor::MSTensor *> &inputs,
