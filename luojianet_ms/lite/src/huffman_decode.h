...
#ifndef LUOJIANET_MS_LITE_LUOJIANET_MS_LITE_SRC_HUFFMAN_DECODE_H_
#define LUOJIANET_MS_LITE_LUOJIANET_MS_LITE_SRC_HUFFMAN_DECODE_H_
...
#endif  // LUOJIANET_MS_LITE_LUOJIANET_MS_LITE_SRC_HUFFMAN_DECODE_H_
