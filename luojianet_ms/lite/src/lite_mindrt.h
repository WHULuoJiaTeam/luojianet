...
#ifndef LUOJIANET_MS_LITE_SRC_LITE_MINDRT_H_
#define LUOJIANET_MS_LITE_SRC_LITE_MINDRT_H_
#include <vector>
#include <memory>
#include <string>
...
class LiteOpActor : public OpActor<lite::Tensor> {
 public:
  ...
  int ResizeGraphInput(const std::vector<luojianet_ms::tensor::MSTensor *> &inputs,
...
#endif  // LUOJIANET_MS_LITE_SRC_LITE_MINDRT_H_
