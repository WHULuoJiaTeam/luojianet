...
#ifndef LITE_LUOJIANET_MS_LITE_C_OPS_OP_COMPAT_REGISTER_H_
#define LITE_LUOJIANET_MS_LITE_C_OPS_OP_COMPAT_REGISTER_H_
...
#endif  // LITE_LUOJIANET_MS_LITE_C_OPS_OP_COMPAT_REGISTER_H_
