 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_OPS_OPS_DEF_H_
#define LUOJIANET_MS_LITE_SRC_OPS_OPS_DEF_H_
#include <string>
#include <map>
#include <memory>
#include <utility>
...
#define OP_SCHEMA_DEF(OP)                                                           \
  namespace luojianet_ms::lite::ops {                                                  \
  std::unique_ptr<schema::PrimitiveT> MSOp2SchemaOp(const luojianet_ms::ops::OP *op) { \
...
#endif  // LUOJIANET_MS_LITE_SRC_OPS_OPS_DEF_H_
