 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_OPS_OPS_FUNC_DECLARE_H_
#define LUOJIANET_MS_LITE_SRC_OPS_OPS_FUNC_DECLARE_H_
...
namespace luojianet_ms::lite::ops {
#define FUNC_MSOP2SCHEMAOP_DECLARE(OP) std::unique_ptr<schema::PrimitiveT> MSOp2SchemaOp(const luojianet_ms::ops::OP *op);
...
#endif
#endif  // LUOJIANET_MS_LITE_SRC_OPS_OPS_FUNC_DECLARE_H_
