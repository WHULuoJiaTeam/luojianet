...
#ifndef LUOJIANET_MS_LITE_SRC_OPS_MS_OPS_UTILS_H_
#define LUOJIANET_MS_LITE_SRC_OPS_MS_OPS_UTILS_H_
...
std::unique_ptr<schema::PrimitiveT> GetPrimitiveT(const luojianet_ms::AnfNodePtr &node);
}  // namespace lite
}  // namespace luojianet_ms
#endif

#endif  // LUOJIANET_MS_LITE_SRC_OPS_MS_OPS_UTILS_H_
