...
#ifndef LUOJIANET_MS_LITE_SRC_OPS_POPULATE_POPULATE_REGISTER_H_
#define LUOJIANET_MS_LITE_SRC_OPS_POPULATE_POPULATE_REGISTER_H_
...
#endif  // LUOJIANET_MS_LITE_SRC_OPS_POPULATE_POPULATE_REGISTER_H_
