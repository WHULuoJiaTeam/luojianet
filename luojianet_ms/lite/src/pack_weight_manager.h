...
#ifndef LUOJIANET_MS_LITE_SRC_PACK_WEIGHT_MANAGER_H_
#define LUOJIANET_MS_LITE_SRC_PACK_WEIGHT_MANAGER_H_
#include <map>
#include <string>
#include <algorithm>
#include <utility>
...
#endif  // LUOJIANET_MS_LITE_SRC_PACK_WEIGHT_MANAGER_H_
