...
#ifndef LUOJIANET_MS_LITE_SRC_REGISTRY_REGISTER_KERNEL_IMPL_H_
#define LUOJIANET_MS_LITE_SRC_REGISTRY_REGISTER_KERNEL_IMPL_H_
...
namespace luojianet_ms::registry {
...
#endif  // LUOJIANET_MS_LITE_SRC_REGISTRY_REGISTER_KERNEL_IMPL_H_
