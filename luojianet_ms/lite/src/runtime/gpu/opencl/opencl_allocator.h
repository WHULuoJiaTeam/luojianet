...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_OPENCL_ALLOCATOR_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_OPENCL_ALLOCATOR_H_
...
class OpenCLAllocator : public luojianet_ms::Allocator {
 public:
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_OPENCL_ALLOCATOR_H_
