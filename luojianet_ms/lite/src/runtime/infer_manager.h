...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_INFER_MANAGER_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_INFER_MANAGER_H_
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_INFER_MANAGER_H_
