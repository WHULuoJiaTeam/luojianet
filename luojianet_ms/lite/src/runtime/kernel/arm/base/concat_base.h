...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_ARM_CONCAT_BASE_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_ARM_CONCAT_BASE_H_
...
class ConcatBaseCPUKernel : public InnerKernel {
 public:
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_ARM_CONCAT_BASE_H_
