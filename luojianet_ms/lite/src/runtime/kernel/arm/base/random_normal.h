...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_ARM_BASE_RANDOM_NORMAL_BASE_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_ARM_BASE_RANDOM_NORMAL_BASE_H_
...
class RandomNormalCPUKernel : public InnerKernel {
 public:
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_ARM_BASE_RANDOM_NORMAL_BASE_H_
