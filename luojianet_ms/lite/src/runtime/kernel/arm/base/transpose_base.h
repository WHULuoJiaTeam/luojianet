 ...
 */
#ifndef LUOJIANET_MS_CCSRC_KERNEL_CPU_ARM_BASE_TRANSPOSE_BASE_H_
#define LUOJIANET_MS_CCSRC_KERNEL_CPU_ARM_BASE_TRANSPOSE_BASE_H_
...
#endif  // LUOJIANET_MS_CCSRC_KERNEL_CPU_ARM_BASE_TRANSPOSE_BASE_H_
