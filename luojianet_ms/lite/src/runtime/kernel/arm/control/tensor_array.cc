...
using luojianet_ms::schema::PrimitiveType_TensorArray;
using luojianet_ms::schema::PrimitiveType_TensorArrayRead;
using luojianet_ms::schema::PrimitiveType_TensorArrayWrite;
