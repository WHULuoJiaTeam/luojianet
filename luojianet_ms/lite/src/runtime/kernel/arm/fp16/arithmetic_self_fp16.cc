...
ArithmeticSelfFp16Func ArithmeticSelfFp16CPUKernel::GetArithmeticSelfFp16Fun(int primitive_type) {
  TYPE_FUNC_INFO type_func_table[] = {{luojianet_ms::schema::PrimitiveType_Abs, ElementAbsFp16},
                                      {luojianet_ms::schema::PrimitiveType_Cos, ElementCosFp16},
                                      {luojianet_ms::schema::PrimitiveType_Log, ElementLogFp16},
                                      {luojianet_ms::schema::PrimitiveType_Square, ElementSquareFp16},
                                      {luojianet_ms::schema::PrimitiveType_Sqrt, ElementSqrtFp16},
                                      {luojianet_ms::schema::PrimitiveType_Rsqrt, ElementRsqrtFp16},
                                      {luojianet_ms::schema::PrimitiveType_Sin, ElementSinFp16},
                                      {luojianet_ms::schema::PrimitiveType_LogicalNot, ElementLogicalNotFp16},
                                      {luojianet_ms::schema::PrimitiveType_Floor, ElementFloorFp16},
                                      {luojianet_ms::schema::PrimitiveType_Ceil, ElementCeilFp16},
                                      {luojianet_ms::schema::PrimitiveType_Round, ElementRoundFp16},
                                      {luojianet_ms::schema::PrimitiveType_Neg, ElementNegativeFp16},
                                      {luojianet_ms::schema::PrimitiveType_Reciprocal, ElementReciprocalFp16},
                                      {luojianet_ms::schema::PrimitiveType_Erf, ElementErfFp16}};
