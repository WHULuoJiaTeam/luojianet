...
using luojianet_ms::lite::kCHWDimNumber;
using luojianet_ms::lite::KernelRegistrar;
using luojianet_ms::lite::kHWDimNumber;
using luojianet_ms::lite::kNCHWDimNumber;
using luojianet_ms::lite::RET_ERROR;
using luojianet_ms::lite::RET_OK;
using luojianet_ms::schema::PrimitiveType_MatMulFusion;
