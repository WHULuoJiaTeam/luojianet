 ...
 */
#include "src/runtime/kernel/arm/fp16/resize_fp16.h"
#include <map>
#include <utility>
...
using luojianet_ms::lite::RET_INVALID_OP_ATTR;
using luojianet_ms::lite::RET_NULL_PTR;
using luojianet_ms::lite::RET_OK;
using luojianet_ms::schema::CoordinateTransformMode_ALIGN_CORNERS;
using luojianet_ms::schema::CoordinateTransformMode_ASYMMETRIC;
using luojianet_ms::schema::CoordinateTransformMode_HALF_PIXEL;
using luojianet_ms::schema::PrimitiveType_Resize;
