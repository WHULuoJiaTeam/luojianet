...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_ARM_FP32_SPARSITY_NHWC_SPMM_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_ARM_FP32_SPARSITY_NHWC_SPMM_H_
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_ARM_FP32_SPARSITY_NHWC_SPMM_H_
