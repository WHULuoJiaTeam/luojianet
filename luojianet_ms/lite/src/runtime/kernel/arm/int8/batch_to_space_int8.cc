...
using luojianet_ms::schema::PrimitiveType_BatchToSpace;
using luojianet_ms::schema::PrimitiveType_BatchToSpaceND;
...
int BatchToSpaceInt8CPUKernel::Prepare() {
  ...
  MS_ASSERT(in_tensors_.front()->format() == luojianet_ms::NHWC);
