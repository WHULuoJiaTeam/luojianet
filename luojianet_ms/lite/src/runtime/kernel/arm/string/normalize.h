 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_ARM_STRING_NORMALIZE_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_ARM_STRING_NORMALIZE_H_
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_KERNEL_ARM_STRING_NORMALIZE_H_
