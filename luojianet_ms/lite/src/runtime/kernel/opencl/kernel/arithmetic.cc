...
using luojianet_ms::lite::opencl::ImageSize;
using luojianet_ms::lite::opencl::MemType;
using luojianet_ms::schema::ActivationType_NO_ACTIVATION;
using luojianet_ms::schema::ActivationType_RELU;
using luojianet_ms::schema::ActivationType_RELU6;
using luojianet_ms::schema::EltwiseMode_MAXIMUM;
using luojianet_ms::schema::EltwiseMode_PROD;
using luojianet_ms::schema::EltwiseMode_SUM;
using luojianet_ms::schema::PrimitiveType_AddFusion;
using luojianet_ms::schema::PrimitiveType_BiasAdd;
