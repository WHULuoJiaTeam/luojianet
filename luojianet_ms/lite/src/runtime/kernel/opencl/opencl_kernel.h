...
#ifndef LUOJIANET_MS_LITE_SRC_OPENCL_KERNEL_H_
#define LUOJIANET_MS_LITE_SRC_OPENCL_KERNEL_H_
...
#include "luojianet_ms/lite/src/weight_decoder.h"
...
#endif  // LUOJIANET_MS_LITE_SRC_OPENCL_KERNEL_H_
