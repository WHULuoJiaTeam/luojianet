...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_NUMA_ADAPTER_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_NUMA_ADAPTER_H_
#include <cstdint>
#include <cstddef>
#include <memory>
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_NUMA_ADAPTER_H_
