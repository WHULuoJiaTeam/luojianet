...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_OPTIMIZE_ALLOCATOR_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_OPTIMIZE_ALLOCATOR_H_
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_OPTIMIZE_ALLOCATOR_H_
