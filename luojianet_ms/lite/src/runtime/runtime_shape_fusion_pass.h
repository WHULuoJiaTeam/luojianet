...
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_RUNTIME_SHAPE_FUSION_PASS_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_RUNTIME_SHAPE_FUSION_PASS_H_
...
#endif
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_RUNTIME_SHAPE_FUSION_PASS_H_
