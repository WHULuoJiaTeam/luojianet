...
#ifndef LUOJIANET_MS_LITE_SRC_SCHEDULER_H_
#define LUOJIANET_MS_LITE_SRC_SCHEDULER_H_
...
class Scheduler {
 public:
  Scheduler(InnerContext *ctx, const luojianet_ms::Context *ms_ctx, Model *src_model, std::vector<Tensor *> *src_tensors,
 ...
 protected:
  ...
  const luojianet_ms::Context *ms_context_ = nullptr;
  Model *src_model_ = nullptr;
  std::vector<Tensor *> *src_tensors_;
  std::vector<Tensor *> *inputs_;
  std::vector<Tensor *> *outputs_;
  std::vector<luojianet_ms::MSTensor> ms_inputs_;
  std::vector<luojianet_ms::MSTensor> ms_outputs_;
...
#endif  // LUOJIANET_MS_LITE_SRC_SCHEDULER_H_
