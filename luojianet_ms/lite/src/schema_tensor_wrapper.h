...
#ifndef LUOJIANET_MS_LITE_SRC_SCHEMA_TENSOR_WRAPPER_H_
#define LUOJIANET_MS_LITE_SRC_SCHEMA_TENSOR_WRAPPER_H_
...
#endif  // LUOJIANET_MS_LITE_SRC_SCHEMA_TENSOR_WRAPPER_H_
