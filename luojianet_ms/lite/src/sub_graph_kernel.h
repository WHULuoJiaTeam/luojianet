...
#ifndef LUOJIANET_MS_LITE_SRC_SUB_GRAPH_KERNEL_H_
#define LUOJIANET_MS_LITE_SRC_SUB_GRAPH_KERNEL_H_
...
class SubGraphKernel : public LiteKernel {
 public:
  ...
  virtual int SetFp16Attr() { return luojianet_ms::lite::RET_OK; }
 ...
 protected:
  ...
  luojianet_ms::lite::Executor *executor_ = nullptr;
...
#endif  // LUOJIANET_MS_LITE_SRC_SUB_GRAPH_KERNEL_H_
