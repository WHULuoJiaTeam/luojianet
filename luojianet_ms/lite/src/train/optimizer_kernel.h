 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_TRAIN_OPTIMIZER_KERNEL_H_
#define LUOJIANET_MS_LITE_SRC_TRAIN_OPTIMIZER_KERNEL_H_
#include <vector>
#include <cmath>
#include <cfloat>
#include <algorithm>
...
using luojianet_ms::lite::RET_OUT_OF_TENSOR_RANGE;
...
#endif  // LUOJIANET_MS_LITE_SRC_TRAIN_OPTIMIZER_KERNEL_H_
