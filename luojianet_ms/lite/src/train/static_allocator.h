 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_TRAIN_STATIC_ALLOCATOR_H_
#define LUOJIANET_MS_LITE_SRC_TRAIN_STATIC_ALLOCATOR_H_
...
#endif  // LUOJIANET_MS_LITE_SRC_TRAIN_STATIC_ALLOCATOR_H_
