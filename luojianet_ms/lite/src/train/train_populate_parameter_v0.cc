...
void PopulateTrainV0Parameters() {
  ...
  lite::Registry g_softmaxCrossEntropyV0ParameterRegistry(
    schema::v0::PrimitiveType_SoftmaxCrossEntropy, PopulateSoftmaxCrossEntropyParameter, luojianet_ms::lite::SCHEMA_V0);
  ...
  lite::Registry g_activationV0ParameterRegistry(schema::v0::PrimitiveType_ActivationGrad,
                                                 PopulateActivationGradParameter, luojianet_ms::lite::SCHEMA_V0);
  ...
  lite::Registry g_conv2DGradFilterV0ParameterRegistry(
    schema::v0::PrimitiveType_Conv2DGradFilter, PopulateConvolutionGradFilterParameter, luojianet_ms::lite::SCHEMA_V0);
  lite::Registry g_conv2DGradInputV0ParameterRegistry(
    schema::v0::PrimitiveType_Conv2DGradInput, PopulateConvolutionGradInputParameter, luojianet_ms::lite::SCHEMA_V0);
  ...
  lite::Registry g_unsortedSegmentSumV0ParameterRegistry(schema::v0::PrimitiveType_UnsortedSegmentSum,
                                                         DefaultPopulateParameter, luojianet_ms::lite::SCHEMA_V0);
  ...
  lite::Registry g_maximumGradV0ParameterRegistry(schema::v0::PrimitiveType_MaximumGrad,
                                                  PopulateArithmeticGradParameter, luojianet_ms::lite::SCHEMA_V0);
  ...
  lite::Registry g_smoothL1LossGradRegistry(schema::v0::PrimitiveType_SmoothL1LossGrad,
                                            PopulateSmoothL1LossGradParameter, luojianet_ms::lite::SCHEMA_V0);
  ...
  lite::Registry g_sigmoidCrossEntropyWithLogitsGradRegistry(
    schema::v0::PrimitiveType_SigmoidCrossEntropyWithLogitsGrad, DefaultPopulateParameter, luojianet_ms::lite::SCHEMA_V0);
}
}  // namespace luojianet_ms::kernel
