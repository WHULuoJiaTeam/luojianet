 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_TRAIN_TRAIN_SESSION_H_
#define LUOJIANET_MS_LITE_SRC_TRAIN_TRAIN_SESSION_H_
#include <vector>
#include <string>
#include <tuple>
...
namespace lite {
using CreatorOp = std::tuple<luojianet_ms::kernel::KernelKey, luojianet_ms::kernel::KernelCreator>;
class TrainSession : virtual public lite::LiteSession {
 public:
  ...
  luojianet_ms::tensor::MSTensor *GetInputsByTensorName(const std::string &tensor_name) const override {
 ...
 protected:
  ...
  // TrainCfg train_cfg_;
  std::unordered_map<std::string, std::vector<luojianet_ms::tensor::MSTensor *>> orig_output_node_map_;
  std::unordered_map<std::string, luojianet_ms::tensor::MSTensor *> orig_output_tensor_map_;
  std::vector<std::string> orig_output_tensor_names_;

  std::unordered_map<std::string, std::vector<luojianet_ms::tensor::MSTensor *>> eval_output_node_map_;
  std::unordered_map<std::string, luojianet_ms::tensor::MSTensor *> eval_output_tensor_map_;
  std::vector<std::string> eval_output_tensor_names_;

  std::unordered_map<std::string, std::vector<luojianet_ms::tensor::MSTensor *>> train_output_node_map_;
  std::unordered_map<std::string, luojianet_ms::tensor::MSTensor *> train_output_tensor_map_;
...
#endif  // LUOJIANET_MS_LITE_SRC_TRAIN_TRAIN_SESSION_H_
