 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_TRAIN_TRANSFER_SESSION_H_
#define LUOJIANET_MS_LITE_SRC_TRAIN_TRANSFER_SESSION_H_
#include <vector>
#include <string>
#include <tuple>
...
class TransferSession : public lite::TrainSession {
 ...
 protected:
  ...
  std::vector<luojianet_ms::tensor::MSTensor *> combined_inputs_;
  std::vector<std::pair<luojianet_ms::tensor::MSTensor *, luojianet_ms::tensor::MSTensor *>> backbone_head_map_;
...
#endif  // LUOJIANET_MS_LITE_SRC_TRAIN_TRANSFER_SESSION_H_
