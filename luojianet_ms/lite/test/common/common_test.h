 ...
 */
#ifndef LUOJIANET_MS_LITE_TEST_COMMON_COMMON_TEST_H_
#define LUOJIANET_MS_LITE_TEST_COMMON_COMMON_TEST_H_
...
#endif  // LUOJIANET_MS_LITE_TEST_COMMON_COMMON_TEST_H_
