...
class DelegateTest : public luojianet_ms::CommonTest {
 public:
  DelegateTest() {}
};
...
class CustomSubgraph : public kernel::Kernel {
 public:
  CustomSubgraph(const std::vector<luojianet_ms::MSTensor> &inputs, const std::vector<luojianet_ms::MSTensor> &outputs)
...
class CustomDelegate : public Delegate {
 public:
  ...
  Status Init() override { return luojianet_ms::kSuccess; }
