...
function Run_Converter() {
    ...
    export BENCHMARK_PATH=${x86_path}/luojianet_ms-lite-${version}-linux-x64/tools/benchmark/benchmark
...
function Run_Hi3516() {
  ...
  cp -a ./runtime/lib/libluojianet-lite.so ${benchmark_test_path}/libluojianet-lite.so || exit 1
