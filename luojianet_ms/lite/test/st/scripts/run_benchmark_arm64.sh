...
models_luojianet_ms_fp16_config=${basepath}/../${config_folder}/models_luojianet_ms_fp16.cfg
...
if [[ $backend == "arm64_tflite" ]]; then
  ...
  fp32_cfg_file_list=("$models_luojianet_ms_config")
  fp16_cfg_file_list=("$models_luojianet_ms_fp16_config")
  ...
  fp32_cfg_file_list=("$models_tf_config" "$models_tflite_config" "$models_caffe_config" "$models_onnx_config" "$models_luojianet_ms_config" \
  ...
  fp16_cfg_file_list=("$models_onnx_fp16_config" "$models_caffe_fp16_config" "$models_tflite_fp16_config" "$models_tf_fp16_config" \
                      "$models_process_only_fp16_config" "$models_luojianet_ms_fp16_config")
fi
