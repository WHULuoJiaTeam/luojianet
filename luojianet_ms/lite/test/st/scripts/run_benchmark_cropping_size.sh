...
function Run_cropping() {
    ...
    ls -l libluojianet-lite.a || exit 1
    ls -l -h libluojianet-lite.a || exit 1
    ls -l -h libluojianet-lite.so || exit 1

    echo "./cropper/cropper --packageFile=./libluojianet-lite.a --configFile=./cropper/cropper_mapping_cpu.cfg --modelFile=${ms_models_path}/${model_name}.ms --outputFile=./libluojianet-lite-${model_name}.a"
    ./cropper/cropper --packageFile=./libluojianet-lite.a --configFile=./cropper/cropper_mapping_cpu.cfg --modelFile=${ms_models_path}/${model_name}.ms --outputFile=./libluojianet-lite-${model_name}.a
    ...
    echo "after cropped:"
    ls -l libluojianet-lite-${model_name}.a || exit 1
    ls -l -h libluojianet-lite-${model_name}.a || exit 1
    mkdir -p mm || exit 1
    cp libluojianet-lite-${model_name}.a mm/ || exit 1
    cd mm/ || exit 1
    ar -x libluojianet-lite-${model_name}.a || exit 1
    ar -d libluojianet-lite-${model_name}.a  *.S.o || exit 1
    cd ../ || exit 1
    echo "after ar -d libluojianet-lite-${model_name}.a  *.S.o"
    ls -l mm/libluojianet-lite-${model_name}.a || exit 1
    ls -l -h mm/libluojianet-lite-${model_name}.a || exit 1
    ...
    -shared -Wl,-soname,libluojianet-lite.so -o libluojianet-lite.so \
    -Wl,--whole-archive ./mm/libluojianet-lite-${model_name}.a -Wl,--no-whole-archive  \
    -llog -ldl -latomic -lm
    ...
    ls -l libluojianet-lite.so  || exit 1
    ls -l -h libluojianet-lite.so  || exit 1
    so_size=`ls libluojianet-lite.so  -l|awk -F ' ' '{print $5}'`
