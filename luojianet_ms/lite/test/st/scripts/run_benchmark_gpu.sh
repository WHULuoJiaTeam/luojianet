...
function Run_Converter() {
    ...
    if [[ $backend == "gpu_gl_texture" ]]; then
        ...
        local cfg_file_list=("$models_onnx_gpu_fp32_config" "$models_luojianet_ms_gpu_fp32_config")
...
function Run_gpu() {
    ...
    if [[ $backend == "gpu_gl_texture" ]]; then
        ...
        local gpu_cfg_file_list=("$models_luojianet_ms_gpu_fp32_config" "$models_luojianet_ms_gpu_fp16_config"
...
models_luojianet_ms_gpu_fp32_config=${basepath}/../${config_folder}/models_luojianet_ms_gpu_fp32.cfg
models_luojianet_ms_gpu_fp16_config=${basepath}/../${config_folder}/models_luojianet_ms_gpu_fp16.cfg
