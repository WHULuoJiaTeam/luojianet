...
function Run_cropper() {
    ...
    cp -a ./runtime/lib/libluojianet-lite.a "${cropper_test_path}"/libluojianet-lite.a || exit 1
    ...
    while read line; do
        ...
        echo "./cropper/cropper --packageFile=./libluojianet-lite.a --configFile=./cropper/cropper_mapping_npu.cfg --modelFile=${ms_models_path}/${model_name}.ms --outputFile=./libluojianet-lite-${model_name}.a"
         ./cropper/cropper --packageFile=./libluojianet-lite.a --configFile=./cropper/cropper_mapping_npu.cfg --modelFile=${ms_models_path}/${model_name}.ms --outputFile=./libluojianet-lite-${model_name}.a
       ...
       "${ANDROID_NDK}"/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -Wl,--whole-archive ./libluojianet-lite-${model_name}.a \
       ...
       -shared -Wl,-soname,libluojianet-lite.so -o libluojianet-lite.so -llog -ldl -latomic -lm
        ...
        adb -s ${device_id} push "${cropper_test_path}"/libluojianet-lite.so /data/local/tmp/cropper_test > adb_push_log.txt
