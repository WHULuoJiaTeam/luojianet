...
docker_image=luojianet_build:210301
function Run_Export(){
...
function Run_arm() {
    ...
    cp -a ${arm_path}/luojianet_ms-lite-${version_arm}-android-${process_unit}/runtime/lib/libluojianet-lite.so ${benchmark_train_test_path}/libluojianet-lite.so || exit 1
    cp -a ${arm_path}/luojianet_ms-lite-${version_arm}-android-${process_unit}/runtime/lib/libluojianet-lite-train.so ${benchmark_train_test_path}/libluojianet-lite-train.so || exit 1
