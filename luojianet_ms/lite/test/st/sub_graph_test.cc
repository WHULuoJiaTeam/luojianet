...
#include "luojianet_ms/lite/include/model.h"
...
class SubGraphTest : public luojianet_ms::CommonTest {
 public:
...
TEST_F(SubGraphTest, RecursiveSubGraphTest) {
  ...
  lite::MetaGraphSerializer::Save(
    *meta_graph, "/mnt/data/workspace/OpenAI/Huawei/luojianet_ms/luojianet_ms/lite/my_test/models/recursive_subgraph");
  //  -----------------------------------------------------------------------
  size_t size = 0;
  char *graph_buf = lite::ReadFile(
    "/mnt/data/workspace/OpenAI/Huawei/luojianet_ms/luojianet_ms/lite/my_test/models/recursive_subgraph.ms", &size);
