...
#include "luojianet_ms/lite/src/runtime/infer_manager.h"

namespace luojianet_ms::lite {

class InferManagerTest : public luojianet_ms::CommonTest {
 public:
  InferManagerTest() {}
};
...
TEST_F(InferManagerTest, InferManagerTest0) {
  ...
  parameter->type_ = luojianet_ms::schema::PrimitiveType_TensorListFromTensor;
...
TEST_F(InferManagerTest, InferManagerTest1) {
  ...
  OpParameter *parameter = new OpParameter;
  parameter->type_ = luojianet_ms::schema::PrimitiveType_TensorListGetItem;
