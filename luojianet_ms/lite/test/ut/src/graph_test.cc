...
#include "luojianet_ms/lite/src/executor.h"
#include "luojianet_ms/lite/schema/inner/anf_ir_generated.h"

namespace luojianet_ms {
class TestLiteInference : public luojianet_ms::CommonTest {
 public:
  TestLiteInference() {}
};
