...
class TestCustomOp : public Kernel {
 public:
  TestCustomOp(const std::vector<luojianet_ms::MSTensor> &inputs, const std::vector<luojianet_ms::MSTensor> &outputs,
...
class TestRegistryCustomOp : public luojianet_ms::CommonTest {
 public:
  TestRegistryCustomOp() = default;
  void SetUp() override {
    static luojianet_ms::registry::KernelReg g_CPUBuiltInTestkFloat32AddkernelReg("CPU", "BuiltInTest", kFloat32, "Add",
                                                                               TestCustomAddCreator);
    static luojianet_ms::registry::KernelInterfaceReg g_BuiltInTestAdd_custom_inter_reg("BuiltInTest", "Add",
