...
class TestCustomAdd : public Kernel {
 public:
  TestCustomAdd(const std::vector<luojianet_ms::MSTensor> &inputs, const std::vector<luojianet_ms::MSTensor> &outputs,
...
class TestRegistry : public luojianet_ms::CommonTest {
 public:
