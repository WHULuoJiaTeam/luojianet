...
class TestArithmeticSelfGradFp16 : public luojianet_ms::CommonTest {
 public:
...
TEST_F(TestArithmeticSelfGradFp16, LogGradFp16) {
  ...
  auto ref_data = reinterpret_cast<const float *>(luojianet_ms::lite::ReadFile(output_path.c_str(), &input_size));
