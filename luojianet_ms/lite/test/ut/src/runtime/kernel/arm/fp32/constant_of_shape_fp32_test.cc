...
#include "luojianet_ms/lite/src/runtime/kernel/arm/base/constant_of_shape.h"
#include "src/tensor_category.h"
#include "src/lite_kernel.h"

namespace luojianet_ms {
class TestConstantOfShapeFp32 : public luojianet_ms::CommonTest {
 public:
...
int ConstantOfShapeTestInit(std::vector<lite::Tensor *> *inputs_, std::vector<lite::Tensor *> *outputs_, float *a_ptr,
  ...
  auto in_t = new lite::Tensor(kNumberTypeInt32, a_shape, luojianet_ms::NHWC, lite::Category::CONST_TENSOR);
  in_t->MallocData();
