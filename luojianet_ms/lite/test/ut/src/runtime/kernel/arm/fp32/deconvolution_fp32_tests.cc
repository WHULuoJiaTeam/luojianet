...
#include "luojianet_ms/lite/src/runtime/kernel/arm/fp32/deconvolution_fp32.h"
#include "nnacl/fp32/deconv_fp32.h"
#include "nnacl/op_base.h"
#include "src/tensor_category.h"

namespace luojianet_ms {
class TestDeConvolutionFp32 : public luojianet_ms::CommonTest {
 public:
...
int DeConvTestInit1(std::vector<lite::Tensor *> *inputs_, std::vector<lite::Tensor *> *outputs_,
  ...
  auto *in_t = new lite::Tensor(kNumberTypeFloat, in_dims_nhwc, luojianet_ms::NHWC, lite::Category::CONST_TENSOR);
  in_t->MallocData();
  float in_nchw[] = {
  ...
  auto *weight_t = new lite::Tensor(kNumberTypeFloat, weight_dims_nhwc, luojianet_ms::NHWC, lite::Category::CONST_TENSOR);
  weight_t->MallocData();
  float weight_nchw[] = {
  ...
  auto *bias_t = new lite::Tensor(kNumberTypeFloat, {6}, luojianet_ms::NHWC, lite::Category::CONST_TENSOR);
  bias_t->MallocData();
  ...
  auto *out_t = new lite::Tensor(kNumberTypeFloat, output_nhwc_dims, luojianet_ms::NHWC, lite::Category::CONST_TENSOR);
  out_t->MallocData();
...
int DeConvTestInit2(std::vector<lite::Tensor *> *inputs_, std::vector<lite::Tensor *> *outputs_,
                    ConvParameter *conv_param, float **correct) {
  auto *in_t = new lite::Tensor(kNumberTypeFloat, {1, 4, 2, 3}, luojianet_ms::NHWC, lite::Category::VAR);
  in_t->MallocData();
  ...
  auto *weight_t = new lite::Tensor(kNumberTypeFloat, {3, 3, 3, 2}, luojianet_ms::NHWC, lite::Category::CONST_TENSOR);
  weight_t->MallocData();
  ...
  auto *out_t = new lite::Tensor(kNumberTypeFloat, out_nhwc_dims, luojianet_ms::NHWC, lite::Category::VAR);
  out_t->MallocData();
  outputs_->push_back(out_t);
...
int DeConvTestInit3(std::vector<lite::Tensor *> *inputs_, std::vector<lite::Tensor *> *outputs_,
  ...
  auto *in_t = new lite::Tensor(kNumberTypeFloat, in_dims_nhwc, luojianet_ms::NHWC, lite::Category::VAR);
  in_t->MallocData();
  ...
  auto *weight_t = new lite::Tensor(kNumberTypeFloat, w_dims_nhwc, luojianet_ms::NHWC, lite::Category::CONST_TENSOR);
  weight_t->MallocData();
  ...
  auto *out_t = new lite::Tensor(kNumberTypeFloat, out_dims_nhwc, luojianet_ms::NC4HW4, lite::Category::VAR);
  out_t->MallocData();
  outputs_->push_back(out_t);
