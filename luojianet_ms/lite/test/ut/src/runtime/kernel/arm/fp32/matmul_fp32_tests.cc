...
#include "luojianet_ms/lite/src/runtime/kernel/arm/fp32/matmul_fp32.h"
...
class TestMatMulFp32 : public luojianet_ms::CommonTest {
 public:
  TestMatMulFp32() {}
};
...
int MMTestInit2(std::vector<lite::Tensor *> *inputs_, std::vector<lite::Tensor *> *outputs_, float *a_ptr, float *b_ptr,
  ...
  auto bias_t = new lite::Tensor(kNumberTypeFloat, bias_shape, luojianet_ms::NHWC, lite::Category::CONST_TENSOR);
  bias_t->MallocData();
