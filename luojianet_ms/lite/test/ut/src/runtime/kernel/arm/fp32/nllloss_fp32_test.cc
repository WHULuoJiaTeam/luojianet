...
#include "luojianet_ms/lite/src/runtime/kernel/arm/fp32/nllloss_fp32.h"
#include "src/kernel_registry.h"
#include "src/lite_kernel.h"
#include "src/tensor_category.h"

namespace luojianet_ms {
class TestNLLLossFp32 : public luojianet_ms::CommonTest {
 public:
  TestNLLLossFp32() {}
};
...
void NLLLossInitArgs(std::vector<lite::Tensor *> *inputs, std::vector<lite::Tensor *> *outputs,
  ...
  auto *loss_t = new lite::Tensor(kNumberTypeFloat32, loss_shape, luojianet_ms::NC, type);
  loss_t->MallocData();
