...
#include "luojianet_ms/lite/src/runtime/kernel/arm/fp32/l2_norm_fp32.h"
#include "luojianet_ms/lite/src/runtime/kernel/arm/fp32/non_max_suppression_fp32.h"
#include "src/kernel_registry.h"
#include "src/lite_kernel.h"

namespace luojianet_ms {
class TestNMSFp32 : public luojianet_ms::CommonTest {
 public:
  TestNMSFp32() = default;
