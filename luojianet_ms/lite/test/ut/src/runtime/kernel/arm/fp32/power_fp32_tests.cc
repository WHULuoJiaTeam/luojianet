...
#include "luojianet_ms/lite/src/runtime/kernel/arm/fp32/power_fp32.h"
#include "src/kernel_registry.h"
#include "src/lite_kernel.h"
#include "src/tensor_category.h"

namespace luojianet_ms {
class TestPowerFp32 : public luojianet_ms::CommonTest {
 public:
  TestPowerFp32() {}
};
...
int PowerTestInit(std::vector<lite::Tensor *> *inputs_, std::vector<lite::Tensor *> *outputs_, float *a_ptr,
  ...
  auto weight_t = new lite::Tensor(kNumberTypeFloat, b_shape, luojianet_ms::NHWC, lite::Category::CONST_TENSOR);
  weight_t->MallocData();
