...
class TestPoolingGradFp32 : public luojianet_ms::CommonTest {
 public:
  TestPoolingGradFp32() {}
};
...
TEST_F(TestPoolingGradFp32, AvgPoolingGradFp32) {
  ...
  auto input_data = reinterpret_cast<float *>(luojianet_ms::lite::ReadFile(input_path.c_str(), &input_size));
  ...
  int loop_count = 100;
  auto time_start = luojianet_ms::lite::GetTimeUs();
  for (int i = 0; i < loop_count; i++) {
    std::fill(output_data, output_data + output_data_size, 0.f);
    AvgPoolingGrad(input_data, output_data, pooling_param->output_batch_, pooling_param);
  }
  auto time_end = luojianet_ms::lite::GetTimeUs();
...
TEST_F(TestPoolingGradFp32, AvgPoolingKernelGradFp32) {
  ...
  auto input1_data = reinterpret_cast<float *>(luojianet_ms::lite::ReadFile(input1_path.c_str(), &input_size));
...
TEST_F(TestPoolingGradFp32, AvgPoolGradStride2Fp32) {
  ...
  auto x_data =
    reinterpret_cast<float *>(luojianet_ms::lite::ReadFile("./pooling/avgpoolgradfp32_s2_x_3_28_28_3.bin", &input_size));
  ...
  auto yt_data =
    reinterpret_cast<float *>(luojianet_ms::lite::ReadFile("./pooling/avgpoolgradfp32_s2_dy_3_28_28_3.bin", &input_size));
...
TEST_F(TestPoolingGradFp32, AvgPoolGradStride3Fp32) {
  ...
  auto x_data =
    reinterpret_cast<float *>(luojianet_ms::lite::ReadFile("./pooling/avgpoolgradfp32_s3_x_3_28_28_3.bin", &input_size));
  ASSERT_NE(x_data, nullptr);
  std::vector<int> dim_x({pool->output_batch_, pool->input_h_, pool->input_w_, pool->input_channel_});
  lite::Tensor x_tensor(TypeId::kNumberTypeFloat32, dim_x);
  x_tensor.set_data(x_data);
  ...
  auto yt_data =
    reinterpret_cast<float *>(luojianet_ms::lite::ReadFile("./pooling/avgpoolgradfp32_s3_dy_3_28_28_3.bin", &input_size));
  ASSERT_NE(yt_data, nullptr);
  std::vector<int> dim_y({pool->output_batch_, pool->output_h_, pool->output_w_, pool->output_channel_});
  lite::Tensor yt_tensor(TypeId::kNumberTypeFloat32, dim_y);
  yt_tensor.set_data(yt_data);
...
TEST_F(TestPoolingGradFp32, MaxPoolingGradFp32) {
  ...
  auto in_data = reinterpret_cast<float *>(luojianet_ms::lite::ReadFile(i_path.c_str(), &input_size));
  ASSERT_NE(in_data, nullptr);

  std::string dy_path = "./pooling/maxpoolgradfp32_1_dy_1_28_28_3.bin";
  auto dy_data = reinterpret_cast<float *>(luojianet_ms::lite::ReadFile(dy_path.c_str(), &input_size));
  ASSERT_NE(dy_data, nullptr);

  std::string dx_path = "./pooling/maxpoolgradfp32_1_dx_1_28_28_3.bin";
  auto dx_data = reinterpret_cast<float *>(luojianet_ms::lite::ReadFile(dx_path.c_str(), &input_size));
...
TEST_F(TestPoolingGradFp32, MaxPoolGradBatchFp32) {
  ...
  auto x_data =
    reinterpret_cast<float *>(luojianet_ms::lite::ReadFile("./pooling/maxpoolgradfp32_1_x_3_28_28_3.bin", &input_size));
  ASSERT_NE(x_data, nullptr);
  std::vector<int> dim_x({3, 28, 28, 3});
  lite::Tensor x_tensor(TypeId::kNumberTypeFloat32, dim_x);
  x_tensor.set_data(x_data);
  ...
  auto y_data =
    reinterpret_cast<float *>(luojianet_ms::lite::ReadFile("./pooling/maxpoolgradfp32_1_dx_3_28_28_3.bin", &input_size));
  ...
  auto yt_data =
    reinterpret_cast<float *>(luojianet_ms::lite::ReadFile("./pooling/maxpoolgradfp32_1_dy_3_28_28_3.bin", &input_size));
  ASSERT_NE(yt_data, nullptr);
  lite::Tensor yt_tensor(TypeId::kNumberTypeFloat32, dim_y);
  yt_tensor.set_data(yt_data);
...
TEST_F(TestPoolingGradFp32, MaxPoolGradStride2Fp32) {
  ...
  auto x_data =
    reinterpret_cast<float *>(luojianet_ms::lite::ReadFile("./pooling/maxpoolgradfp32_s2_x_3_28_28_3.bin", &input_size));
  ASSERT_NE(x_data, nullptr);
  ...
  auto y_data =
    reinterpret_cast<float *>(luojianet_ms::lite::ReadFile("./pooling/maxpoolgradfp32_s2_dx_3_28_28_3.bin", &input_size));
  ASSERT_NE(y_data, nullptr);
  ...
  auto yt_data =
    reinterpret_cast<float *>(luojianet_ms::lite::ReadFile("./pooling/maxpoolgradfp32_s2_dy_3_28_28_3.bin", &input_size));
  ASSERT_NE(yt_data, nullptr);
  lite::Tensor yt_tensor(TypeId::kNumberTypeFloat32, dim_y);
  yt_tensor.set_data(yt_data);
...
TEST_F(TestPoolingGradFp32, MaxPoolGradStride3Fp32) {
  ...
  auto x_data =
    reinterpret_cast<float *>(luojianet_ms::lite::ReadFile("./pooling/maxpoolgradfp32_s3_x_3_28_28_3.bin", &input_size));
  ASSERT_NE(x_data, nullptr);
  std::vector<int> dim_x({maxpool->output_batch_, maxpool->input_h_, maxpool->input_w_, maxpool->input_channel_});
  lite::Tensor x_tensor(TypeId::kNumberTypeFloat32, dim_x);
  x_tensor.set_data(x_data);
  ...
  auto y_data =
    reinterpret_cast<float *>(luojianet_ms::lite::ReadFile("./pooling/maxpoolgradfp32_s3_dx_3_28_28_3.bin", &input_size));
  ASSERT_NE(y_data, nullptr);
  std::vector<int> dim_y({maxpool->output_batch_, maxpool->output_h_, maxpool->output_w_, maxpool->output_channel_});
  lite::Tensor y_tensor(TypeId::kNumberTypeFloat32, dim_y);
  y_tensor.set_data(y_data);
  ...
  auto yt_data =
    reinterpret_cast<float *>(luojianet_ms::lite::ReadFile("./pooling/maxpoolgradfp32_s3_dy_3_28_28_3.bin", &input_size));
  ASSERT_NE(yt_data, nullptr);
  lite::Tensor yt_tensor(TypeId::kNumberTypeFloat32, dim_y);
  yt_tensor.set_data(yt_data);
