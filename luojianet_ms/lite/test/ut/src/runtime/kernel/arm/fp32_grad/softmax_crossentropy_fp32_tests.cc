...
class TestSoftmaxCrossEntropyFp32 : public luojianet_ms::CommonTest {
 public:
...
TEST_F(TestSoftmaxCrossEntropyFp32, SoftmaxCrossEntropyFp32) {
  ...
  auto ll_labels = reinterpret_cast<int64_t *>(luojianet_ms::lite::ReadFile(label_path.c_str(), &input_size));
  ...
  ((luojianet_ms::kernel::SparseSoftmaxCrossEntropyWithLogitsCPUKernel *)kernel_obj)->Train();
  kernel_obj->Run();
