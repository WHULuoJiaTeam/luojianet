...
#include "luojianet_ms/lite/src/runtime/kernel/arm/fp32_grad/softmax_grad.h"
#include "nnacl/fp32_grad/softmax_grad.h"
#include "luojianet_ms/lite/src/kernel_registry.h"

namespace luojianet_ms {
class TestSoftmaxGradFp32 : public luojianet_ms::CommonTest {
 public:
  TestSoftmaxGradFp32() {}
};
...
TEST_F(TestSoftmaxGradFp32, SoftmaxGradAxis0) {
  ...
  auto yt_data = reinterpret_cast<float *>(luojianet_ms::lite::ReadFile(yt_path.c_str(), &input_size));
...
TEST_F(TestSoftmaxGradFp32, SoftmaxGradAxis1) {
  ...
  // auto output_data = reinterpret_cast<float *>(luojianet_ms::lite::ReadFile(input_path.c_str(), &input_size));
