...
#include "luojianet_ms/lite/src/runtime/kernel/arm/int8/deconvolution_int8.h"

using luojianet_ms::lite::DeviceType;

namespace luojianet_ms {
using luojianet_ms::lite::LiteQuantParam;
using luojianet_ms::lite::Tensor;
class TestDeconvInt8 : public luojianet_ms::CommonTest {
 public:
  TestDeconvInt8() {}
};
...
int DeConvInt8TestInit1(std::vector<lite::Tensor *> *inputs_, std::vector<lite::Tensor *> *outputs_,
  ...
  auto *in_t = new Tensor(kNumberTypeInt8, {1, 4, 2, 3}, luojianet_ms::NHWC, lite::Category::VAR);
  in_t->MallocData();
  ...
  auto *weight_t = new Tensor(kNumberTypeInt8, {3, 3, 3, 2}, luojianet_ms::NHWC, lite::Category::CONST_TENSOR);
  weight_t->MallocData();
  ...
  auto *out_t = new Tensor(kNumberTypeInt8, {1, 7, 3, 2}, luojianet_ms::NHWC, lite::Category::VAR);
  out_t->MallocData();
