...
#include "luojianet_ms/lite/src/runtime/kernel/arm/fp32/activation_fp32.h"
#include "nnacl/fp32/activation_fp32.h"
#include "luojianet_ms/lite/src/runtime/kernel/arm/int8/hswish_int8.h"
#include "luojianet_ms/lite/src/kernel_registry.h"
#include "luojianet_ms/lite/include/context.h"

namespace luojianet_ms {
class TestHSwishInt8 : public luojianet_ms::CommonTest {
 public:
  TestHSwishInt8() {}
};
