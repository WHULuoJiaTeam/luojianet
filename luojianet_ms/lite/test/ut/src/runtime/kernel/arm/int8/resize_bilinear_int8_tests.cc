...
class TestResizeBilinearInt8 : public luojianet_ms::CommonTest {
 public:
...
void TestResizeBilinearInt8::Prepare(const std::vector<int> &in_shape, const std::vector<int> &out_shape,
                                     int8_t *input_data, int8_t *output_data, const luojianet_ms::LiteQuantParam quant_in,
                                     const luojianet_ms::LiteQuantParam quant_out, const bool align_corners,
