...
#ifndef LUOJIANET_MS_LITE_TEST_UT_SRC_RUNTIME_KERNEL_OPENCL_COMMON_H_
#define LUOJIANET_MS_LITE_TEST_UT_SRC_RUNTIME_KERNEL_OPENCL_COMMON_H_
...
using Tensor = luojianet_ms::lite::Tensor;
using ArgsTuple = std::tuple<std::vector<int>, void *, luojianet_ms::lite::Category>;
using ArgsTupleOut = std::tuple<std::vector<int>, void *>;
using ArgsTupleOutWithDType = std::tuple<std::vector<int>, void *, luojianet_ms::TypeId>;
using ArgsTupleWithDtype = std::tuple<std::vector<int>, void *, luojianet_ms::lite::Category, luojianet_ms::TypeId>;
constexpr luojianet_ms::lite::Category VAR = luojianet_ms::lite::Category::VAR;
constexpr luojianet_ms::lite::Category CONST_TENSOR = luojianet_ms::lite::Category::CONST_TENSOR;
constexpr luojianet_ms::lite::Category CONST_SCALAR = luojianet_ms::lite::Category::CONST_SCALAR;
...
#endif  // LUOJIANET_MS_LITE_TEST_UT_SRC_RUNTIME_KERNEL_OPENCL_COMMON_H_
