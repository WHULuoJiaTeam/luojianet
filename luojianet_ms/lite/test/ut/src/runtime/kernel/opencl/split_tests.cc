...
TEST_F(TestOpenCL_Split, input2_axis3) {
  ...
  auto output_data1 = reinterpret_cast<float *>(luojianet_ms::lite::ReadFile(output1Ppath.c_str(), &output1_size));
  auto output_data2 = reinterpret_cast<float *>(luojianet_ms::lite::ReadFile(output2Ppath.c_str(), &output2_size));
