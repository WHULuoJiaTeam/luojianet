...
#ifndef LUOJIANET_MS_LITE_TEST_UT_TOOLS_OPTIMIZER_FUSION_FUSION_INOUT_TEST_FUSION_INOUT_TEST_H_
#define LUOJIANET_MS_LITE_TEST_UT_TOOLS_OPTIMIZER_FUSION_FUSION_INOUT_TEST_FUSION_INOUT_TEST_H_
...
class FusionInoutTest : public luojianet_ms::CommonTest {
 public:
