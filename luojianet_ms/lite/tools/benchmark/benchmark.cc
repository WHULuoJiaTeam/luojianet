...
int Benchmark::FillGLTextureToTensor(std::map<std::string, GLuint> *gl_texture, luojianet_ms::tensor::MSTensor *tensor,
...
int Benchmark::CheckInputNames() {
  ...
  std::transform(ms_inputs_.begin(), ms_inputs_.end(), ms_input_names.begin(),
                 [](luojianet_ms::tensor::MSTensor *input) { return input->tensor_name(); });
