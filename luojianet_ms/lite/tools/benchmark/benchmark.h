...
class MS_API Benchmark : public BenchmarkBase {
 ...
 protected:
  ...
  int FillGLTextureToTensor(std::map<std::string, GLuint> *gl_texture, luojianet_ms::tensor::MSTensor *tensor,
 ...
 private:
  ...
  std::unordered_map<std::string, luojianet_ms::tensor::MSTensor *> ms_outputs_;
