...
const std::unordered_map<luojianet_ms::Format, std::string> kTensorFormatMap{
  {luojianet_ms::NCHW, "NCHW"}, {luojianet_ms::NHWC, "NHWC"},     {luojianet_ms::NHWC4, "NHWC4"}, {luojianet_ms::HWKC, "HWKC"},
  {luojianet_ms::HWCK, "HWCK"}, {luojianet_ms::KCHW, "KCHW"},     {luojianet_ms::CKHW, "CKHW"},   {luojianet_ms::KHWC, "KHWC"},
  {luojianet_ms::CHWK, "CHWK"}, {luojianet_ms::HW, "HW"},         {luojianet_ms::HW4, "HW4"},     {luojianet_ms::NC, "NC"},
  {luojianet_ms::NC4, "NC4"},   {luojianet_ms::NC4HW4, "NC4HW4"}, {luojianet_ms::NCDHW, "NCDHW"}};
...
int BenchmarkBase::Init() {
  ...
  if (dump_cfg_path != nullptr) {
    ...
    MS_LOG(INFO) << "No LUOJIANET_MS_DUMP_CONFIG in env, don't need to dump data";
  }
