...
extern const std::unordered_map<luojianet_ms::Format, std::string> kTensorFormatMap;

const std::unordered_map<std::string, luojianet_ms::ModelType> ModelTypeMap{
  {"MindIR_Lite", luojianet_ms::ModelType::kMindIR_Lite}, {"MindIR", luojianet_ms::ModelType::kMindIR}};

namespace dump {
constexpr auto kConfigPath = "LUOJIANET_MS_DUMP_CONFIG";
