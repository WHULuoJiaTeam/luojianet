 ...
 */
#ifndef LUOJIANET_MS_LITE_TOOLS_BENCHMARK_BENCHMARK_C_API_H_
#define LUOJIANET_MS_LITE_TOOLS_BENCHMARK_BENCHMARK_C_API_H_
...
using luojianet_ms::lite::BenchmarkBase;
using luojianet_ms::lite::BenchmarkFlags;

namespace luojianet_ms::tools {
...
#endif  // LUOJIANET_MS_LITE_TOOLS_BENCHMARK_BENCHMARK_C_API_H_
