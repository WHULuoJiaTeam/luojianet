 ...
 */
#ifndef LUOJIANET_MS_LITE_SRC_RUNTIME_AGENT_NNIE_NNIE_MEMORY_H_
#define LUOJIANET_MS_LITE_SRC_RUNTIME_AGENT_NNIE_NNIE_MEMORY_H_
#include <fcntl.h>
#include <sys/mman.h>
#include <sys/stat.h>
#include <sys/types.h>
...
#endif  // LUOJIANET_MS_LITE_SRC_RUNTIME_AGENT_NNIE_NNIE_MEMORY_H_
