...
#ifndef LUOJIANET_MS_LITE_TOOLS_BENCHMARK_NNIE_PROPOSAL_PROPOSAL_H_
#define LUOJIANET_MS_LITE_TOOLS_BENCHMARK_NNIE_PROPOSAL_PROPOSAL_H_
#include <vector>
...
int32_t ProposalInit(ProposalParam *param, const std::vector<luojianet_ms::MSTensor> &inputs, uint32_t max_roi_num,
                     uint32_t ori_image_height, uint32_t ori_image_width);
int32_t ProposalRun(std::vector<luojianet_ms::MSTensor> *inputs, std::vector<luojianet_ms::MSTensor> *outputs,
                    ProposalParam *param);
void ProposalDeInit(ProposalParam *param);
}  // namespace proposal
}  // namespace luojianet_ms
#endif  // LUOJIANET_MS_LITE_TOOLS_BENCHMARK_NNIE_PROPOSAL_PROPOSAL_H_
