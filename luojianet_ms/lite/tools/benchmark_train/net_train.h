...
#ifndef LUOJIANET_MS_LITE_TOOLS_BENCHMARK_TRAIN_NET_TRAIN_H_
#define LUOJIANET_MS_LITE_TOOLS_BENCHMARK_TRAIN_NET_TRAIN_H_
...
class MS_API NetTrain {
 ...
 private:
  ...
  void CheckSum(luojianet_ms::tensor::MSTensor *tensor, std::string node_type, int id, std::string in_out);
  // call GenerateRandomData to fill inputTensors
  int GenerateInputData(std::vector<luojianet_ms::tensor::MSTensor *> *ms_inputs);

  int GenerateRandomData(luojianet_ms::tensor::MSTensor *tensor);

  int ReadInputFile(std::vector<luojianet_ms::tensor::MSTensor *> *ms_inputs);
  ...
  luojianet_ms::KernelCallBack before_call_back_;
  luojianet_ms::KernelCallBack after_call_back_;
};

int MS_API RunNetTrain(int argc, const char **argv);
}  // namespace luojianet_ms::lite
#endif  // LUOJIANET_MS_LITE_TOOLS_BENCHMARK_TRAIN_NET_TRAIN_H_
