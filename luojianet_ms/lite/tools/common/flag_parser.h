...
#ifndef LUOJIANET_MS_LITE_TOOLS_COMMON_FLAG_PARSER_H
#define LUOJIANET_MS_LITE_TOOLS_COMMON_FLAG_PARSER_H
...
#endif  // LUOJIANET_MS_LITE_TOOLS_COMMON_FLAG_PARSER_H
