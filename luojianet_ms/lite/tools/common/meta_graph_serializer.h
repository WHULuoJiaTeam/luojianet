...
#ifndef LUOJIANET_MS_LITE_TOOLS_COMMON_META_GRAPH_SERIALIZER_H
#define LUOJIANET_MS_LITE_TOOLS_COMMON_META_GRAPH_SERIALIZER_H
...
#endif  // LUOJIANET_MS_LITE_TOOLS_COMMON_META_GRAPH_SERIALIZER_H
