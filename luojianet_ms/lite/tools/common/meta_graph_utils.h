...
#ifndef LUOJIANET_MS_LITE_TOOLS_COMMON_META_GRAPH_UTIL_H
#define LUOJIANET_MS_LITE_TOOLS_COMMON_META_GRAPH_UTIL_H
...
#endif  // LUOJIANET_MS_LITE_TOOLS_COMMON_META_GRAPH_UTIL_H
