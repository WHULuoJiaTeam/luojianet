...
#include "luojianet_ms/core/ops/switch.h"
#include "luojianet_ms/core/ops/call.h"
#include "luojianet_ms/core/ops/fusion/partial_fusion.h"
...
STATUS NodeUtils::ConvertDims(luojianet_ms::schema::Format src_format, const std::vector<int32_t> &src_dims,
                              luojianet_ms::schema::Format dst_format, std::vector<int32_t> *dst_dims) {
...
ValueNodePtr GetPartialFusionPrim() {
  auto partial_prim = std::make_shared<luojianet_ms::ops::PartialFusion>();
...
ValueNodePtr GetSwitchAnfPrim() {
  auto switch_prim = std::make_shared<luojianet_ms::ops::Switch>();
...
ValueNodePtr GetCallAnfPrim() {
  auto call_prim = std::make_shared<luojianet_ms::ops::Call>();
