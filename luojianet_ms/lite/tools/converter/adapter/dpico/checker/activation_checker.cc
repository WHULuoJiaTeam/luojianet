...
bool ActivationChecker::Check(CNodePtr op, int32_t output_num, luojianet_ms::Format format) {
  ...
  auto activation_type = static_cast<luojianet_ms::ActivationType>(GetValue<int64_t>(value_ptr));
