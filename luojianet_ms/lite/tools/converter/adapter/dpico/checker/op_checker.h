...
class OpChecker {
 public:
  ...
  virtual bool Check(api::CNodePtr op, int32_t output_num, luojianet_ms::Format format) = 0;
...
bool CheckInputW(const api::CNodePtr &op, size_t index, luojianet_ms::Format format, int limit_w);
