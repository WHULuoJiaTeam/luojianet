...
bool CheckAttr(const CNodePtr &op, luojianet_ms::Format format, const PrimitivePtr &primitive,
...
bool ReduceChecker::Check(CNodePtr op, int32_t output_num, luojianet_ms::Format format) {
