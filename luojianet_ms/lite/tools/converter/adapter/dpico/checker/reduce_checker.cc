...
bool CheckAttr(const api::CNodePtr &op, luojianet_ms::Format format, const api::PrimitivePtr &primitive,
...
bool ReduceChecker::Check(api::CNodePtr op, int32_t output_num, luojianet_ms::Format format) {
