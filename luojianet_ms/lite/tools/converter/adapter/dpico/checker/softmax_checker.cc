...
bool CheckVectorAndTensorChannel(const std::vector<int64_t> &input_shape, luojianet_ms::Format format) {
...
bool SoftmaxChecker::Check(api::CNodePtr op, int32_t output_num, luojianet_ms::Format format) {
