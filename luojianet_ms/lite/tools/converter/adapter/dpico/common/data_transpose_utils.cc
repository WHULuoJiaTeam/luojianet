...
template <typename T>
STATUS DoTransposeData(const api::TensorPtr &tensor, luojianet_ms::Format src_format, luojianet_ms::Format dst_format) {
...
STATUS TransFilterFormat(const api::TensorPtr &tensor, luojianet_ms::Format src_format, luojianet_ms::Format dst_format) {
  if (tensor == nullptr) {
    MS_LOG(ERROR) << "tensor is nullptr.";
    return RET_ERROR;
  }
  std::unordered_map<TypeId, std::function<STATUS(const api::TensorPtr &, luojianet_ms::Format, luojianet_ms::Format)>>
