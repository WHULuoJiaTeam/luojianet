...
#ifndef DPICO_INFER_DPICO_CUSTOM_INFER_H_
#define DPICO_INFER_DPICO_CUSTOM_INFER_H_
...
namespace kernel {
class CustomInterface : public KernelInterface {
 public:
  CustomInterface() {}
...
#endif  // DPICO_INFER_DPICO_CUSTOM_INFER_H_
