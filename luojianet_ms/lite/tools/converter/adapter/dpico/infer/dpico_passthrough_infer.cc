...
Status DpicoPassThroughInterface::Infer(std::vector<luojianet_ms::MSTensor> *inputs,
                                        std::vector<luojianet_ms::MSTensor> *outputs, const schema::Primitive *primitive,
