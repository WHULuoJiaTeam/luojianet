...
#ifndef DPICO_MAPPER_ACTIVATION_MAPPER_H_
#define DPICO_MAPPER_ACTIVATION_MAPPER_H_
...
namespace dpico {
class ActivationMapper : public OpMapper {
 public:
  ActivationMapper() : OpMapper("Activation") {}
...
#endif  // DPICO_MAPPER_ACTIVATION_MAPPER_H_
