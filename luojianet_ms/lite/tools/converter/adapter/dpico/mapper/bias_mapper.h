...
#ifndef DPICO_MAPPER_BIAS_MAPPER_H_
#define DPICO_MAPPER_BIAS_MAPPER_H_
...
namespace dpico {
class BiasMapper : public OpMapper {
 public:
  BiasMapper() : OpMapper("Bias") {}
  ~BiasMapper() override = default;
...
#endif  // DPICO_MAPPER_BIAS_MAPPER_H_
