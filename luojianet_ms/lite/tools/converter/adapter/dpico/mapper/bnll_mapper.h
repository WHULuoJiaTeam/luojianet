...
#ifndef DPICO_MAPPER_BNLL_MAPPER_H_
#define DPICO_MAPPER_BNLL_MAPPER_H_
...
namespace dpico {
class BnllMapper : public OpMapper {
 public:
  BnllMapper() : OpMapper("Bnll") {}
  ~BnllMapper() override = default;
...
#endif  // DPICO_MAPPER_BNLL_MAPPER_H_
