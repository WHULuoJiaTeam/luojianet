...
#ifndef DPICO_MAPPER_CONCAT_MAPPER_H_
#define DPICO_MAPPER_CONCAT_MAPPER_H_
...
namespace dpico {
class ConcatMapper : public OpMapper {
 public:
  ConcatMapper() : OpMapper("Concat") {}
...
#endif  // DPICO_MAPPER_CONCAT_MAPPER_H_
