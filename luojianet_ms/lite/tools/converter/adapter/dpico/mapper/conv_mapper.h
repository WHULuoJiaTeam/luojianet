...
#ifndef DPICO_MAPPER_CONV_MAPPER_H_
#define DPICO_MAPPER_CONV_MAPPER_H_
...
namespace dpico {
class ConvMapper : public OpMapper {
 public:
  ConvMapper() : OpMapper("Convolution") {}
  ~ConvMapper() override = default;
...
#endif  // DPICO_MAPPER_CONV_MAPPER_H_
