...
#ifndef DPICO_MAPPER_CROP_MAPPER_H_
#define DPICO_MAPPER_CROP_MAPPER_H_
...
namespace dpico {
class CropMapper : public OpMapper {
 public:
  CropMapper() : OpMapper("Crop") {}
  ~CropMapper() override = default;
...
#endif  // DPICO_MAPPER_CROP_MAPPER_H_
