...
#ifndef DPICO_MAPPER_DECBBOX_MAPPER_H_
#define DPICO_MAPPER_DECBBOX_MAPPER_H_
...
namespace dpico {
class DecBBoxMapper : public OpMapper {
 public:
  DecBBoxMapper() : OpMapper("DecBBox") {}
  ~DecBBoxMapper() override = default;
...
#endif  // DPICO_MAPPER_DECBBOX_MAPPER_H_
