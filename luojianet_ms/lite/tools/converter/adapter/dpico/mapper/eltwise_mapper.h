...
#ifndef DPICO_MAPPER_ELTWISE_MAPPER_H_
#define DPICO_MAPPER_ELTWISE_MAPPER_H_
...
namespace dpico {
class EltwiseMapper : public OpMapper {
 public:
  EltwiseMapper() : OpMapper("Eltwise") {}
...
#endif  // DPICO_MAPPER_ELTWISE_MAPPER_H_
