...
#ifndef DPICO_MAPPER_FC_MAPPER_H_
#define DPICO_MAPPER_FC_MAPPER_H_
...
namespace dpico {
class FCMapper : public OpMapper {
 public:
  FCMapper() : OpMapper("FC") {}
  ~FCMapper() override = default;
...
#endif  // DPICO_MAPPER_FC_MAPPER_H_
