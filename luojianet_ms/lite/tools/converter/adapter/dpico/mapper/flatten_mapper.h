...
#ifndef DPICO_MAPPER_FLATTEN_MAPPER_H_
#define DPICO_MAPPER_FLATTEN_MAPPER_H_
...
namespace dpico {
class FlattenMapper : public OpMapper {
 public:
  FlattenMapper() : OpMapper("Flatten") {}
  ~FlattenMapper() override = default;
...
#endif  // DPICO_MAPPER_FLATTEN_MAPPER_H_
