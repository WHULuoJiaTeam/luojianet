...
#ifndef DPICO_MAPPER_GRU_MAPPER_H_
#define DPICO_MAPPER_GRU_MAPPER_H_
...
namespace dpico {
class GruMapper : public OpMapper {
 public:
  GruMapper() : OpMapper("Gru") {}
  ~GruMapper() override = default;
...
#endif  // DPICO_MAPPER_GRU_MAPPER_H_
