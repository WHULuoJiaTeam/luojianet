...
#ifndef DPICO_MAPPER_INTERP_MAPPER_H_
#define DPICO_MAPPER_INTERP_MAPPER_H_
...
namespace dpico {
class InterpMapper : public OpMapper {
 public:
  InterpMapper() : OpMapper("Interp") {}
  ~InterpMapper() override = default;
...
#endif  // DPICO_MAPPER_INTERP_MAPPER_H_
