...
#ifndef DPICO_MAPPER_LRN_MAPPER_H_
#define DPICO_MAPPER_LRN_MAPPER_H_
...
namespace dpico {
class LrnMapper : public OpMapper {
 public:
  LrnMapper() : OpMapper("Lrn") {}
...
#endif  // DPICO_MAPPER_LRN_MAPPER_H_
