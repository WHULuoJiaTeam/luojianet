...
#ifndef DPICO_MAPPER_LSTM_MAPPER_H_
#define DPICO_MAPPER_LSTM_MAPPER_H_
...
namespace dpico {
class LstmMapper : public OpMapper {
 public:
  LstmMapper() : OpMapper("Lstm") {}
  ~LstmMapper() override = default;
...
#endif  // DPICO_MAPPER_LSTM_MAPPER_H_
