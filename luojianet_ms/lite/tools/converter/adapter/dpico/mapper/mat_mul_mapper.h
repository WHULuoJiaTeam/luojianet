...
#ifndef DPICO_MAPPER_MATMUL_MAPPER_H_
#define DPICO_MAPPER_MATMUL_MAPPER_H_
...
namespace dpico {
class MatMulMapper : public OpMapper {
 public:
  MatMulMapper() : OpMapper("MatMul") {}
  ~MatMulMapper() override = default;
...
#endif  // DPICO_MAPPER_MATMUL_MAPPER_H_
