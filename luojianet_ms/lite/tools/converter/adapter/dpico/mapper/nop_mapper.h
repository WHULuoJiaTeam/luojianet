...
#ifndef DPICO_MAPPER_NOP_MAPPER_H_
#define DPICO_MAPPER_NOP_MAPPER_H_
...
namespace dpico {
class NopMapper : public OpMapper {
 public:
  NopMapper() : OpMapper("Nop") {}
  ~NopMapper() override = default;
...
#endif  // DPICO_MAPPER_NOP_MAPPER_H_
