...
#ifndef DPICO_MAPPER_PRELU_MAPPER_H_
#define DPICO_MAPPER_PRELU_MAPPER_H_
...
namespace dpico {
class PReluMapper : public OpMapper {
 public:
  PReluMapper() : OpMapper("PRelu") {}
...
#endif  // DPICO_MAPPER_PRELU_MAPPER_H_
