...
const std::unordered_map<luojianet_ms::NearestMode, mapper::NearestMode> kNearestModeMap = {
  {luojianet_ms::NearestMode::ROUND_HALF_DOWN, mapper::NearestMode::ROUND_PREFER_FLOOR},
  {luojianet_ms::NearestMode::ROUND_HALF_UP, mapper::NearestMode::ROUND_PREFER_CEIL},
  {luojianet_ms::NearestMode::CEIL, mapper::NearestMode::NEAREST_CEIL},
  {luojianet_ms::NearestMode::FLOOR, mapper::NearestMode::NEAREST_FLOOR}};
...
STATUS ResizeMapper::Map(const CNodePtr &cnode, std::vector<BaseOperatorPtr> *base_operators, const PrimitivePtr &prim,
  ...
  if (prim->GetAttr(ops::kNearestMode) != nullptr) {
    auto nearest_mode = static_cast<luojianet_ms::NearestMode>(resize_prim->get_nearest_mode());
