...
#ifndef DPICO_MAPPER_REVERSE_MAPPER_H_
#define DPICO_MAPPER_REVERSE_MAPPER_H_
...
namespace dpico {
class ReverseMapper : public OpMapper {
 public:
  ReverseMapper() : OpMapper("Reverse") {}
  ~ReverseMapper() override = default;
...
#endif  // DPICO_MAPPER_REVERSE_MAPPER_H_
