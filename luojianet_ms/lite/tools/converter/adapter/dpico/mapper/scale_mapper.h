...
#ifndef DPICO_MAPPER_SCALE_MAPPER_H_
#define DPICO_MAPPER_SCALE_MAPPER_H_
...
namespace dpico {
class ScaleMapper : public OpMapper {
 public:
  ScaleMapper() : OpMapper("Scale") {}
  ~ScaleMapper() override = default;
...
#endif  // DPICO_MAPPER_SCALE_MAPPER_H_
