...
#ifndef DPICO_MAPPER_SLICE_MAPPER_H_
#define DPICO_MAPPER_SLICE_MAPPER_H_
...
namespace dpico {
class SliceMapper : public OpMapper {
 public:
  SliceMapper() : OpMapper("Slice") {}
  ~SliceMapper() override = default;
...
#endif  // DPICO_MAPPER_SLICE_MAPPER_H_
