...
#ifndef DPICO_MAPPER_SQUEEZE_MAPPER_H_
#define DPICO_MAPPER_SQUEEZE_MAPPER_H_
...
namespace dpico {
class SqueezeMapper : public OpMapper {
 public:
  SqueezeMapper() : OpMapper("Squeeze") {}
...
#endif  // DPICO_MAPPER_SQUEEZE_MAPPER_H_
