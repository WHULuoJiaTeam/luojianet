...
#ifndef DPICO_MAPPER_TILE_MAPPER_H_
#define DPICO_MAPPER_TILE_MAPPER_H_
...
namespace dpico {
class TileMapper : public OpMapper {
 public:
  TileMapper() : OpMapper("Tile") {}
  ~TileMapper() override = default;
...
#endif  // DPICO_MAPPER_TILE_MAPPER_H_
