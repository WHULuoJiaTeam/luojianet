...
#ifndef DPICO_MAPPER_UPSAMPLE_MAPPER_H_
#define DPICO_MAPPER_UPSAMPLE_MAPPER_H_
...
namespace dpico {
class UpsampleMapper : public OpMapper {
 public:
  UpsampleMapper() : OpMapper("Upsample") {}
...
#endif  // DPICO_MAPPER_UPSAMPLE_MAPPER_H_
