...
#ifndef DPICO_PARSER_CAFFE_CAFFE_ABSVAL_PARSER_H_
#define DPICO_PARSER_CAFFE_CAFFE_ABSVAL_PARSER_H_
...
namespace lite {
class CaffeAbsvalParser : public CaffeNodeParser {
 public:
...
#endif  // DPICO_PARSER_CAFFE_CAFFE_ABSVAL_PARSER_H_
