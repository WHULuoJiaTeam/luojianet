...
#ifndef DPICO_PARSER_CAFFE_LSTM_PARSER_H_
#define DPICO_PARSER_CAFFE_LSTM_PARSER_H_
...
namespace lite {
class CaffeLstmParser : public CaffeNodeParser {
 public:
...
#endif  // DPICO_PARSER_CAFFE_LSTM_PARSER_H_
