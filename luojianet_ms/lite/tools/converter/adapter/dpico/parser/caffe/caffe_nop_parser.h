...
#ifndef DPICO_PARSER_CAFFE_CAFFE_NOP_PARSER_H_
#define DPICO_PARSER_CAFFE_CAFFE_NOP_PARSER_H_
...
namespace lite {
class CaffeNopParser : public CaffeNodeParser {
 public:
...
#endif  // DPICO_PARSER_CAFFE_CAFFE_NOP_PARSER_H_
