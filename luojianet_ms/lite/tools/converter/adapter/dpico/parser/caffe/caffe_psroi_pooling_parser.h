...
#ifndef DPICO_PARSER_CAFFE_PSROI_POOLING_PARSER_H_
#define DPICO_PARSER_CAFFE_PSROI_POOLING_PARSER_H_
...
namespace lite {
class CaffePSROIPoolingParser : public CaffeNodeParser {
 public:
...
#endif  // DPICO_PARSER_CAFFE_PSROI_POOLING_PARSER_H_
