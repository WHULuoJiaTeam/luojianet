...
#ifndef DPICO_PARSER_CAFFE_CAFFE_RNN_PARSER_H_
#define DPICO_PARSER_CAFFE_CAFFE_RNN_PARSER_H_
...
namespace lite {
class CaffeRnnParser : public CaffeNodeParser {
 public:
...
#endif  // DPICO_PARSER_CAFFE_CAFFE_RNN_PARSER_H_
