...
#ifndef DPICO_PARSER_CAFFE_CAFFE_SHUFFLE_CHANNEL_PARSER_H_
#define DPICO_PARSER_CAFFE_CAFFE_SHUFFLE_CHANNEL_PARSER_H_
...
namespace lite {
class CaffeShuffleChannelParser : public CaffeNodeParser {
 public:
...
#endif  // DPICO_PARSER_CAFFE_CAFFE_SHUFFLE_CHANNEL_PARSER_H_
