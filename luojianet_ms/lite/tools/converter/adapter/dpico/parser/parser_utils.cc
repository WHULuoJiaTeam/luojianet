...
int GetTransposePerm(luojianet_ms::Format src_format, luojianet_ms::Format dst_format, std::vector<int> *perm) {
...
int GetTransposePermSharing(luojianet_ms::Format src_format, luojianet_ms::Format dst_format, std::vector<int> *perm) {
  MS_ASSERT(perm != nullptr);
  auto src_format_str = dpico::FormatEnumToString(src_format);
  auto dst_format_str = dpico::FormatEnumToString(dst_format);
  if (src_format_str.empty() || dst_format_str.empty() || src_format_str.size() != dst_format_str.size()) {
...
int UnifyVariableConvWeight(const api::FuncGraphPtr &graph, const AnfNodePtr &weight_node, luojianet_ms::Format src_format,
...
int HandleConstConvWeightShared(const api::FuncGraphPtr &graph, const AnfNodePtr &weight_node,
                                luojianet_ms::Format src_format, luojianet_ms::Format dst_format,
...
int UnifyConstConvWeight(const api::FuncGraphPtr &graph, const AnfNodePtr &weight_node, luojianet_ms::Format src_format,
                         luojianet_ms::Format dst_format, std::set<AnfNodePtr> *has_visited) {
  MS_ASSERT(graph != nullptr && weight_node != nullptr && has_visited != nullptr);
  if (src_format == dst_format) {
    return lite::RET_OK;
