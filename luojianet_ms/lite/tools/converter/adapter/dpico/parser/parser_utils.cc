...
int UnifyConvWeightFormat(const api::FuncGraphPtr &graph, const api::CNodePtr &cnode, luojianet_ms::Format src_format,
                          luojianet_ms::Format dst_format, std::set<api::AnfNodePtr> *has_visited) {
