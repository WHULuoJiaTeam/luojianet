...
#ifndef LUOJIANET_MS_LITE_TOOLS_CONVERTER_CONVERTER_FLAGS_H
#define LUOJIANET_MS_LITE_TOOLS_CONVERTER_CONVERTER_FLAGS_H
...
class Flags : public virtual luojianet_ms::lite::FlagParser {
 public:
  Flags();
  ...
  std::string device;
  luojianet_ms::Format graphInputFormat = luojianet_ms::NHWC;
