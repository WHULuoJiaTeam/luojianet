...
#ifndef LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_GRAPH_MINDIR_CONTROL_FLOW_ADJUST_H_
#define LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_GRAPH_MINDIR_CONTROL_FLOW_ADJUST_H_
...
#endif  // LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_GRAPH_MINDIR_CONTROL_FLOW_ADJUST_H_
