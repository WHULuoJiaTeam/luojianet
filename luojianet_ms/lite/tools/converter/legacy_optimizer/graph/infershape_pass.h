...
#ifndef LUOJIANET_MS_PREDICT_INFERSHAPE_PASS_H
#define LUOJIANET_MS_PREDICT_INFERSHAPE_PASS_H
...
using luojianet_ms::schema::TensorT;
...
#endif  // LUOJIANET_MS_PREDICT_INFERSHAPE_PASS_H
