...
#ifndef LUOJIANET_MS_LITE_MICRO_CODER_MEMORY_ALLOCATOR_H_
#define LUOJIANET_MS_LITE_MICRO_CODER_MEMORY_ALLOCATOR_H_
#include <map>
#include <vector>
#include <memory>
#include <utility>
...
#endif  // LUOJIANET_MS_LITE_MICRO_CODER_MEMORY_ALLOCATOR_H_
