...
#ifndef LUOJIANET_MS_LITE_MICRO_CODER_MEMORY_MANAGER_H_
#define LUOJIANET_MS_LITE_MICRO_CODER_MEMORY_MANAGER_H_
...
#endif  // LUOJIANET_MS_LITE_MICRO_CODER_MEMORY_MANAGER_H_
