...
#ifndef LUOJIANET_MS_LITE_MICRO_CODER_GENERATOR_CMAKE_COMPONENT_H_
#define LUOJIANET_MS_LITE_MICRO_CODER_GENERATOR_CMAKE_COMPONENT_H_
...
#endif  // LUOJIANET_MS_LITE_MICRO_CODER_GENERATOR_CMAKE_COMPONENT_H_
