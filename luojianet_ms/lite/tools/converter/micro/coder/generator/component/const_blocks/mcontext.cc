...
#ifndef LUOJIANET_MS_LITE_MICRO_LIBRARY_SOURCE_CONTEXT_H_
#define LUOJIANET_MS_LITE_MICRO_LIBRARY_SOURCE_CONTEXT_H_
...
#endif  // LUOJIANET_MS_LITE_MICRO_LIBRARY_SOURCE_CONTEXT_H_
)RAW";
