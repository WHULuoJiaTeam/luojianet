...
std::string Conv2DBaseCoder::LayoutTransformFp32(luojianet_ms::Format src_format, luojianet_ms::Format dst_format) {
  std::string ret;
...
std::string Conv2DBaseCoder::LayoutTransformInt8(luojianet_ms::Format src_format, luojianet_ms::Format dst_format) {
  std::string ret;
...
std::string Conv2DBaseCoder::LayoutTransform(TypeId data_type, luojianet_ms::Format src_format,
                                             luojianet_ms::Format dst_format) {
  std::string ret;
  switch (data_type) {
...
int Conv2DBaseCoder::CheckLayout(lite::Tensor *input_tensor) {
  luojianet_ms::TypeId data_type = input_tensor->data_type();
  luojianet_ms::Format input_format = input_tensor->format();
  luojianet_ms::Format execute_format = luojianet_ms::NHWC4;
