...
#ifndef LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_BASE_DTYPE_CAST_CODER_H
#define LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_BASE_DTYPE_CAST_CODER_H
...
#endif  // LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_BASE_DTYPE_CAST_CODER_H
