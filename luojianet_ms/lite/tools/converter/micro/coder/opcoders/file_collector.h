...
#ifndef LUOJIANET_MS_LITE_MICRO_CODER_FILE_COLLECTOR_H_
#define LUOJIANET_MS_LITE_MICRO_CODER_FILE_COLLECTOR_H_
...
// namespace luojianet_ms::lite::micro
#endif  // LUOJIANET_MS_LITE_MICRO_CODER_FILE_COLLECTOR_H_
