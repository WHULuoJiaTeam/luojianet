...
#ifndef LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_INT8_CODER_H_
#define LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_INT8_CODER_H_
#include <string>
#include <memory>
#include <vector>
...
#endif  // LUOJIANET_MS_LITE_MICRO_CODER_OPCODERS_INT8_CODER_H_
