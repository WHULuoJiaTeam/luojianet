 ...
 */
#ifndef LUOJIANET_MS_LITE_MICRO_CODER_SOFTMAX_INT8_CODER_H_
#define LUOJIANET_MS_LITE_MICRO_CODER_SOFTMAX_INT8_CODER_H_
...
#endif  // LUOJIANET_MS_LITE_MICRO_CODER_SOFTMAX_INT8_CODER_H_
