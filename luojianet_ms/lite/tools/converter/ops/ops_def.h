...
#ifndef LITE_LUOJIANET_MS_LITE_TOOLS_CONVERTER_OPS_OPS_DEF_H_
#define LITE_LUOJIANET_MS_LITE_TOOLS_CONVERTER_OPS_OPS_DEF_H_
...
#endif  // LITE_LUOJIANET_MS_LITE_C_OPS_NEXTITERATION_H_
