...
#ifndef LITE_LUOJIANET_MS_LITE_TOOLS_CONVERTER_OPS_WHILE_H_
#define LITE_LUOJIANET_MS_LITE_TOOLS_CONVERTER_OPS_WHILE_H_
#include <vector>
#include <memory>
...
#endif  // LITE_LUOJIANET_MS_LITE_TOOLS_CONVERTER_OPS_WHILE_H_
