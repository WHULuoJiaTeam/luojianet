...
#ifndef LUOJIANET_MS_LITE_TOOLS_CONVERTER_PARSER_ONNX_DECONV_PARSER_H
#define LUOJIANET_MS_LITE_TOOLS_CONVERTER_PARSER_ONNX_DECONV_PARSER_H
...
class OnnxDeConvParser : public OnnxConvBaseParser {
 ...
 private:
  STATUS ParseOnnxAttr(const onnx::NodeProto &onnx_node, int64_t *group, luojianet_ms::PadMode *pad_mode,
                       std::vector<int64_t> *output_paddings);
};
}  // namespace lite
}  // namespace luojianet_ms
#endif  // LUOJIANET_MS_LITE_TOOLS_CONVERTER_PARSER_ONNX_DECONV_PARSER_H
