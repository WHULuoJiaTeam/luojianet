...
namespace lite {
namespace {
static std::unordered_map<int, luojianet_ms::TypeId> kOnnxTypeTransferMap = {
  {onnx::TensorProto_DataType_INT8, luojianet_ms::kNumberTypeInt8},
  {onnx::TensorProto_DataType_UINT8, luojianet_ms::kNumberTypeUInt8},
  {onnx::TensorProto_DataType_INT16, luojianet_ms::kNumberTypeInt16},
  {onnx::TensorProto_DataType_INT32, luojianet_ms::kNumberTypeInt32},
  {onnx::TensorProto_DataType_UINT32, luojianet_ms::kNumberTypeUInt32},
  {onnx::TensorProto_DataType_INT64, luojianet_ms::kNumberTypeInt64},
  {onnx::TensorProto_DataType_FLOAT16, luojianet_ms::kNumberTypeFloat16},
  {onnx::TensorProto_DataType_FLOAT, luojianet_ms::kNumberTypeFloat32},
  {onnx::TensorProto_DataType_DOUBLE, luojianet_ms::kNumberTypeFloat64},
  {onnx::TensorProto_DataType_BOOL, luojianet_ms::kNumberTypeBool}};
}  // namespace

int64_t OnnxNodeParser::opset_version_ = 0;

luojianet_ms::PadMode OnnxNodeParser::GetOnnxPadMode(const onnx::AttributeProto &onnx_node_attr) {
  if (onnx_node_attr.s() == "NOTSET") {
    return luojianet_ms::PadMode::PAD;
  } else if (onnx_node_attr.s() == "SAME_UPPER" || onnx_node_attr.s() == "SAME_LOWER") {
    return luojianet_ms::PadMode::SAME;
  } else if (onnx_node_attr.s() == "VALID") {
    return luojianet_ms::PadMode::VALID;
  } else {
