...
#ifndef LUOJIANET_MS_LITE_TOOLS_CONVERTER_PARSER_ONNX_NODE_PARSER_H
#define LUOJIANET_MS_LITE_TOOLS_CONVERTER_PARSER_ONNX_NODE_PARSER_H
...
class OnnxNodeParser {
 ...
 protected:
  static luojianet_ms::PadMode GetOnnxPadMode(const onnx::AttributeProto &onnx_node_attr);
...
#endif  // LUOJIANET_MS_LITE_TOOLS_CONVERTER_PARSER_ONNX_NODE_PARSER_H
