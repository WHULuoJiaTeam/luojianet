...
#ifndef LUOJIANET_MS_LITE_SRC_PASS_FUNCTIONALIZE_WHILE_H_
#define LUOJIANET_MS_LITE_SRC_PASS_FUNCTIONALIZE_WHILE_H_
#include <string>
#include <set>
#include <vector>
#include <map>
...
#endif  // LUOJIANET_MS_LITE_SRC_PASS_FUNCTIONALIZE_WHILE_PASS_H_
