...
STATUS TFConvBaseParser::ParseKernels(const tensorflow::NodeDef &node_def, const luojianet_ms::Format &format,
...
STATUS TFConvBaseParser::ParseStrides(const tensorflow::NodeDef &node_def, const luojianet_ms::Format &format,
...
STATUS TFConvBaseParser::ParseExplicitPaddings(const tensorflow::NodeDef &node_def, const luojianet_ms::Format &format,
...
STATUS TFConvBaseParser::ParseDilations(const tensorflow::NodeDef &node_def, const luojianet_ms::Format &format,
...
luojianet_ms::PadMode TFConvBaseParser::ParsePadMode(const tensorflow::NodeDef &node_def, bool *is_ori_pad_mode) {
  tensorflow::AttrValue attr_value;
