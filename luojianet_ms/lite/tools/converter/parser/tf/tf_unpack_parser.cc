 ...
 */
#include "tools/converter/parser/tf/tf_unpack_parser.h"
#include <string>
#include <memory>
#include <map>
#include <vector>
...
namespace lite {
ops::PrimitiveC *TFUnpackParser::Parse(const tensorflow::NodeDef &tf_op,
...
TFNodeRegistrar g_tfUnpackParser("Unpack", new TFUnpackParser());
}  // namespace lite
}  // namespace luojianet_ms
