...
namespace lite {
std::unordered_map<int, luojianet_ms::TypeId> TF_TYPE_MAP = {{tensorflow::DT_INT8, luojianet_ms::kNumberTypeInt8},
                                                          {tensorflow::DT_UINT8, luojianet_ms::kNumberTypeUInt8},
                                                          {tensorflow::DT_INT16, luojianet_ms::kNumberTypeInt16},
                                                          {tensorflow::DT_UINT16, luojianet_ms::kNumberTypeUInt16},
                                                          {tensorflow::DT_INT32, luojianet_ms::kNumberTypeInt32},
                                                          {tensorflow::DT_INT64, luojianet_ms::kNumberTypeInt64},
                                                          {tensorflow::DT_HALF, luojianet_ms::kNumberTypeFloat16},
                                                          {tensorflow::DT_FLOAT, luojianet_ms::kNumberTypeFloat32},
                                                          {tensorflow::DT_DOUBLE, luojianet_ms::kNumberTypeFloat64},
                                                          {tensorflow::DT_COMPLEX64, luojianet_ms::kNumberTypeComplex64},
                                                          {tensorflow::DT_BOOL, luojianet_ms::kNumberTypeBool},
                                                          {tensorflow::DT_STRING, luojianet_ms::kObjectTypeString},
                                                          {tensorflow::DT_VARIANT, luojianet_ms::kObjectTypeTensorType}};
...
luojianet_ms::Format TensorFlowUtils::ParseNodeFormat(const tensorflow::NodeDef &node_def) {
  tensorflow::AttrValue attr_value;
  if (!FindAttrValue(node_def, "data_format", &attr_value)) {
    MS_LOG(ERROR) << "Find attr data_format failed";
    return luojianet_ms::Format::NCHW;
  }
  if (attr_value.s() == "NHWC") {
    return luojianet_ms::Format::NHWC;
  }
  return luojianet_ms::Format::NCHW;
}
}  // namespace lite
