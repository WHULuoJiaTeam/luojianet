...
namespace lite {
std::map<tflite::ActivationFunctionType, luojianet_ms::ActivationType> tfMsActivationFunctionMap{
  {tflite::ActivationFunctionType_NONE, luojianet_ms::ActivationType::NO_ACTIVATION},
  {tflite::ActivationFunctionType_RELU, luojianet_ms::ActivationType::RELU},
  {tflite::ActivationFunctionType_RELU6, luojianet_ms::ActivationType::RELU6},
  {tflite::ActivationFunctionType_TANH, luojianet_ms::ActivationType::TANH},
};
...
luojianet_ms::ActivationType GetActivationFunctionType(tflite::ActivationFunctionType tfliteAFType) {
...
luojianet_ms::PadMode GetPadMode(tflite::Padding tflite_padmode) {
  if (tflite_padmode == tflite::Padding_SAME) {
...
STATUS getPaddingParam(const std::unique_ptr<tflite::TensorT> &tensor, luojianet_ms::PadMode pad_mode, int strideH,
  ...
  int padLeft = 0;
  int padRight = 0;
  if (pad_mode == luojianet_ms::PadMode::SAME) {
