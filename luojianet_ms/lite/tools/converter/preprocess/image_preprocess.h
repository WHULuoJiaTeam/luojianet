 ...
 */
#ifndef LUOJIANET_MS_LITE_TOOLS_CONVERTER_PREPROCESS_IMAGE_PREPROCESS_H
#define LUOJIANET_MS_LITE_TOOLS_CONVERTER_PREPROCESS_IMAGE_PREPROCESS_H
...
int PreProcess(const preprocess::DataPreProcessParam &data_pre_process_param, const std::string &input_name,
               size_t image_index, luojianet_ms::tensor::MSTensor *tensor);
...
#endif  // LUOJIANET_MS_LITE_TOOLS_CONVERTER_PREPROCESS_IMAGE_PREPROCESS_H
