 ...
 */
#ifndef LUOJIANET_MS_LITE_TOOLS_CONVERTER_PREPROCESS_OPENCV_UTILS_H
#define LUOJIANET_MS_LITE_TOOLS_CONVERTER_PREPROCESS_OPENCV_UTILS_H
#include <string>
...
#endif  // LUOJIANET_MS_LITE_TOOLS_CONVERTER_PREPROCESS_OPENCV_UTILS_H
