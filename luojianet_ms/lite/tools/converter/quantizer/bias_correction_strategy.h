...
#ifndef LUOJIANET_MS_LITE_TOOLS_CONVERTER_QUANTIZER_BIASCORRECTION_H
#define LUOJIANET_MS_LITE_TOOLS_CONVERTER_QUANTIZER_BIASCORRECTION_H
#include <memory>
#include <map>
#include <string>
#include <vector>
...
#endif  // LUOJIANET_MS_LITE_TOOLS_CONVERTER_QUANTIZER_BIASCORRECTION_H
