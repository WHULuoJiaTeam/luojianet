...
#ifndef LUOJIANET_MS_LITE_TOOLS_CONVERTER_QUANTIZER_CALIBRATOR_H
#define LUOJIANET_MS_LITE_TOOLS_CONVERTER_QUANTIZER_CALIBRATOR_H
#include <string>
#include <map>
...
class Calibrator {
 public:
  ...
  int GenerateInputData(const std::string &input_name, size_t image_index, luojianet_ms::tensor::MSTensor *tensor) const;
  ...
  int CollectDataDistribution(
    const std::string &node_name, const std::vector<luojianet_ms::tensor::MSTensor *> &tensors,
...
#endif  // LUOJIANET_MS_LITE_TOOLS_CONVERTER_QUANTIZER__CALIBRATOR_H
