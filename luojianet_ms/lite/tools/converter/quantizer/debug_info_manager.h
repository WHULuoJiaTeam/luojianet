...
class DebugInfoManager {
 ...
 private:
  ...
  int AddComparedInfo(const luojianet_ms::CallBackParam &call_back_param,
                      const std::vector<luojianet_ms::tensor::MSTensor *> &inputs, OpParameter *op_parameter,
  ...
  int SetQuantStaticInfo(const std::vector<luojianet_ms::tensor::MSTensor *> &inputs, OpParameter *op_parameter,
                         int tensor_index, QuantDebugInfo *quant_debug_info, const luojianet_ms::lite::Tensor &tensor);
