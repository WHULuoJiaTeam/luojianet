...
#ifndef LUOJIANET_MS_LITE_TOOLS_CONVERTER_QUANTIZER_FSEBITSTREAM_H
#define LUOJIANET_MS_LITE_TOOLS_CONVERTER_QUANTIZER_FSEBITSTREAM_H
#include <cstdint>
...
#endif  // LUOJIANET_MS_LITE_TOOLS_CONVERTER_QUANTIZER_
