...
#ifndef LUOJIANET_MS_LITE_TOOLS_CONVERTER_QUANTIZER_FSE_ENCODER_H
#define LUOJIANET_MS_LITE_TOOLS_CONVERTER_QUANTIZER_FSE_ENCODER_H
...
#endif  // LUOJIANET_MS_LITE_TOOLS_CONVERTER_QUANTIZER_FSE_ENCODER_H
