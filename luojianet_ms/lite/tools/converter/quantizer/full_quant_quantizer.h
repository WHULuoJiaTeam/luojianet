...
#ifndef LUOJIANET_MS_LITE_TOOLS_CONVERTER_QUANTIZER_FULL_QUANT_QUANTIZER_H
#define LUOJIANET_MS_LITE_TOOLS_CONVERTER_QUANTIZER_FULL_QUANT_QUANTIZER_H
...
class FullQuantQuantizer : public Quantizer {
 ...
 private:
  ...
  int CheckFp32TensorVec(const std::string &node_name, const std::vector<luojianet_ms::tensor::MSTensor *> &tensor_vec);
 ...
 private:
  ...
  std::set<luojianet_ms::ActivationType> support_activation_;
...
#endif  // LUOJIANET_MS_LITE_TOOLS_CONVERTER_QUANTIZER_FULL_QUANT_QUANTIZER_H
