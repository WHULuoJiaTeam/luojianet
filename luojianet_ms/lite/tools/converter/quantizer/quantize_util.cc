...
#include "luojianet_ms/lite/tools/converter/quantizer/quantize_util.h"
#include <cmath>
#include <string>
#include <memory>
#include <vector>
...
int DeQuantData(luojianet_ms::tensor::MSTensor *tensor, std::vector<double> *dequant_data, int preferred_dim) {
