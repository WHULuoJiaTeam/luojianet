...
-I${LUOJIANET_MS_HOME}/luojianet_ms/ccsrc/plugin/device/cpu/kernel
...
getCommonFile() {
  ...
  others_files_h=(
    ...
    luojianet_ms/ccsrc/plugin/device/cpu/kernel/nnacl/infer/infer_register.h
    luojianet_ms/ccsrc/plugin/device/cpu/kernel/nnacl/nnacl_utils.h
    luojianet_ms/lite/src/ops/populate/populate_register.h
    luojianet_ms/ccsrc/plugin/device/cpu/kernel/nnacl/op_base.h
    luojianet_ms/core/ir/dtype/type_id.h
    luojianet_ms/core/utils/overload.h
    luojianet_ms/lite/tools/common/option.h
    luojianet_ms/ccsrc/plugin/device/cpu/kernel/nnacl/intrinsics/ms_simd_instructions.h
    luojianet_ms/ccsrc/plugin/device/cpu/kernel/nnacl/intrinsics/ms_simd_instructions_fp16.h
    luojianet_ms/ccsrc/plugin/device/cpu/kernel/nnacl/infer/infer.h
    luojianet_ms/ccsrc/plugin/device/cpu/kernel/nnacl/tensor_c.h
    luojianet_ms/ccsrc/plugin/device/cpu/kernel/nnacl/errorcode.h
  )
  ...
  assembly_files=()
  while IFS='' read -r line; do assembly_files+=("$line"); done < <(ls luojianet_ms/ccsrc/plugin/device/cpu/kernel/nnacl/assembly/*/*.S)
  others_files_c=(
    luojianet_ms/ccsrc/plugin/device/cpu/kernel/nnacl/nnacl_utils.c
    luojianet_ms/lite/src/runtime/infer_manager.cc
    luojianet_ms/lite/src/ops/populate/populate_register.cc
    luojianet_ms/lite/src/ops/populate/custom_populate.cc
    luojianet_ms/ccsrc/plugin/device/cpu/kernel/nnacl/infer/infer_register.c
    luojianet_ms/ccsrc/plugin/device/cpu/kernel/nnacl/infer/shape_fusion_infer.c
    luojianet_ms/lite/src/runtime/kernel/arm/fp32/shape_fusion_fp32.cc
...
getOpsFile "REG_INFER\(.*?, PrimType_" "luojianet_ms/ccsrc/plugin/device/cpu/kernel/nnacl/infer" "prototype" &
# support for cpu
