...
OUTPUT_LOCATION = "luojianet_ms/lite/tools/dataset/cropper"
...
MANUAL_HEADERS = [
    ...
    "luojianet_ms",
    "luojianet_ms/ccsrc",
    "luojianet_ms/ccsrc/minddata/dataset",
    "luojianet_ms/ccsrc/minddata/dataset/kernels/image",
    "luojianet_ms/core",
    "luojianet_ms/lite",
]
...
EXTERNAL_DEPS = [
    ...
    "build/luojianet_ms/_deps/sqlite-src",
    "build/luojianet_ms/_deps/pybind11-src/include",
    "build/luojianet_ms/_deps/tinyxml2-src",
    "build/luojianet_ms/_deps/jpeg_turbo-src",
    "build/luojianet_ms/_deps/jpeg_turbo-src/_build",
    "build/luojianet_ms/_deps/icu4c-src/icu4c/source/i18n",
    "build/luojianet_ms/_deps/icu4c-src/icu4c/source/common",
    "luojianet_ms/lite/build/_deps/tinyxml2-src",
    "luojianet_ms/lite/build/_deps/jpeg_turbo-src",
    "luojianet_ms/lite/build/_deps/jpeg_turbo-src/_build",
    "luojianet_ms/lite/build/_deps/nlohmann_json-src",
]
...
DATASET_PATH = "luojianet_ms/ccsrc/minddata/dataset"
...
def build_source_file_path(dep_h):
    ...
    if 'include/api/types.h' in dep_h:
        dep_cc = "luojianet_ms/ccsrc/cxx_api/types.cc"
        return dep_cc
...
if __name__ == "__main__":
    ...
    try:
        # change directory to luojianet_ms directory
