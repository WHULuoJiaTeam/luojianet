...
#ifndef LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_COMMON_GLLO_UTILS_H_
#define LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_COMMON_GLLO_UTILS_H_
...
#endif  // LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_COMMON_GLLO_UTILS_H_
