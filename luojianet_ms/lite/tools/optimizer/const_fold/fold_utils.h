...
#ifndef LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_CONST_FOLD_FOLD_UTILS_H_
#define LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_CONST_FOLD_FOLD_UTILS_H_
...
class ConstFoldProcessor {
 ...
 private:
  ...
  std::shared_ptr<luojianet_ms::Context> ms_context_{nullptr};
};
}  // namespace opt
}  // namespace luojianet_ms
#endif  // LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_CONST_FOLD_FOLD_UTILS_H_
