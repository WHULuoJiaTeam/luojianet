...
#ifndef LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_FORMAT_TO_FORMAT_BASE_H_
#define LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_FORMAT_TO_FORMAT_BASE_H_
...
class ToFormatBase : public Pass {
 public:
  explicit ToFormatBase(FmkType fmk_type = converter::kFmkTypeMs, bool train_flag = false,
                        const std::string &pass_name = "ToFormatBase")
 ...
 protected:
  ...
  luojianet_ms::Format format_{luojianet_ms::NHWC};
...
#endif  // LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_FORMAT_TO_FORMAT_BASE_H_
