...
#ifndef LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_FORMAT_TO_NCHW_FORMAT_H_
#define LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_FORMAT_TO_NCHW_FORMAT_H_
...
class ToNCHWFormat : public ToFormatBase {
 public:
  explicit ToNCHWFormat(FmkType fmk_type = converter::kFmkTypeMs, bool train_flag = false)
      : ToFormatBase(fmk_type, train_flag, "ToNCHWFormat") {
    format_ = luojianet_ms::NCHW;
  }
...
#endif  // LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_FORMAT_TO_NCHW_FORMAT_H_
