...
#ifndef LUOJIANET_MS_LITE_SRC_PASS_FUSION_CONV_BIASADD_FUSION_H_
#define LUOJIANET_MS_LITE_SRC_PASS_FUSION_CONV_BIASADD_FUSION_H_
...
#endif  // LUOJIANET_MS_LITE_SRC_PASS_FUSION_CONV_BIASADD_FUSION_H_
