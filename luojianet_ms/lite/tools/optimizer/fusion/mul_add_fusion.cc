...
bool MulAddFusion::CheckAddNode(const luojianet_ms::CNodePtr &cnode) const {
...
bool MulAddFusion::CheckMulNode(const luojianet_ms::FuncGraphPtr &func_graph, const luojianet_ms::CNodePtr &cnode) const {
...
AnfNodePtr MulAddFusion::Process(const std::string &pattern_name, const luojianet_ms::FuncGraphPtr &func_graph,
