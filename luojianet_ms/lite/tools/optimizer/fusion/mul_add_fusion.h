...
#ifndef LUOJIANET_MS_LITE_SRC_PASS_FUSION_MUL_ADD_FUSION_H_
#define LUOJIANET_MS_LITE_SRC_PASS_FUSION_MUL_ADD_FUSION_H_
...
class MulAddFusion : public MultiplePatternProcessPass {
 ...
 private:
  ...
  bool CheckAddNode(const luojianet_ms::CNodePtr &cnode) const;
  bool CheckMulNode(const luojianet_ms::FuncGraphPtr &func_graph, const luojianet_ms::CNodePtr &cnode) const;
...
#endif  // LUOJIANET_MS_LITE_SRC_PASS_FUSION_CONV_ACTIVATION_FUSION_H_
