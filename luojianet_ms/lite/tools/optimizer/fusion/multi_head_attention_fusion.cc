...
AnfNodePtr MultiHeadAttentionFusion::Process(const std::string &pattern_name, const luojianet_ms::FuncGraphPtr &func_graph,
                                             const luojianet_ms::AnfNodePtr &node,
                                             const luojianet_ms::EquivPtr &equiv) const {
