...
const AnfNodePtr SqueezeFusion::Process(const FuncGraphPtr &func_graph, const AnfNodePtr &unsqueeze_node,
  ...
  auto unsqueeze_prim = api::MakeShared<luojianet_ms::ops::Unsqueeze>(unsqueeze_primitive);
  auto squeeze_prim = api::MakeShared<luojianet_ms::ops::Squeeze>(squeeze_primitive);
