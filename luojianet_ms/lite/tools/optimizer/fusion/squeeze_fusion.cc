...
const AnfNodePtr SqueezeFusion::Process(const FuncGraphPtr &func_graph, const AnfNodePtr &unsqueeze_node,
  ...
  auto unsqueeze_prim = utils::cast<std::shared_ptr<luojianet_ms::ops::Unsqueeze>>(unsqueeze_primitive);
  auto squeeze_prim = utils::cast<std::shared_ptr<luojianet_ms::ops::Squeeze>>(squeeze_primitive);
