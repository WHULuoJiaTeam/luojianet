...
#ifndef LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_FUSION_TF_GELU_FUSION_H_
#define LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_FUSION_TF_GELU_FUSION_H_
...
#endif  // LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_FUSION_TF_GELU_FUSION_H_
