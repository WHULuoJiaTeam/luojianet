 ...
 */
#ifndef LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_FUSION_TF_LSTM_CELL_FUSION_H_
#define LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_FUSION_TF_LSTM_CELL_FUSION_H_
#include <vector>
#include <memory>
#include <string>
...
#endif  // LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_FUSION_TF_LSTM_CELL_FUSION_H_
