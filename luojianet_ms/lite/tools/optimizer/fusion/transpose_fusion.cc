...
#include "luojianet_ms/core/ops/transpose.h"
...
AnfNodePtr TransposeFusion::TransTransFusion(const FuncGraphPtr &func_graph, const luojianet_ms::AnfNodePtr &node) const {
...
int TransposeFusion::AdjustAxis(const luojianet_ms::AnfNodePtr &node) const {
  MS_ASSERT(node != nullptr);
...
AnfNodePtr TransposeFusion::Process(const std::string &pattern_name, const luojianet_ms::FuncGraphPtr &func_graph,
                                    const luojianet_ms::AnfNodePtr &node, const luojianet_ms::EquivPtr &equiv) const {
