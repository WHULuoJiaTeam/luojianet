 ...
 */
#ifndef LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_GRAPH_SLICE_PREPOSE_PASS_H_
#define LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_GRAPH_SLICE_PREPOSE_PASS_H_
...
#include "luojianet_ms/core/ir/manager.h"
...
using lite::RET_OK;
using lite::STATUS;
using TransactionPtr = std::shared_ptr<luojianet_ms::FuncGraphTransaction>;
...
#endif  // LUOJIANET_MS_LITE_TOOLS_OPTIMIZER_GRAPH_SLICE_PREPOSE_PASS_H_
