...
int SpecialNodePostProcess::HandleInstanceNorm(const FuncGraphPtr &func_graph, const CNodePtr &cnode) {
  ...
  pre_trans_prim->AddAttr(ops::kFormat, MakeValue<int64_t>(luojianet_ms::NHWC));
  ...
  post_trans_prim->AddAttr(ops::kFormat, MakeValue<int64_t>(luojianet_ms::NCHW));
  prim->AddAttr(ops::kFormat, MakeValue<int64_t>(luojianet_ms::NCHW));
