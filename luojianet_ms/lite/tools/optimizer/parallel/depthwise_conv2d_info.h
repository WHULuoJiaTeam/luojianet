...
#ifndef LUOJIANET_MS_LITE_SRC_PASS_PARALLEL_DEPTHWISE_CONV2D_INFO_H_
#define LUOJIANET_MS_LITE_SRC_PASS_PARALLEL_DEPTHWISE_CONV2D_INFO_H_
#include <string>
#include <vector>
#include <memory>
...
#endif  // LUOJIANET_MS_LITE_SRC_PASS_PARALLEL_DEPTHWISE_CONV2D_INFO_H_
