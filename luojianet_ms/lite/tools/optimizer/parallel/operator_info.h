...
#ifndef LUOJIANET_MS_LITE_SRC_PASS_PARALLEL_OPERATOR_INFO_H_
#define LUOJIANET_MS_LITE_SRC_PASS_PARALLEL_OPERATOR_INFO_H_
...
#endif  // LUOJIANET_MS_LITE_SRC_PASS_PARALLEL_OPERATOR_INFO_H_
