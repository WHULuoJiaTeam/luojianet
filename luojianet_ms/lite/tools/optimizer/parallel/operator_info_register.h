...
#ifndef LUOJIANET_MS_LITE_TOOLS_OPERATOR_INFO_REGISTER_H
#define LUOJIANET_MS_LITE_TOOLS_OPERATOR_INFO_REGISTER_H
...
#endif  // LUOJIANET_MS_LITE_TOOLS_OPERATOR_INFO_REGISTER_H
