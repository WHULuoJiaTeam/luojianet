...
#ifndef LUOJIANET_MS_LITE_SRC_PASS_PARALLEL_SPLIT_STRATEGY_H_
#define LUOJIANET_MS_LITE_SRC_PASS_PARALLEL_SPLIT_STRATEGY_H_
...
#endif  // LUOJIANET_MS_LITE_SRC_PASS_PARALLEL_SPLIT_STRATEGY_H_
