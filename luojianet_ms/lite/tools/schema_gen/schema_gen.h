 ...
 */
#ifndef LUOJIANET_MS_LITE_TOOLS_SCHEMA_GEN_SCHEMA_GEN_H_
#define LUOJIANET_MS_LITE_TOOLS_SCHEMA_GEN_SCHEMA_GEN_H_
#include <string>
...
#endif  // LUOJIANET_MS_LITE_TOOLS_SCHEMA_GEN_SCHEMA_GEN_H_
