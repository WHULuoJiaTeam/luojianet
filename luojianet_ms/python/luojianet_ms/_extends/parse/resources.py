...
from luojianet_ms import RowTensor, SparseTensor, COOTensor, CSRTensor
from luojianet_ms.ops import functional as F, composite as C
from luojianet_ms.ops.composite import multitype_ops
...
# namespace define
functional_ns = CellNamespace('luojianet_ms.ops.functional')
composite_ns = CellNamespace('luojianet_ms.ops.composite')
trope_ns = CellNamespace('luojianet_ms._extends.parse.trope')
