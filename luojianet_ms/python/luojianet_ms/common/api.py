...
def ms_function(fn=None, obj=None, input_signature=None):
    ...
    if fn is not None:
        return wrap_luojianet(fn)
    return wrap_luojianet


def _generate_pip_args(obj, *args, method="call"):
...
class _PynativeExecutor:
    ...
    The main functions include: call op graph, compile op graph, auto grad and run op graph.
