...
def set_dump(target, enabled=True):
    ...
    `target` should be an instance of :class:`luojianet_ms.nn.Cell` or :class:`luojianet_ms.ops.Primitive` .
    ...
    The default enabled status for a :class:`luojianet_ms.nn.Cell` or :class:`luojianet_ms.ops.Primitive` is False.
