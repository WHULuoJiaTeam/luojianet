...
def set_dump(target, enabled=True):
    ...
    Target should be an instance of Module or Primitive. The default enabled
    ...
    `dump document <https://luojianet_ms.cn/docs/programming_guide/zh-CN/master/dump_in_graph_mode.html>`_
    for details.
    ...
    Note:
        ...
        2. When target is a cell and enabled is True, this API will the enable
           ...
           call method). To make this API effective, please use
