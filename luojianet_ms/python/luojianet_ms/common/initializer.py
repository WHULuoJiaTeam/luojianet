...
class Zero(Initializer):
    ...
    Examples:
        >>> import luojianet_ms
        >>> from luojianet_ms.common.initializer import initializer, Zero
        >>> tensor1 = initializer(Zero(), [1, 2, 3], luojianet_ms.float32)
        >>> tensor2 = initializer('zeros', [1, 2, 3], luojianet_ms.float32)
    """
...
class One(Initializer):
    ...
    Examples:
        >>> import luojianet_ms
        >>> from luojianet_ms.common.initializer import initializer, One
        >>> tensor1 = initializer(One(), [1, 2, 3], luojianet_ms.float32)
        >>> tensor2 = initializer('ones', [1, 2, 3], luojianet_ms.float32)
    """
    def _initialize(self, arr):
        _assignment(arr, 1)
...
class XavierUniform(Initializer):
    ...
    Examples:
        >>> import luojianet_ms
        >>> from luojianet_ms.common.initializer import initializer, XavierUniform
        >>> tensor1 = initializer(XavierUniform(), [1, 2, 3], luojianet_ms.float32)
        >>> tensor2 = initializer('xavier_uniform', [1, 2, 3], luojianet_ms.float32)
    """
...
class HeUniform(Initializer):
    ...
    Examples:
        >>> import luojianet_ms
        >>> from luojianet_ms.common.initializer import initializer, HeUniform
        >>> tensor1 = initializer(HeUniform(), [1, 2, 3], luojianet_ms.float32)
        >>> tensor2 = initializer('he_uniform', [1, 2, 3], luojianet_ms.float32)
    """
...
class HeNormal(Initializer):
    ...
    Examples:
        >>> import luojianet_ms
        >>> from luojianet_ms.common.initializer import initializer, HeNormal
        >>> tensor1 = initializer(HeNormal(), [1, 2, 3], luojianet_ms.float32)
        >>> tensor2 = initializer('he_normal', [1, 2, 3], luojianet_ms.float32)
    """
    def __init__(self, negative_slope=0, mode='fan_in', nonlinearity='leaky_relu'):
...
class Constant(Initializer):
    ...
    Examples:
        ...
        >>> tensor1 = initializer(0, [1, 2, 3], luojianet_ms.float32)
        >>> tensor2 = initializer(5, [1, 2, 3], luojianet_ms.float32)
    """
...
class Identity(Initializer):
    ...
    Examples:
        >>> import luojianet_ms
        >>> from luojianet_ms.common.initializer import initializer, Identity
        >>> tensor1 = initializer(Identity(), [2, 3], luojianet_ms.float32)
        >>> tensor2 = initializer('identity', [2, 3], luojianet_ms.float32)
    """
    def _initialize(self, arr):
        if len(arr.shape) != 2:
...
class Sparse(Initializer):
    ...
    Examples:
        >>> import luojianet_ms
        >>> from luojianet_ms.common.initializer import initializer, Sparse
...
class Dirac(Initializer):
    ...
    Examples:
        >>> import luojianet_ms
        >>> from luojianet_ms.common.initializer import initializer, Dirac
        >>> tensor1 = initializer(Dirac(groups=2), [6, 4, 3, 3], luojianet_ms.float32)
        >>> tensor2 = initializer("dirac", [6, 4, 3, 3], luojianet_ms.float32)
    """
...
class Orthogonal(Initializer):
    ...
    Examples:
        >>> import luojianet_ms
        >>> from luojianet_ms.common.initializer import initializer, Orthogonal
...
class VarianceScaling(Initializer):
    ...
    Examples:
        >>> import luojianet_ms
        >>> from luojianet_ms.common.initializer import initializer, VarianceScaling
        >>> tensor1 = initializer(VarianceScaling(scale=1.0, mode='fan_out',
        ...                                       distribution='untruncated_normal'), [2, 3], luojianet_ms.float32)
        >>> tensor2 = initializer('varianceScaling', [2, 3], luojianet_ms.float32)
    """
...
class Uniform(Initializer):
    ...
    Examples:
        ...
        >>> tensor1 = initializer(Uniform(), [1, 2, 3], luojianet_ms.float32)
        >>> tensor2 = initializer('uniform', [1, 2, 3], luojianet_ms.float32)
    """
...
class Normal(Initializer):
    ...
    Examples:
        >>> import luojianet_ms
        >>> from luojianet_ms.common.initializer import initializer, Normal
        >>> tensor1 = initializer(Normal(), [1, 2, 3], luojianet_ms.float32)
        >>> tensor2 = initializer('normal', [1, 2, 3], luojianet_ms.float32)
    """
...
class TruncatedNormal(Initializer):
    ...
    Examples:
        ...
        >>> tensor1 = initializer(TruncatedNormal(), [1, 2, 3], luojianet_ms.float32)
        >>> tensor2 = initializer('truncatedNormal', [1, 2, 3], luojianet_ms.float32)
    """
...
def initializer(init, shape=None, dtype=mstype.float32):
    ...
    Args:
        ...
        dtype (:class:`luojianet_ms.dtype`): The type of data in initialized tensor. Default: luojianet_ms.float32.
    ...
    Examples:
        ...
        >>> from luojianet_ms.common.initializer import initializer, One
        >>> data = Tensor(np.zeros([1, 2, 3]), luojianet_ms.float32)
        >>> tensor1 = initializer(data, [1, 2, 3], luojianet_ms.float32)
        >>> tensor2 = initializer('ones', [1, 2, 3], luojianet_ms.float32)
        >>> tensor3 = initializer(One(), [1, 2, 3], luojianet_ms.float32)
        >>> tensor4 = initializer(0, [1, 2, 3], luojianet_ms.float32)
    """
