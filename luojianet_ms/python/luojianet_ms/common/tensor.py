...
class Tensor(Tensor_):
    ...
    Args:
        ...
        dtype (:class:`luojianet_ms.dtype`): Used to indicate the data type of the output Tensor. The argument should
            be defined in `luojianet_ms.dtype`. If it is None, the data type of the output Tensor will be the same
    ...
    @property
    def dtype(self):
        """Return the dtype of the tensor (:class:`luojianet_ms.dtype`)."""
        return self._dtype
    ...
    def all(self, axis=(), keep_dims=False):
        ...
        See also:
            :func:`luojianet_ms.Tensor.any`: Check any tensor element along a given axis evaluate to True.
    ...
    def any(self, axis=(), keep_dims=False):
        ...
        See also:
            :func:`luojianet_ms.Tensor.all`: Check all tensor elements along a given axis evaluate to True.
    ...
    def view(self, *shape):
        """
        Reshape the tensor according to the input shape. It's the same as :func:`luojianet_ms.Tensor.reshape`,
    ...
    def mean(self, axis=(), keep_dims=False):
        ...
        See also:
            :func:`luojianet_ms.Tensor.std`: Compute the standard deviation along the specified axis.

            :func:`luojianet_ms.Tensor.var`: Compute the variance along the specified axis.
    ...
    def ravel(self):
        ...
        See also:
            :func:`luojianet_ms.Tensor.reshape`: Give a new shape to a tensor without changing its data.

            :func:`luojianet_ms.Tensor.flatten`: Return a copy of the tensor collapsed into one dimension.
    ...
    def flatten(self, order='C'):
        ...
        See also:
            ...
            :func:`luojianet_ms.Tensor.ravel`: Return a contiguous flattened tensor.
    ...
    def narrow(self, axis, start, length):
        ...
        Examples:
            >>> import luojianet_ms
            >>> from luojianet_ms import Tensor
            >>> x = Tensor([[1, 2, 3], [4, 5, 6], [7, 8, 9]], luojianet_ms.int32)
    ...
    def squeeze(self, axis=None):
        ...
        See also:
            :func:`luojianet_ms.Tensor.expand_as`: Expand the dimension of target tensor to the dimension of input tensor.
    ...
    def astype(self, dtype, copy=True):
        ...
        Args:
            dtype (Union[:class:`luojianet_ms.dtype`, numpy.dtype, str]): Designated tensor dtype, can be in
                format of :class:`luojianet_ms.dtype.float32` or :class:`numpy.float32` or `float32`.
    ...
    def argmax(self, axis=None):
        ...
        See also:
            :func:`luojianet_ms.Tensor.argmin`: Return the indices of the minimum values along an axis.

            :func:`luojianet_ms.Tensor.min`: Return the minimum of a tensor or minimum along an axis.

            :func:`luojianet_ms.Tensor.max`: Return the maximum of a tensor or maximum along an axis.
    ...
    def argmin(self, axis=None):
        ...
        See also:
            :func:`luojianet_ms.Tensor.argmax`: Return the indices of the maximum values along an axis.
    ...
    def cumsum(self, axis=None, dtype=None):
        ...
        Args:
            ...
            dtype (:class:`luojianet_ms.dtype`, optional): If not specified, stay the same as original
        ...
        See also:
            :func:`luojianet_ms.Tensor.sum`: Return sum of tensor elements over a given axis.
    ...
    def min(self, axis=None, keepdims=False, initial=None, where=True):
        ...
        Examples:
            >>> from luojianet_ms import Tensor
            >>> import luojianet_ms.numpy as np
            >>> a = Tensor(np.arange(4).reshape((2,2)).astype('float32'))
            >>> output = a.min()
            >>> print(output)
            0.0
    ...
    def clip(self, xmin, xmax, dtype=None):
        ...
        Args:
            ...
            dtype (:class:`luojianet_ms.dtype`, optional): Overrides the dtype of the
    ...
    def resize(self, *new_shape):
        ...
        See also:
            ...
            :func:`luojianet_ms.Tensor.repeat`: Repeat elements of a tensor.
    ...
    def diagonal(self, offset=0, axis1=0, axis2=1):
        ...
        See also:
            :func:`luojianet_ms.Tensor.trace`: Return the sum along diagonals of the tensor.
    ...
    def trace(self, offset=0, axis1=0, axis2=1, dtype=None):
        ...
        Args:
            ...
            axis2 (int, optional): Axis to be used as the second axis of the 2-D
                sub-arrays from which the diagonals should be taken. Defaults to
                second axis.
            dtype (:class:`luojianet_ms.dtype`, optional): defaults to None. Overrides the dtype of the
                output Tensor.
        ...
        See also:
            :func:`luojianet_ms.Tensor.diagonal`: Return specified diagonals.
    ...
    def var(self, axis=None, ddof=0, keepdims=False):
        ...
        See also:
            :func:`luojianet_ms.Tensor.mean`: Reduce a dimension of a tensor by averaging all elements in the dimension.
    ...
    def sum(self, axis=None, dtype=None, keepdims=False, initial=None):
        ...
        See also:
            :func:`luojianet_ms.Tensor.cumsum`: Return the cumulative sum of the elements along a given axis.
    ...
    def repeat(self, repeats, axis=None):
        ...
        See also:
            ...
            :func:`luojianet_ms.Tensor.resize`: Changes shape and size of tensor in-place.
...
class SparseTensor(COOTensor_):
    ...
    Examples:
        >>> import luojianet_ms as ms
        >>> import luojianet_ms.nn as nn
        >>> from luojianet_ms import Tensor, SparseTensor
...
class COOTensor(COOTensor_):
    ...
    Examples:
        >>> import luojianet_ms as ms
        >>> import luojianet_ms.nn as nn
        >>> from luojianet_ms import Tensor, COOTensor
    ...
    @property
    def dtype(self):
        """Return the dtype of the values of COOTensor (:class:`luojianet_ms.dtype`)."""
        return self._dtype
    ...
    def astype(self, dtype):
        ...
        Args:
            dtype (Union[:class:`luojianet_ms.dtype`, numpy.dtype, str]): Designated tensor dtype.
...
class CSRTensor(CSRTensor_):
    ...
    Args:
        indptr (Tensor): 1-D Tensor of shape `[M]`, which equals to `shape[0] + 1`, which indicates the
            ...
            must be :class:`luojianet_ms.int16`, :class:`luojianet_ms.int32` or :class:`luojianet_ms.int64`.
    ...
    @property
    def dtype(self):
        """Return the dtype of the values of CSRTensor (:class:`luojianet_ms.dtype`)."""
        return self._dtype
