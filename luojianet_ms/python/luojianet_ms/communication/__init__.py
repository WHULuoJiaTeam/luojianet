...
<https://www.luojianet_ms.cn/tutorials/experts/en/r1.7/parallel/train_ascend.html>`_ for more details.
For the GPU device, users need to prepare the host file and mpi, please see the `GPU tutorial \
<https://www.luojianet_ms.cn/tutorials/experts/en/r1.7/parallel/train_gpu.html>`_
for more details.
"""
