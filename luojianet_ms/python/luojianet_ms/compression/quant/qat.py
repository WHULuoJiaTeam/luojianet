...
User can use quantization aware to train a model. LuoJiaNET supports quantization aware training,
...
aware training, LuoJiaNET provides conversion functions to convert the trained model into lower precision.
