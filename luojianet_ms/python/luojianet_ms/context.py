...
# ============================================================================
"""
The context of luojianet_ms, used to configure the current execution environment,
...
from luojianet_ms._c_expression import MSContext, ms_ctx_param
from luojianet_ms._checkparam import args_type_check, Validator, args_unreset_check
from luojianet_ms.parallel._auto_parallel_context import _set_auto_parallel_context, _get_auto_parallel_context, \
    _reset_auto_parallel_context
from luojianet_ms.parallel._ps_context import _set_ps_context, _get_ps_context, _reset_ps_context
...
def _context():
    ...
    if _k_context is None:
        ...
        try:
            from luojianet_ms import default_config
...
def set_auto_parallel_context(**kwargs):
    ...
    Note:
        ...
        next task, interface luojianet_ms.context.reset_auto_parallel_context() should be called to reset
        the configuration.
    ...
    Args:
        ...
        auto_parallel_search_mode (str): This is the old version of 'search_mode'. Here, remaining this attribute is
                     for forward compatibility, and this attribute will be deleted in a future LuoJiaNet version.
...
def set_context(**kwargs):
    ...
    Args:
        ...
        device_target (str): The target device to run, support "Ascend", "GPU", and "CPU".
            If device target is not set, the version of LuoJiaNet package is used.
        ...
        enable_profiling (bool): This parameters is deprecated, and will be deleted in the next version.
            Please use luojianet_ms.profiler.Profiler api instead.
        ...
        env_config_path (str): Config path for DFX.
            Through context.set_context(env_config_path="./luojianet_config.json")
        ...
        enable_graph_kernel (bool): Whether to enable graph kernel fusion to optimize network execution performance.
            ...
            `Enabling Graph Kernel Fusion <https://www.luojianet_ms.cn/docs/programming_guide
        ...
        auto_tune_mode (str): The mode of auto tune when op building, get the best tiling performance.
            ...
            `Enable the operator optimization tool <https://www.luojianet_ms.cn/docs/programming_guide/en
        ...
        enable_sparse (bool): Whether to enable sparsity feature. Default: False.
            ...
            `sparse tensor <https://www.luojianet_ms.cn/docs/programming_guide/en/master/tensor.html#sparse-tensor>`_.
    ...
    for key, value in kwargs.items():
        ...
        raise ValueError(f"For 'context.set_context', the keyword argument {key} is not recognized! For detailed "
                         f"usage of 'set_context', please refer to the LuoJiaNet official website.")
...
def get_context(attr_key):
    ...
    raise ValueError(f"For 'context.get_context', the argument {attr_key} is not recognized! For detailed "
                     f"usage of 'get_context', please refer to the LuoJiaNet official website.")
