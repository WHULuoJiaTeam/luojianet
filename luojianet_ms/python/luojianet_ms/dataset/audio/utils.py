...
from luojianet_ms.dataset.core.validator_helpers import check_non_negative_float32, check_non_negative_int32, \
...
def create_dct(n_mfcc, n_mels, norm=NormMode.NONE):
    ...
    Examples:
        >>> from luojianet_ms.dataset.audio import create_dct, NormMode
        >>>
...
def melscale_fbanks(n_freqs, f_min, f_max, n_mels, sample_rate, norm=NormType.NONE, mel_type=MelType.HTK):
    ...
    Examples:
        >>> from luojianet_ms.dataset.audio import melscale_fbanks
        >>>
