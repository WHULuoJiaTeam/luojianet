...
"""
import threading
from luojianet_ms._c_dataengine import PyDSCallback
...
class DSCallback:
    ...
    Examples:
        >>> from luojianet_ms.dataset import DSCallback
...
class WaitedDSCallback(Callback, DSCallback):
    ...
    `luojianet_ms.train.callback \
    <https://www.luojianet_ms.cn/docs/en/r1.7/api_python/luojianet_ms.train.html#luojianet_ms.train.callback.Callback>`_.
    ...
    Examples:
        ...
        >>> from luojianet_ms.dataset import WaitedDSCallback
    ...
    def ds_epoch_begin(self, ds_run_context):
        """
        Internal method, do not call/override. Define luojianet_ms.dataset.DSCallback.ds_epoch_begin
        to wait for luojianet_ms.train.callback.Callback.epoch_end.
    ...
    def ds_step_begin(self, ds_run_context):
        """
        Internal method, do not call/override. Define luojianet_ms.dataset.DSCallback.ds_step_begin
        to wait for luojianet_ms.train.callback.Callback.step_end.
