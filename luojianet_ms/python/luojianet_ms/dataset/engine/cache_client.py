...
import copy
from luojianet_ms._c_dataengine import CacheClient
...
class DatasetCache:
    ...
    For details, please check `Tutorial <https://www.luojianet_ms.cn/docs/programming_guide/en/master/enable_cache.html>`_,
    `Programming guide <https://www.luojianet_ms.cn/docs/programming_guide/en/master/cache.html>`_.
