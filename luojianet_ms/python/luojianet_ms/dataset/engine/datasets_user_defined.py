...
`tutorial <https://www.luojianet_ms.cn/tutorials/zh-CN/r1.7/advanced/dataset/custom.html>`
...
def _convert_row(row):
    ...
    if isinstance(row, prim_type):
        ...
        elif isinstance(row, Tensor):      # luojianet_ms.Tensor
            item = row.asnumpy()
        else:
    ...
    for x in row:
        ...
        elif isinstance(x, Tensor):      # luojianet_ms.Tensor
