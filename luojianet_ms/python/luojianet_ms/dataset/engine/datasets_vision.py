...
class KITTIDataset(MappableDataset):
    ...
    You can unzip the original KITTI dataset files into this directory structure and read by LuoJiaNET's API.
...
class LFWDataset(MappableDataset, VisionBaseDataset):
    ...
    You can unzip the original LFW dataset files into this directory structure and read by LuoJiaNET's API.
...
class OmniglotDataset(MappableDataset):
    ...
    You can unzip the original Omniglot dataset files into this directory structure and read by LuoJiaNET's API.
