...
import numpy as np
from luojianet_ms._c_dataengine import GraphDataClient
from luojianet_ms._c_dataengine import GraphDataServer
from luojianet_ms._c_dataengine import Tensor
from luojianet_ms._c_dataengine import SamplingStrategy as Sampling
from luojianet_ms._c_dataengine import OutputFormat as Format
...
class GraphData:
    ...
    About how to load raw graph dataset into LuoJiaNET please
    refer to `Loading Graph Dataset <https://www.luojianet_ms.cn/tutorials/zh-CN/r1.7/advanced/\
