...
def check_generatordataset(method):
    ...
    def new_method(self, *args, **kwargs):
        ...
        check_list = ['luojianet_ms.nn', 'luojianet_ms.ops', 'luojianet_ms.numpy', 'luojianet_ms.compression']
        ...
        if sampler is not None:
            ...
            if not isinstance(sampler, samplers.BuiltinSampler):
                try:
                    ...
                    raise TypeError("sampler should be either iterable or from luojianet_ms.dataset.samplers.")
...
def check_map(method):
    ...
    @wraps(method)
    def new_method(self, *args, **kwargs):
        from luojianet_ms.dataset.callback import DSCallback
