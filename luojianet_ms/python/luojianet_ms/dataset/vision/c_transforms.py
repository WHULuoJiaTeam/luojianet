...
Examples:
    >>> from luojianet_ms.dataset.vision import Border, Inter
...
class AutoAugment(ImageTensorOperation):
    ...
    Examples:
        >>> from luojianet_ms.dataset.vision import AutoAugmentPolicy, Inter
...
class BoundingBoxAugment(ImageTensorOperation):
    ...
    Raises:
        TypeError: If `transform` is not an image processing operation
            in :class:`luojianet_ms.dataset.vision.c_transforms`.
...
class ConvertColor(ImageTensorOperation):
    ...
    Raises:
        TypeError: If `convert_mode` is not of type :class:`luojianet_ms.dataset.vision.c_transforms.ConvertMode`.
        RuntimeError: If given tensor shape is not <H, W> or <H, W, C>.
...
class CutMixBatch(ImageTensorOperation):
    ...
    Raises:
        TypeError: If `image_batch_format` is not of type :class:`luojianet_ms.dataset.vision.ImageBatchFormat`.
    ...
    Examples:
        >>> from luojianet_ms.dataset.vision import ImageBatchFormat
        >>> onehot_op = c_transforms.OneHot(num_classes=10)
        >>> image_folder_dataset= image_folder_dataset.map(operations=onehot_op,
        ...                                                input_columns=["label"])
...
class Pad(ImageTensorOperation):
    ...
    Raises:
        ...
        TypeError: If `padding_mode` is not of type :class:`luojianet_ms.dataset.vision.Border`.
...
class RandomAffine(ImageTensorOperation):
    ...
    Raises:
        ...
        TypeError: If `resample` is not of type :class:`luojianet_ms.dataset.vision.Inter`.
        TypeError: If `fill_value` is not of type int or tuple[int].
...
class RandomCropDecodeResize(ImageTensorOperation):
    ...
    Raises:
        ...
        TypeError: If `interpolation` is not of type :class:`luojianet_ms.dataset.vision.Inter`.
...
class SlicePatches(ImageTensorOperation):
    ...
    Raises:
        ...
        TypeError: If `slice_mode` is not of type :class:`luojianet_ms.dataset.vision.Inter`.
