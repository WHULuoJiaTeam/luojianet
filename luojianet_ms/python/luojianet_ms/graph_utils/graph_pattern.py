...
from luojianet_ms._c_expression import Pattern, OneOf_, Prim_, Call_, NoneOf_, Any, NewTensor_, NewParameter_, Imm
...
class OneOf(OneOf_):
    ...
    def __init__(self, patterns=None):
        r"""
        Args:
            patterns(Union[:class:`luojianet_ms.graph_utils.graph_pattern`,
                           tuple[:class:`luojianet_ms.graph_utils.graph_pattern`],
                           list[:class:`luojianet_ms.graph_utils.graph_pattern`]]): list of allowed patterns,
...
class Prim(Prim_):
    ...
    def __init__(self, types, name=None):
        r"""
        Args:
            types (Union[str, :class:`luojianet_ms.ops.Primitive`, list[:class:`luojianet_ms.ops.Primitive`],
                   tuple[:class:`luojianet_ms.ops.Primitive`]):
...
class Call(Call_):
    ...
    def __init__(self, prim_pattern, inputs=None):
        r"""
        Args:
            prim_pattern (Union[str, :class:`luojianet_ms.graph_utils.graph_pattern.IsPrimTypeOf`,
                          :class:`luojianet_ms.ops.Primitive`]): Primitive ValueNode in the Primitive CNode.
            inputs (Union[list[:class:`luojianet_ms.graph_utils.graph_pattern`],
                          tuple[:class:`luojianet_ms.graph_utils.graph_pattern`]]):
...
class NoneOf(NoneOf_):
    ...
    def __init__(self, patterns=None):
        r"""
        Args:
            patterns(Union[list[:class:`luojianet_ms.graph_utils.graph_pattern`]]: list of forbidden patterns, each
...
class NewTensor(NewTensor_):
    ...
    def __init__(self, input_tensor):
        r"""
        Args:
            input_tensor(:class:`luojianet_ms.common.tensor.Tensor`): new tensor to be used in the target.
...
class NewParameter(NewParameter_):
    ...
    def __init__(self, para_name, default_tensor, requires_grad=False, layerwise_parallel=False):
        ...
        Args:
            ...
            default_tensor(:class:`luojianet_ms.common.tensor.Tensor`): default value for the new Parameter.
