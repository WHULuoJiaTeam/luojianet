...
from luojianet_ms.graph_utils.graph_pattern import Pattern, NewParameter
from luojianet_ms._c_expression import PyPassManager_
...
def register_pass(requires_grad=True, run_only_once=False):
    ...
    Examples:
        >>> from luojianet_ms.graph_utils.graph_pattern import Call, Any
...
def gen_new_parameter(pattern):
    ...
    Examples:
        >>> from luojianet_ms.graph_utils.graph_pattern import NewParameter
