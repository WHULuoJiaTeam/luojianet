...
class _DataFormatter(logging.Formatter):
    ...
    def format(self, record):
        ...
        """
        # NOTICE: when the Installation directory of luojianet_ms changed,
        # ms_home_path must be changed
        ms_install_home_path = 'luojianet_ms'
...
def info(msg, *args, **kwargs):
    """
    Log a message with severity 'INFO' on the LuoJiaNet logger.
...
def debug(msg, *args, **kwargs):
    """
    Log a message with severity 'DEBUG' on the LuoJiaNet logger.
...
def error(msg, *args, **kwargs):
    """Log a message with severity 'ERROR' on the LuoJiaNet logger."""
    _get_logger().error(msg, *args, **kwargs)


def warning(msg, *args, **kwargs):
    """Log a message with severity 'WARNING' on the LuoJiaNet logger."""
    _get_logger().warning(msg, *args, **kwargs)


def critical(msg, *args, **kwargs):
    """Log a message with severity 'CRITICAL' on the LuoJiaNet logger."""
