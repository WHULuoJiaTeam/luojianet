...
from luojianet_ms.common.hook_handle import HookHandle
from luojianet_ms.context import ParallelMode
from luojianet_ms.ops.composite import Shard
from .. import context
...
class Module(Cell_):
    ...
    IGNORE_LIST = ['_scope', '_cell_init_args', '_auto_prefix', '_cells', '_params', '_construct_inputs_names',
                   '_construct_inputs_num', '_create_time', '_luojianet_ms_flags', '_parallel_inputs_run',
    ...
    def add_flags(self, **flags):
        ...
        """
        if not hasattr(self, "_luojianet_ms_flags"):
            self._luojianet_ms_flags = {}
        self._luojianet_ms_flags.update({**flags})
    ...
    def get_flags(self):
        ...
        if not hasattr(self, "_luojianet_ms_flags"):
            self._luojianet_ms_flags = {}
        return self._luojianet_ms_flags
    ...
    def set_boost(self, boost_type):
        ...
        `algorithm library <https://gitee.com/luojianet_ms/luojianet_ms/tree/master/luojianet_ms/python/luojianet_ms/boost>`_.
    ...
    def register_forward_pre_hook(self, hook_fn):
        ...
        Returns:
            Handle, it is an instance of `luojianet_ms.common.hook_handle.HookHandle` and corresponding to the `hook_fn` .
