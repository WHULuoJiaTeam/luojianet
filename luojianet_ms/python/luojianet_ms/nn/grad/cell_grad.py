...
class _FirstGrad(Module):
    ...
    def call(self, u, first_grad_input):
...
class _JvpFirstGrad(Module):
    ...
    def call(self, u, fn, first_grad_input):
...
class _FirstGradSingleValue(Module):
    ...
    def call(self, u, first_grad_single_value_input):
...
class _JvpFirstGradSingleValue(Module):
    ...
    def call(self, u, fn, first_grad_single_value_input):
...
class Jvp(Module):
    ...
    Args:
        network (Module): The network that takes Tensor inputs and returns a tuple of Tensors or a Tensor.
