...
class Conv2d(_Conv):
    ...
    Examples:
        ...
        >>> x = Tensor(np.ones([1, 120, 1024, 640]), luojianet_ms.float32)
        >>> output = net(x).shape
        >>> print(output)
        (1, 240, 1024, 640)
    """
...
class Conv1d(_Conv):
    ...
    Examples:
        ...
        >>> x = Tensor(np.ones([1, 120, 640]), luojianet_ms.float32)
        >>> output = net(x).shape
        >>> print(output)
        (1, 240, 640)
    """
...
class Conv3d(_Conv):
    ...
    Examples:
        >>> x = Tensor(np.ones([16, 3, 10, 32, 32]), luojianet_ms.float32)
...
class Conv3dTranspose(_Conv):
    ...
    Examples:
        >>> x = Tensor(np.ones([32, 16, 10, 32, 32]), luojianet_ms.float32)
...
class Conv2dTranspose(_Conv):
    ...
    Examples:
        ...
        >>> x = Tensor(np.ones([1, 3, 16, 50]), luojianet_ms.float32)
        >>> output = net(x).shape
        >>> print(output)
        (1, 64, 19, 53)
        """
...
class Conv1dTranspose(_Conv):
    ...
    Examples:
        ...
        >>> x = Tensor(np.ones([1, 3, 50]), luojianet_ms.float32)
        >>> output = net(x).shape
        >>> print(output)
        (1, 64, 53)
    """
