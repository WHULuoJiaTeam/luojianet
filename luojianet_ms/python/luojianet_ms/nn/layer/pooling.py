...
class MaxPool2d(_PoolNd):
    ...
    Examples:
        ...
        >>> x = Tensor(np.random.randint(0, 10, [1, 2, 4, 4]), luojianet_ms.float32)
        >>> output = pool(x)
        >>> print(output.shape)
        (1, 2, 2, 2)
    """
...
class MaxPool1d(_PoolNd):
    ...
    Examples:
        ...
        >>> x = Tensor(np.random.randint(0, 10, [1, 2, 4]), luojianet_ms.float32)
        >>> output = max_pool(x)
        >>> result = output.shape
        >>> print(result)
        (1, 2, 2)
...
class AvgPool1d(_PoolNd):
    ...
    Examples:
        ...
        >>> x = Tensor(np.random.randint(0, 10, [1, 3, 6]), luojianet_ms.float32)
        >>> output = pool(x)
        >>> result = output.shape
        >>> print(result)
        (1, 3, 1)
