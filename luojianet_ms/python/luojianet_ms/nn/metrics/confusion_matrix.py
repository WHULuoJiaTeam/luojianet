...
class ConfusionMatrix(Metric):
    ...
    'TPR', 'TNR', etc., use class 'luojianet_ms.metrics.ConfusionMatrixMetric'.
...
class ConfusionMatrixMetric(Metric):
    ...
    If you only want to calculate confusion matrix, please use 'luojianet_ms.metrics.ConfusionMatrix'.
