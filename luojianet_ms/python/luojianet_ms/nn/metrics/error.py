...
class MAE(Metric):
    ...
    Examples:
        ...
        >>>
        >>> x = Tensor(np.array([0.1, 0.2, 0.6, 0.9]), luojianet_ms.float32)
        >>> y = Tensor(np.array([0.1, 0.25, 0.7, 0.9]), luojianet_ms.float32)
        >>> error = nn.MAE()
        >>> error.clear()
        >>> error.update(x, y)
        >>> result = error.eval()
...
class MSE(Metric):
    ...
    Examples:
        ...
        >>>
        >>> x = Tensor(np.array([0.1, 0.2, 0.6, 0.9]), luojianet_ms.float32)
        >>> y = Tensor(np.array([0.1, 0.25, 0.5, 0.9]), luojianet_ms.float32)
        >>> error = nn.MSE()
        >>> error.clear()
        >>> error.update(x, y)
        >>> result = error.eval()
