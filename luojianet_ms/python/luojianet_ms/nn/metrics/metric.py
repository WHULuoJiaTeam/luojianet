...
def rearrange_inputs(func):
    ...
    This decorator is currently applied on the `update` of :class:`luojianet_ms.nn.Metric`.

    Examples:
        >>> from luojianet_ms.nn import rearrange_inputs
...
class Metric(metaclass=ABCMeta):
    ...
    :class:`luojianet_ms.nn.MAE`, :class:`luojianet_ms.nn.Recall` etc.
    ...
    def set_indexes(self, indexes):
        ...
        Note:
            ...
            :func:`luojianet_ms.nn.rearrange_inputs` for the `indexes` to take effect.
