...
from luojianet_ms.nn.layer import DenseThor, Conv2dThor, EmbeddingThor, EmbeddingLookupThor
from luojianet_ms.nn.wrap import DistributedGradReducer
from luojianet_ms.train.train_thor.convert_utils import ConvertNetUtils
...
def thor(net, learning_rate, damping, momentum, weight_decay=0.0, loss_scale=1.0, batch_size=32,
    ...
    Examples:
        >>> from luojianet_ms.nn import thor
        >>> from luojianet_ms import Model
        >>> from luojianet_ms import FixedLossScaleManager
