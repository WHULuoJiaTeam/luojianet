# LuoJiaNet Deep Probabilistic Programming

![LuoJiaNet+ZhuSuan](https://images.gitee.com/uploads/images/2020/0814/172009_ff0cdc1a_6585083.png "MS-Zhusuan.PNG")

LuoJiaNet Deep Probabilistic Programming (MDP) is a programming library for Bayesian deep learning. MDP is cooperatively developed with [ZhuSuan](https://zhusuan.readthedocs.io/en/latest/), which provides deep learning style primitives and algorithms for building probabilistic models and applying Bayesian inference.
...
- Distributions ([luojianet_ms.nn.probability.distribution](https://gitee.com/luojianet_ms/luojianet_ms/tree/master/luojianet_ms/python/luojianet_ms/nn/probability/distribution)): A large collection of probability distributions.
- Bijectors([luojianet_ms.nn.probability.bijectors](https://gitee.com/luojianet_ms/luojianet_ms/tree/master/luojianet_ms/python/luojianet_ms/nn/probability/bijector)): Reversible and composable transformations of random variables.

### Layer 1-2: Probabilistic inference algorithms

- SVI([luojianet_ms.nn.probability.infer.variational](https://gitee.com/luojianet_ms/luojianet_ms/tree/master/luojianet_ms/python/luojianet_ms/nn/probability/infer/variational)): A unified interface for stochastic variational inference.
...
- Layers([luojianet_ms.nn.probability.bnn_layers](https://gitee.com/luojianet_ms/luojianet_ms/tree/master/luojianet_ms/python/luojianet_ms/nn/probability/bnn_layers)): BNN layers, which are used to call BNN.
...
- Uncertainty Estimation([luojianet_ms.nn.probability.toolbox.uncertainty_evaluation](https://gitee.com/luojianet_ms/luojianet_ms/tree/master/luojianet_ms/python/luojianet_ms/nn/probability/toolbox/uncertainty_evaluation.py)): Interfaces to estimate epistemic uncertainty and aleatoric uncertainty.
...
MDP requires LuoJiaNet version 0.7.0-beta or later. MDP is actively evolving. Interfaces may change as LuoJiaNet releases are iteratively updated.

## Tutorial

### Bayesian Neural Network

1. Process the required dataset. The MNIST dateset is used in the example. Data processing is consistent with [Implementing an Image Classification Application](https://www.luojianet_ms.cn/tutorials/en/master/quick_start.html) in Tutorial.
...
The way to call Bayesian Neural Network by bnn_layers is the same as DNN. It's worth noting that bnn_layers and traditional layers of DNN can be combined with each other.
...
2. Use ELBO interface to define the loss function and define the optimizer, then call the cell_net using WithLossCell.
...
3. Process the required dataset. The MNIST dateset is used in the example. Data processing is consistent with [Implementing an Image Classification Application](https://www.luojianet_ms.cn/tutorials/en/master/quick_start.html) in Tutorial.
...
```python
from luojianet_ms.nn.probability.infer import SVI
...
```python
from luojianet_ms.nn.probability import transforms
...
- [Bayesian LeNet](https://gitee.com/luojianet_ms/luojianet_ms/blob/master/tests/st/probability/bnn_layers/test_bnn_layer.py). How to call and train a LeNet by bnn layers.
...
- [Conditional Variational Auto-Encoder](https://gitee.com/luojianet_ms/luojianet_ms/blob/master/tests/st/probability/dpn/test_gpu_svi_cvae.py): Conditional Variational Auto-Encoder (CVAE) model trained with MNIST to generate sample images.
- [VAE-GAN](https://gitee.com/luojianet_ms/luojianet_ms/blob/master/tests/st/probability/dpn/test_gpu_vae_gan.py): VAE-GAN model trained with MNIST to generate sample images.
- [Uncertainty Estimation](https://gitee.com/luojianet_ms/luojianet_ms/blob/master/tests/st/probability/toolbox/test_uncertainty.py): Evaluate uncertainty of model and data.

## Community

As part of LuoJiaNet, we are committed to creating an open and friendly environment.

- [Gitee](https://gitee.com/luojianet_ms/luojianet_ms/issues): Report bugs or make feature requests.
