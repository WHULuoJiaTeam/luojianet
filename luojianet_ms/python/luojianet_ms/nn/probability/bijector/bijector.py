...
class Bijector(Module):
    ...
    Args:
        ...
        dtype (luojianet_ms.dtype): The type of the distributions that the Bijector can operate on. Default: None.
    ...
    Note:
        ...
        raised. Only subtype of luojianet_ms.float_type can be used to specify bijector's `dtype`.
    """
    ...
    def __call__(self, *args, **kwargs):
        ...
        go in the call and invoke the corresponding Bijector function.
