...
def cast_to_tensor(t, hint_type=mstype.float32):
    ...
    Args:
        ...
        dtype (luojianet_ms.dtype): dtype of the Tensor. Default: mstype.float32.
...
def cast_type_for_device(dtype):
    ...
    Args:
        dtype (luojianet_ms.dtype): input dtype.
    Returns:
        luojianet_ms.dtype.
    """
...
def set_param_type(args, hint_type):
    ...
    Args:
        ...
        hint_type (luojianet_ms.dtype): hint type to return.
