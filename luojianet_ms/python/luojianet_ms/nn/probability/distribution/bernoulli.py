...
class Bernoulli(Distribution):
    ...
    Examples:
        ...
        >>> b1 = msd.Bernoulli(0.5, dtype=luojianet_ms.int32)
        ...
        >>> b2 = msd.Bernoulli(dtype=luojianet_ms.int32)
        >>> # Here are some tensors used below for testing
        >>> value = Tensor([1, 0, 1], dtype=luojianet_ms.int32)
        >>> probs_a = Tensor([0.6], dtype=luojianet_ms.float32)
        >>> probs_b = Tensor([0.2, 0.3, 0.4], dtype=luojianet_ms.float32)
