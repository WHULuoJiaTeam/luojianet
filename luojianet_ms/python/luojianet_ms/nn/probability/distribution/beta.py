...
class Beta(Distribution):
    ...
    Args:
        ...
        dtype (luojianet_ms.dtype): The type of the event samples. Default: mstype.float32.
    ...
    Inputs and Outputs of APIs:
        ...
        please refer to :class:`luojianet_ms.nn.probability.distribution.Distribution`, and examples below.
    ...
    Examples:
        ...
        >>> b1 = msd.Beta([3.0], [4.0], dtype=luojianet_ms.float32)
        ...
        >>> b2 = msd.Beta(dtype=luojianet_ms.float32)
        >>> # Here are some tensors used below for testing
        >>> value = Tensor([0.1, 0.5, 0.8], dtype=luojianet_ms.float32)
        >>> concentration1_a = Tensor([2.0], dtype=luojianet_ms.float32)
        >>> concentration0_a = Tensor([2.0, 2.0, 2.0], dtype=luojianet_ms.float32)
        >>> concentration1_b = Tensor([1.0], dtype=luojianet_ms.float32)
        >>> concentration0_b = Tensor([1.0, 1.5, 2.0], dtype=luojianet_ms.float32)
