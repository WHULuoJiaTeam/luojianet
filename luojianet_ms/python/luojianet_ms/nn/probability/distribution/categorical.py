...
from luojianet_ms.ops.functional import stop_gradient
...
class Categorical(Distribution):
    ...
    Args:
        ...
        dtype (luojianet_ms.dtype): The type of the event samples. Default: mstype.int32.
    ...
    Examples:
        ...
        >>> ca1 = msd.Categorical(probs=[0.2, 0.8], dtype=luojianet_ms.int32)
        ...
        >>> ca2 = msd.Categorical(dtype=luojianet_ms.int32)
        >>> # Here are some tensors used below for testing
        >>> value = Tensor([1, 0], dtype=luojianet_ms.int32)
        >>> probs_a = Tensor([0.5, 0.5], dtype=luojianet_ms.float32)
        >>> probs_b = Tensor([0.35, 0.65], dtype=luojianet_ms.float32)
