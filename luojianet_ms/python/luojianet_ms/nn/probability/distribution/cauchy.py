...
class Cauchy(Distribution):
    ...
    Examples:
        ...
        >>> cauchy1 = msd.Cauchy(3.0, 4.0, dtype=luojianet_ms.float32)
        >>> # A Cauchy distribution can be initialized without arguments.
        >>> # In this case, 'loc' and `scale` must be passed in through arguments.
        >>> cauchy2 = msd.Cauchy(dtype=luojianet_ms.float32)
        >>> # Here are some tensors used below for testing
        >>> value = Tensor([1.0, 2.0, 3.0], dtype=luojianet_ms.float32)
        >>> loc_a = Tensor([2.0], dtype=luojianet_ms.float32)
        >>> scale_a = Tensor([2.0, 2.0, 2.0], dtype=luojianet_ms.float32)
        >>> loc_b = Tensor([1.0], dtype=luojianet_ms.float32)
        >>> scale_b = Tensor([1.0, 1.5, 2.0], dtype=luojianet_ms.float32)
