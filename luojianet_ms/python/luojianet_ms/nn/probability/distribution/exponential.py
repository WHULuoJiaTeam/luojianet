...
class Exponential(Distribution):
    ...
    Examples:
        ...
        >>> e1 = msd.Exponential(0.5, dtype=luojianet_ms.float32)
        ...
        >>> e2 = msd.Exponential(dtype=luojianet_ms.float32)
        >>> # Here are some tensors used below for testing
        >>> value = Tensor([1, 2, 3], dtype=luojianet_ms.float32)
        >>> rate_a = Tensor([0.6], dtype=luojianet_ms.float32)
        >>> rate_b = Tensor([0.2, 0.5, 0.4], dtype=luojianet_ms.float32)
