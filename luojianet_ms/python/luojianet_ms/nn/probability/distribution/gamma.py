...
class Gamma(Distribution):
    ...
    Examples:
        ...
        >>> g1 = msd.Gamma([3.0], [4.0], dtype=luojianet_ms.float32)
        ...
        >>> g2 = msd.Gamma(dtype=luojianet_ms.float32)
        >>> # Here are some tensors used below for testing
        >>> value = Tensor([1.0, 2.0, 3.0], dtype=luojianet_ms.float32)
        >>> concentration_a = Tensor([2.0], dtype=luojianet_ms.float32)
        >>> rate_a = Tensor([2.0, 2.0, 2.0], dtype=luojianet_ms.float32)
        >>> concentration_b = Tensor([1.0], dtype=luojianet_ms.float32)
        >>> rate_b = Tensor([1.0, 1.5, 2.0], dtype=luojianet_ms.float32)
        >>>
