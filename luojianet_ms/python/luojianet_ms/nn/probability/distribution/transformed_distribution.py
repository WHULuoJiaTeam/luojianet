...
class TransformedDistribution(Distribution):
    ...
    Note:
        ...
        For example, mynormal = msd.Normal(dtype=luojianet_ms.float32) cannot be used to initialized a
    ...
    Examples:
        ...
        >>> tx = Tensor(x, dtype=luojianet_ms.float32)
        >>> cdf, sample = net(tx)
        >>> print(sample.shape)
        (2, 3)
    """
    ...
    def dtype(self):
        ...
        Output:
            LuoJiaNET.dtype, the dtype of the transformed distribution.
        """
        return self._dtype
