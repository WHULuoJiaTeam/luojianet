...
class Uniform(Distribution):
    ...
    Examples:
        ...
        >>> u1 = msd.Uniform(0.0, 1.0, dtype=luojianet_ms.float32)
        ...
        >>> u2 = msd.Uniform(dtype=luojianet_ms.float32)
        >>>
        >>> # Here are some tensors used below for testing
        >>> value = Tensor([0.5, 0.8], dtype=luojianet_ms.float32)
        >>> low_a = Tensor([0., 0.], dtype=luojianet_ms.float32)
        >>> high_a = Tensor([2.0, 4.0], dtype=luojianet_ms.float32)
        >>> low_b = Tensor([-1.5], dtype=luojianet_ms.float32)
        >>> high_b = Tensor([2.5, 5.], dtype=luojianet_ms.float32)
