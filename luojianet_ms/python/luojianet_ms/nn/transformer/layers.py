...
from luojianet_ms.common.initializer import initializer, Tensor
...
class _LayerNorm(Cell):
    ...
    def shard(self, strategy):
        ...
        Examples:
            >>> import luojianet_ms
            >>> net = luojianet_ms.parallel.nn.transformer.LayerNorm(normalized_shape=(1024, 10))
            >>> net.shard(((10, 2, 1),))
        """
        if self.is_self_defined:
...
class FixedSparseAttention(nn.Cell):
    ...
    Examples:
        ...
        >>> from luojianet_ms.nn.transformer import FixedSparseAttention
