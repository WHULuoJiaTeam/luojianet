...
class EmbeddingOpParallelConfig(_Config):
    r"""
        ...
        Examples:
            >>> from luojianet_ms.nn.transformer import EmbeddingOpParallelConfig
...
class TransformerRecomputeConfig(_Config):
    r"""
        ...
        Examples:
            >>> from luojianet_ms.nn.transformer import TransformerRecomputeConfig
...
class FeedForward(Module):
    r"""
        ...
        Examples:
            >>> import numpy as np
            >>> from luojianet_ms.nn.transformer import FeedForward
...
class AttentionMask(Module):
    r"""
        ...
        Examples:
            >>> import numpy as np
            >>> from luojianet_ms.nn.transformer import AttentionMask
            >>> from luojianet_ms import Tensor
...
class VocabEmbedding(Module):
    """
        ...
        Examples:
            >>> import numpy as np
            >>> from luojianet_ms.nn.transformer import VocabEmbedding
            >>> from luojianet_ms import Tensor
            >>> from luojianet_ms import dtype as mstype
...
class MultiHeadAttention(Module):
    r"""
        ...
        Examples:
            >>> import numpy as np
            >>> from luojianet_ms.nn.transformer import MultiHeadAttention
            >>> from luojianet_ms import dtype as mstype
            >>> from luojianet_ms import Tensor
...
class TransformerEncoderLayer(Module):
    r"""
        ...
        Examples:
            >>> import numpy as np
            >>> from luojianet_ms import dtype as mstype
            >>> from luojianet_ms.nn.transformer import TransformerEncoderLayer
            >>> from luojianet_ms import Tensor
...
class TransformerDecoderLayer(Module):
    r"""
        ...
        Examples:
            >>> import numpy as np
            >>> from luojianet_ms import dtype as mstype
            >>> from luojianet_ms.nn.transformer import TransformerDecoderLayer
            >>> from luojianet_ms import Tensor
...
class TransformerEncoder(Module):
    r"""
        ...
        Examples:
            >>> import numpy as np
            >>> from luojianet_ms import dtype as mstype
            >>> from luojianet_ms.nn.transformer import TransformerEncoder
            >>> from luojianet_ms import Tensor
...
class TransformerDecoder(Module):
    r"""
        ...
        Examples:
            >>> import numpy as np
            >>> from luojianet_ms import dtype as mstype
            >>> from luojianet_ms.nn.transformer import TransformerDecoder
            >>> from luojianet_ms import Tensor
...
class Transformer(Module):
    r"""
        ...
        Examples:
            >>> import numpy as np
            >>> from luojianet_ms import dtype as mstype
            >>> from luojianet_ms.nn.transformer import Transformer
            >>> from luojianet_ms import Tensor
