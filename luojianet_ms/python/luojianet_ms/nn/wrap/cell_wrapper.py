...
from luojianet_ms.parallel._utils import (_get_device_num, _get_gradients_mean,
...
class TrainOneStepCell(Cell):
    ...
    Examples:
        ...
        >>> #1) Using the WithLossCell provided by LuoJiaNET
    ...
    def __init__(self, network, optimizer, sens=1.0):
        ...
        if self.reducer_flag:
            ...
            if isinstance(self.optimizer, (nn.AdaSumByGradWrapCell, nn.AdaSumByDeltaWeightWrapCell)):
                from luojianet_ms.communication.management import get_group_size, create_group, get_rank
...
class GetNextSingleOp(Cell):
    ...
    Args:
        dataset_types (list[:class:`luojianet_ms.dtype`]): The types of dataset.
...
class ParameterUpdate(Cell):
    ...
    Examples:
        ...
        >>> weight = Tensor(np.arange(12).reshape((4, 3)), luojianet_ms.float32)
