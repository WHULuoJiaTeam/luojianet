...
class DynamicLossScaleUpdateCell(Cell):
    ...
    `get_update_cell` method of :class:`luojianet_ms.DynamicLossScaleManager` will return this class, it will be called
    by :class:`luojianet_ms.nn.TrainOneStepWithLossScaleCell` during training to update loss scale.
...
class FixedLossScaleUpdateCell(Cell):
    ...
    `get_update_cell` method of :class:`luojianet_ms.FixedLossScaleManager` will return this class, it will be called
    by :class:`luojianet_ms.nn.TrainOneStepWithLossScaleCell` during trainning.
