...
def diff(a, n=1, axis=-1, prepend=None, append=None):
    ...
    Note:
        Since zero-shaped Tensor is not supported in LuoJiaNET, a value error is raised if
...
def cov(m, y=None, rowvar=True, bias=False, ddof=None, fweights=None, aweights=None, dtype=None):
    ...
    Note:
        ...
        are detected, a value error will be raised, in LuoJiaNET we converts all values
        to positive instead.
    ...
    Args:
        ...
        dtype (Union[:class:`luojianet_ms.dtype`, str], optional): Data-type of the
...
def exp2(x, dtype=None):
    ...
    Args:
        ...
        dtype (:class:`luojianet_ms.dtype`, optional): Defaults to :class:`None`. Overrides the dtype of the
            output Tensor.
...
def cumsum(a, axis=None, dtype=None):
    ...
    Args:
        ...
        dtype (:class:`luojianet_ms.dtype`, optional): If not specified, stay the same as `a`,
...
def log1p(x, dtype=None):
    ...
    Args:
        x (Tensor): Input array.
        dtype (:class:`luojianet_ms.dtype`): Default: :class:`None`. Overrides the dtype of the
            output Tensor.
...
def log2(x, dtype=None):
    ...
    Args:
        x (Tensor): Input tensor.
        dtype (:class:`luojianet_ms.dtype`, optional): Default: :class:`None`. Overrides the dtype of the
            output Tensor.
...
def tan(x, dtype=None):
    ...
    Raises:
        TypeError: If the input is not a tensor or is :class:`tensor.dtype` is :class:`luojianet_ms.float64`.
...
def promote_types(type1, type2):
    ...
    Args:
        type1 (Union[:class:`luojianet_ms.dtype`, str]): First data type.
        type2 (Union[:class:`luojianet_ms.dtype`, str]): Second data type.

    Returns:
        The promoted data type.

    Raises:
        TypeError: If the input are not valid :class:`luojianet_ms.dtype` input.
...
def corrcoef(x, y=None, rowvar=True, dtype=None):
    ...
    Args:
        ...
        rowvar (bool, optional): If rowvar is `True` (default), then each row represents
            ...
            Default: `True`.
        dtype (:class:`luojianet_ms.dtype`, optional): Data-type of the result. By default,
...
def searchsorted(a, v, side='left', sorter=None):
    ...
    Examples:
        >>> from luojianet_ms import numpy as np
...
def result_type(*arrays_and_dtypes):
    ...
    Args:
        *arrays_and_dtypes (Union[int, float, bool, list, tuple, Tensor, :class:`luojianet_ms.dtype`, str]):
            The operands of some operation whose result type is needed.

    Returns:
        :class:`luojianet_ms.dtype`, the result type.
...
def cumprod(a, axis=None, dtype=None):
    ...
    Args:
        ...
        dtype (:class:`luojianet_ms.dtype`, optional): Default: `None`. Overrides the dtype of the
            output Tensor.
