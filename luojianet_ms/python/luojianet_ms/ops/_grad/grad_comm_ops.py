...
from luojianet_ms.communication import get_rank, get_group_size
from luojianet_ms.parallel._utils import _get_enable_parallel_optimizer, _get_grad_accumulation_shard
