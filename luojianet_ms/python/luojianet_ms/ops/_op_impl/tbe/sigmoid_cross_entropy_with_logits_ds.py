...
sigmoid_cross_entropy_with_logits_ds_op_info = TBERegOp("SigmoidCrossEntropyWithLogits") \
    .fusion_type("OPAQUE") \
    .async_flag(False) \
...
@op_info_register(sigmoid_cross_entropy_with_logits_ds_op_info)
def _sigmoid_cross_entropy_with_logits_ds_tbe():
