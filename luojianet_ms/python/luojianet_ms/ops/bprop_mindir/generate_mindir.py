...
if __name__ == "__main__":
    ...
    parser.add_argument('--luojianet_path', type=str, default=None,
    ...
    luojianet_path = args_opt.luojianet_path
    bprop_src_dir = None
    bprop_mindir_src_dir = None
    if not luojianet_path is None:
        luojianet_path = luojianet_path.rstrip('/')
        bprop_src_dir = luojianet_path + "/luojianet_ms/python/luojianet_ms/ops/_grad"
        bprop_mindir_src_dir = luojianet_path + "/luojianet_ms/python/luojianet_ms/ops/bprop_mindir"
