...
Example:
    >>> input = Tensor([2, 3], luojianet_ms.int32)
    >>> ones = ones_like(input) # The dtype of ones is luojianet_ms.int32
    >>> input = Tensor([2, 3], luojianet_ms.float16)
    >>> ones = ones_like(input) # The dtype of ones is luojianet_ms.float16
"""
