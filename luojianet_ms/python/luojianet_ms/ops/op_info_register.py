...
BUILT_IN_OPS_REGISTER_PATH = "luojianet_ms/ops/_op_impl"
BUILT_IN_CUSTOM_OPS_REGISTER_PATH = "luojianet_ms/ops/_op_impl/_custom_op"
...
def custom_info_register(*reg_info):
    ...
    Examples:
        >>> from luojianet_ms.ops import custom_info_register, CustomRegOp, DataType
...
class CustomRegOp(RegOp):
    r"""
    Class used for generating the registration information for the `func` parameter of :class:`luojianet_ms.ops.Custom`.
    ...
    Examples:
        >>> from luojianet_ms.ops import CustomRegOp, DataType
