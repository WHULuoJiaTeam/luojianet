...
class CusBatchMatMul(PrimitiveWithInfer):
    ...
    Examples:
        >>> input_x = Tensor(np.ones(shape=[2, 128, 128]), luojianet_ms.float32)
        >>> input_y = Tensor(np.ones(shape=[2, 128, 128]), luojianet_ms.float32)
    ...
    def __init__(self):
        ...
        from luojianet_ms.ops._op_impl._custom_op.batch_matmul_impl import cus_batch_matmul
...
class CusCholeskyTrsm(PrimitiveWithInfer):
    ...
    Examples:
        >>> input_x = Tensor(np.ones(shape=[256, 256]), luojianet_ms.float32)
    ...
    def __init__(self):
        ...
        from luojianet_ms.ops._op_impl._custom_op.cholesky_trsm_impl import cus_cholesky_trsm
...
class CusFusedAbsMax1(PrimitiveWithInfer):
    ...
    Examples:
        >>> input_x = Tensor(np.ones(shape=[1, 3]), luojianet_ms.float32)
    ...
    def __init__(self, origin_shape=(-1, -1)):
        ...
        from luojianet_ms.ops._op_impl._custom_op.fused_abs_max1_impl import cus_fused_abs_max1
...
class CusImg2Col(PrimitiveWithInfer):
    ...
    Examples:
        >>> input_x = Tensor(np.ones(shape=[32, 3, 224, 224]), luojianet_ms.float16)
    ...
    def __init__(self, ksizes, strides, dilates=(1, 1, 1, 1), mode="NC1HWC0"):
        ...
        self.mode = mode
        from luojianet_ms.ops._op_impl._custom_op.img2col_impl import cus_img2col
...
class CusMatMulCubeDenseLeft(PrimitiveWithInfer):
    ...
    Examples:
        >>> input_x = Tensor(np.ones(shape=[16, 16, 16, 16]), luojianet_ms.float16)
        >>> input_y = Tensor(np.ones(shape=[256, 256]), luojianet_ms.float16)
    ...
    def __init__(self):
        ...
        self.init_prim_io_names(inputs=['x1', 'x2'], outputs=['y'])
        from luojianet_ms.ops._op_impl._custom_op.matmul_cube_dense_left_impl import cus_matmul_cube_dense_left
...
class CusMatMulCubeFraczRightMul(PrimitiveWithInfer):
    ...
    Examples:
        >>> input_x1 = Tensor(np.ones(shape=[256, 256]), luojianet_ms.float16)
        >>> input_x2 = Tensor(np.ones(shape=[16, 16, 16, 16]), luojianet_ms.float16)
        >>> input_x3 = Tensor(np.ones(shape=[1, ]), luojianet_ms.float16)
    ...
    def __init__(self):
        ...
        from luojianet_ms.ops._op_impl._custom_op.matmul_cube_fracz_right_mul_impl import cus_matmul_cube_fraczrightmul
...
class CusMatMulCube(PrimitiveWithInfer):
    ...
    Examples:
        >>> input_x = Tensor(np.ones(shape=[256, 256]), luojianet_ms.float16)
        >>> input_y = Tensor(np.ones(shape=[256, 256]), luojianet_ms.float16)
    ...
    def __init__(self, transpose_a=False, transpose_b=False):
        ...
        from luojianet_ms.ops._op_impl._custom_op.matmul_cube_impl import cus_matmul_cube
...
class CusMatrixCombine(PrimitiveWithInfer):
    ...
    def __init__(self):
        ...
        from luojianet_ms.ops._op_impl._custom_op.matrix_combine_impl import cus_matrix_combine
...
class CusTranspose02314(PrimitiveWithInfer):
    ...
    Examples:
        >>> input_x = Tensor(np.ones(shape=[32, 1, 224, 224, 16]), luojianet_ms.float16)
    ...
    def __init__(self):
        ...
        self.init_prim_io_names(inputs=['x1'], outputs=['y'])
        from luojianet_ms.ops._op_impl._custom_op.transpose02314_impl import cus_transpose02314
...
class CusMatMulCubeDenseRight(PrimitiveWithInfer):
    ...
    Examples:
        >>> input_x = Tensor(np.ones(shape=[256, 256]), luojianet_ms.float16)
        >>> input_y = Tensor(np.ones(shape=[16, 16, 16, 16]), luojianet_ms.float16)
    ...
    def __init__(self):
        ...
        self.init_prim_io_names(inputs=['x1', 'x2', 'x3'], outputs=['y'])
        from luojianet_ms.ops._op_impl._custom_op.matmul_cube_dense_right_impl import cus_matmul_cube_dense_right
...
class CusMatMulCubeFraczLeftCast(PrimitiveWithInfer):
    ...
    def __init__(self):
        ...
        self.init_prim_io_names(inputs=['x1', 'x2'], outputs=['y'])
        from luojianet_ms.ops._op_impl._custom_op.matmul_cube_fracz_left_cast_impl import cus_matmul_cube_fraczleftcast
