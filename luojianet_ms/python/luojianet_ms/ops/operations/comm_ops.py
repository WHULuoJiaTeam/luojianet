...
class ReduceOp:
    ...
    Note:
        ...
        official websit of `LuoJiaNet \
        <https://www.luojianet_ms.cn/docs/api/zh-CN/master/api_python/luojianet_ms.ops.html#communication-operators>`_.
...
class Broadcast(PrimitiveWithInfer):
    ...
    Examples:
        ...
        >>> # Please refer to the tutorial > Distributed Training on luojianet_ms.cn.
        >>> from luojianet_ms import Tensor
