...
class ReduceOp:
    ...
    Note:
        ...
        official website of `LuoJiaNET \
        <https://www.luojianet_ms.cn/docs/en/r1.7/api_python/luojianet_ms.ops.html#communication-operators>`_.
    ...
    Examples:
        ...
        >>> from luojianet_ms.ops import ReduceOp
...
class AllReduce(PrimitiveWithInfer):
    ...
    Examples:
        >>> # This example should be run with two devices. Refer to the tutorial > Distributed Training on luojianet_ms.cn
        >>> import numpy as np
        >>> from luojianet_ms.communication import init
...
class Broadcast(PrimitiveWithInfer):
    ...
    Examples:
        ...
        >>> # on luojianet_ms.cn and focus on the contents of these three parts: Configuring Distributed Environment
...
class NeighborExchange(Primitive):
    ...
    Note:
        ...
        <https://www.luojianet_ms.cn/tutorials/experts/zh-CN/r1.7/parallel/communicate_ops.html#id2>`_.
    ...
    Example:
        >>> # This example should be run with 2 devices. Refer to the tutorial > Distributed Training on luojianet_ms.cn
        >>> import os
...
class AlltoAll(PrimitiveWithInfer):
    ...
    Example:
        >>> # This example should be run with 8 devices. Refer to the tutorial > Distributed Training on luojianet_ms.cn
        >>> import os
        >>> import luojianet_ms as ms
        >>> from luojianet_ms import Tensor
        >>> from luojianet_ms import context
