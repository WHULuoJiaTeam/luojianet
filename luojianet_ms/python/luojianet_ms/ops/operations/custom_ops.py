...
from luojianet_ms.ops import DataType
from luojianet_ms.common import dtype as mstype
from luojianet_ms._c_expression import Oplib
...
class Custom(ops.PrimitiveWithInfer):
    ...
    primitives. You can call a `Custom` object with a predefined function, which describes the computation
    logic of a user defined operator. You can also call another `Custom` object with another predefined
    ...
    Args:
        ...
        out_dtype (Union[function, :class:`luojianet_ms.dtype`, tuple[:class:`luojianet_ms.dtype`]]): The output data type
            infer function or the value of output data type of `func`.

            If func has single output, then the value of output shape is a `luojianet_ms.dtype`.

            If func has multiple outputs, then the value of output shape is a tuple of `luojianet_ms.dtype`, each item
    ...
    Examples:
        ...
        >>> from luojianet_ms.ops import CustomRegOp, custom_info_register, DataType
        >>> from luojianet_ms.common import dtype as mstype
