...
import inspect
import numpy as np
from luojianet_ms._c_expression import Oplib, typing
...
class Custom(ops.PrimitiveWithInfer):
            ...
            - str: If func is of str type, then str should be a path of file along with a function name.
              ...
              1. for "aot":
                 ...
                 - Define a "xxx.cc"/"xxx.cu" file:
                   ...
                   - 0: LuoJiaNET will continue to run if this aot kernel is successfully executed
                   - others: LuoJiaNET will raise exception and exit
    ...
    def __infer__(self, *args):
        ...
        if not isinstance(infer_dtype, (typing.Type, tuple, list)):
            raise TypeError(
                "The input 'out_dtype' should be one of a luojianet_ms.dtype, tuple, list, and function, "
