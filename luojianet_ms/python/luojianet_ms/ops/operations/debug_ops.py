...
class InsertGradientOf(PrimitiveWithInfer):
    ...
    Args:
        f (Function): LuoJiaNET's Function. Callback function.
    ...
    Raises:
        TypeError: If `f` is not a function of luojianet_ms.
    ...
    Examples:
        >>> import numpy as np
        >>> from luojianet_ms import Tensor, ops, ms_function
...
class Print(PrimitiveWithInfer):
    ...
    For more information, please refer to :func:`luojianet_ms.context.set_context` and :func:`luojianet_ms.parse_print`.
    ...
    Note:
        ...
        `Summary <https://www.luojianet_ms.cn/mindinsight/docs/zh-CN/r1.7/summary_record.html?highlight=summary#>`_.
