...
class RandomCategorical(PrimitiveWithInfer):
    ...
    Args:
        dtype (luojianet_ms.dtype): The type of output. Its value must be one of luojianet_ms.int16,
            luojianet_ms.int32 and luojianet_ms.int64. Default: luojianet_ms.int64.
    ...
    Raises:
        TypeError: If `dtype` is not one of the following: luojianet_ms.int16, luojianet_ms.int32, luojianet_ms.int64.
