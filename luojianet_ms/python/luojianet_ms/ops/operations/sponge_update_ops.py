...
class NeighborListRefresh(PrimitiveWithInfer):
    """
    Update (or call if first time) the Verlet neighbor list for the
    ...
    Args:
        ...
        atom_numbers (int32): the number of atoms n.
        not_first_time (int32): whether to call the neighbor list first time or not.
...
class BondForceWithAtomEnergyAndVirial(PrimitiveWithInfer):
    ...
    there is no way to call `Examples` using random methods. For details, refer the webpage `SPONGE in LuoJiaNet
