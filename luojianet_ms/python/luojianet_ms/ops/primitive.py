...
import inspect
import copy
from luojianet_ms.common.api import _wrap_func
from luojianet_ms.log import _LogActionOnce
from luojianet_ms import context, log as logger
...
class Primitive(Primitive_):
    ...
    Examples:
        >>> from luojianet_ms.ops.primitive import prim_attr_register, Primitive
        >>> add = Primitive('add')
        >>>
    ...
    def __init__(self, name):
        ...
        if hasattr(self.__class__, '__luojianet_ms_signature__'):
            out = self._fill_signature(self.__class__.__luojianet_ms_signature__)
    ...
    def check_elim(self, *args):
        ...
        Examples:
            ...
            ...
            >>> addn = AddN()
            >>> input_x = Tensor(np.array([1, 2, 3]), luojianet_ms.float32)
...
class PrimitiveWithCheck(Primitive):
    ...
    Examples:
        >>> from luojianet_ms.ops.primitive import prim_attr_register, PrimitiveWithCheck
    ...
    def check_dtype(self, *args):
        ...
        Args:
            args (:class:`luojianet_ms.dtype`): data type of inputs.
...
class PrimitiveWithInfer(Primitive):
    ...
    def infer_dtype(self, *args):
        ...
        Return:
            :class:`luojianet_ms.dtype`, data type of outputs.
        """
        return None
