...
class Primitive(Primitive_):
    ...
    def __init__(self, name):
        ...
        if hasattr(self.__class__, '__luojianet_signature__'):
            out = self._fill_signature(self.__class__.__luojianet_signature__)
    ...
    def _clone(self):
        ...
        # __init__ should be called to call cpp object.
