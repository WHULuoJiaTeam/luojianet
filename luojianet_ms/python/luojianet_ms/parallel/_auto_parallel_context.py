...
from luojianet_ms.parallel._dp_allreduce_fusion import _set_fusion_strategy_by_idx, _set_fusion_strategy_by_size
from luojianet_ms.parallel._ps_context import _is_role_pserver
from luojianet_ms._c_expression import AutoParallelContext
from luojianet_ms._checkparam import args_type_check, Validator
...
class _AutoParallelContext:
    ...
    def set_device_num(self, device_num):
        ...
        from luojianet_ms.communication._comm_helper import _HCCL_TEST_AVAILABLE
    ...
    def set_auto_parallel_search_mode(self, search_mode):
        ...
        logger.warning("The attribute 'auto_parallel_search_mode' is currently replaced by 'search_mode'. "
                       "The attribute 'auto_parallel_search_mode' will be deleted in a future LuoJiaNet version.")
        self.check_context_handle()
        ret = self._context_handle.set_strategy_search_mode(search_mode)
        if ret is False:
    ...
    def set_sharding_propagation(self, sharding_propagation):
        ...
        logger.warning("This attribute is replaced by context.set_auto_parallel(search_mode='sharding_propagation'), "
                       "and this attribute will be deleted in a future LuoJiaNet version.")
        self.check_context_handle()
