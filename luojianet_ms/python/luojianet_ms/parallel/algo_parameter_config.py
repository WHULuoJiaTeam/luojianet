...
import threading
from luojianet_ms._c_expression import CostModelContext
...
def set_algo_parameters(**kwargs):
    ...
    <https://gitee.com/luojianet_ms/luojianet_ms/blob/master/tests/ut/python/parallel/test_auto_parallel_resnet.py>`_.
