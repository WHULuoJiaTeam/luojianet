...
NOTE:
    ...
    The import path of Transformer APIs have been modified from `luojianet_ms.parallel.nn` to `luojianet_ms.nn.transformer`,
...
from luojianet_ms.nn.transformer import AttentionMask, VocabEmbedding, MultiHeadAttention, FeedForward, \
...
log.warning("'luojianet_ms.parallel.nn' will be deprecated in the future. Please use 'luojianet_ms.nn.transformer' instead.")
