...
from luojianet_ms.parallel.nn.layers import _check_input_dtype, _check_input_shape
...
class CrossEntropyLoss(Module):
    ...
    Examples:
        ...
        >>> from luojianet_ms.parallel.nn import CrossEntropyLoss
    ...
    def call(self, logits, label, input_mask):
