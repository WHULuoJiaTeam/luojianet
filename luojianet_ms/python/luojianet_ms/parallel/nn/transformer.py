...
from luojianet_ms.parallel._utils import _get_parallel_mode
...
class EmbeddingOpParallelConfig(_Config):
    ...
    Examples:
        >>> from luojianet_ms.parallel.nn import EmbeddingOpParallelConfig
...
class TransformerRecomputeConfig(_Config):
    ...
    Examples:
        >>> from luojianet_ms.parallel.nn import TransformerRecomputeConfig
...
class TransformerOpParallelConfig(_Config):
    ...
    def dp_mp_config(self):
        r"""
            ...
            Examples:
                >>> from luojianet_ms.parallel.nn import TransformerOpParallelConfig
                >>> config=TransformerOpParallelConfig(data_parallel=1, model_parallel=1, vocab_emb_dp=True)
                >>> parallel_config = config.dp_mp_config
        """
...
class FeedForward(Module):
    ...
    Examples:
        >>> import numpy as np
        >>> from luojianet_ms.parallel.nn import FeedForward
...
class AttentionMask(Module):
    ...
    Examples:
        >>> import numpy as np
        >>> from luojianet_ms.parallel.nn import AttentionMask
        >>> from luojianet_ms import Tensor
...
class VocabEmbedding(Module):
    ...
    Examples:
        >>> import numpy as np
        >>> from luojianet_ms.parallel.nn import VocabEmbedding
        >>> from luojianet_ms import Tensor
        >>> from luojianet_ms import dtype as mstype
...
class MultiHeadAttention(Module):
    ...
    Examples:
        >>> import numpy as np
        >>> from luojianet_ms.parallel.nn import MultiHeadAttention
        >>> from luojianet_ms import dtype as mstype
        >>> from luojianet_ms import Tensor
    ...
    def call(self, query_tensor, key_tensor, value_tensor, attention_mask, key_past=None,
...
class TransformerEncoderLayer(Module):
    ...
    Examples:
        >>> import numpy as np
        >>> from luojianet_ms import dtype as mstype
        >>> from luojianet_ms.parallel.nn import TransformerEncoderLayer
        >>> from luojianet_ms import Tensor
    ...
    def call(self, x, input_mask, init_reset=True, batch_valid_length=None):
...
class TransformerDecoderLayer(Module):
    ...
    Examples:
        >>> import numpy as np
        >>> from luojianet_ms import dtype as mstype
        >>> from luojianet_ms.parallel.nn import TransformerDecoderLayer
        >>> from luojianet_ms import Tensor
...
class TransformerEncoder(Module):
    ...
    Examples:
        >>> import numpy as np
        >>> from luojianet_ms import dtype as mstype
        >>> from luojianet_ms.parallel.nn import TransformerEncoder
        >>> from luojianet_ms import Tensor
    ...
    def call(self, hidden_states, attention_mask, init_reset=True, batch_valid_length=None):
        present_layer = ()
        if self.use_moe is True:
...
class TransformerDecoder(Module):
    ...
    Examples:
        >>> import numpy as np
        >>> from luojianet_ms import dtype as mstype
        >>> from luojianet_ms.parallel.nn import TransformerDecoder
        >>> from luojianet_ms import Tensor
    ...
    def call(self, hidden_states, attention_mask, encoder_output=None, memory_mask=None,
                  init_reset=True, batch_valid_length=None):
        present_layer = ()
        if self.use_moe is True:
            accum_loss = self.aux_loss
...
class Transformer(Module):
    ...
    Examples:
        >>> import numpy as np
        >>> from luojianet_ms import dtype as mstype
        >>> from luojianet_ms.parallel.nn import Transformer
        >>> from luojianet_ms import Tensor
