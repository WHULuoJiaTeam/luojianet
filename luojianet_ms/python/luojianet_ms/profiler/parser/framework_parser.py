...
from luojianet_ms.profiler.parser.framework_struct import TASK_DESC_STRUCT
from luojianet_ms.profiler.parser.framework_struct import TENSOR_DATA_STRUCT
from luojianet_ms.profiler.parser.framework_struct import STEP_INFO_STRUCT
from luojianet_ms.profiler.parser.framework_enum import VmDataType, VmFormat, FileDataType
from luojianet_ms.profiler.common.struct_type import StructType
from luojianet_ms.profiler.common.util import combine_stream_task_id
...
from luojianet_ms.profiler.common.exceptions.exceptions import ProfilerParamValueErrorException
        ...
        for file in Path(data_dir).glob(r'Framework*[0-9]'):
            ...
            if match['data_type'] not in FileDataType.members():
                ...
                if match['data_type'].startswith('vm'):
                    raise RuntimeError("The current profiler file is generated by LuoJiaNET 1.5 or earlier. Use "
                                       "LuoJiaNET 1.5 or the matching LuoJiaNET version to parse the profiler file.")
                continue
