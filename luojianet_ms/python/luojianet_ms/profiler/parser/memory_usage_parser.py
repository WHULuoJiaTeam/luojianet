...
from luojianet_ms.profiler.common.exceptions.exceptions import ProfilerIOException, \
    ProfilerFileNotFoundException, ProfilerRawFileException
from luojianet_ms.profiler.common.validator.validate_path import validate_and_normalize_path
from luojianet_ms.profiler.parser.container import MemoryGraph as Graph
from luojianet_ms.profiler.parser.container import MemoryNode as Node
from luojianet_ms.profiler.parser.container import MemoryTensor as Tensor
import luojianet_ms._c_expression as c_expression

if not c_expression.security.enable_security():
    from luojianet_ms.train.memory_profiling_pb2 import MemoryProto
else:
    MemoryProto = None
