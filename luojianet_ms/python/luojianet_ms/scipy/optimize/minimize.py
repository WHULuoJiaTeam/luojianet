...
def minimize(func, x0, args=(), *, method, tol=None, options=None):
    ...
    - Gradients of ``func`` are calculated automatically using LuoJiaNet's autodiff
    ...
    Examples:
        >>> import numpy as onp
        >>> from luojianet_ms.scipy.optimize import minimize
    ...
    if not isinstance(args, tuple):
        msg = "args argument to luojianet_ms.scipy.optimize.minimize must be a tuple, got {}"
