...
from luojianet_ms.common.dtype import dtype_to_nptype, pytype_to_dtype
...
from luojianet_ms.train.node_strategy_pb2 import ParallelStrategyMap as ckpt_strategy
