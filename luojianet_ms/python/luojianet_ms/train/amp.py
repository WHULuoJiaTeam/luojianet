...
def build_train_network(network, optimizer, loss_fn=None, level='O0', boost_level='O0', **kwargs):
    ...
    Args:
        ...
        cast_model_type (:class:`luojianet_ms.dtype`): Supports `mstype.float16` or `mstype.float32` . If set, the
        ...
        loss_scale_manager (Union[None, LossScaleManager]): If not None, must be subclass of
            :class:`luojianet_ms.LossScaleManager` for scaling the loss. If set, the `level` setting will take no effect
            on this property.
