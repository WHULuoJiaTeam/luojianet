...
from luojianet_ms.train.serialization import _fill_param_into_net
from luojianet_ms.train.summary.summary_record import _cache_summary_tensor_data
...
def checkpoint_cb_for_save_op(parameter_list):
    """
    The checkpoint callback function for LuoJiaNET.
...
def summary_cb_for_save_op(summary_list):
    """
    The summary callback function for LuoJiaNET.
...
class Callback:
    ...
    `Callback <https://www.luojianet_ms.cn/tutorials/experts/en/r1.7/debug/custom_debug.html>`_.
...
class RunContext:
    ...
    This class needs to be used with :class:`luojianet_ms.train.callback.Callback`.
