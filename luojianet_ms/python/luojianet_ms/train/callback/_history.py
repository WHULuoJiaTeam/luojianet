...
class History(Callback):
    ...
    Note:
        Normally used in `luojianet_ms.Model.train`.

    Examples:
        >>> import numpy as np
        >>> import luojianet_ms.dataset as ds
        >>> from luojianet_ms.train.callback import History
    ...
    def begin(self, run_context):
        ...
        Args:
            run_context (RunContext): Context of the `luojianet_ms.Model.{train | eval}`.
        """
        self.epoch = {"epoch": []}
