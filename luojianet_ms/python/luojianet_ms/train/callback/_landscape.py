...
from luojianet_ms.train.summary_pb2 import LossLandscape
from luojianet_ms.train.summary import SummaryRecord
from luojianet_ms.train.summary.enums import PluginEnum
from luojianet_ms.train.anf_ir_pb2 import DataType
...
class SummaryLandscape:
    ...
    Examples:
        ...
        >>> from luojianet_ms.nn import Loss, Accuracy
        >>>
    ...
    def _normalize_vector(parameters, get_v, get_w):
        ...
        for i, param in enumerate(parameters):
            # Here as LuoJiaNet ckpt has hyperparameters, we should skip them to make sure
    ...
    def _calc_coefs(self, parameter_group, final_param_ndarray, v_vector, w_vector):
        ...
        for parameters in parameter_group:
            testi = list()
            for param in parameters:
                # Here as LuoJiaNet ckpt has hyperparameters,
