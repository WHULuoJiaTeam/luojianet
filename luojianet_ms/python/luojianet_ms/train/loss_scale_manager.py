...
class FixedLossScaleManager(LossScaleManager):
    ...
    def get_update_cell(self):
        ...
        Returns:
            None or :class:`luojianet_ms.FixedLossScaleUpdateCell`. Instance of
            :class:`luojianet_ms.FixedLossScaleUpdateCell` when `drop_overflow_update` is True. None when
...
class DynamicLossScaleManager(LossScaleManager):
    ...
    def get_update_cell(self):
        ...
        Returns:
            :class:`luojianet_ms.DynamicLossScaleUpdateCell`.
        """
