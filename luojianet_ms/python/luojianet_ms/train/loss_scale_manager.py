...
class FixedLossScaleManager(LossScaleManager):
    ...
    inherits from :class:`luojianet_ms.LossScaleManager`.
    ...
    def get_update_cell(self):
        ...
        Returns:
            None or :class:`luojianet_ms.nn.FixedLossScaleUpdateCell`. Instance of
            :class:`luojianet_ms.nn.FixedLossScaleUpdateCell` when `drop_overflow_update` is True. None when
...
class DynamicLossScaleManager(LossScaleManager):
    ...
    adjusted, inherits from :class:`luojianet_ms.LossScaleManager`.
    ...
    Examples:
        >>> from luojianet_ms import Model, nn, DynamicLossScaleManager
        >>>
        >>> net = Net()
    ...
    def get_update_cell(self):
        ...
        Returns:
            :class:`luojianet_ms.nn.DynamicLossScaleUpdateCell`.
        """
