    ...
    def add_value(self, plugin, name, value):
        ...
        Args:
            ...
            value (Union[Tensor, GraphProto, TrainLineage, EvaluationLineage, DatasetGraph, UserDefinedInfo,
                ...
                - The data type of value should be 'GraphProto' (see `luojianet_ms/ccsrc/anf_ir.proto
                  <https://gitee.com/luojianet_ms/luojianet_ms/blob/master/luojianet_ms/ccsrc/utils/anf_ir.proto>`_) object
                ...
                - The data type of value should be a 'TrainLineage' object when the plugin is 'train_lineage',
                  see `luojianet_ms/ccsrc/lineage.proto
                  <https://gitee.com/luojianet_ms/luojianet_ms/blob/master/luojianet_ms/ccsrc/utils/lineage.proto>`_.
                ...
                - The data type of value should be a 'LossLandscape' object when the plugin is 'LANDSCAPE',
                  see `luojianet_ms/ccsrc/summary.proto
                  <https://gitee.com/luojianet_ms/luojianet_ms/blob/master/luojianet_ms/ccsrc/utils/summary.proto>`_.
