...
is redefined to inherit the Model class provided by LuoJiaNET. The parameter of THOR for controlling the frequency
of updating the second-order matrix can be obtained by the ModelThor class. """
import math
from luojianet_ms.train.callback import RunContext
...
from luojianet_ms.parallel._utils import _need_to_full, _to_full_tensor
...
def _convert_to_ms_type(types):
    """
    Convert from numpy type to luojianet_ms tensor type.
