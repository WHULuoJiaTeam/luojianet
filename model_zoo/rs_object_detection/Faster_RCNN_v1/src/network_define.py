...
class LossCallBack(Callback):
    ...
    def step_end(self, run_context):
        ...
        if self.count >= 1:
            ...
            loss_file = open("./output_dir/loss_{}.log".format(self.rank_id), "a+")
...
class LossNet(nn.Module):
    ...
    def call(self, x1, x2, x3, x4, x5, x6):
        # print('===> rpn_loss: ', float(x1[0].asnumpy()), ', rcnn_loss: ', float(x2.asnumpy()), ', rpn_cls_loss: ', float(x3[0].asnumpy()),
        #       ', rpn_reg_loss: ', float(x4[0].asnumpy()), ', rcnn_cls_loss: ', float(x5.asnumpy()), ', rcnn_reg_loss: ', float(x6.asnumpy()), ',')
        return x1 + x2
