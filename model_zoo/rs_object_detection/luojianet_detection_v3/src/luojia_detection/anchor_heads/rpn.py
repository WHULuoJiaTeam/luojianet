...
from ..bbox_assigners import BboxAssignSample
...
class RPN(nn.Module):
    ...
    def __init__(self,
        ...
        self.num_expected_total = Tensor(np.array(cfg_rpn.num_expected_neg * self.batch_size).astype(self.np_cast_type))
        self.num_bboxes = cfg_rpn.num_bboxes
    ...
    def forward(self, inputs, img_metas, anchor_list, gt_bboxes, gt_labels, gt_valids):
        loss_print = ()
        rpn_cls_score = ()
        rpn_bbox_pred = ()
        rpn_cls_score_total = ()
