...
def get_config():
    ...
    parser.add_argument("--config_path", type=str, default=os.path.join(current_dir, "../../../configs/mask_rcnn_r152_fpn_ml_inference.yaml"),
    ...
    parser.add_argument("--ml_infer_cfg_path", type=str, default=None, help="Inference ml config file path.")
    parser.add_argument("--ml_infer_checkpoint_path", type=str, default=None, help="Inference ml checkpoint path.")
    ...
    if args.enable_infer:
        ...
        if args.ml_infer_cfg_path is not None:
            final_config["ml_cfg_path"] = args.ml_infer_cfg_path
        if args.ml_infer_checkpoint_path is not None:
            final_config["ml_checkpoint_path"] = args.ml_infer_checkpoint_path
