...
from ..heads import RcnnCls, RcnnMask
from ..roi_extractors import SingleRoIExtractor
from ..anchor_heads.anchor_generator import AnchorGenerator

class Mask_Rcnn_Resnet(nn.Module):
    """
    MaskRcnn Network.
    ...
    Examples:
        net = Mask_Rcnn_Resnet()
    """
    def __init__(self, config):
        super(Mask_Rcnn_Resnet, self).__init__()
    ...
    def call(self, img_data, img_metas, gt_bboxes, gt_labels, gt_valids, gt_masks):
...
class MaskRcnn_Infer(nn.Module):
    def __init__(self, config):
