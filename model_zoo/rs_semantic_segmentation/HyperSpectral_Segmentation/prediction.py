...
def prediction(config, ckpt_path=''):
...
if __name__ == "__main__":
    ...
    parser.add_argument('-o','--output_pth', type=str, default=None, help='Output file path')
    ...
    output_pth = args_opt.output_pth

    default_config = FreeNet_HC_config
    default_config['test']['params']['test_data_dir'] = input_file
    default_config['picture_save_dir'] = output_pth

    prediction(default_config, checkpoint_path)