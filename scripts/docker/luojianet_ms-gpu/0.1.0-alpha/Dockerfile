...
RUN pip install --no-cache-dir https://ms-release.obs.cn-north-4.myhuaweicloud.com/0.1.0-alpha/LuoJiaNET/gpu/cuda-10.1/luojianet_ms-0.1.0-cp37-cp37m-linux_x86_64.whl
