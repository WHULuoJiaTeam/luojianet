...
RUN pip install --no-cache-dir https://ms-release.obs.cn-north-4.myhuaweicloud.com/0.7.0-beta/LuoJiaNET/gpu/ubuntu_x86/cuda-10.1/luojianet_ms_gpu-0.7.0-cp37-cp37m-linux_x86_64.whl
