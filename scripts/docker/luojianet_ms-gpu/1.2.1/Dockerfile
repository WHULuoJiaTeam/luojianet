...
RUN pip install --no-cache-dir https://ms-release.obs.cn-north-4.myhuaweicloud.com/1.2.1/LuoJiaNET/gpu/ubuntu_x86/cuda-10.1/luojianet_ms_gpu-1.2.1-cp37-cp37m-linux_x86_64.whl
