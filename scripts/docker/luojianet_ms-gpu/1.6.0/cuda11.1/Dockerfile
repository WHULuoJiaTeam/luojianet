...
# Install LuoJiaNET cuda-11.1, MindInsight, Serving whl package
RUN pip install --no-cache-dir https://ms-release.obs.cn-north-4.myhuaweicloud.com/1.6.0/LuoJiaNET/gpu/x86_64/cuda-11.1/luojianet_ms_gpu-1.6.0-cp37-cp37m-linux_x86_64.whl \
    && pip install --no-cache-dir https://ms-release.obs.cn-north-4.myhuaweicloud.com/1.6.0/MindInsight/any/mindinsight-1.6.0-py3-none-any.whl \
    && pip install --no-cache-dir https://ms-release.obs.cn-north-4.myhuaweicloud.com/1.6.0/Serving/x86_64/luojianet_ms_serving-1.6.0-cp37-cp37m-linux_x86_64.whl
