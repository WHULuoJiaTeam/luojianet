...
# Prepare and Install luojianet_ms ascend by Conda on EulerOS 2.8.
#
# This file will:
...
#   To set augments, run it as `PYTHON_VERSION=3.9 LUOJIANET_MS_VERSION=1.6.0 bash ./euleros-ascend-conda.sh`.
...
install_name="luojianet_ms-ascend"
