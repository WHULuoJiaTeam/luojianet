...
#
# Usage:
#   Run script like `LUOJIANET_MS_VERSION=1.7.0 bash ./euleros-ascend-pip.sh`.
#   To set augments, run it as `PYTHON_VERSION=3.9 LUOJIANET_MS_VERSION=1.6.0 bash ./euleros-ascend-pip.sh`.
