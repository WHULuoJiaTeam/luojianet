...
class BuildPy(build_py):
    ...
    def run(self):
        super().run()
        luojianet_dir = os.path.join(pkg_dir, 'build', 'lib', 'luojianet_ms')
        update_permissions(luojianet_dir)
        luojianet_dir = os.path.join(pkg_dir, 'build', 'lib', 'luojianet_ms', '_akg')
        update_permissions(luojianet_dir)
