...
from luojianet_ms.tests.models.Bert_NEZHA.bert_model import BertAttention, SaturateCast, \
...
@luojianet_ms_test(pipeline_for_compare_forward_with_npy_for_group_by_group_config_using_group_policy)
