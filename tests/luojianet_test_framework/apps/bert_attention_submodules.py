...
from luojianet_ms.tests.models.Bert_NEZHA.bert_model import SaturateCast, RelaPosEmbeddingsGenerator
...
class BertAttentionRelativePositionKeys(nn.Module):
    ...
    def call(self, input_tensor, query_layer):
...
class BertAttentionSoftmax(nn.Module):
    ...
    def call(self, to_tensor, attention_scores):
...
class BertAttentionRelativePositionValues(nn.Module):
    ...
    def call(self, input_tensor, attention_probs):
        # use_relative_position, supplementary logic
