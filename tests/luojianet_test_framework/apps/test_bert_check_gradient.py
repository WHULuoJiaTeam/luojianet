...
from luojianet_ms.tests.models.Bert_NEZHA import GetNextSentenceOutput, BertNetworkWithLoss
from luojianet_ms.tests.models.Bert_NEZHA.bert_model import BertConfig, \
...
@luojianet_ms_test(pipeline_for_compare_inputs_grad_with_numerical_diff_for_group_by_group_config)
def test_bert_check_gradient_wrt_inputs_exec():
    context.set_context(mode=context.GRAPH_MODE)
    return verification_set


@luojianet_ms_test(pipeline_for_compare_params_grad_with_numerical_diff_for_group_by_group_config)
