...
"""Component that call function that init params with random function and return forward results."""
...
class RunBlockWithRandParamBC(IBuilderComponent):
    """
    Build a function with uniformed params that run luojianet_ms pipeline.
