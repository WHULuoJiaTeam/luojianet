...
class ApplyAddSignNet(nn.Module):
    ...
    def forward(self, lr, alpha, sign_decay, beta, grad):
...
class ApplyCenteredRMSPropNet(nn.Module):
    ...
    def forward(self, mean_grad, mean_square, moment, grad, learning_rate):
...
class ApplyFtrlNet(nn.Module):
    ...
    def forward(self, grad, lr, l1, l2, lr_power):
...
class ApplyPowerSignNet(nn.Module):
    ...
    def forward(self, lr, logbase, sign_decay, beta, grad):
...
class ApplyProximalAdagradNet(nn.Module):
    ...
    def forward(self, lr, l1, l2, grad):
...
class ApplyProximalGradientDescentNet(nn.Module):
    ...
    def forward(self, alpha, l1, l2, delta):
...
class ApplyRMSPropNet(nn.Module):
    ...
    def forward(self, mean_square, moment, learning_rate, grad):
...
class FusedSparseProximalAdagradNet(nn.Module):
    ...
    def forward(self, lr, l1, l2, grad, indices):
...
class SGDNet(nn.Module):
    ...
    def forward(self, gradient, learning_rate, accum, momentum, stat):
