...
def test_fallback_control_sink_tensor():
    """
    Feature: Fallback feature: support define Tensor in Class call.
    Description: Fallback feature: support define Tensor in Class call.
    Expectation: Fallback feature: support define Tensor in Class call.
    """
