...
class YoloLossBlock(nn.Module):
    ...
    def call(self, grid, prediction, pred_xy, pred_wh, y_true, gt_box):
...
class YoloWithLossCell(nn.Module):
    ...
    def call(self, x, y_true_0, y_true_1, y_true_2, gt_0, gt_1, gt_2):
...
class YoloBoxScores(nn.Module):
    ...
    def call(self, box_xy, box_wh, box_confidence, box_probs, image_shape):
