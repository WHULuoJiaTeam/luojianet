...
class XYLoss(nn.Module):
    ...
    def call(self, object_mask, box_loss_scale, predict_xy, true_xy):
...
class WHLoss(nn.Module):
    ...
    def call(self, object_mask, box_loss_scale, predict_wh, true_wh):
...
class ConfidenceLoss(nn.Module):
    ...
    def call(self, object_mask, predict_confidence, ignore_mask):
...
class ClassLoss(nn.Module):
    ...
    def call(self, object_mask, predict_class, class_probs):
