...
class MindDataTestAWEIOp : public UT::CVOP::CVOpCommon {
 protected:
  MindDataTestAWEIOp() : CVOpCommon() {}

  std::shared_ptr<Tensor> output_tensor_;
};

TEST_F(MindDataTestAWEIOp, TestOp1) {
  MS_LOG(INFO) << "Doing testAWEI.";
  std::unique_ptr<AWEIOp> op(new AWEIOp());
  EXPECT_TRUE(op->OneToOne());
  
  std::string band2 ="/test_luojianet/luojianet1/luojianet/test_data/LC81220392013285LGN01/LC08_L1TP_122039_20131012_20170429_01_T1_B2.TIF";
  ...
  std::string band5 ="/test_luojianet/luojianet1/luojianet/test_data/LC81220392013285LGN01/LC08_L1TP_122039_20131012_20170429_01_T1_B5.TIF";
  ...
  std::string band7 ="/test_luojianet/luojianet1/luojianet/test_data/LC81220392013285LGN01/LC08_L1TP_122039_20131012_20170429_01_T1_B7.TIF";
  ...
  mergesrc.push_back(input_band5);
  mergesrc.push_back(input_band6);
  mergesrc.push_back(input_band7);
  ...
  cv::imwrite("/test_luojianet/luojianet1/luojianet/temp_awei.tif", output_img);
  MS_LOG(INFO) << "testAWEI end.";
