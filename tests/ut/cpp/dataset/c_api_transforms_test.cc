...
#include "luojianet_ms/ccsrc/minddata/dataset/core/tensor.h"
#include "luojianet_ms/ccsrc/minddata/dataset/core/data_type.h"
...
TEST_F(MindDataTestPipeline, TestConcatenateSuccess1) {
  ...
  ASSERT_OK(schema->add_column("col1", luojianet_ms::DataType::kNumberTypeInt16, {1}));
  ...
  luojianet_ms::MSTensor prepend_MSTensor =
    luojianet_ms::MSTensor(std::make_shared<luojianet_ms::dataset::DETensor>(prepend_tensor));
  ...
  luojianet_ms::MSTensor append_MSTensor =
    luojianet_ms::MSTensor(std::make_shared<luojianet_ms::dataset::DETensor>(append_tensor));
...
TEST_F(MindDataTestPipeline, TestConcatenateFail2) {
  ...
  GlobalContext::config_manager()->set_seed(246);
  std::shared_ptr<SchemaObj> schema = Schema();
  ASSERT_OK(schema->add_column("col1", luojianet_ms::DataType::kNumberTypeInt16, {1, 2}));
  std::shared_ptr<Dataset> ds = RandomData(1, schema);
  EXPECT_NE(ds, nullptr);
  ds = ds->SetNumWorkers(1);
  EXPECT_NE(ds, nullptr);
...
TEST_F(MindDataTestPipeline, TestFillSuccessInt) {
  ...
  std::shared_ptr<SchemaObj> schema = Schema();
  ASSERT_OK(schema->add_column("col1", luojianet_ms::DataType::kNumberTypeInt32, {6}));
  ...
  luojianet_ms::MSTensor fill_value_MSTensor =
    luojianet_ms::MSTensor(std::make_shared<luojianet_ms::dataset::DETensor>(fill_value_tensor));
...
TEST_F(MindDataTestPipeline, TestFillSuccessBool) {
  ...
  std::shared_ptr<SchemaObj> schema = Schema();
  ASSERT_OK(schema->add_column("col1", luojianet_ms::DataType::kNumberTypeBool, {4}));
...
TEST_F(MindDataTestPipeline, TestFillSuccessDownTypecast16) {
  ...
  GlobalContext::config_manager()->set_seed(963);
  std::shared_ptr<SchemaObj> schema = Schema();
  ASSERT_OK(schema->add_column("col1", luojianet_ms::DataType::kNumberTypeUInt16, {4}));
  std::shared_ptr<Dataset> ds = RandomData(3, schema);
  EXPECT_NE(ds, nullptr);
  ds = ds->SetNumWorkers(2);
  EXPECT_NE(ds, nullptr);
...
TEST_F(MindDataTestPipeline, TestFillSuccessUpTypecast) {
  ...
  GlobalContext::config_manager()->set_seed(963);
  std::shared_ptr<SchemaObj> schema = Schema();
  ASSERT_OK(schema->add_column("col1", luojianet_ms::DataType::kNumberTypeFloat32, {2}));
...
TEST_F(MindDataTestPipeline, TestMaskSuccess1) {
  ...
  GlobalContext::config_manager()->set_seed(246);
  std::shared_ptr<SchemaObj> schema = Schema();
  ASSERT_OK(schema->add_column("col1", luojianet_ms::DataType::kNumberTypeInt16, {4}));
  std::shared_ptr<Dataset> ds = RandomData(4, schema);
  EXPECT_NE(ds, nullptr);
  ds = ds->SetNumWorkers(2);
  EXPECT_NE(ds, nullptr);
  ...
  luojianet_ms::MSTensor constant_MSTensor =
    luojianet_ms::MSTensor(std::make_shared<luojianet_ms::dataset::DETensor>(constant_tensor));
...
TEST_F(MindDataTestPipeline, TestMaskSuccess2) {
  ...
  GlobalContext::config_manager()->set_seed(246);
  std::shared_ptr<SchemaObj> schema = Schema();
  ASSERT_OK(schema->add_column("col1", luojianet_ms::DataType::kNumberTypeFloat16, {4}));
  std::shared_ptr<Dataset> ds = RandomData(4, schema);
  EXPECT_NE(ds, nullptr);
  ds = ds->SetNumWorkers(2);
  EXPECT_NE(ds, nullptr);
  ...
  transforms::Mask mask =
    transforms::Mask(RelationalOp::kLessEqual, constant_MSTensor, luojianet_ms::DataType::kNumberTypeBool);
  ds = ds->Map({mask}, {"col1"});
  EXPECT_NE(ds, nullptr);
  ...
  luojianet_ms::MSTensor constant_MSTensor2 =
    luojianet_ms::MSTensor(std::make_shared<luojianet_ms::dataset::DETensor>(constant_tensor2));
  ...
  while (row.size() != 0) {
    ...
    luojianet_ms::MSTensor expected_tensor2 =
      luojianet_ms::MSTensor(std::make_shared<luojianet_ms::dataset::DETensor>(de_expected_tensor2));
...
TEST_F(MindDataTestPipeline, TestMaskSuccess3) {
  ...
  transforms::Mask mask =
    transforms::Mask(RelationalOp::kEqual, constant_MSTensor, luojianet_ms::DataType::kNumberTypeInt16);
  ds = ds->Map({mask}, {"text"});
  EXPECT_NE(ds, nullptr);
...
TEST_F(MindDataTestPipeline, TestMaskFail1) {
  ...
  luojianet_ms::MSTensor constant_MSTensor =
    luojianet_ms::MSTensor(std::make_shared<luojianet_ms::dataset::DETensor>(constant_tensor));
  transforms::Mask mask =
    transforms::Mask(RelationalOp::kGreater, constant_MSTensor, luojianet_ms::DataType::kObjectTypeString);
  ds = ds->Map({mask}, {"col1"});
  EXPECT_NE(ds, nullptr);
...
TEST_F(MindDataTestPipeline, TestPadEndSuccess1) {
  ...
  luojianet_ms::MSTensor pad_value_MSTensor =
    luojianet_ms::MSTensor(std::make_shared<luojianet_ms::dataset::DETensor>(pad_value));
...
TEST_F(MindDataTestPipeline, TestPadEndSuccess2) {
  ...
  GlobalContext::config_manager()->set_seed(246);
  std::shared_ptr<SchemaObj> schema = Schema();
  ASSERT_OK(schema->add_column("col1", luojianet_ms::DataType::kNumberTypeInt16, {2}));
  std::shared_ptr<Dataset> ds = RandomData(4, schema);
  EXPECT_NE(ds, nullptr);
  ds = ds->SetNumWorkers(2);
  EXPECT_NE(ds, nullptr);
...
TEST_F(MindDataTestPipeline, TestSliceSuccess5) {
  ...
  ASSERT_OK(schema->add_column("col1", luojianet_ms::DataType::kNumberTypeInt16, {3, 2}));
  std::shared_ptr<Dataset> ds = RandomData(4, schema);
  EXPECT_NE(ds, nullptr);
  ds = ds->SetNumWorkers(2);
  EXPECT_NE(ds, nullptr);
...
TEST_F(MindDataTestPipeline, TestTypeCastSuccess) {
  ...
  EXPECT_EQ(ori_type, luojianet_ms::DataType(luojianet_ms::TypeId::kNumberTypeUInt8));
  ...
  std::shared_ptr<TensorTransform> type_cast =
    std::make_shared<transforms::TypeCast>(luojianet_ms::DataType::kNumberTypeUInt16);
  ...
  EXPECT_EQ(cur_type, luojianet_ms::DataType(luojianet_ms::TypeId::kNumberTypeUInt16));
...
TEST_F(MindDataTestPipeline, TestTypeCastFail) {
  ...
  // incorrect data type
  std::shared_ptr<TensorTransform> type_cast =
    std::make_shared<transforms::TypeCast>(luojianet_ms::DataType::kTypeUnknown);
