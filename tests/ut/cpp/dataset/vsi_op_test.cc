...
#include "minddata/dataset/kernels/image/vsi_op.h"
...
class MindDataTestVSIOp : public UT::CVOP::CVOpCommon {
 protected:
  MindDataTestVSIOp() : CVOpCommon() {}

  std::shared_ptr<Tensor> output_tensor_;
};

TEST_F(MindDataTestVSIOp, TestOp1) {
  MS_LOG(INFO) << "Doing testVSI.";
  std::unique_ptr<VSIOp> op(new VSIOp());
  ...
  std::string bandhv ="/test_luojianet/luojianet1/luojianet/test_data/SAR/HHHV/s1a-ew-grd-hv-20220117t144920-20220117t145019-041502-04ef79-002.tiff";
  ...
  cv::imwrite("/test_luojianet/luojianet1/luojianet/temp_VSI.tif", output_img);
  MS_LOG(INFO) << "testVSI end.";
