...
// #include "luojianet_ms/ccsrc/runtime/device/ascend/ascend_device_address.h"
#include "luojianet_ms/ccsrc/runtime/device/gpu/gpu_device_address.h"
...
using AscendDeviceAddress = device::gpu::GPUDeviceAddress;
