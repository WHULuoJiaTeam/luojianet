...
class UniformProb1(nn.Module):
    ...
    def forward(self, value, low, high):
...
def test_uniform_prob1():
    """
    Test probability functions: passing low/high, value through forward.
    """
    net = UniformProb1()
...
class UniformKl(nn.Module):
    ...
    def forward(self, low_b, high_b, low_a, high_a):
...
class UniConstruct(nn.Module):
    """
    Uniform distribution: going through forward.
    """
