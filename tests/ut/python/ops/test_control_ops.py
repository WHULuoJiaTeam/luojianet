...
def test_switch_layer():
    ...
    class SwitchLayerCell(nn.Module):
        def __init__(self):
...
def test_parser_switch_layer_inputs_tuple():
    class TwoInputTupleFinalNet(nn.Module):
        ...
        def forward(self, i, inputa, inputb):
