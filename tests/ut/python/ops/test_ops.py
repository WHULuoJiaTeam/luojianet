...
class NLLLoss(nn.Module):
    ...
    def call(self, input_x, target, weight):
...
class ClipByNorm(nn.Module):
    ...
    def call(self, input_x, max_norm):
...
class LaplaceNet(nn.Module):
    ...
    def call(self, mean, lambda_param):
...
class DynamicGRUV2Net(nn.Module):
    ...
    def call(self, x, w_i, w_h, b_i, b_h, init_h):
